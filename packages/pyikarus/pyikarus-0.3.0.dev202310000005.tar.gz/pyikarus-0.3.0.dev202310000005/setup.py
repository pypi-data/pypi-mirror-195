...
pyikarusVersion = "0.3.0.dev202310000005" #+ datetime.today().time().strftime("%H%M%S")
duneVersion = "2.9.0"

metadata = metaData(duneVersion)[1]
metadata["version"] = pyikarusVersion

metadata["packages"] = find_namespace_packages(where="python", include=["ikarus.*"],exclude=["tests", "tests.*"])
