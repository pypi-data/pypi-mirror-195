...
class RequestContext(types.SimpleNamespace):
...
class RequestContextHandlerProtocol(typing.Protocol):
    def __call__(self, request_context: RequestContext):
        pass


class RequestContextHandlerProtocolAsync(typing.Protocol):
    async def __call__(self, request_context: RequestContext):
        pass
