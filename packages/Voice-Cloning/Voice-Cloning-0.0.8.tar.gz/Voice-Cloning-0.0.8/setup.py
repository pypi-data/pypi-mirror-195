...
setup(
    ...
    package_data={'voice_cloning': ['saved_models/default/*', 'saved_models/Indian-voice-cloning/*', 'encoder/data_objects/*', 'synthesizer/models/*', 'synthesizer/utils/*', 'vocoder/models/*']},
