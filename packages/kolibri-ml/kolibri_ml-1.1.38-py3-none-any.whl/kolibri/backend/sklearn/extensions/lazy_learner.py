    ...
    def fit(self, X, y):
        ...
        * `n_nodes_`: number of nodes
        ...
        if self.distance=='heom':
            distance_metric = HEOM(X, cat_ix=self.categorical_ix, encode_categories=False, nan_equivalents = [12345], num_features_dist_importance=self.num_features_dist_importance).get_distance
