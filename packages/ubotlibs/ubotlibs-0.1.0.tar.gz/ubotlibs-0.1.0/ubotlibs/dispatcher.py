...
class Dispatcher:
    ...
    def __init__(self, client: "ubotlibs.Client"):
        ...
        async def message_parser(update, users, chats):
            return (
                await ubotlibs.types.Message._parse(self.client, update.message, users, chats,
        ...
        async def poll_parser(update, users, chats):
            return (
                ubotlibs.types.Poll._parse_update(self.client, update),
                PollHandler
            )
        ...
        async def chat_member_updated_parser(update, users, chats):
            return (
                ubotlibs.types.ChatMemberUpdated._parse(self.client, update, users, chats),
                ChatMemberUpdatedHandler
            )

        async def chat_join_request_parser(update, users, chats):
            return (
                ubotlibs.types.ChatJoinRequest._parse(self.client, update, users, chats),
