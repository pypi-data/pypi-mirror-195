...
class UserStatusHandler(Handler):
    ...
    It is intended to be used with :meth:`~darmilibs.Client.add_handler`.

    For a nicer way to register this handler, have a look at the :meth:`~darmilibs.Client.on_user_status` decorator.
