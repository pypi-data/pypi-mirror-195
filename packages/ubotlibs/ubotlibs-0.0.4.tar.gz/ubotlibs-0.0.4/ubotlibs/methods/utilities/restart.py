...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~darmilibs.Client.stop` and then :meth:`~darmilibs.Client.start` in a row in
        ...
        Returns:
            :obj:`~darmilibs.Client`: The restarted client itself.
