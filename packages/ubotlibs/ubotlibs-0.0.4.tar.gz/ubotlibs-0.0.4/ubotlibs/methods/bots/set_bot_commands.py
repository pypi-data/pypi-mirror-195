...
class SetBotCommands:
    async def set_bot_commands(
        ...
        Parameters:
            commands (List of :obj:`~darmilibs.types.BotCommand`):
                A list of bot commands.
                At most 100 commands can be specified.

            scope (:obj:`~darmilibs.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~darmilibs.types.BotCommandScopeDefault`.
        ...
        Example:
            .. code-block:: python
                ...
                from darmilibs.types import BotCommand
