...
from darmilibs.crypto import aes, rsa, prime
from darmilibs.errors import SecurityCheckMismatch
from darmilibs.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "darmilibs.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
