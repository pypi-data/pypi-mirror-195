...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~darmilibs.types.InputMediaPhoto`, :obj:`~darmilibs.types.InputMediaVideo`, :obj:`~darmilibs.types.InputMediaAudio` and :obj:`~darmilibs.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~darmilibs.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from darmilibs.types import InputMediaPhoto, InputMediaVideo
