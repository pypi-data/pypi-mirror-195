...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~darmilibs.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~darmilibs.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~darmilibs.types.Message` objects.
