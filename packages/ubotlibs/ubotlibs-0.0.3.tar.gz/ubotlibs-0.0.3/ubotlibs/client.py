...
import darmilibs
from darmilibs import __version__, __license__
from darmilibs import enums
from darmilibs import raw
from darmilibs import utils
from darmilibs.crypto import aes
from darmilibs.errors import CDNFileHashMismatch
from darmilibs.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest, ListenerCanceled
)
from darmilibs.handlers.handler import Handler
from darmilibs.methods import Methods
from darmilibs.session import Auth, Session
from darmilibs.storage import FileStorage, MemoryStorage
from darmilibs.types import User, TermsOfService
from darmilibs.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~darmilibs.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~darmilibs.enums.ParseMode`):
        ...
        try:
            ...
            if isinstance(r, raw.types.upload.File):
                ...
                try:
                    ...
                    raise e
        except darmilibs.StopTransmission:
            raise
        except Exception as e:
            log.error(e, exc_info=True)
