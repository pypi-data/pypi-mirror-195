...
async def compose(
    ...
    If you want to run a single client, you can use Client's bound method :meth:`~darmilibs.Client.run`.

    Parameters:
        clients (List of :obj:`~darmilibs.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from darmilibs import Client, compose
