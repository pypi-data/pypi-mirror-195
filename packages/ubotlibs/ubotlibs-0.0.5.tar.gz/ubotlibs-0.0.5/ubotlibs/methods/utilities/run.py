...
import darmilibs
from darmilibs.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~darmilibs.Client.start`, :meth:`~darmilibs.idle` and :meth:`~darmilibs.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`darmilibs.compose`.
