...
obj = MangaDL4(name='attack on titan no requiem', url="https://3asq.org/manga/attack-on-titan-no-requiem/")
...
obj = MangaDL4(url="https://3asq.org/manga/attack-on-titan-no-requiem/", start=1, end=2)
