...
def _align(args):
    align_bams(args.fasta, args.unaligned_bam, args.aligned_bam,
...
def run_pbcpg_pipeline(args):
    ...
    align_bams(args.fasta, args.unaligned_bam, aligned_bam,
              threads=max(1, args.threads-1),
              memory_mb = max(floor(args.memory/args.threads), 1))
...
def parse_arguments():
    ...
    io_args.add_argument("unaligned_bam", metavar="<unaligned.bam>", nargs='+',
