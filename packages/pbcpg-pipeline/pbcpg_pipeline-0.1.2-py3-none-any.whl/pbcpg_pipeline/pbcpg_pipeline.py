...
from pbcpg_pipeline.align_bam import align_bam
...
def _align(args):
    align_bam(args.fasta, args.unaligned_bam, args.aligned_bam,
...
def parse_arguments():
    ...
    io_args.add_argument("bam", metavar="<unaligned.bam>",
    ...
    io_args.add_argument("unaligned_bam", metavar="<unaligned.bam>",
