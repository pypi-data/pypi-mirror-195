...
Modes.add_argument('-nP', action='store_true', help='This flag will execute Mode 2, NO PORT SCAN, which will '
                                                        'execute the Host Discovery and 802.11 WLAN Discovery '
                                                        'processes.')
Modes.add_argument('-w', action='store_true', help='This flag will execute Mode 3, WIRELESS ONLY, which will '
                                                       'execute the 802.11 WLAN Discovery process exclusively. ')
Modes.add_argument('-l', action='store_true', help='This flag will execute Mode 4, LOCAL SCAN ONLY, which will '
                                                       'execute the Host Discovery and Port Scan processes')
Modes.add_argument('-hD', action='store_true', help='This flag will execute Mode 5, HOST DISCOVERY ONLY, which '
                                                        'will execute the Host Discovery Process exclusively.')
Options.add_argument('--wP', action='store', dest='WLANScanPeriod', default=60, type=int, metavar= '<integer value in seconds>',
...
Options.add_argument('--pP', action='store', dest='PortScanPeriod', default=60, type=int, metavar= '<integer value in seconds>',
