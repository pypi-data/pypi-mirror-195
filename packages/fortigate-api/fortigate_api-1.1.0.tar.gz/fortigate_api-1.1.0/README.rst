...
CiscoConfParse
--------------
Helper that parses the Fortigate configuration to find and modify configuration commands.
CiscoConfParse doesn't natively support Fortigate configuration,
but after some tweaking it's a good tool to play with Fortigate configuration lines.
