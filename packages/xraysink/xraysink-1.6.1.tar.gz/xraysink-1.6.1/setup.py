...
install_requires = \
['aws_xray_sdk>=2,<3', 'wrapt>=1.15,<2.0']

extras_require = \
{'stylecheck': ['black==23.1.0',
                'flake8>=4,<5',
                'flake8-bugbear>=22.1.11',
                'flake8-builtins>=2.1,<2.2',
                'flake8-comprehensions>=3.10,<3.11',
                'flake8-eradicate>=1.4,<1.5',
                'flake8-executable>=2.1,<2.2',
                'flake8-implicit-str-concat>=0.4,<0.5',
                'flake8-import-order>=0.18,<0.19',
                'flake8-logging-format>=0.9,<0.10',
                'flake8-pytest-style>=1.7,<1.8',
                'flake8-print>=5,<6',
                'flake8-simplify>=0.19,<0.20',
                'flake8-string-format>=0.3,<0.4',
                'flake8-use-fstring>=1.4,<1.5',
                'setuptools>=67,<68',
                'yamllint>=1.29,<1.30'],
 'stylecheck:python_version >= "3.7"': ['zimports>=0.6,<0.7'],
 'testing': ['aiohttp>=3,<4',
             'async-asgi-testclient>=1.4.4,<2.0.0',
             'fastapi>=0.73,<0.74',
             'pytest>=7,<8',
             'pytest-asyncio>=0.14,<0.15',
             'pytest-cov>=3.0,<4.0',
             'setuptools>=67,<68'],
 'testing:python_version < "3.7"': ['coverage[toml]>=6.2,<6.3',
                                    'coverage[toml]>=6.2,<6.3'],
 'testing:python_version >= "3.7"': ['coverage[toml]>=6.3,<7.0',
                                     'coverage[toml]>=6.3,<7.0']}
