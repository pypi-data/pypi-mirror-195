...
class OutlierManager:
    ...
    def detect_outlier_multivariable_isolation_forest(self,df,contaminacion=0.01,n_estimators=100,plot=True):
        """
        ...
        if plot: #plot the results
            print("The PCA is only for plotting purposes, the model is not trained with it. The model is trained with the original data")
