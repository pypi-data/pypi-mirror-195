...
from typing import Iterable, Generator, Callable, Dict, Type, List
...
class Stream(Streamable[T]):
    ...
    def __init__(self, iterable: Iterable[T]):
        ...
        if issubclass(self.__type, Generator):
            self.__data: Iterable = iterable
        else:
            self.__data: Iterable = (i for i in iterable)
        self.__size = None
    ...
    def takewhile(self, predicate: Callable[[T], bool] = _default_call_return_true):
