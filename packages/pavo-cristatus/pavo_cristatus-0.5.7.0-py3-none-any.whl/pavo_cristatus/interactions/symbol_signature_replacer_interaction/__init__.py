from pavo_cristatus.interactions.symbol_signature_replacer_interaction import symbol_signature_replacer_interaction
...
dependency_module_name = "symbol_signature_replacer_interaction"

__all__ = [dependency_module_name]

pavo_cristatus_dependency_wrapper(resolvable_name=dependency_module_name,
                                  transformation=access_interaction_callable)(lambda: symbol_signature_replacer_interaction)