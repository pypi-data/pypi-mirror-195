...
setup(
       # the name must match the folder name 'verysimplemodule'
        ...
        install_requires=['Flask==2.2.3', 'python-socketio==5.7.2', 'psutil==5.9.4', 'pyserial==3.5', 'requests==2.28.2', 'importlib-metadata==6.0.0', 'python-dotenv==1.0.0'], # add any additional packages that 
