...
class UtilityFunctions():
    ...
    def merge_match_perc(self,df_1,df_2,left_on=None,right_on=None,on=None,how='left',tag=""):
        ...
        df_1_rows = df_1.shape[0] #number of rows in df_1
        ...
        num_rows = output_df.shape[0] #number of rows in output_df after merge
        ...
        print(f"{tag} df_1 has {df_1_rows} rows")
        print(f'{num_matches} matches, how = {how}, out of {num_rows} rows ({match_perc}%)')
        print(f'{rows_diff}')
        return output_df
