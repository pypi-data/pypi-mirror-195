...
class JobHistory(object):
    ...
    def __init__(self, comment=None, compute_reference=None, execution_state=None, job_id=None, job_state=None, new_version=None, node_id=None, shard_index=None, shard_state=None, time=None, type=None):  # noqa: E501
