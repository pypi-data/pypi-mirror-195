...
class ExecutionState(object):
    ...
    def __init__(self, compute_reference=None, create_time=None, job_id=None, node_id=None, published_results=None, run_output=None, shard_index=None, state=None, status=None, update_time=None, verification_proposal=None, verification_result=None, version=None):  # noqa: E501
