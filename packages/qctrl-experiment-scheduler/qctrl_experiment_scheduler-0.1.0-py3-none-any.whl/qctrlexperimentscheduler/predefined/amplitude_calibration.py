...
class AmplitudeCalibrationBackend:
    """
    Base class for the backends where you can use the predefined
    ...
    form of the fraction of the results in the state |1>.
    """
...
def create_amplitude_calibration_graph(
    ...
    both the pi and the pi/2 pulses. The subsequent nodes use these two
    ...
    for pi pulse calibration uses a pi/2 pulse, the fine pi/2 pulse
