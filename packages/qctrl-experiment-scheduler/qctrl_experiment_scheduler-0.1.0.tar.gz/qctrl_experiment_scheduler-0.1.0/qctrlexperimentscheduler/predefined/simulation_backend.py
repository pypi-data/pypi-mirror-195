...
def simulate_single_qubit(
    ...
    np.ndarray
        ...
        a qubit in state 0 or 1, respectively. The prbabilities reside in
...
class SimulationAmplitudeCalibrationBackend(AmplitudeCalibrationBackend):
    ...
    def pi_pulse_experiment(
        ...
        -------
        np.ndarray
            The fraction of times the experiments measured a qubit in |1>
    ...
    def pi_2_pulse_experiment(
        ...
        """
        Run a simulation of a series of Gaussian pi/2 pulses applied to a qubit
        initially in state |0>.
        ...
        drag : np.ndarray
            ...
            that is broadcastable with the `amplitude`.
        repetition_count : int
            The number of times the pi/2 pulse is applied to the qubit in this
            experiment.
        shot_count : int, optional
            The number of shots of each experiment. If not provided, defaults
            to the default number of shots of the backend.
    ...
    def pi_2_and_pi_pulse_experiment(
        ...
        """
        Run a simulation of a Gaussian pi/2 pulse followed by a series
        of Gaussian pi pulses applied to a qubit initially in state |0>.

        Parameters
        ----------
        pi_2_pulse_amplitude : np.ndarray
            Value of amplitudes of the pi/2 pulse. Must be a 1D array
            that is broadcastable with `pi_2_pulse_drag`, `pi_pulse_amplitude`,
            and `pi_pulse_drag`.
        pi_2_pulse_drag : np.ndarray
            Value of the DRAG parameter of the pi/2 pulse. Must be a 1D array
