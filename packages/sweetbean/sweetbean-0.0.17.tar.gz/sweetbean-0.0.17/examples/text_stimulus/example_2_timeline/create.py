...
from sweetbean.sequence import StimulusBlock, Experiment
...
correct_key = TimelineVariable('corret_key', ['j', 'f'])
...
train_block = StimulusBlock([fixation, so_s, stroop, so_f], timeline)
