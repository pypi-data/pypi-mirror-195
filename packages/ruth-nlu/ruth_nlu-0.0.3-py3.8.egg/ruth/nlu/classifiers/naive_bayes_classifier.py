...
class NaiveBayesClassifier(IntentClassifier):
    ...
    def load(cls, meta: Dict[Text, Any], model_dir: Path):
        """Load this model from the passed directory."""
