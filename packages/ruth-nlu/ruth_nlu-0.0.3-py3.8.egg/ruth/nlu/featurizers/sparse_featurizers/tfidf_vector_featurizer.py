"""TF-IDF vector featurizer. which is a sparse featurizer
...
class TfidfVectorFeaturizer(SparseFeaturizer):
    ...
    def _load_params(self):
        """Loads the parameters from the element config."""
    ...
    def _verify_analyzer(self) -> None:
        """Verifies the analyzer parameter."""
    ...
    def _build_vectorizer(
        ...
        """Builds a TfidfVectorizer object with the given parameters."""
    ...
    def train(self, training_data: TrainData) -> TfidfVectorizer:
        """Trains the featurizer on the given training data."""
    ...
    def parse(self, message: RuthData):
        """Converts a single message into a vector."""
    ...
    def create_vector(self, examples: List[RuthData]):
        """Creates a vector from the given examples."""
        features = []
    ...
    def _add_featurizer_data(self, training_examples: List[RuthData], features):
        """Adds the featurizer data to the given examples."""
    ...
    def persist(self, file_name: Text, model_dir: Text):
        """Persists the featurizer to disk."""
    ...
    def load(
        ...
        """Loads the featurizer from disk."""
