"""Count vectorizer is a featurizer that converts a sequence of tokens into a vector."""
import logging
...
class CountVectorFeaturizer(SparseFeaturizer):
    ...
    def _load_params(self):
        """Loads the parameters from the defaults config"""
    ...
    def _build_vectorizer(
        ...
        """Builds a CountVectorizer object with the given parameters."""
    ...
    def create_vectors(self, examples: List[RuthData]):
        """Creates vectors for the given examples."""
        features = []
    ...
    def _add_features_to_data(self, training_examples: List[RuthData], features):
        """Adds the features to the training examples."""
    ...
    def parse(self, message: RuthData):
        """Parses the message and adds the features to it."""
    ...
    def get_vocablary_from_vectorizer(self):
        """Returns the vocabulary from the vectorizer."""
    ...
    def persist(self, file_name: Text, model_dir: Text):
        """Persists the featurizer to the given path."""
    ...
    def load(
        ...
        """Loads the featurizer from the given path."""
