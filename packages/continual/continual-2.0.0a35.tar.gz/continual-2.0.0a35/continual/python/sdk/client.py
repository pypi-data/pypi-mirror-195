...
class Client:
    ...
    def __init__(
        ...
        if version_info["client_version"] != version_info["server_version"]:
            print("WARNING: Incompatible SDK version. Please upgrade your SDK.")
        if version_info["is_upgrade_required"]:
            print("WARNING: SDK version is outdated.")
