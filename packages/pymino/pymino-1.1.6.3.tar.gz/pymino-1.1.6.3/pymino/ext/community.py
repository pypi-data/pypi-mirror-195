...
class Community:
    ...
    **Parameters:**
    ...
    @community
    def fetch_object(self, objectId: str, objectType: ObjectTypes = ObjectTypes.USER, comId: Union[str, int] = None) -> LinkInfo:
        """
    ...
    def fetch_invitationId(self, inviteCode: str) -> str:
        """
    ...
    @community
    def join_community_by_code(self, inviteCode: str, comId: Union[str, int] = None) -> ApiResponse:
        """
    ...
    @community
    def online_status(self, onlineStatus: OnlineTypes = OnlineTypes.ONLINE, comId: Union[str, int] = None) -> ApiResponse:
        """
    ...
    @community
    def fetch_public_chats(self, chatType: ChatTypes = ChatTypes.RECOMMENDED, start: int = 0, size: int = 25, comId: Union[str, int] = None) -> CThreadList:
        """
    ...
    @community
    def strike(self, userId: str, amountOfTime: int = 5, title: str = None, reason: str = None, comId: Union[str, int] = None) -> ApiResponse:
        """
