...
import unittest
import uuid
from uvs_training_sdk import TrainingClient, DatasetClient, Dataset, AnnotationKind, ResourceType, TrainingParameters, Model, ModelKind, Evaluation, EvaluationClient, ModelStatus, EvaluationStatus


def is_configured():
    return os.getenv('UVS_ENDPOINT') and os.getenv('UVS_KEY') and os.getenv('IC_DATASET_URL') and os.getenv('OD_DATASET_URL')


class TestE2E(unittest.TestCase):
    def setUp(self):
        self.endpoint = os.getenv('UVS_ENDPOINT')
        self.resource_key = os.getenv('UVS_KEY')
