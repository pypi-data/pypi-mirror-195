...
RegisterOrFixPoint = Union[RegisterUserInput, FixPointNumber]
RegisterOrConst = Union[RegisterOrFixPoint, float]
...
class ArithmeticOperationParams(FunctionParams):
    ...
    @staticmethod
    def _arg_as_obj(arg: RegisterOrConst) -> RegisterOrFixPoint:
