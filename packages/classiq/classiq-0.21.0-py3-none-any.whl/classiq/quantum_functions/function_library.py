...
class FunctionLibrary:
    ...
    def __init__(self, *functions, name: str = DEFAULT_FUNCTION_LIBRARY_NAME):
        ...
        Args:
            ...
            *functions (:obj:`FunctionDefinition`, optional): A list of functions to initialize the object.
        """
    ...
    def add_function(
        self,
        function_data: Union[
            FunctionDefinition, QuantumFunction, Type[QuantumFunctionFactory]
        ],
        ...
        Args:
            function_data (FunctionDefinition): The function data object.
        ...
        if not isinstance(
            ...
            raise ClassiqValueError(
                f"FunctionDefinition object expected, got {function_data.__class__.__name__}"
            )
    ...
    @staticmethod
    def _to_params(data: FunctionDefinition) -> CustomFunction:
        parameters = (
