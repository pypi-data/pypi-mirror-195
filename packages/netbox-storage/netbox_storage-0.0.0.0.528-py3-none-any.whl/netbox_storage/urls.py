...
urlpatterns = [
    ...
    # MountedVolume urls
    #
    path("mountedvolume/", MountedVolumeListView.as_view(), name="mounted_volume_list"),
    path("mountedvolume/add/", MountedVolumeEditView.as_view(), name="mounted_volume_add"),
    path("mountedvolume/import/", MountedVolumeBulkImportView.as_view(), name="mounted_volume_import"),
    path("mountedvolume/edit/", MountedVolumeBulkEditView.as_view(), name="mounted_volume_bulk_edit"),
    path("mountedvolume/delete/", MountedVolumeBulkDeleteView.as_view(), name="mounted_volume_bulk_delete"),
    path("mountedvolume/<int:pk>/", MountedVolumeView.as_view(), name="mounted_volume"),
    path("mountedvolume/<int:pk>/edit/", MountedVolumeEditView.as_view(), name="mounted_volume_edit"),
    path("mountedvolume/<int:pk>/delete/", MountedVolumeDeleteView.as_view(), name="mounted_volume_delete"),
    path(
        "mountedvolume/<int:pk>/changelog/",
        ObjectChangeLogView.as_view(),
        name="mounted_volume_changelog",
