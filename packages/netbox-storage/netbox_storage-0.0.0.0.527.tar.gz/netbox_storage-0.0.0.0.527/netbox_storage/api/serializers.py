...
from netbox_storage.api.nested_serializers import NestedFilesystemSerializer, NestedDriveSerializer, \
    NestedPartitionSerializer, NestedLinuxVolumeSerializer
from netbox_storage.models import Drive, Filesystem, Partition, LinuxVolume, StorageConfigurationLinuxVolume
...
class StorageConfigurationLinuxVolumeSerializer(serializers.ModelSerializer):
    linux_volume = NestedLinuxVolumeSerializer(required=False, allow_null=True)
