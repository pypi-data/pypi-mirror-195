    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("virtual_machine",
                 models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE,
                                   related_name="virtual_machine_logical_volume", to="virtualization.virtualmachine")),
            ],
            options={
                "ordering": ("lv_name", "id"),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("virtual_machine",
                 models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE,
                                   related_name="virtual_machine_linux_volume", to="virtualization.virtualmachine")),
            ],
            options={
                "ordering": ("path", "fs", "id"),
            },
