...
class LVSimpleForm(NetBoxModelForm):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.instance.vg_name is not None:
            print(f"{self.instance.vg_name}")
        elif self.instance.lv_name is not None:
            print(f"{self.instance.size}")
        else:
            print(f"{self.instance.hard_drive_label}")
