...
from netbox_storage.models import PhysicalVolume, LogicalVolume, LinuxVolume, StorageConfiguration
...
class RelatedDrives(PluginTemplateExtension):
    ...
    def left_page(self):
        ...
        storage_configuration = StorageConfiguration.objects.filter(virtual_machine=obj)
