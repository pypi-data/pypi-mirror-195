...
class LogicalVolume(NetBoxModel):
    ...
    virtual_machine = models.ForeignKey(
        to='virtualization.VirtualMachine',
        on_delete=models.CASCADE,
        related_name='virtual_machine_logical_volume',
    )
...
class LinuxVolume(NetBoxModel):
    ...
    virtual_machine = models.ForeignKey(
        to='virtualization.VirtualMachine',
        on_delete=models.CASCADE,
        related_name='virtual_machine_linux_volume',
    )
...
class TemplateConfiguration(NetBoxModel):
    platform = models.ForeignKey(
        Platform,
        on_delete=models.CASCADE,
        related_name='template_platform',
    )