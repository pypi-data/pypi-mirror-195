    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("id", models.BigAutoField(primary_key=True, serialize=False)),
                ("partition",
                 models.ForeignKey(on_delete=models.deletion.CASCADE, related_name="partition_mounted_volume",
                                   to="netbox_storage.partition")),
                ("path", models.CharField(max_length=255)),
                ("fs",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("device", models.CharField(max_length=255)),
                ("parent_device",
                 models.ForeignKey(on_delete=models.deletion.PROTECT, related_name="drive_parent_device",
                                   to="netbox_storage.device")),
                ("size", models.FloatField()),
                ("type", models.CharField(max_length=255)),
                ("description", models.CharField(max_length=255)),
            ],
