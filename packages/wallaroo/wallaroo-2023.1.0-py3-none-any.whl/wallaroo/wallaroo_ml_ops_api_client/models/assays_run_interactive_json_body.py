...
from ..models.assays_run_interactive_json_body_baseline_type_2 import \
...
class AssaysRunInteractiveJsonBody:
    ...
    status: str
    iopath: str
    baseline: Union[AssaysRunInteractiveJsonBodyBaselineType0, AssaysRunInteractiveJsonBodyBaselineType1, AssaysRunInteractiveJsonBodyBaselineType2]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.baseline, AssaysRunInteractiveJsonBodyBaselineType1):
            baseline = self.baseline.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_baseline(data: object) -> Union[AssaysRunInteractiveJsonBodyBaselineType0, AssaysRunInteractiveJsonBodyBaselineType1, AssaysRunInteractiveJsonBodyBaselineType2]:
            try:
            ...
            if not isinstance(data, dict):
                raise TypeError()
            baseline_type_2 = AssaysRunInteractiveJsonBodyBaselineType2.from_dict(data)
