...
from ..models.assays_create_json_body_baseline_type_0_user_provided import \
...
class AssaysCreateJsonBodyBaselineType0:
    """
    Attributes:
        user_provided (AssaysCreateJsonBodyBaselineType0UserProvided):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        user_provided = AssaysCreateJsonBodyBaselineType0UserProvided.from_dict(d.pop("UserProvided"))
