...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, AssaysGetBaselineResponse400, AssaysGetBaselineResponse401, AssaysGetBaselineResponse500]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, AssaysGetBaselineResponse400, AssaysGetBaselineResponse401, AssaysGetBaselineResponse500]]:
    return Response(
