...
from ..models.v1_model_get_model_by_id_response_200_model_config_tensor_fields import \
    V1ModelGetModelByIdResponse200ModelConfigTensorFields
from ..types import UNSET, Unset

T = TypeVar("T", bound="V1ModelGetModelByIdResponse200ModelConfig")

@attr.s(auto_attribs=True)
class V1ModelGetModelByIdResponse200ModelConfig:
    ...
    Attributes:
        ...
        tensor_fields (Union[Unset, None, V1ModelGetModelByIdResponse200ModelConfigTensorFields]):  Optional Tensor
    ...
    id: int
    runtime: str
    tensor_fields: Union[Unset, None, V1ModelGetModelByIdResponse200ModelConfigTensorFields] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tensor_fields: Union[Unset, None, V1ModelGetModelByIdResponse200ModelConfigTensorFields]
        if _tensor_fields is None:
            tensor_fields = None
        elif isinstance(_tensor_fields,  Unset):
            tensor_fields = UNSET
        else:
            tensor_fields = V1ModelGetModelByIdResponse200ModelConfigTensorFields.from_dict(_tensor_fields)
        ...
        v1_model_get_model_by_id_response_200_model_config = cls(
            id=id,
            runtime=runtime,
        ...
        v1_model_get_model_by_id_response_200_model_config.additional_properties = d
        return v1_model_get_model_by_id_response_200_model_config
