...
from ..models.assays_create_json_body_baseline_type_1_fixed import \
...
class AssaysCreateJsonBodyBaselineType1:
    """
    Attributes:
        fixed (AssaysCreateJsonBodyBaselineType1Fixed):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        fixed = AssaysCreateJsonBodyBaselineType1Fixed.from_dict(d.pop("Fixed"))
