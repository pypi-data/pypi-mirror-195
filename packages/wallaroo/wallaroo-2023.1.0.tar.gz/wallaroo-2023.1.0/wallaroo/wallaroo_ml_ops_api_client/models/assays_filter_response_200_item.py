...
from ..models.assays_filter_response_200_item_baseline_type_2 import \
...
class AssaysFilterResponse200Item:
    ...
    status: str
    iopath: str
    baseline: Union[AssaysFilterResponse200ItemBaselineType0, AssaysFilterResponse200ItemBaselineType1, AssaysFilterResponse200ItemBaselineType2]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.baseline, AssaysFilterResponse200ItemBaselineType1):
            baseline = self.baseline.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_baseline(data: object) -> Union[AssaysFilterResponse200ItemBaselineType0, AssaysFilterResponse200ItemBaselineType1, AssaysFilterResponse200ItemBaselineType2]:
            try:
            ...
            if not isinstance(data, dict):
                raise TypeError()
            baseline_type_2 = AssaysFilterResponse200ItemBaselineType2.from_dict(data)
