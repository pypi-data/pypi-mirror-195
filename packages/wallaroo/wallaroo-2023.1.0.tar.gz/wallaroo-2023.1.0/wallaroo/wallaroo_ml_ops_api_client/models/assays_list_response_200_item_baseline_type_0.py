...
from ..models.assays_list_response_200_item_baseline_type_0_user_provided import \
...
class AssaysListResponse200ItemBaselineType0:
    """
    Attributes:
        user_provided (AssaysListResponse200ItemBaselineType0UserProvided):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        user_provided = AssaysListResponse200ItemBaselineType0UserProvided.from_dict(d.pop("UserProvided"))
