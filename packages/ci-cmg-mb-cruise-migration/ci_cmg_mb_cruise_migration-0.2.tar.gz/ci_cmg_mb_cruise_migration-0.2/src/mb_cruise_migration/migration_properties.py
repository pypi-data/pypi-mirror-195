...
class RunParameters(object):
    def __init__(self, config):
        ...
        self.test_level = config['test_level']
        self.max_test_survey = config['max_test_survey']
        self.migrate_shapes = config['migrate_shapes']
        self.concurrent_survey_migrations = config['concurrent_survey_migrations']
...
class Migrate(object):
    def __init__(self, config):
        self.canadian_data = config['canadian_data']
