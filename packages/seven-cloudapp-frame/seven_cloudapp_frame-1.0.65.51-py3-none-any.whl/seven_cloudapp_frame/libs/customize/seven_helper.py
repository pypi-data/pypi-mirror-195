...
@LastEditTime: 2023-03-07 15:50:43
...
class SevenHelper:
    ...
    @classmethod   
    def replace_value_to_list(self, data_list, old_value, new_value):
        """
        ...
        """
        try:
            data_index = data_list.index(old_value)
            data_list[data_index] = new_value
        except:
            pass
        return data_list