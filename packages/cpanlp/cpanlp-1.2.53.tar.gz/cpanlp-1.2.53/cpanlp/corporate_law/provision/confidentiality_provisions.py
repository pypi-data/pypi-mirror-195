class ConfidentialityProvisions:
    """
Confidentiality provisions in corporate law are provisions that prohibit employees from sharing confidential information with third parties. Here are some key features of confidentiality provisions:

Definition of confidential information: Confidentiality provisions typically define what constitutes confidential information, which may include trade secrets, proprietary information, customer lists, financial information, and other sensitive business information.
