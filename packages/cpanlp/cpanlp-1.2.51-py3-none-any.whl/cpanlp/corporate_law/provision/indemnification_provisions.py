class IndemnificationProvisions:
    """
 Indemnification provisions in corporate law are provisions that protect company officers and directors from personal liability in certain situations. Here are some key features of indemnification provisions:
...
Limits on protection: Indemnification provisions may not provide protection for actions that are deemed to be in bad faith or illegal, or for situations where the officer or director acted with gross negligence or willful misconduct.
Advancement of legal expenses: Indemnification provisions may require the company to pay for legal expenses incurred by officers and directors in connection with legal proceedings arising from their official duties, even if they are later found not to be liable.
Conditions for indemnification: Indemnification provisions may require officers and directors to meet certain conditions, such as cooperating with the company's defense of legal proceedings or obtaining approval from the company's board of directors.   
    """
