...
otherwise an empty string."""),
    ...
    'lino_xl.lib.google.lino.modlib.users.User.calendar_sync_token' : _("""The next sync token for the user's calendar synchronization obtained
from the finish of an ongoing synchronization, done by the
sync_google_calendar() function."""),
