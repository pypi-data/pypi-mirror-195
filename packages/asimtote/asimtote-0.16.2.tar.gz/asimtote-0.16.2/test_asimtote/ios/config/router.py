...
""")
    ...
    def test_IPv6Route_VRFTag(self):
        self.cfg.parse_str("""
...
""")
    ...
    def test_RtMap_SetIPNxtHopVrfyTrk(self):
        ...
        self.cfg.parse_str("""
route-map TestRtMap permit 10
 set ipv6 next-hop verify-availability 10::1 200 track 20
 set ipv6 next-hop verify-availability 20::1 100 track 30
 set ipv6 next-hop verify-availability 30::1 300 track 10
""")
            ...
            "route-map": {
                "TestRtMap": {
                    10: {
                        "action": "permit",
                        "set": {
                            "ipv6-next-hop-verify-availability-track": {
                                100: { "addr": "20::1", "track-obj": 30 },
                                200: { "addr": "10::1", "track-obj": 20 },
                                300: { "addr": "30::1", "track-obj": 10 }
                            }
                        }
                    }
                }
...
""")
    ...
    def test_RtrBGP_NbrFallOver(self):
        self.cfg.parse_str("""
router bgp 100.1
