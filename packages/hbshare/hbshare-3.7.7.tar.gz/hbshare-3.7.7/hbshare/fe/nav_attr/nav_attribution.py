...
if __name__ == '__main__':
    ...
    #                        factor_type='style_allo', benchmark_id='000300', nav_frequency='day').get_all(processed=True)
    # 私募样例
    res = StyleAttribution(fund_id='6E0108', fund_type='private', start_date='20181211', end_date='20220915',
