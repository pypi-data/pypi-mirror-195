...
if __name__ == '__main__':
    HoldingExtractor(data_path='D:\\估值表基地\\因诺聚配中证500指数增强', table_name="private_fund_holding",
                     fund_name="因诺聚配中证500指数增强").writeToDB()
