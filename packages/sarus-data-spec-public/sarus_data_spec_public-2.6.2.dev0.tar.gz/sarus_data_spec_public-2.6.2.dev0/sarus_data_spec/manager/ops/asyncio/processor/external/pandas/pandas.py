...
async def pd_sum_groupby(  # type: ignore[no-untyped-def]
    groupby: Any, *args, **kwargs
) -> Any:
...
async def pd_std_groupby(  # type: ignore[no-untyped-def]
    groupby: Any, *args, **kwargs
) -> Any:
...
async def pd_mean_groupby(  # type: ignore[no-untyped-def]
    groupby: Any, *args, **kwargs
) -> Any:
...
async def pd_median_groupby(  # type: ignore[no-untyped-def]
    groupby: Any, *args, **kwargs
) -> Any:
