...
from src.adapters import to_metafield_definition, to_shopify_book, to_shopify_shop
from src.utils import concunrrently_handle_tasks
...
document = Path("./src/document.graphql").read_text()
