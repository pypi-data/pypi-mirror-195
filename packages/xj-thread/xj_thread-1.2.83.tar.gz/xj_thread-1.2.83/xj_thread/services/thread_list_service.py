...
class ThreadListService:
    ...
    def list(params):
        ...
        conditions = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "category_id", "category_value", "category_id_list", "category_parent_id", "platform_code",
                "classify_id", "classify_value", "classify_id_list", "classify_parent_id",
                "user_id", "user_id_list", "id_list",
                "title", "create_time_start", "create_time_end", "access_level", "has_enroll", "has_fee", "has_comment", "need_auth"
            ],
            alias_dict={
                "id_list": "id__in",
                "user_id_list": "user_id__in",
                "category_id_list": "category__in",
