...
class HttpRequest:
    ...
    def get_responses_stream(self, urls: List[Url], pipes: List[Observable] = [], headers: Dict[str, str] = None, allow_redirects: bool = True, timeout: int = 5, verify: bool = False, max_retries: int = 3, proxy_builder: Callable[[], Dict[str, str]]=None) -> List[Any]:
        responses = []
        for url in urls:
            try:
