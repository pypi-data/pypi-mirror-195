...
def test_read_write():
    omron = AllenBradleyClient('192.168.1.172', 44818, 0)
...
def test_iot_ab_read():
    ...
    dict_point = {}
    dict_point['plc10'] = {'point_writable': True, 'point_name': 'plc10', 'point_device_address': '192.168.1.172/44818/0', 'point_address': 'A11', 'point_type': 10, 'point_scale': '1'}
    dict_point['plc11'] = {'point_writable': True, 'point_name': 'plc11', 'point_device_address': '192.168.1.172/44818/0', 'point_address': 'A1', 'point_type': 10, 'point_scale': '1'}
