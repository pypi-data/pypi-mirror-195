...
def test_siemens():
    s7 = SiemensS7Client(SiemensS7Version.S7_1500, '192.168.1.172', 102, 0, 1)
    aa = s7.read('V2634', 8)
    print(aa)
...
def test_iot_siemens_read():
    ...
    dict_point = {}
    dict_point['plc10'] = {'point_writable': True, 'point_name': 'plc10', 'point_device_address': '6/192.168.1.172/102/0/1', 'point_address': 'I0.0', 'point_type': 0, 'point_scale': '1'}
    dict_point['plc11'] = {'point_writable': True, 'point_name': 'plc11', 'point_device_address': '6/192.168.1.172/102/0/1', 'point_address': 'DB1,0.3', 'point_type': 0, 'point_scale': '1'}
    dict_point['plc12'] = {'point_writable': True, 'point_name': 'plc12', 'point_device_address': '6/192.168.1.172/102/0/1', 'point_address': 'MW300', 'point_type': 10, 'point_scale': '1'}
