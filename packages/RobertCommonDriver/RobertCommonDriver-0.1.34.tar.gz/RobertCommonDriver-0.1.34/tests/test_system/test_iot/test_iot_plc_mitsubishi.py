...
def test_read_write():
    omron = MitsubishiClient(MitsubishiVersion.Qna_3E, '192.168.1.172', 6000)
...
def test_read_write1():
    omron = MitsubishiClient(MitsubishiVersion.A_1E, '192.168.1.172', 6001)
    omron.logging(call_logging=logging_print)
    while True:
...
def test_iot_mistubishi_read():
    ...
    dict_point = {}
    dict_point['plc10'] = {'point_writable': True, 'point_name': 'plc10', 'point_device_address': '2/192.168.1.172/6000', 'point_address': 'D263', 'point_type': 18, 'point_scale': '1'}
    dict_point['plc11'] = {'point_writable': True, 'point_name': 'plc11', 'point_device_address': '2/192.168.1.172/6000', 'point_address': 'D260', 'point_type': 18, 'point_scale': '1'}
