...
def test_read_write():
    omron = OmronFinsClient('192.168.1.172', 9600, 0x0B)
...
def test_iot_omron_read():
    ...
    dict_point = {}
    dict_point['plc10'] = {'point_writable': True, 'point_name': 'plc10', 'point_device_address': '192.168.1.172/9600/11', 'point_address': 'D263', 'point_type': 18, 'point_scale': '1'}
    dict_point['plc11'] = {'point_writable': True, 'point_name': 'plc11', 'point_device_address': '192.168.1.172/9600/11', 'point_address': 'W320', 'point_type': 6, 'point_scale': '1'}
    dict_point['plc12'] = {'point_writable': True, 'point_name': 'plc12', 'point_device_address': '192.168.1.172/9600/11', 'point_address': 'W330.2', 'point_type': 0, 'point_scale': '1'}
