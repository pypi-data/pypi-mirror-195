def main():
    ...
    STEAM = "Images\\Test.png"
    VALO = "Images\\VALORANT.PNG"
    ...
    def Program():
        ...
        # SHOP = resource_path("Images\SHOP.PNG")
        # BUY = resource_path("Images\BUY.PNG")
        # VALORANT = resource_path("Images\VALORANT.PNG")
        ...
        def Relode():
            sleep(RefreshEvery)
            shop = pg.locateCenterOnScreen("Images\\SHOP.PNG", confidence=0.8)
            lounge = pg.locateCenterOnScreen("Images\Lounge.png", confidence=0.8)
        ...
        while True:
            ...
            if product != None:
                ...
                sleep(2)
                Buy = pg.locateCenterOnScreen("Images\\BUY.PNG", confidence=0.8)
        ...
        if not exit:
            ...
            while True:
                try:
                    Key = pg.locateCenterOnScreen("Images\\Key.png", confidence=0.8)
                    if Key != None:
                        break
                except:
            ...
            sleep(0.5)
            try:
                confirm = pg.locateCenterOnScreen("Images\\confirm.png", confidence=0.8)
    ...
    backg = customtkinter.CTkImage(Image.open("Images\\bg.jpg"), size=(700, 600))


    loginwin.resizable(width=False, height=False)

    loginwin.iconbitmap("Images\\logo.ico")
    ...
    logoIMG = customtkinter.CTkImage(Image.open("Images\\logo.png"), size=(70, 80))
