def main():
    ...
    def Program():
        ...
        def Relode():
            sleep(RefreshEvery)
            shop = pg.locateCenterOnScreen(data_folder / "SHOP.PNG", confidence=0.8)
            lounge = pg.locateCenterOnScreen(data_folder / "Lounge.png", confidence=0.8)
        ...
        while True:
            ...
            if product != None:
                ...
                sleep(2)
                Buy = pg.locateCenterOnScreen(data_folder / "BUY.PNG", confidence=0.8)
        ...
        if not exit:
            ...
            while True:
                try:
                    Key = pg.locateCenterOnScreen(data_folder / "Key.png", confidence=0.8)
                    if Key != None:
                        break
                except:
            ...
            sleep(0.5)
            try:
                confirm = pg.locateCenterOnScreen(data_folder / "confirm.png", confidence=0.8)
    ...
    def outputwindow():
        ...
        window.iconbitmap(data_folder / "logo.ico")
    ...
    label2 = customtkinter.CTkLabel(frame, text="↝↝↝↝↝↝↝↝↝↝↝↝↝", font=customtkinter.CTkFont("Montserrat", 30, weight="bold"), text_color="#dadada")
