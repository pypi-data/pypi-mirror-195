def main():
    ...
    STEAM = os.path.abspath("AutoBuff\\Main\\Images\\test.jpg")
    VALO = os.path.abspath("AutoBuff\\Main\\Images\\VALORANT.PNG")
    ROBLOX = os.path.abspath("AutoBuff\\Main\\Images\\Roblox.png")
    exit = False
    ...
    def Program():
        ...
        def Relode():
            sleep(RefreshEvery)
            shop = pg.locateCenterOnScreen(os.path.abspath("AutoBuff\\Main\\Images\\SHOP.PNG"), confidence=0.8)
            lounge = pg.locateCenterOnScreen(os.path.abspath("AutoBuff\\Main\\Images\\Lounge.png"), confidence=0.8)
        ...
        while True:
            ...
            if product != None:
                ...
                sleep(2)
                Buy = pg.locateCenterOnScreen(os.path.abspath("AutoBuff\\Main\\Images\\BUY.PNG"), confidence=0.8)
        ...
        if not exit:
            ...
            while True:
                try:
                    Key = pg.locateCenterOnScreen(os.path.abspath("AutoBuff\\Main\\Images\\Key.png"), confidence=0.8)
                    if Key != None:
                        break
                except:
            ...
            sleep(0.5)
            try:
                confirm = pg.locateCenterOnScreen(os.path.abspath("AutoBuff\\Main\\Images\\confirm.png"), confidence=0.8)
    ...
    def outputwindow():
        ...
        window.iconbitmap(os.path.abspath("AutoBuff\\Main\\Images\\logo.ico"))
    ...
    backg = customtkinter.CTkImage(Image.open(os.path.abspath("AutoBuff\\Main\\Images\\bg.jpg")), size=(700, 600))


    loginwin.resizable(width=False, height=False)

    loginwin.iconbitmap(os.path.abspath("AutoBuff\\Main\\Images\\logo.ico"))
    ...
    logoIMG = customtkinter.CTkImage(Image.open(os.path.abspath("AutoBuff\\Main\\Images\\logo.png")), size=(70, 80))
