def main():
    ...
    STEAM = "Main\\Images\\Test.png"
    VALO = "Main\\Images\\VALORANT.PNG"
    ROBLOX = "Main\\Images\\Roblox.png"
    exit = False
    ...
    def Program():
        ...
        def Relode():
            sleep(RefreshEvery)
            shop = pg.locateCenterOnScreen("Main\\Images\\SHOP.PNG", confidence=0.8)
            lounge = pg.locateCenterOnScreen("Main\\Images\\Lounge.png", confidence=0.8)
        ...
        while True:
            ...
            if product != None:
                ...
                sleep(2)
                Buy = pg.locateCenterOnScreen("Main\\Images\\BUY.PNG", confidence=0.8)
        ...
        if not exit:
            ...
            while True:
                try:
                    Key = pg.locateCenterOnScreen("Main\\Images\\Key.png", confidence=0.8)
                    if Key != None:
                        break
                except:
            ...
            sleep(0.5)
            try:
                confirm = pg.locateCenterOnScreen("Main\\Images\\confirm.png", confidence=0.8)
    ...
    def outputwindow():
        ...
        window.iconbitmap("Main\\Images\\logo.ico")
    ...
    backg = customtkinter.CTkImage(Image.open("Main\\Images\\bg.jpg"), size=(700, 600))


    loginwin.resizable(width=False, height=False)

    loginwin.iconbitmap("Main\\Images\\logo.ico")
    ...
    logoIMG = customtkinter.CTkImage(Image.open("Main\\Images\\logo.png"), size=(70, 80))
