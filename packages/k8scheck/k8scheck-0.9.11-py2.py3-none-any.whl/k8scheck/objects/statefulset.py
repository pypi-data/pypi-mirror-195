...
class StatefulSet(ApiObject):
    ...
    def _add_k8scheck_labels(self) -> None:
        """Add a k8scheck label to the StatefulSet object.
        ...
        """
        self.klabel_key = "k8scheck/statefulset"
        ...
        if self.obj.spec is None:
            log.warning("statefulset spec not set - cannot set k8scheck label")
            return
    ...
    def create(self, namespace: str = None) -> None:
        ...
        Args:
            namespace: The namespace to create the StatefulSet under.
                If the StatefulSet was loaded via the k8scheck client, the
