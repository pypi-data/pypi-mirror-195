...
def event_key(key: object, /) -> event[...]:
    """
    A utility function to set the key to use for event properties created by ``@events(collections=...)``.
    ...
    Example::
        ...
        class EventKeyExample:
            ...
            changing: event[str, CancelEventArgs] = event_key(__event_changing)
