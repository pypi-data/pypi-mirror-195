...
class ChannelsNotPresent(Exception):
    ...
    def __init__(self, channels, recordid="Unknown"):
        msg = "Channels of record %s where not present: %s, you can define 'aliases' for the channelname or make the channel optional" % (recordid, channels)
        super().__init__(msg)
...
class RecordLoader:
    ...
    def groupByChannel(self, group, recordIds):
