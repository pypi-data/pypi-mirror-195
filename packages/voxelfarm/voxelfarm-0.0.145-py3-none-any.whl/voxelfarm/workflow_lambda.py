...
class workflow_lambda_host:
    ...
    def create_product_version(self, project_id, product_id, inputs = None, files = None, fields = None):
        ...
        if  project_entity:
            ...
            if not project_entity.ContainsKey('workflow_id'):
            ...
            field_id = f'workflow_folder_{product_id}'
            if not project_entity.ContainsKey(field_id):
