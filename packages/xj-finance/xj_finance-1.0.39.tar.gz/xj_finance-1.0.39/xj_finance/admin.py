...
class SandBoxAdmin(admin.ModelAdmin):
    fields = ('id', 'sand_box_name', 'sand_box_label', 'description')
...
class StatusCodeAdmin(admin.ModelAdmin):
    fields = ('id', 'finance_status_code', 'description',)
    list_display = ('id', 'finance_status_code', 'description',)
    search_fields = ('id', 'finance_status_code', 'description',)
    readonly_fields = ['id']
