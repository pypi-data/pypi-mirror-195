    ...
    def finance_flow_writing(params, fund_type=None):
        ...
        if fund_type == "RECHARGE":  # 充值行为
            try:
                ...
                user_finance_data['finance_status_code'] = "43"  # 资金状态码 finance_status_code 43 已下单支付 待接单
                ...
                platform_finance_data['finance_status_code'] = "43"  # 资金状态码 finance_status_code 43 已下单支付 待接单
            ...
            try:
                ...
                user_finance_data['finance_status_code'] = "242"  # 资金状态码 finance_status_code 242 报名成功 待付款
                user_add_data, user_err_txt = FinanceTransactService.post(user_finance_data)
                if user_err_txt:
                    return None, user_err_txt
                ...
                platform_finance_data['finance_status_code'] = "242"  # 资金状态码 finance_status_code 242 报名成功 待付款
                finance_add_data, err_txt = FinanceTransactService.post(platform_finance_data)
                if err_txt:
                    return None, err_txt
                return None, None
