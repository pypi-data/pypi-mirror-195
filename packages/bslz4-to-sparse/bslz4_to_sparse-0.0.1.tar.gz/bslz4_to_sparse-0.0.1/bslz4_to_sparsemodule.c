 ...
 * Generation date: Tue Mar  7 08:16:26 2023
...
/*frompyobj*/
  ...
  if (capi_cmp_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 1st argument `cmp' of bslz4_to_sparse.bslz4_u16 to C/Fortran array" );
  } else {
  ...
  if (capi_msk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 2nd argument `msk' of bslz4_to_sparse.bslz4_u16 to C/Fortran array" );
  } else {
  ...
  if (capi_out_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 3rd argument `out' of bslz4_to_sparse.bslz4_u16 to C/Fortran array" );
  } else {
  ...
  if (capi_outP_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 4th argument `outP' of bslz4_to_sparse.bslz4_u16 to C/Fortran array" );
  } else {
...
/*frompyobj*/
  ...
  if (capi_cmp_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 1st argument `cmp' of bslz4_to_sparse.bslz4_u32 to C/Fortran array" );
  } else {
    cmp = (unsigned_char *)(PyArray_DATA(capi_cmp_tmp));
  ...
  if (capi_msk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 2nd argument `msk' of bslz4_to_sparse.bslz4_u32 to C/Fortran array" );
  } else {
    msk = (unsigned_char *)(PyArray_DATA(capi_msk_tmp));
  ...
  if (capi_out_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 3rd argument `out' of bslz4_to_sparse.bslz4_u32 to C/Fortran array" );
  } else {
  ...
  if (capi_outP_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(bslz4_to_sparse_error,"failed in converting 4th argument `outP' of bslz4_to_sparse.bslz4_u32 to C/Fortran array" );
  } else {
    outP = (unsigned *)(PyArray_DATA(capi_outP_tmp));
