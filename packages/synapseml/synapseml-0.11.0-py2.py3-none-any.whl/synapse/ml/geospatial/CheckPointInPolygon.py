...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_e892d7eb2cd8_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_e892d7eb2cd8_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_e892d7eb2cd8_error")
        self._setDefault(outputCol="CheckPointInPolygon_e892d7eb2cd8_output")
