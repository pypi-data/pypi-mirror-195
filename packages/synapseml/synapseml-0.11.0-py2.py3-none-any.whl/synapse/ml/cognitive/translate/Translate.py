...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_6b1a908b67a3_error",
        fromLanguage=None,
        ...
        outputCol="Translate_6b1a908b67a3_output",
        ...
        self._setDefault(errorCol="Translate_6b1a908b67a3_error")
        self._setDefault(outputCol="Translate_6b1a908b67a3_output")
