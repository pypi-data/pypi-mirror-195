...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_e53b6baf3e3c_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_e53b6baf3e3c_output",
        ...
        self._setDefault(errorCol="Transliterate_e53b6baf3e3c_error")
        self._setDefault(outputCol="Transliterate_e53b6baf3e3c_output")
