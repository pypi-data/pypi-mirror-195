...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryLookup_55f5a379d537_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_55f5a379d537_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_55f5a379d537_error")
        self._setDefault(outputCol="DictionaryLookup_55f5a379d537_output")
