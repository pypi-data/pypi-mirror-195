...
class DocumentTranslator(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DocumentTranslator_eb8aaf7f86f4_error",
        filterPrefix=None,
        ...
        outputCol="DocumentTranslator_eb8aaf7f86f4_output",
        pollingDelay=300,
        serviceName=None,
        sourceLanguage=None,
        ...
        self._setDefault(errorCol="DocumentTranslator_eb8aaf7f86f4_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="DocumentTranslator_eb8aaf7f86f4_output")
