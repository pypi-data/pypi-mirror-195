...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_1d7182187d25_error",
        handler=None,
        outputCol="Detect_1d7182187d25_output",
        ...
        self._setDefault(errorCol="Detect_1d7182187d25_error")
        self._setDefault(outputCol="Detect_1d7182187d25_output")
