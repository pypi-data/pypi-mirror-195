...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_95964bfbc7dc_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_95964bfbc7dc_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_95964bfbc7dc_error")
        self._setDefault(outputCol="DictionaryExamples_95964bfbc7dc_output")
