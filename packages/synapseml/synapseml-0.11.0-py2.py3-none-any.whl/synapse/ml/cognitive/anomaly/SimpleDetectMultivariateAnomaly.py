...
class SimpleDetectMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(
        ...
        endTime=None,
        errorCol="SimpleDetectMultivariateAnomaly_e4294667f78f_error",
        handler=None,
        ...
        modelId=None,
        outputCol="SimpleDetectMultivariateAnomaly_e4294667f78f_output",
        pollingDelay=300,
        startTime=None,
        ...
        self._setDefault(errorCol="SimpleDetectMultivariateAnomaly_e4294667f78f_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="SimpleDetectMultivariateAnomaly_e4294667f78f_output")
