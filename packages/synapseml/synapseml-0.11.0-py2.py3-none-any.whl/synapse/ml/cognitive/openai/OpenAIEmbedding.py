...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OpenAIEmbedding_052deb860a78_error",
        handler=None,
        outputCol="OpenAIEmbedding_052deb860a78_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_052deb860a78_error")
        self._setDefault(outputCol="OpenAIEmbedding_052deb860a78_output")
