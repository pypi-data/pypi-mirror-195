...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAPICompletion_7fb1cbe0fcc2_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAPICompletion_7fb1cbe0fcc2_output",
        ...
        self._setDefault(errorCol="OpenAPICompletion_7fb1cbe0fcc2_error")
        self._setDefault(outputCol="OpenAPICompletion_7fb1cbe0fcc2_output")
