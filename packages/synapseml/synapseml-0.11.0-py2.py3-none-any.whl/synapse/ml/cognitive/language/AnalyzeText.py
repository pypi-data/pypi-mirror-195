...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_3a8716b9d234_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_3a8716b9d234_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_3a8716b9d234_error")
        self._setDefault(outputCol="AnalyzeText_3a8716b9d234_output")
