...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_fd61bc4bbd83_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_fd61bc4bbd83_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_fd61bc4bbd83_error")
        self._setDefault(outputCol="GenerateThumbnails_fd61bc4bbd83_output")
