...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_59fd5e86d3ff_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_59fd5e86d3ff_output",
        ...
        self._setDefault(errorCol="OCR_59fd5e86d3ff_error")
        self._setDefault(outputCol="OCR_59fd5e86d3ff_output")
