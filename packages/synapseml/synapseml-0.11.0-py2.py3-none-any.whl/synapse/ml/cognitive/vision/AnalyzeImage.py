...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_5c2476bbb559_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_5c2476bbb559_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_5c2476bbb559_error")
        self._setDefault(outputCol="AnalyzeImage_5c2476bbb559_output")
