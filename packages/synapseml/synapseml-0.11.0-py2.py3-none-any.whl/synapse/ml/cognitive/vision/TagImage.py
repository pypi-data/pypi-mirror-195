...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_89358fd61f4d_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_89358fd61f4d_output",
        ...
        self._setDefault(errorCol="TagImage_89358fd61f4d_error")
        self._setDefault(outputCol="TagImage_89358fd61f4d_output")
