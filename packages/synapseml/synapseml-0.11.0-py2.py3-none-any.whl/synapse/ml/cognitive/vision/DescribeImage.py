...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_28a18a055be5_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_28a18a055be5_output",
        ...
        self._setDefault(errorCol="DescribeImage_28a18a055be5_error")
        self._setDefault(outputCol="DescribeImage_28a18a055be5_output")
