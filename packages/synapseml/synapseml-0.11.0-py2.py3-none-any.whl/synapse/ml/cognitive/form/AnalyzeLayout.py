...
class AnalyzeLayout(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeLayout_9c440e9c6c92_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeLayout_9c440e9c6c92_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        readingOrder=None,
        ...
        self._setDefault(errorCol="AnalyzeLayout_9c440e9c6c92_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeLayout_9c440e9c6c92_output")
