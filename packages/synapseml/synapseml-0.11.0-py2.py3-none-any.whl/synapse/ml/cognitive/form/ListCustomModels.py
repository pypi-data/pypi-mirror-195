...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_807a7cc99692_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_807a7cc99692_output",
        ...
        self._setDefault(errorCol="ListCustomModels_807a7cc99692_error")
        self._setDefault(outputCol="ListCustomModels_807a7cc99692_output")
