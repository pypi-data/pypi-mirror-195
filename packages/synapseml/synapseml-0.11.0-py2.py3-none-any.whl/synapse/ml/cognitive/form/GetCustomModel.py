...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_2e3ac5ec02da_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_2e3ac5ec02da_output",
        ...
        self._setDefault(errorCol="GetCustomModel_2e3ac5ec02da_error")
        self._setDefault(outputCol="GetCustomModel_2e3ac5ec02da_output")
