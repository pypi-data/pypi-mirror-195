...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_aa22492dafe9_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_aa22492dafe9_output",
        ...
        self._setDefault(errorCol="GroupFaces_aa22492dafe9_error")
        self._setDefault(outputCol="GroupFaces_aa22492dafe9_output")
