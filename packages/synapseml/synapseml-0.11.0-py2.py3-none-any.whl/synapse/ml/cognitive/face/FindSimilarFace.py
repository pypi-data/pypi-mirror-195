...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_a515dea086f8_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_a515dea086f8_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_a515dea086f8_error")
        self._setDefault(outputCol="FindSimilarFace_a515dea086f8_output")
