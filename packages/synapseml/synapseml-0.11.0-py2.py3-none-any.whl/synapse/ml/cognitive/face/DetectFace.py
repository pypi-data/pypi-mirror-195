...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_1826c13ab836_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_1826c13ab836_output",
        ...
        self._setDefault(errorCol="DetectFace_1826c13ab836_error")
        self._setDefault(outputCol="DetectFace_1826c13ab836_output")
