...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_c30b2f423d4c_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_c30b2f423d4c_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_c30b2f423d4c_error")
        self._setDefault(outputCol="VerifyFaces_c30b2f423d4c_output")
