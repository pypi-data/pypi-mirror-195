...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_264493ff9eb2_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_264493ff9eb2_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_264493ff9eb2_error")
        self._setDefault(outputCol="NER_264493ff9eb2_output")
