...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddDocuments_a83eed886229_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_a83eed886229_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_a83eed886229_error")
        self._setDefault(outputCol="AddDocuments_a83eed886229_output")
