...
class Utils:
    def __init__(self):
        ...
        self._check_df_operand()
        self._check_str_operand()
        self._check_str_in_df()
    ...
    @classmethod
    def _check_df_operand(cls, operand: pd.DataFrame) -> None:
        """
    ...
    @classmethod
    def _check_str_operand(cls, operand: str) -> None:
        """
    ...
    @classmethod
    def _check_str_in_df(cls, X: pd.DataFrame, operand: str) -> None:
        """
