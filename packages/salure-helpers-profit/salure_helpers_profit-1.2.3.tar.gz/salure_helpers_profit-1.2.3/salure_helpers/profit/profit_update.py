...
class UpdateConnector(SalureConnect):
    ...
    def upload_dossieritem(self, data: dict, attachments: Union[dict, None] = None) -> requests.Response:
        """
        ...
        required_fields = ['employee_id', 'dossieritem_type_id']
        ...
        attachments = attachments if attachments is not None else [{"filename": data['filename'],
