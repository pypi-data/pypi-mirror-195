...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self) -> 'List[_1511.OptimizationVariable]':
    ...
    @property
    def target_history(self) -> 'List[_1511.OptimizationVariable]':
    ...
    def add_input_history(self, value: '_1511.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1511.OptimizationVariable'):
