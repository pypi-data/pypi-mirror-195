...
from mastapy.math_utility.optimisation import _1524, _1523
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def integer_range(self) -> '_1555.IntegerRange':
    ...
    def integer_range(self, value: '_1555.IntegerRange'):
    ...
    @property
    def specification_type(self) -> '_1524.TargetingPropertyTo':
        ...
        return constructor.new_from_mastapy_type(_1524.TargetingPropertyTo)(value) if value is not None else None

    @specification_type.setter
    def specification_type(self, value: '_1524.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1523.SpecifyOptimisationInputAs':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1523.SpecifyOptimisationInputAs)(value) if value is not None else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1523.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
