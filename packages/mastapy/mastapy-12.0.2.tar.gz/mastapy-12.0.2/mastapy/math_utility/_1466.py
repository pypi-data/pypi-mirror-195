...
class CoordinateSystemEditor(_0.APIBase):
    ...
    @property
    def rotation_axis(self) -> '_1493.RotationAxis':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1493.RotationAxis)(value) if value is not None else None

    @rotation_axis.setter
    def rotation_axis(self, value: '_1493.RotationAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
