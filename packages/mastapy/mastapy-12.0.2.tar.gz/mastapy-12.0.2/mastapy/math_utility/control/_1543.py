...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def differential_gain_vs_time_and_error(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def differential_gain_vs_time_and_error(self, value: '_1532.GriddedSurfaceAccessor'):
    ...
    @property
    def integral_gain_vs_time_and_error(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def integral_gain_vs_time_and_error(self, value: '_1532.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def proportional_gain_vs_time_and_error(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def proportional_gain_vs_time_and_error(self, value: '_1532.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def update_method(self) -> '_1488.PIDControlUpdateMethod':
        ...
        return constructor.new_from_mastapy_type(_1488.PIDControlUpdateMethod)(value) if value is not None else None

    @update_method.setter
    def update_method(self, value: '_1488.PIDControlUpdateMethod'):
