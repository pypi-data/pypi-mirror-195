...
from mastapy.utility_gui.charts import _1823, _1821
...
class ThreeDChartDefinition(_1821.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self) -> '_1710.AxisSettings':
    ...
    def data_points_for_surfaces(self) -> 'List[_1823.PointsForSurface]':
