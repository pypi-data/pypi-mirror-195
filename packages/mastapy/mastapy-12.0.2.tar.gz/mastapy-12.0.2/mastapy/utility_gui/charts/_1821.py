...
from mastapy.utility.report import _1710, _1715
...
class NDChartDefinition(_1715.ChartDefinition):
    """NDChartDefinition
    ...
    @property
    def x_axis(self) -> '_1710.AxisSettings':
    ...
    @property
    def y_axis(self) -> '_1710.AxisSettings':
