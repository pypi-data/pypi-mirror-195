...
from mastapy.bearings import _1854
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.bearings.roller_bearing_profiles import (
    _1899, _1893, _1894, _1895,
    _1896, _1897, _1898, _1900
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1854.RollerBearingProfileTypes':
        ...
        return constructor.new_from_mastapy_type(_1854.RollerBearingProfileTypes)(value) if value is not None else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1854.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1899.RollerBearingProfile':
        ...
        if _1899.RollerBearingProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1893.RollerBearingConicalProfile':
        ...
        if _1893.RollerBearingConicalProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1894.RollerBearingCrownedProfile':
        ...
        if _1894.RollerBearingCrownedProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1895.RollerBearingDinLundbergProfile':
        ...
        if _1895.RollerBearingDinLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1896.RollerBearingFlatProfile':
        ...
        if _1896.RollerBearingFlatProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1897.RollerBearingJohnsGoharProfile':
        ...
        if _1897.RollerBearingJohnsGoharProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1898.RollerBearingLundbergProfile':
        ...
        if _1898.RollerBearingLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1900.RollerBearingUserSpecifiedProfile':
        ...
        if _1900.RollerBearingUserSpecifiedProfile.TYPE not in temp.__class__.__mro__:
