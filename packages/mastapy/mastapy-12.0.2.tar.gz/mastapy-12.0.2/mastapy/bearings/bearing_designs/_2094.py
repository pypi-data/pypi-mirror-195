...
class LinearBearing(_2091.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1845.BearingStiffnessMatrixOption':
        ...
        return constructor.new_from_mastapy_type(_1845.BearingStiffnessMatrixOption)(value) if value is not None else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1845.BearingStiffnessMatrixOption'):
