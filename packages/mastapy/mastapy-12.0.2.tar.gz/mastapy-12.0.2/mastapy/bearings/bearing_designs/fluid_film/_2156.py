...
class TiltingPadThrustBearing(_2148.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1863.TiltingPadTypes':
        ...
        return constructor.new_from_mastapy_type(_1863.TiltingPadTypes)(value) if value is not None else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1863.TiltingPadTypes'):
