...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1906.DefaultOrUserInput':
        ...
        return constructor.new_from_mastapy_type(_1906.DefaultOrUserInput)(value) if value is not None else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1906.DefaultOrUserInput'):
