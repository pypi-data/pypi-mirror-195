...
from mastapy.bearings.bearing_results.fluid_film import _2084, _2080
...
class LoadedPlainJournalBearingResults(_2080.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_2084.LoadedPlainJournalBearingRow]':
