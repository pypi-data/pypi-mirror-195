...
from mastapy.bearings.bearing_results.rolling.skf_module import _2039, _2058
...
class AdjustedSpeed(_2058.SKFCalculationResult):
    """AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_2039.AdjustmentFactors':
