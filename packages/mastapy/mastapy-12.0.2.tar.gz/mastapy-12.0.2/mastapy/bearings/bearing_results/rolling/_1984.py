...
from mastapy.bearings.bearing_results.rolling import _1983, _1972
...
class LoadedNeedleRollerBearingRow(_1972.LoadedCylindricalRollerBearingRow):
    """LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1983.LoadedNeedleRollerBearingResults':
