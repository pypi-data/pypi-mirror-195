...
class ISO14179SettingsPerBearingType(_1553.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    """ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1859.RollingBearingType':
        ...
        return constructor.new_from_mastapy_type(_1859.RollingBearingType)(value) if value is not None else None
