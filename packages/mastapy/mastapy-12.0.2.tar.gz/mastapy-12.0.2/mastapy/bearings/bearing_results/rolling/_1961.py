...
from mastapy.bearings.bearing_results import _1922
...
class LoadedBallBearingDutyCycle(_1922.LoadedRollingBearingDutyCycle):
    """LoadedBallBearingDutyCycle
    ...
    @property
    def track_truncation_inner_summary(self) -> '_1804.DutyCyclePropertySummaryPercentage[_1964.LoadedBallBearingResults]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1964.LoadedBallBearingResults](temp) if temp is not None else None

    @property
    def track_truncation_outer_summary(self) -> '_1804.DutyCyclePropertySummaryPercentage[_1964.LoadedBallBearingResults]':
