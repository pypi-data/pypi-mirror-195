...
from mastapy.bearings.bearing_results.rolling import _1936, _2036, _2035
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def force_from_inner_race(self) -> '_1907.ElementForce':
    ...
    @property
    def operating_internal_clearance(self) -> '_1936.InternalClearance':
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_2035.StressAtPosition]':
    ...
    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_2035.StressAtPosition]':
