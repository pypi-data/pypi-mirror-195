...
from mastapy.bearings.bearing_results.rolling import _2034, _1991
...
class LoadedNonBarrelRollerBearingResults(_1991.LoadedRollerBearingResults):
    """LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_2034.SMTRibStressResults':
