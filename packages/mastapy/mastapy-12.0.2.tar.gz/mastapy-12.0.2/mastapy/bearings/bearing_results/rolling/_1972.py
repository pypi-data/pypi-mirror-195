...
from mastapy.bearings.bearing_results.rolling import _1971, _1983, _1987
...
class LoadedCylindricalRollerBearingRow(_1987.LoadedNonBarrelRollerBearingRow):
    """LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1971.LoadedCylindricalRollerBearingResults':
