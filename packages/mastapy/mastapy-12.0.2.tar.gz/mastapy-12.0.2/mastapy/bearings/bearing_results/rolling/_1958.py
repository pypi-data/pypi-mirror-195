...
from mastapy.bearings.bearing_results.rolling import _1955
...
class LoadedAxialThrustNeedleRollerBearingElement(_1955.LoadedAxialThrustCylindricalRollerBearingElement):
    """LoadedAxialThrustNeedleRollerBearingElement
