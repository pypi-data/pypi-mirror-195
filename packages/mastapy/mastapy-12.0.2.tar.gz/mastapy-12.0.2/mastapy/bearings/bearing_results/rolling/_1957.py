...
from mastapy.bearings.bearing_results.rolling import _1956, _1959, _1987
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1987.LoadedNonBarrelRollerBearingRow):
    """LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1956.LoadedAxialThrustCylindricalRollerBearingResults':
