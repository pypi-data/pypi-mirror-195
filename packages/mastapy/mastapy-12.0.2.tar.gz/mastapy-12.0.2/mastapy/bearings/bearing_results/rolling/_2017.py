...
from mastapy.bearings.bearing_results.rolling import _2016, _1965
...
class LoadedThrustBallBearingRow(_1965.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2016.LoadedThrustBallBearingResults':
