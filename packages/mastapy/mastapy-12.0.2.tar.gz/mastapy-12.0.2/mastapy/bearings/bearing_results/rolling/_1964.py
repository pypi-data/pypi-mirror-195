...
from mastapy.bearings.bearing_results.rolling import _1935, _2037, _1995
...
class LoadedBallBearingResults(_1995.LoadedRollingBearingResults):
    """LoadedBallBearingResults
    ...
    @property
    def friction_model_for_gyroscopic_moment(self) -> '_1935.FrictionModelForGyroscopicMoment':
        ...
        return constructor.new_from_mastapy_type(_1935.FrictionModelForGyroscopicMoment)(value) if value is not None else None
    ...
    @property
    def track_truncation(self) -> '_2037.TrackTruncationSafetyFactorResults':
