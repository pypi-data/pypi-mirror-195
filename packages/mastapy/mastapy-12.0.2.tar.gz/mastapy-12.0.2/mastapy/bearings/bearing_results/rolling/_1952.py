...
from mastapy.bearings.bearing_results.rolling import _1951, _1992
...
class LoadedAsymmetricSphericalRollerBearingRow(_1992.LoadedRollerBearingRow):
    """LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1951.LoadedAsymmetricSphericalRollerBearingResults':
