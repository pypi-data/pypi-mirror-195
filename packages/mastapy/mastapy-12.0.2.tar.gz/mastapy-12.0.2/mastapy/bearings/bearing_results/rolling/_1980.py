...
from mastapy.bearings.bearing_results.rolling import _1979, _1978, _1965
...
class LoadedFourPointContactBallBearingRow(_1965.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1979.LoadedFourPointContactBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1978.LoadedFourPointContactBallBearingRaceResults]':
