...
from mastapy.bearings.bearing_results.rolling.abma import _2078, _2076, _2077
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling import (
    _1932, _1940, _1942, _1936,
    _2036, _2022, _1996
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _2065, _2063, _2069, _2066,
    _2068, _2064, _2070
)
from mastapy.bearings.bearing_results.rolling.fitting import _2072, _2074, _2075
from mastapy.bearings.bearing_results.rolling.skf_module import _2060
...
class LoadedRollingBearingResults(_1917.LoadedDetailedBearingResults):
    """LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1847.FluidFilmTemperatureOptions':
        ...
        return constructor.new_from_mastapy_type(_1847.FluidFilmTemperatureOptions)(value) if value is not None else None
    ...
    @property
    def ansiabma(self) -> '_2078.ANSIABMAResults':
        ...
        if _2078.ANSIABMAResults.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_2076.ANSIABMA112014Results':
        ...
        if _2076.ANSIABMA112014Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_2077.ANSIABMA92015Results':
        ...
        if _2077.ANSIABMA92015Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def din732(self) -> '_1932.DIN732Results':
    ...
    @property
    def iso2812007(self) -> '_2065.ISO2812007Results':
        ...
        if _2065.ISO2812007Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_2063.BallISO2812007Results':
        ...
        if _2063.BallISO2812007Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_2069.RollerISO2812007Results':
        ...
        if _2069.RollerISO2812007Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_2066.ISO762006Results':
    ...
    @property
    def isotr1417912001(self) -> '_1940.ISOTR1417912001Results':
    ...
    @property
    def isotr1417922001(self) -> '_1942.ISOTR1417922001Results':
    ...
    @property
    def isots162812008(self) -> '_2068.ISOTS162812008Results':
        ...
        if _2068.ISOTS162812008Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_2064.BallISOTS162812008Results':
        ...
        if _2064.BallISOTS162812008Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_2070.RollerISOTS162812008Results':
        ...
        if _2070.RollerISOTS162812008Results.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def inner_ring_fitting_at_assembly(self) -> '_2072.InnerRingFittingThermalResults':
    ...
    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_2072.InnerRingFittingThermalResults':
    ...
    @property
    def maximum_static_contact_stress(self) -> '_2022.MaximumStaticContactStress':
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_2074.OuterRingFittingThermalResults':
    ...
    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_2074.OuterRingFittingThermalResults':
    ...
    @property
    def skf_module_results(self) -> '_2060.SKFModuleResults':
    ...
    @property
    def all_mounting_results(self) -> 'List[_2075.RingFittingThermalResults]':
    ...
    @property
    def rows(self) -> 'List[_1996.LoadedRollingBearingRow]':
