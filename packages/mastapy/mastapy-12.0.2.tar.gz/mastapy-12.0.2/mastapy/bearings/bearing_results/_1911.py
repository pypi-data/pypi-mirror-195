...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self) -> '_2091.BearingDesign':
    ...
    @property
    def bearing_design_of_type_detailed_bearing(self) -> '_2092.DetailedBearing':
    ...
    @property
    def bearing_design_of_type_dummy_rolling_bearing(self) -> '_2093.DummyRollingBearing':
    ...
    @property
    def bearing_design_of_type_linear_bearing(self) -> '_2094.LinearBearing':
    ...
    @property
    def bearing_design_of_type_non_linear_bearing(self) -> '_2095.NonLinearBearing':
    ...
    @property
    def bearing_design_of_type_angular_contact_ball_bearing(self) -> '_2096.AngularContactBallBearing':
    ...
    @property
    def bearing_design_of_type_angular_contact_thrust_ball_bearing(self) -> '_2097.AngularContactThrustBallBearing':
    ...
    @property
    def bearing_design_of_type_asymmetric_spherical_roller_bearing(self) -> '_2098.AsymmetricSphericalRollerBearing':
    ...
    @property
    def bearing_design_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_2099.AxialThrustCylindricalRollerBearing':
    ...
    @property
    def bearing_design_of_type_axial_thrust_needle_roller_bearing(self) -> '_2100.AxialThrustNeedleRollerBearing':
    ...
    @property
    def bearing_design_of_type_ball_bearing(self) -> '_2101.BallBearing':
    ...
    @property
    def bearing_design_of_type_barrel_roller_bearing(self) -> '_2103.BarrelRollerBearing':
    ...
    @property
    def bearing_design_of_type_crossed_roller_bearing(self) -> '_2109.CrossedRollerBearing':
    ...
    @property
    def bearing_design_of_type_cylindrical_roller_bearing(self) -> '_2110.CylindricalRollerBearing':
    ...
    @property
    def bearing_design_of_type_deep_groove_ball_bearing(self) -> '_2111.DeepGrooveBallBearing':
    ...
    @property
    def bearing_design_of_type_four_point_contact_ball_bearing(self) -> '_2115.FourPointContactBallBearing':
    ...
    @property
    def bearing_design_of_type_multi_point_contact_ball_bearing(self) -> '_2120.MultiPointContactBallBearing':
    ...
    @property
    def bearing_design_of_type_needle_roller_bearing(self) -> '_2121.NeedleRollerBearing':
    ...
    @property
    def bearing_design_of_type_non_barrel_roller_bearing(self) -> '_2122.NonBarrelRollerBearing':
    ...
    @property
    def bearing_design_of_type_roller_bearing(self) -> '_2123.RollerBearing':
    ...
    @property
    def bearing_design_of_type_rolling_bearing(self) -> '_2126.RollingBearing':
    ...
    @property
    def bearing_design_of_type_self_aligning_ball_bearing(self) -> '_2127.SelfAligningBallBearing':
    ...
    @property
    def bearing_design_of_type_spherical_roller_bearing(self) -> '_2130.SphericalRollerBearing':
    ...
    @property
    def bearing_design_of_type_spherical_roller_thrust_bearing(self) -> '_2131.SphericalRollerThrustBearing':
    ...
    @property
    def bearing_design_of_type_taper_roller_bearing(self) -> '_2132.TaperRollerBearing':
    ...
    @property
    def bearing_design_of_type_three_point_contact_ball_bearing(self) -> '_2133.ThreePointContactBallBearing':
    ...
    @property
    def bearing_design_of_type_thrust_ball_bearing(self) -> '_2134.ThrustBallBearing':
    ...
    @property
    def bearing_design_of_type_toroidal_roller_bearing(self) -> '_2135.ToroidalRollerBearing':
    ...
    @property
    def bearing_design_of_type_pad_fluid_film_bearing(self) -> '_2148.PadFluidFilmBearing':
    ...
    @property
    def bearing_design_of_type_plain_grease_filled_journal_bearing(self) -> '_2150.PlainGreaseFilledJournalBearing':
    ...
    @property
    def bearing_design_of_type_plain_journal_bearing(self) -> '_2152.PlainJournalBearing':
    ...
    @property
    def bearing_design_of_type_plain_oil_fed_journal_bearing(self) -> '_2154.PlainOilFedJournalBearing':
    ...
    @property
    def bearing_design_of_type_tilting_pad_journal_bearing(self) -> '_2155.TiltingPadJournalBearing':
    ...
    @property
    def bearing_design_of_type_tilting_pad_thrust_bearing(self) -> '_2156.TiltingPadThrustBearing':
    ...
    @property
    def bearing_design_of_type_concept_axial_clearance_bearing(self) -> '_2158.ConceptAxialClearanceBearing':
    ...
    @property
    def bearing_design_of_type_concept_clearance_bearing(self) -> '_2159.ConceptClearanceBearing':
    ...
    @property
    def bearing_design_of_type_concept_radial_clearance_bearing(self) -> '_2160.ConceptRadialClearanceBearing':
    ...
    @property
    def radial_load_summary(self) -> '_1803.DutyCyclePropertySummaryForce[_1838.BearingLoadCaseResultsLightweight]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1838.BearingLoadCaseResultsLightweight](temp) if temp is not None else None

    @property
    def z_thrust_reaction_summary(self) -> '_1803.DutyCyclePropertySummaryForce[_1838.BearingLoadCaseResultsLightweight]':
    ...
    @property
    def bearing_load_case_results(self) -> 'List[_1912.LoadedBearingResults]':
