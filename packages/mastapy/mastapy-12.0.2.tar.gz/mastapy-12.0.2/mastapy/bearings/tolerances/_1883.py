...
from mastapy.bearings.tolerances import _1884, _1879, _1871
...
class SupportDetail(_1871.InterferenceDetail):
    """SupportDetail
    ...
    @property
    def material_source(self) -> '_1884.SupportMaterialSource':
        ...
        return constructor.new_from_mastapy_type(_1884.SupportMaterialSource)(value) if value is not None else None
    ...
    @property
    def radial_specification_method(self) -> '_1879.RadialSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1879.RadialSpecificationMethod)(value) if value is not None else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1879.RadialSpecificationMethod'):
