...
class RollingBearingDatabase(_1796.SQLDatabase['_1857.RollingBearingKey', '_2126.RollingBearing']):
    """RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_2126.RollingBearing'):
    ...
    def create_bearing(self, type_: '_1859.RollingBearingType', designation: Optional['str'] = 'None') -> '_2126.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_2126.RollingBearing':
        """ 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1859.RollingBearingType', designation: Optional['str'] = 'None') -> '_1857.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1857.RollingBearingKey':
        """ 'CreateKey' is the original name of this method.
    ...
    def remove_from_database(self, bearing: '_2126.RollingBearing'):
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1832.BearingCatalog') -> 'List[_2126.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1832.BearingCatalog') -> '_2126.RollingBearing':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1832.BearingCatalog', type_: '_1859.RollingBearingType') -> 'List[_2126.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1832.BearingCatalog', type_: '_1859.RollingBearingType', bore_range: '_1455.Range', outer_diameter_range: '_1455.Range', width_range: '_1455.Range', dynamic_capacity_range: '_1455.Range', number_of_rows: 'int', material_type: '_1848.HybridSteelAll') -> 'List[_2126.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
