...
from mastapy.bearings.bearing_results.rolling.skf_module import _2057
...
class SKFSettings(_1561.PerMachineSettings):
    """SKFSettings
    ...
    @property
    def skf_authentication(self) -> '_2057.SKFAuthentication':
