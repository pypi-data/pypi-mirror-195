...
class OilPumpDetail(_1553.IndependentReportablePropertiesBase['OilPumpDetail']):
    """OilPumpDetail
    ...
    @property
    def electric_power_consumed_vs_speed(self) -> '_1500.Vector2DListAccessor':
    ...
    def electric_power_consumed_vs_speed(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ElectricPowerConsumedVsSpeed = value

    @property
    def oil_flow_rate_vs_speed(self) -> '_1500.Vector2DListAccessor':
    ...
    def oil_flow_rate_vs_speed(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def operating_oil_pressure_vs_speed(self) -> '_1500.Vector2DListAccessor':
    ...
    def operating_oil_pressure_vs_speed(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
