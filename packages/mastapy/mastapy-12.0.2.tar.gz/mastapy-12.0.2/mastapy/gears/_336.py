...
class PocketingPowerLossCoefficients(_1794.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def raw_pocketing_power_loss_lookup_table(self, value: '_1532.GriddedSurfaceAccessor'):
