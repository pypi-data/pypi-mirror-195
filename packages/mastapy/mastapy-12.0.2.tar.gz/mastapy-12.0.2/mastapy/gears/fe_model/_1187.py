...
class GearFEModel(_1211.GearImplementationDetail):
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7487.TaskProgress'):
        """ 'CalculateStiffnessFromFE' is the original name of this method.
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_320.GearFlanks', progress: '_7487.TaskProgress'):
        """ 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
