...
class CylindricalGearMeshMicroGeometry(_1215.GearMeshImplementationDetail):
    ...
    @property
    def left_flank_lead_modification_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def left_flank_profile_modification_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def right_flank_lead_modification_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def right_flank_profile_modification_chart(self) -> '_1829.TwoDChartDefinition':
