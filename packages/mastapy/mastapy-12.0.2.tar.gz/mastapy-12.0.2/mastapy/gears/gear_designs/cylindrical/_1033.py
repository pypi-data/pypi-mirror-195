...
class CylindricalPlanetaryGearSetDesign(_1021.CylindricalGearSetDesign):
    ...
    @property
    def planet_gear_phasing_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_1478.FourierSeries':
