...
class ElectricMachineDetail(_0.APIBase):
    ...
    @property
    def results_locations(self) -> 'List[_1487.Named2DLocation]':
    ...
    def generate_design_without_non_linear_dq_model(self) -> '_1558.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def try_generate_non_linear_dq_model(self) -> '_1558.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def try_generate_non_linear_dq_model_with_task_progress(self, progress: '_7487.TaskProgress') -> '_1558.MethodOutcomeWithResult[ElectricMachineDetail]':
