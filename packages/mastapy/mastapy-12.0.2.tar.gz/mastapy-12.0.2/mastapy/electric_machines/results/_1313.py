...
class NonLinearDQModel(_1298.ElectricMachineDQModel):
    ...
    @property
    def alignment_torque_map_at_reference_temperatures(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def d_axis_armature_flux_linkage_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def q_axis_armature_flux_linkage_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def reluctance_torque_map_at_reference_temperatures(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def rotor_eddy_current_loss_per_frequency_exponent_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def rotor_excess_loss_per_frequency_exponent_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def rotor_hysteresis_loss_per_frequency_exponent_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def stator_eddy_current_loss_per_frequency_exponent_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def stator_excess_loss_per_frequency_exponent_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def stator_hysteresis_loss_per_frequency_exponent_map(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def torque_map_at_reference_temperatures(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def torque_at_max_current_and_reference_temperatures(self) -> '_1829.TwoDChartDefinition':
