...
from mastapy.utility_gui.charts.colour import _1830
...
class ElectricMachineResultsViewable(_168.ElmerResultsViewable):
    ...
    @property
    def field_lines_colour_map(self) -> '_1830.ColourMapOption':
        ...
        return constructor.new_from_mastapy_type(_1830.ColourMapOption)(value) if value is not None else None

    @field_lines_colour_map.setter
    def field_lines_colour_map(self, value: '_1830.ColourMapOption'):
    ...
    @property
    def parts_to_view(self) -> 'List[_1807.EnumWithBool[_1273.RegionID]]':
