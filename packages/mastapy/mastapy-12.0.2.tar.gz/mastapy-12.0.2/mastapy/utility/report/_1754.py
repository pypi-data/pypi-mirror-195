...
from mastapy.utility.report import _1752, _1745
...
class UserTextRow(_1745.CustomRow):
    """UserTextRow
    ...
    @property
    def heading_size(self) -> '_1752.HeadingSize':
        ...
        return constructor.new_from_mastapy_type(_1752.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1752.HeadingSize'):
