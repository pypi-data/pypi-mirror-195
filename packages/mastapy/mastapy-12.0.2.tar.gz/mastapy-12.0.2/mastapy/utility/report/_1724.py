...
from mastapy.utility.report import _1716, _1740
...
class CustomReportChartItem(_1740.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    def point_shape(self) -> '_1716.SMTChartPointShape':
        ...
        return constructor.new_from_mastapy_type(_1716.SMTChartPointShape)(value) if value is not None else None

    @point_shape.setter
    def point_shape(self, value: '_1716.SMTChartPointShape'):
