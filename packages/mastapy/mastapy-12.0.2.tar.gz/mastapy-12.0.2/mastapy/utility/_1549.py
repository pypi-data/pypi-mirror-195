...
class FileHistory(_0.APIBase):
    ...
    @property
    def items(self) -> 'List[_1550.FileHistoryItem]':
    ...
    def add_file_history_item(self, item: '_1550.FileHistoryItem'):
    ...
    def create_history_item(self, user_name: 'str', comment: 'str') -> '_1550.FileHistoryItem':
