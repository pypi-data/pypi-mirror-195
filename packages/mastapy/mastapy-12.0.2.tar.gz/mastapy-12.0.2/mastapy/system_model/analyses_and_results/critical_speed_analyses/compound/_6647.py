...
class CVTPulleyCompoundCriticalSpeedAnalysis(_6693.PulleyCompoundCriticalSpeedAnalysis):
    """CVTPulleyCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6518.CVTPulleyCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6518.CVTPulleyCriticalSpeedAnalysis]':
