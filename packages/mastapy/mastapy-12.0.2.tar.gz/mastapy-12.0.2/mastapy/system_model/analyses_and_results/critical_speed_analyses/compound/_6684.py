...
class PartCompoundCriticalSpeedAnalysis(_7474.PartCompoundAnalysis):
    """PartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6555.PartCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6555.PartCriticalSpeedAnalysis]':
