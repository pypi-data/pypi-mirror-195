...
class RollingRingAssemblyCompoundCriticalSpeedAnalysis(_6703.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """RollingRingAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6567.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6567.RollingRingAssemblyCriticalSpeedAnalysis]':
