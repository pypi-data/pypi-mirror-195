...
class BoltedJointCompoundCriticalSpeedAnalysis(_6703.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """BoltedJointCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6494.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6494.BoltedJointCriticalSpeedAnalysis]':
