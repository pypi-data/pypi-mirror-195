...
class StraightBevelDiffGearCompoundCriticalSpeedAnalysis(_6621.BevelGearCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6581.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6581.StraightBevelDiffGearCriticalSpeedAnalysis]':
