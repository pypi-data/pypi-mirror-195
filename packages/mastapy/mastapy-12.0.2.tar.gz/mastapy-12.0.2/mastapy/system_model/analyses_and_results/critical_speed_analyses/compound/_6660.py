...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6658, _6659, _6665
...
class FaceGearSetCompoundCriticalSpeedAnalysis(_6665.GearSetCompoundCriticalSpeedAnalysis):
    """FaceGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6531.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def face_gears_compound_critical_speed_analysis(self) -> 'List[_6658.FaceGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_compound_critical_speed_analysis(self) -> 'List[_6659.FaceGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6531.FaceGearSetCriticalSpeedAnalysis]':
