...
class DatumCompoundCriticalSpeedAnalysis(_6630.ComponentCompoundCriticalSpeedAnalysis):
    """DatumCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6527.DatumCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6527.DatumCriticalSpeedAnalysis]':
