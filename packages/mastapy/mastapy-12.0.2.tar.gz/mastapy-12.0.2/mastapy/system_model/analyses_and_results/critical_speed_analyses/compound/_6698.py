...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(_6670.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """RollingRingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6568.RollingRingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6568.RollingRingConnectionCriticalSpeedAnalysis]':
