...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6634, _6635, _6665
...
class ConceptGearSetCompoundCriticalSpeedAnalysis(_6665.GearSetCompoundCriticalSpeedAnalysis):
    """ConceptGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6505.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gears_compound_critical_speed_analysis(self) -> 'List[_6634.ConceptGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_compound_critical_speed_analysis(self) -> 'List[_6635.ConceptGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6505.ConceptGearSetCriticalSpeedAnalysis]':
