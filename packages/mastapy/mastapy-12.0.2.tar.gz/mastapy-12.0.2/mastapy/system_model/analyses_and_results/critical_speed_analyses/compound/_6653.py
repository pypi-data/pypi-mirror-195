...
class CylindricalGearMeshCompoundCriticalSpeedAnalysis(_6664.GearMeshCompoundCriticalSpeedAnalysis):
    """CylindricalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6524.CylindricalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6524.CylindricalGearMeshCriticalSpeedAnalysis]':
