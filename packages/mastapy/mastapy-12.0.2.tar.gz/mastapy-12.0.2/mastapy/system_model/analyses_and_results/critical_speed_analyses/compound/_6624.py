...
class BoltCompoundCriticalSpeedAnalysis(_6630.ComponentCompoundCriticalSpeedAnalysis):
    """BoltCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6493.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6493.BoltCriticalSpeedAnalysis]':
