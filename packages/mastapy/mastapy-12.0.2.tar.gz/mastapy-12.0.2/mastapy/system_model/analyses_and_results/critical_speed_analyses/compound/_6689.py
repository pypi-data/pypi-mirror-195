...
class PlanetaryGearSetCompoundCriticalSpeedAnalysis(_6654.CylindricalGearSetCompoundCriticalSpeedAnalysis):
    """PlanetaryGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6560.PlanetaryGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6560.PlanetaryGearSetCriticalSpeedAnalysis]':
