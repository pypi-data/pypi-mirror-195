...
class BevelDifferentialSunGearCompoundCriticalSpeedAnalysis(_6616.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6489.BevelDifferentialSunGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6489.BevelDifferentialSunGearCriticalSpeedAnalysis]':
