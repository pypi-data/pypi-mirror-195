...
class BeltConnectionCompoundCriticalSpeedAnalysis(_6670.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """BeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6483.BeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6483.BeltConnectionCriticalSpeedAnalysis]':
