...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6713, _6714, _6623
...
class StraightBevelGearSetCompoundCriticalSpeedAnalysis(_6623.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6586.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6713.StraightBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6714.StraightBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6586.StraightBevelGearSetCriticalSpeedAnalysis]':
