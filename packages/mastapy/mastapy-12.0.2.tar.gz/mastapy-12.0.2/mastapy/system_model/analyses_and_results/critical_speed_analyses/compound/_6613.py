...
class BearingCompoundCriticalSpeedAnalysis(_6641.ConnectorCompoundCriticalSpeedAnalysis):
    """BearingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6482.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6482.BearingCriticalSpeedAnalysis]':
