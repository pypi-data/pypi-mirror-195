...
class FlexiblePinAssemblyCompoundCriticalSpeedAnalysis(_6703.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """FlexiblePinAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6533.FlexiblePinAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6533.FlexiblePinAssemblyCriticalSpeedAnalysis]':
