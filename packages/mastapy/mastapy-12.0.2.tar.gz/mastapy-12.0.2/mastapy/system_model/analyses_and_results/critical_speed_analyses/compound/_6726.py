...
class UnbalancedMassCompoundCriticalSpeedAnalysis(_6727.VirtualComponentCompoundCriticalSpeedAnalysis):
    """UnbalancedMassCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6597.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6597.UnbalancedMassCriticalSpeedAnalysis]':
