...
class CouplingHalfCompoundCriticalSpeedAnalysis(_6682.MountableComponentCompoundCriticalSpeedAnalysis):
    """CouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6513.CouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6513.CouplingHalfCriticalSpeedAnalysis]':
