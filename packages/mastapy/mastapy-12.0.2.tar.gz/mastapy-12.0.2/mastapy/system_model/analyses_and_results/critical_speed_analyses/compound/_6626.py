...
class ClutchCompoundCriticalSpeedAnalysis(_6642.CouplingCompoundCriticalSpeedAnalysis):
    """ClutchCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6496.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6496.ClutchCriticalSpeedAnalysis]':
