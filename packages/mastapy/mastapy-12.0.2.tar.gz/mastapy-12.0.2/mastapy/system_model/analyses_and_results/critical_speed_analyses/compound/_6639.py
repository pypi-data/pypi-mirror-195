...
class ConicalGearSetCompoundCriticalSpeedAnalysis(_6665.GearSetCompoundCriticalSpeedAnalysis):
    """ConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6508.ConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6508.ConicalGearSetCriticalSpeedAnalysis]':
