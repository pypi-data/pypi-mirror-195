...
class GuideDxfModelCompoundCriticalSpeedAnalysis(_6630.ComponentCompoundCriticalSpeedAnalysis):
    """GuideDxfModelCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6537.GuideDxfModelCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6537.GuideDxfModelCriticalSpeedAnalysis]':
