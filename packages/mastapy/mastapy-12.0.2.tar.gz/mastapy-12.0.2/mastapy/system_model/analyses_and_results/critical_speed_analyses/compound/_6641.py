...
class ConnectorCompoundCriticalSpeedAnalysis(_6682.MountableComponentCompoundCriticalSpeedAnalysis):
    """ConnectorCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6510.ConnectorCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6510.ConnectorCriticalSpeedAnalysis]':
