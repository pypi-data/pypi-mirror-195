...
class AbstractShaftCompoundCriticalSpeedAnalysis(_6607.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    """AbstractShaftCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6475.AbstractShaftCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6475.AbstractShaftCriticalSpeedAnalysis]':
