...
class TorqueConverterConnectionCompoundCriticalSpeedAnalysis(_6643.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """TorqueConverterConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6593.TorqueConverterConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6593.TorqueConverterConnectionCriticalSpeedAnalysis]':
