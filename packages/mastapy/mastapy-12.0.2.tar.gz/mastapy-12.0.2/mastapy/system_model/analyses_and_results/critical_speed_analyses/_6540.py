...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6538, _6539, _6480
...
class HypoidGearSetCriticalSpeedAnalysis(_6480.AGMAGleasonConicalGearSetCriticalSpeedAnalysis):
    """HypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def hypoid_gears_critical_speed_analysis(self) -> 'List[_6538.HypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_critical_speed_analysis(self) -> 'List[_6539.HypoidGearMeshCriticalSpeedAnalysis]':
