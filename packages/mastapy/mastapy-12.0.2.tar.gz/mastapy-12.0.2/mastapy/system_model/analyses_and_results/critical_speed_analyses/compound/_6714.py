...
class StraightBevelGearMeshCompoundCriticalSpeedAnalysis(_6622.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """StraightBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6585.StraightBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6585.StraightBevelGearMeshCriticalSpeedAnalysis]':
