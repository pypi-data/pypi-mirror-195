...
class KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis(_6638.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6543.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6543.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
