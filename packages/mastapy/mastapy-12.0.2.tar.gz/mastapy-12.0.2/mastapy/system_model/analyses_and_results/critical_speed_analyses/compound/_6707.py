...
class SpringDamperCompoundCriticalSpeedAnalysis(_6642.CouplingCompoundCriticalSpeedAnalysis):
    """SpringDamperCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6579.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6579.SpringDamperCriticalSpeedAnalysis]':
