...
class SpiralBevelGearCompoundCriticalSpeedAnalysis(_6621.BevelGearCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6575.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6575.SpiralBevelGearCriticalSpeedAnalysis]':
