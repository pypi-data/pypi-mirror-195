...
class ConceptCouplingConnectionCompoundCriticalSpeedAnalysis(_6643.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ConceptCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6500.ConceptCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6500.ConceptCouplingConnectionCriticalSpeedAnalysis]':
