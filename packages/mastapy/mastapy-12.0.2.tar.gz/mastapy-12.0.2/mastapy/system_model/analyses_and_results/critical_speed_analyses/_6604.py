...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6602, _6603, _6492
...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6492.BevelGearSetCriticalSpeedAnalysis):
    """ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def zerol_bevel_gears_critical_speed_analysis(self) -> 'List[_6602.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_critical_speed_analysis(self) -> 'List[_6603.ZerolBevelGearMeshCriticalSpeedAnalysis]':
