...
class TorqueConverterTurbineCompoundCriticalSpeedAnalysis(_6644.CouplingHalfCompoundCriticalSpeedAnalysis):
    """TorqueConverterTurbineCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6596.TorqueConverterTurbineCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6596.TorqueConverterTurbineCriticalSpeedAnalysis]':
