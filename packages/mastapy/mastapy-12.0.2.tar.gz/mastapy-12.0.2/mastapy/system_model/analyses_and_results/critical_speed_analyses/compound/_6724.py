...
class TorqueConverterPumpCompoundCriticalSpeedAnalysis(_6644.CouplingHalfCompoundCriticalSpeedAnalysis):
    """TorqueConverterPumpCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6595.TorqueConverterPumpCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6595.TorqueConverterPumpCriticalSpeedAnalysis]':
