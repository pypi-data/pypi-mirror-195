...
class PointLoadCompoundCriticalSpeedAnalysis(_6727.VirtualComponentCompoundCriticalSpeedAnalysis):
    """PointLoadCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6562.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6562.PointLoadCriticalSpeedAnalysis]':
