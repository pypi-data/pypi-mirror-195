...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6710, _6711, _6623
...
class StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis(_6623.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6583.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_critical_speed_analysis(self) -> 'List[_6710.StraightBevelDiffGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_critical_speed_analysis(self) -> 'List[_6711.StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6583.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
