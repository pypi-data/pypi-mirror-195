...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6575, _6576, _6492
...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6492.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6575.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6576.SpiralBevelGearMeshCriticalSpeedAnalysis]':
