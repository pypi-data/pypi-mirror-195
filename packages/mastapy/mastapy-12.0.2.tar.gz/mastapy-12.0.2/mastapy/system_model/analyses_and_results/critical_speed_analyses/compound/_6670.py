...
class InterMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6640.ConnectionCompoundCriticalSpeedAnalysis):
    """InterMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6541.InterMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6541.InterMountableComponentConnectionCriticalSpeedAnalysis]':
