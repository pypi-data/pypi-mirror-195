...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import (
    _6613, _6615, _6618, _6625,
    _6624, _6646, _6626, _6631,
    _6636, _6648, _6650, _6654,
    _6661, _6660, _6662, _6669,
    _6676, _6679, _6680, _6681,
    _6683, _6685, _6690, _6691,
    _6692, _6694, _6696, _6701,
    _6700, _6706, _6707, _6712,
    _6715, _6718, _6722, _6726,
    _6730, _6733, _6605
)
...
class AssemblyCompoundCriticalSpeedAnalysis(_6605.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """AssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6481.AssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6613.BearingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6615.BeltDriveCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6618.BevelDifferentialGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6625.BoltedJointCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6624.BoltCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6646.CVTCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6626.ClutchCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6631.ConceptCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6636.ConceptGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6648.CycloidalAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6650.CycloidalDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6654.CylindricalGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6661.FEPartCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6660.FaceGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6662.FlexiblePinAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6669.HypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6676.KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6679.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6680.MassDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6681.MeasurementComponentCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6683.OilSealCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6685.PartToPartShearCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6690.PlanetCarrierCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6691.PointLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6692.PowerLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6694.RingPinsCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6696.RollingRingAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6701.ShaftHubConnectionCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6700.ShaftCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6706.SpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6707.SpringDamperCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6712.StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6715.StraightBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6718.SynchroniserCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6722.TorqueConverterCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6726.UnbalancedMassCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6730.WormGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6733.ZerolBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6481.AssemblyCriticalSpeedAnalysis]':
