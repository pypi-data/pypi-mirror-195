...
class AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6640.ConnectionCompoundCriticalSpeedAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6477.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6477.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
