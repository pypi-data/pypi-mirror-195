...
class ConceptGearMeshCompoundCriticalSpeedAnalysis(_6664.GearMeshCompoundCriticalSpeedAnalysis):
    """ConceptGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6504.ConceptGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6504.ConceptGearMeshCriticalSpeedAnalysis]':
