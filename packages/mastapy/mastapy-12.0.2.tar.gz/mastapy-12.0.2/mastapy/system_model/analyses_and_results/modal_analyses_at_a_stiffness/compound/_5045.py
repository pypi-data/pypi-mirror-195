...
class SynchroniserPartCompoundModalAnalysisAtAStiffness(_4969.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """SynchroniserPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4916.SynchroniserPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4916.SynchroniserPartModalAnalysisAtAStiffness]':
