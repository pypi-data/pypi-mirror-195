...
class CVTCompoundModalAnalysisAtAStiffness(_4940.BeltDriveCompoundModalAnalysisAtAStiffness):
    """CVTCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4841.CVTModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4841.CVTModalAnalysisAtAStiffness]':
