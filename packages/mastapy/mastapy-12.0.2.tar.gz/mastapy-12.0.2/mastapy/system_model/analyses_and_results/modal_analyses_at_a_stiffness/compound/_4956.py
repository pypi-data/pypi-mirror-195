...
class ConceptCouplingCompoundModalAnalysisAtAStiffness(_4967.CouplingCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4828.ConceptCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4828.ConceptCouplingModalAnalysisAtAStiffness]':
