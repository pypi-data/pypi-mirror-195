...
class RingPinsCompoundModalAnalysisAtAStiffness(_5007.MountableComponentCompoundModalAnalysisAtAStiffness):
    """RingPinsCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4890.RingPinsModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4890.RingPinsModalAnalysisAtAStiffness]':
