...
class ShaftCompoundModalAnalysisAtAStiffness(_4931.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """ShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4897.ShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4897.ShaftModalAnalysisAtAStiffness]':
