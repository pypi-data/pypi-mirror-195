...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5038, _5039, _4948
...
class StraightBevelGearSetCompoundModalAnalysisAtAStiffness(_4948.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4911.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5038.StraightBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5039.StraightBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4911.StraightBevelGearSetModalAnalysisAtAStiffness]':
