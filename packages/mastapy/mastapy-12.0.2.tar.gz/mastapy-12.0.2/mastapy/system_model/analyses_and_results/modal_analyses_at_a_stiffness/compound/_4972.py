...
class CVTPulleyCompoundModalAnalysisAtAStiffness(_5018.PulleyCompoundModalAnalysisAtAStiffness):
    """CVTPulleyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4842.CVTPulleyModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4842.CVTPulleyModalAnalysisAtAStiffness]':
