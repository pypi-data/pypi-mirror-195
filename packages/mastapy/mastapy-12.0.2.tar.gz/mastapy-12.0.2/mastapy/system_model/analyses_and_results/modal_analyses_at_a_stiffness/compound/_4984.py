...
class FaceGearMeshCompoundModalAnalysisAtAStiffness(_4989.GearMeshCompoundModalAnalysisAtAStiffness):
    """FaceGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4854.FaceGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4854.FaceGearMeshModalAnalysisAtAStiffness]':
