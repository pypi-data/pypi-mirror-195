...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4925, _4924, _4861
...
class WormGearSetModalAnalysisAtAStiffness(_4861.GearSetModalAnalysisAtAStiffness):
    """WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4925.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4924.WormGearMeshModalAnalysisAtAStiffness]':
