...
class BoltedJointCompoundModalAnalysisAtAStiffness(_5028.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BoltedJointCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4819.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4819.BoltedJointModalAnalysisAtAStiffness]':
