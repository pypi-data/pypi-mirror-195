...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4941, _4942, _4948
...
class BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness(_4948.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4813.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4941.BevelDifferentialGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4942.BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4813.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
