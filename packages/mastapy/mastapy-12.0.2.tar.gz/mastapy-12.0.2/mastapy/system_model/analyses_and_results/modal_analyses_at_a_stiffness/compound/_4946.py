...
class BevelGearCompoundModalAnalysisAtAStiffness(_4934.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    """BevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4817.BevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4817.BevelGearModalAnalysisAtAStiffness]':
