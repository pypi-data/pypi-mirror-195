...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4954
...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness(_4954.CoaxialConnectionCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4844.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4844.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
