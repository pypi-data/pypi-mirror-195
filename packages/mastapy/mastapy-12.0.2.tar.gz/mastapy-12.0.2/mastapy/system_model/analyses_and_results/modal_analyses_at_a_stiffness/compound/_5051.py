...
class UnbalancedMassCompoundModalAnalysisAtAStiffness(_5052.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """UnbalancedMassCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4922.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4922.UnbalancedMassModalAnalysisAtAStiffness]':
