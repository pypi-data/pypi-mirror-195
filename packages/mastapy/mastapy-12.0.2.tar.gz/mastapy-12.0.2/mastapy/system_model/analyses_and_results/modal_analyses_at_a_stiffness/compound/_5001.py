...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4999, _5000, _4998
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness(_4998.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4872.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4999.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5000.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4872.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]':
