...
class PlanetCarrierCompoundModalAnalysisAtAStiffness(_5007.MountableComponentCompoundModalAnalysisAtAStiffness):
    """PlanetCarrierCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4886.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4886.PlanetCarrierModalAnalysisAtAStiffness]':
