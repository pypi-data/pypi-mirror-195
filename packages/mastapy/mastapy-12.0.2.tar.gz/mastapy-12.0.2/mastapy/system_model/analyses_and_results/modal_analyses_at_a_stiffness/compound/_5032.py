...
class SpringDamperCompoundModalAnalysisAtAStiffness(_4967.CouplingCompoundModalAnalysisAtAStiffness):
    """SpringDamperCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4905.SpringDamperModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4905.SpringDamperModalAnalysisAtAStiffness]':
