...
class InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness(_4965.ConnectionCompoundModalAnalysisAtAStiffness):
    """InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4866.InterMountableComponentConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4866.InterMountableComponentConnectionModalAnalysisAtAStiffness]':
