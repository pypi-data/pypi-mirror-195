...
class RollingRingAssemblyCompoundModalAnalysisAtAStiffness(_5028.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """RollingRingAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4892.RollingRingAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4892.RollingRingAssemblyModalAnalysisAtAStiffness]':
