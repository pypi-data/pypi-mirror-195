...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness(_4965.ConnectionCompoundModalAnalysisAtAStiffness):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4803.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4803.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
