...
class RollingRingConnectionCompoundModalAnalysisAtAStiffness(_4995.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """RollingRingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4893.RollingRingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4893.RollingRingConnectionModalAnalysisAtAStiffness]':
