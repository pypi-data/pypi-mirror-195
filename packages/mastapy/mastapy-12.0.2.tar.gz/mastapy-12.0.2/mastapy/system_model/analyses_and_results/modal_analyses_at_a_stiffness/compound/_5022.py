...
class RollingRingCompoundModalAnalysisAtAStiffness(_4969.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """RollingRingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4894.RollingRingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4894.RollingRingModalAnalysisAtAStiffness]':
