...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5056, _5057, _4948
...
class ZerolBevelGearSetCompoundModalAnalysisAtAStiffness(_4948.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4929.ZerolBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5056.ZerolBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5057.ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4929.ZerolBevelGearSetModalAnalysisAtAStiffness]':
