...
class SynchroniserCompoundModalAnalysisAtAStiffness(_5028.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """SynchroniserCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4915.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4915.SynchroniserModalAnalysisAtAStiffness]':
