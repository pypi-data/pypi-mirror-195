...
class ConicalGearSetCompoundModalAnalysisAtAStiffness(_4990.GearSetCompoundModalAnalysisAtAStiffness):
    """ConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4834.ConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4834.ConicalGearSetModalAnalysisAtAStiffness]':
