...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4977, _4978, _4990
...
class CylindricalGearSetCompoundModalAnalysisAtAStiffness(_4990.GearSetCompoundModalAnalysisAtAStiffness):
    """CylindricalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4849.CylindricalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4977.CylindricalGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4978.CylindricalGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4849.CylindricalGearSetModalAnalysisAtAStiffness]':
