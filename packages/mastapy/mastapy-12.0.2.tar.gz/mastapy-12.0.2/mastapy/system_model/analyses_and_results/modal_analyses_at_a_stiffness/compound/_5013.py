...
class PlanetaryConnectionCompoundModalAnalysisAtAStiffness(_5027.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """PlanetaryConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4884.PlanetaryConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4884.PlanetaryConnectionModalAnalysisAtAStiffness]':
