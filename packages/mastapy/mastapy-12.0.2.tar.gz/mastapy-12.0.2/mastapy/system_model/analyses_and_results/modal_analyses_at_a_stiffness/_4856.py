...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4855, _4854, _4861
...
class FaceGearSetModalAnalysisAtAStiffness(_4861.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4855.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4854.FaceGearMeshModalAnalysisAtAStiffness]':
