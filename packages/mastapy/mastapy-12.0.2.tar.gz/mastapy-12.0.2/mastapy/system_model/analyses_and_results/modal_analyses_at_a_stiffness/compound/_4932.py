...
class AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness(_4955.ComponentCompoundModalAnalysisAtAStiffness):
    """AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4802.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4802.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
