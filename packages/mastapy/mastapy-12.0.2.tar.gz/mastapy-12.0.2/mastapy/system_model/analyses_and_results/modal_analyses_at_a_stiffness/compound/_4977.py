...
class CylindricalGearCompoundModalAnalysisAtAStiffness(_4988.GearCompoundModalAnalysisAtAStiffness):
    """CylindricalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4848.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4848.CylindricalGearModalAnalysisAtAStiffness]':
