...
TAssembly = TypeVar('TAssembly', bound='_2391.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6737.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5617.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    """AbstractAssemblyStaticLoadCaseGroup
