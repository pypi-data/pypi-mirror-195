...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6470, _6473, _6472
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self) -> '_6470.ExcelFileDetails':
    ...
    @property
    def masta_file_details(self) -> '_6473.MASTAFileDetails':
    ...
    @property
    def working_folder(self) -> '_1566.SelectableFolder':
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6472.ExcelSheetDesignStateSelector]':
