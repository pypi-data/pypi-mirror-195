...
class CycloidalDiscCentralBearingConnectionAdvancedTimeSteppingAnalysisForModulation(_6963.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscCentralBearingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_2293.CycloidalDiscCentralBearingConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2686.CycloidalDiscCentralBearingConnectionSystemDeflection':
