...
class BearingAdvancedTimeSteppingAnalysisForModulation(_6975.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """BearingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2648.BearingSystemDeflection':
