...
class TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation(_7108.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7059.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7059.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
