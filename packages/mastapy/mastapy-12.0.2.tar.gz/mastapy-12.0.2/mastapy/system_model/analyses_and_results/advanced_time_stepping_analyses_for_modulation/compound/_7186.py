...
class TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation(_7106.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7057.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7057.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
