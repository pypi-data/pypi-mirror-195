...
class SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(_6977.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2760.SpringDamperConnectionSystemDeflection':
