...
class CVTCompoundAdvancedTimeSteppingAnalysisForModulation(_7079.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CVTCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6979.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6979.CVTAdvancedTimeSteppingAnalysisForModulation]':
