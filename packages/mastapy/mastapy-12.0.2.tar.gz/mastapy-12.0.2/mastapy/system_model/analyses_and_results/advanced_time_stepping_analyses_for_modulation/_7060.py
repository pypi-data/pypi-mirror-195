...
class TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(_6978.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2781.TorqueConverterTurbineSystemDeflection':
