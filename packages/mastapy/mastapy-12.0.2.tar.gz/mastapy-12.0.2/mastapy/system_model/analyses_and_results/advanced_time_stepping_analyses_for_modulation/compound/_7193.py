...
class WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7128.GearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2287.WormGearMesh':
    ...
    @property
    def connection_design(self) -> '_2287.WormGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7064.WormGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7064.WormGearMeshAdvancedTimeSteppingAnalysisForModulation]':
