...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7048, _7049, _6957
...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6957.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2767.StraightBevelGearSetSystemDeflection':
    ...
    @property
    def straight_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7048.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7049.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
