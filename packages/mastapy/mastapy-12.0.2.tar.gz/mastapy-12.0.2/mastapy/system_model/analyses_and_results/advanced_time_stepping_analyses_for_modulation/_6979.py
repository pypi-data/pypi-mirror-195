...
class CVTAdvancedTimeSteppingAnalysisForModulation(_6949.BeltDriveAdvancedTimeSteppingAnalysisForModulation):
    """CVTAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2684.CVTSystemDeflection':
