...
class ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6977.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6768.ConceptCouplingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2667.ConceptCouplingConnectionSystemDeflection':
