...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6950, _6951, _6957
...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(_6957.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def bevel_differential_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6950.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6951.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
