...
class OilSealAdvancedTimeSteppingAnalysisForModulation(_6975.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """OilSealAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2734.OilSealSystemDeflection':
