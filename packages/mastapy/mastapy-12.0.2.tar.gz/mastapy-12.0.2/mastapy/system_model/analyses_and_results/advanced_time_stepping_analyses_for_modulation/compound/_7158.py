...
class RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation(_7146.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7029.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7029.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
