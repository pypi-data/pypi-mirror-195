...
class AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(_6964.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2641.AbstractShaftOrHousingSystemDeflection':
