...
class GearMeshAdvancedTimeSteppingAnalysisForModulation(_7005.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """GearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_2271.GearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2709.GearMeshSystemDeflection':
