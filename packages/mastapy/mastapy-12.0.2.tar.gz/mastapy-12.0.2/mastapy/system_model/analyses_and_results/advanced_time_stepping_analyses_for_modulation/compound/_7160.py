...
class RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7167.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2552.RollingRingAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7032.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7032.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
