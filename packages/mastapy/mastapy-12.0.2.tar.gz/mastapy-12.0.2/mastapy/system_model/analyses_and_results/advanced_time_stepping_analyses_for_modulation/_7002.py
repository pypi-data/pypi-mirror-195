...
class HypoidGearAdvancedTimeSteppingAnalysisForModulation(_6942.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2715.HypoidGearSystemDeflection':
