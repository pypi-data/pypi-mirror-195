...
class SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation(_6978.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2761.SpringDamperHalfSystemDeflection':
