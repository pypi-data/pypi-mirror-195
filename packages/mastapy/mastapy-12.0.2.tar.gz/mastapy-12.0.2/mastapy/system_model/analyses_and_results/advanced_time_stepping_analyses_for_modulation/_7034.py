...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _2578, _6945
...
class RootAssemblyAdvancedTimeSteppingAnalysisForModulation(_6945.AssemblyAdvancedTimeSteppingAnalysisForModulation):
    """RootAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_inputs(self) -> '_2578.AdvancedTimeSteppingAnalysisForModulation':
    ...
    @property
    def results(self) -> '_5809.RootAssemblyHarmonicAnalysisResultsPropertyAccessor':
    ...
    @property
    def system_deflection_results(self) -> '_2750.RootAssemblySystemDeflection':
