...
class GearCompoundAdvancedTimeSteppingAnalysisForModulation(_7146.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6997.GearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6997.GearAdvancedTimeSteppingAnalysisForModulation]':
