...
class PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7106.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2543.PartToPartShearCoupling':
    ...
    @property
    def assembly_design(self) -> '_2543.PartToPartShearCoupling':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7020.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7020.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
