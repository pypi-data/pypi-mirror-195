...
class BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft(_3423.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3214.BoltedJointSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3214.BoltedJointSteadyStateSynchronousResponseOnAShaft]':
