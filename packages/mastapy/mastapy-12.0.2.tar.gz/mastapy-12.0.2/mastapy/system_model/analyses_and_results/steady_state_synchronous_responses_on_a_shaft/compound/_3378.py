...
class FaceGearCompoundSteadyStateSynchronousResponseOnAShaft(_3383.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """FaceGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3250.FaceGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3250.FaceGearSteadyStateSynchronousResponseOnAShaft]':
