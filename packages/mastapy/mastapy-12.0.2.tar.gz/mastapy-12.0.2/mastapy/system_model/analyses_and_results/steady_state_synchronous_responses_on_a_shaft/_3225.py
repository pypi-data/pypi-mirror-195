...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3226, _3224, _3254
...
class ConceptGearSetSteadyStateSynchronousResponseOnAShaft(_3254.GearSetSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def concept_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3226.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3224.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft]':
