...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3326.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3291.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3291.ShaftSteadyStateSynchronousResponseOnAShaft]':
