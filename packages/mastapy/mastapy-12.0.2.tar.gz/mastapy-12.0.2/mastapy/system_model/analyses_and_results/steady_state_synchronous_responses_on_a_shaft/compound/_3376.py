...
class DatumCompoundSteadyStateSynchronousResponseOnAShaft(_3350.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """DatumCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3246.DatumSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3246.DatumSteadyStateSynchronousResponseOnAShaft]':
