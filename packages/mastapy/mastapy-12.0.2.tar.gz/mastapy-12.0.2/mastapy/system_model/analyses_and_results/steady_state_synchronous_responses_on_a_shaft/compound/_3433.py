...
class StraightBevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_3341.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3306.StraightBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3306.StraightBevelGearSteadyStateSynchronousResponseOnAShaft]':
