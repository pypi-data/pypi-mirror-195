...
class WormGearCompoundSteadyStateSynchronousResponseOnAShaft(_3383.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3321.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3321.WormGearSteadyStateSynchronousResponseOnAShaft]':
