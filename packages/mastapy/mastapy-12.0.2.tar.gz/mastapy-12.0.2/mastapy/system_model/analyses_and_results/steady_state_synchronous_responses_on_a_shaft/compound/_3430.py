...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft(_3341.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3303.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3303.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
