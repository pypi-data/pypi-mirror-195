...
class CouplingConnectionCompoundMultibodyDynamicsAnalysis(_5534.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5357.CouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5357.CouplingConnectionMultibodyDynamicsAnalysis]':
