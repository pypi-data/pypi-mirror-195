...
class VirtualComponentCompoundMultibodyDynamicsAnalysis(_5546.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """VirtualComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5455.VirtualComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5455.VirtualComponentMultibodyDynamicsAnalysis]':
