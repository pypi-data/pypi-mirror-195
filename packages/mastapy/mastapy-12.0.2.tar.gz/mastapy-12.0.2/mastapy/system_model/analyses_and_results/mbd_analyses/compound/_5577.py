...
class StraightBevelGearCompoundMultibodyDynamicsAnalysis(_5485.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5440.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5440.StraightBevelGearMultibodyDynamicsAnalysis]':
