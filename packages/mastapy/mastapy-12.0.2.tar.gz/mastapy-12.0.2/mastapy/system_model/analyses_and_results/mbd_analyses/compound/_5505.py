...
class ConnectorCompoundMultibodyDynamicsAnalysis(_5546.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """ConnectorCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5356.ConnectorMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5356.ConnectorMultibodyDynamicsAnalysis]':
