...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5458, _5457, _5381
...
class WormGearSetMultibodyDynamicsAnalysis(_5381.GearSetMultibodyDynamicsAnalysis):
    """WormGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5458.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_multibody_dynamics_analysis(self) -> 'List[_5458.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_multibody_dynamics_analysis(self) -> 'List[_5457.WormGearMeshMultibodyDynamicsAnalysis]':
