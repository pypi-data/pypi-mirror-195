...
class SynchroniserHalfCompoundMultibodyDynamicsAnalysis(_5584.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5444.SynchroniserHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5444.SynchroniserHalfMultibodyDynamicsAnalysis]':
