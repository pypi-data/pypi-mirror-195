...
class SynchroniserSleeveCompoundMultibodyDynamicsAnalysis(_5584.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserSleeveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5447.SynchroniserSleeveMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5447.SynchroniserSleeveMultibodyDynamicsAnalysis]':
