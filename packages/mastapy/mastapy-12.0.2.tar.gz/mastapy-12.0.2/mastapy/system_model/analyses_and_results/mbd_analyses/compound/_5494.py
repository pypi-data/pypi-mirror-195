...
class ComponentCompoundMultibodyDynamicsAnalysis(_5548.PartCompoundMultibodyDynamicsAnalysis):
    """ComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5345.ComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5345.ComponentMultibodyDynamicsAnalysis]':
