...
class UnbalancedMassCompoundMultibodyDynamicsAnalysis(_5591.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """UnbalancedMassCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5454.UnbalancedMassMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5454.UnbalancedMassMultibodyDynamicsAnalysis]':
