...
class MassDiscCompoundMultibodyDynamicsAnalysis(_5591.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """MassDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5400.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5400.MassDiscMultibodyDynamicsAnalysis]':
