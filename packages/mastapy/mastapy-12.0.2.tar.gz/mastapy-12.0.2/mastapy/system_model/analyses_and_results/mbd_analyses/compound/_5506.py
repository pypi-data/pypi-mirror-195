...
class CouplingCompoundMultibodyDynamicsAnalysis(_5567.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """CouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5359.CouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5359.CouplingMultibodyDynamicsAnalysis]':
