...
class AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis(_5502.ConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5321.AGMAGleasonConicalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5321.AGMAGleasonConicalGearMeshMultibodyDynamicsAnalysis]':
