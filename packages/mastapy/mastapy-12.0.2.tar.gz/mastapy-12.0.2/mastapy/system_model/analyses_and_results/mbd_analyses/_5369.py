...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5368, _5367, _5381
...
class CylindricalGearSetMultibodyDynamicsAnalysis(_5381.GearSetMultibodyDynamicsAnalysis):
    """CylindricalGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5368.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_multibody_dynamics_analysis(self) -> 'List[_5368.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_multibody_dynamics_analysis(self) -> 'List[_5367.CylindricalGearMeshMultibodyDynamicsAnalysis]':
