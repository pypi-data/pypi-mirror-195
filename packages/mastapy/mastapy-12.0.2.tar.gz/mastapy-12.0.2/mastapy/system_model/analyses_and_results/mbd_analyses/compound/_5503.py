...
class ConicalGearSetCompoundMultibodyDynamicsAnalysis(_5529.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5354.ConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5354.ConicalGearSetMultibodyDynamicsAnalysis]':
