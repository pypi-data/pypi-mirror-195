...
class BeltDriveCompoundMultibodyDynamicsAnalysis(_5567.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BeltDriveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5329.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5329.BeltDriveMultibodyDynamicsAnalysis]':
