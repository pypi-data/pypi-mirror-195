...
class PowerLoadCompoundMultibodyDynamicsAnalysis(_5591.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PowerLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5415.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5415.PowerLoadMultibodyDynamicsAnalysis]':
