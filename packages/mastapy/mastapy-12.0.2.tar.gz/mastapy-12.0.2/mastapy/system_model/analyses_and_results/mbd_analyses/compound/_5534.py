...
class InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5504.ConnectionCompoundMultibodyDynamicsAnalysis):
    """InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5390.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5390.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
