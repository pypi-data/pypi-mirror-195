...
class SpringDamperCompoundMultibodyDynamicsAnalysis(_5506.CouplingCompoundMultibodyDynamicsAnalysis):
    """SpringDamperCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5435.SpringDamperMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5435.SpringDamperMultibodyDynamicsAnalysis]':
