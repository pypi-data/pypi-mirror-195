...
class TorqueConverterPumpCompoundMultibodyDynamicsAnalysis(_5508.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterPumpCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5451.TorqueConverterPumpMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5451.TorqueConverterPumpMultibodyDynamicsAnalysis]':
