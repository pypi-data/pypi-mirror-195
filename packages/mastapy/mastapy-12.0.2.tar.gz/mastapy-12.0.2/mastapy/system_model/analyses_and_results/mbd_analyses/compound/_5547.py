...
class OilSealCompoundMultibodyDynamicsAnalysis(_5505.ConnectorCompoundMultibodyDynamicsAnalysis):
    """OilSealCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5406.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5406.OilSealMultibodyDynamicsAnalysis]':
