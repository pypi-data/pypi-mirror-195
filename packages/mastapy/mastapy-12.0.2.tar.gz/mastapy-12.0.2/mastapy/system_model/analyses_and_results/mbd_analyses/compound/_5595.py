...
class ZerolBevelGearCompoundMultibodyDynamicsAnalysis(_5485.BevelGearCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5461.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5461.ZerolBevelGearMultibodyDynamicsAnalysis]':
