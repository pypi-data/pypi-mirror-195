...
class RingPinsCompoundMultibodyDynamicsAnalysis(_5546.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """RingPinsCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5417.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5417.RingPinsMultibodyDynamicsAnalysis]':
