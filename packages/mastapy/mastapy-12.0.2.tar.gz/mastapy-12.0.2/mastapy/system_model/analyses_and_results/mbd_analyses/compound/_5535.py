...
class KlingelnbergCycloPalloidConicalGearCompoundMultibodyDynamicsAnalysis(_5501.ConicalGearCompoundMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5392.KlingelnbergCycloPalloidConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5392.KlingelnbergCycloPalloidConicalGearMultibodyDynamicsAnalysis]':
