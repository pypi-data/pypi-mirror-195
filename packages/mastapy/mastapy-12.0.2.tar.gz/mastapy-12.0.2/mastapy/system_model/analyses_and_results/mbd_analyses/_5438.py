...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5437, _5436, _5337
...
class StraightBevelDiffGearSetMultibodyDynamicsAnalysis(_5337.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5437.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_multibody_dynamics_analysis(self) -> 'List[_5437.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_multibody_dynamics_analysis(self) -> 'List[_5436.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
