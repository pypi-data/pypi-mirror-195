...
class FEPartCompoundMultibodyDynamicsAnalysis(_5471.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """FEPartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5376.FEPartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5376.FEPartMultibodyDynamicsAnalysis]':
