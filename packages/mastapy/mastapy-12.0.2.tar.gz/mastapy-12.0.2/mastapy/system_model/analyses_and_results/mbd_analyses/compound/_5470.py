...
class AbstractShaftCompoundMultibodyDynamicsAnalysis(_5471.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5318.AbstractShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5318.AbstractShaftMultibodyDynamicsAnalysis]':
