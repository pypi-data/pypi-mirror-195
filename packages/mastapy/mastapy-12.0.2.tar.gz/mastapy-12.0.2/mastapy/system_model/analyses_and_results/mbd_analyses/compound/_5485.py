...
class BevelGearCompoundMultibodyDynamicsAnalysis(_5473.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """BevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5336.BevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5336.BevelGearMultibodyDynamicsAnalysis]':
