...
class StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis(_5574.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5442.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5442.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
