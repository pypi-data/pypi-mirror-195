...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5577, _5578, _5487
...
class StraightBevelGearSetCompoundMultibodyDynamicsAnalysis(_5487.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5441.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5577.StraightBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5578.StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5441.StraightBevelGearSetMultibodyDynamicsAnalysis]':
