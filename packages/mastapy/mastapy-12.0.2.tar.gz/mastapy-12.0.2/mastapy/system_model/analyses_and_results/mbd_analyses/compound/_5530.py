...
class GuideDxfModelCompoundMultibodyDynamicsAnalysis(_5494.ComponentCompoundMultibodyDynamicsAnalysis):
    """GuideDxfModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5382.GuideDxfModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5382.GuideDxfModelMultibodyDynamicsAnalysis]':
