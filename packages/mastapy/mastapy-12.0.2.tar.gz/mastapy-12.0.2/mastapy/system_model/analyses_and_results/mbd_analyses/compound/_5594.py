...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5592, _5593, _5529
...
class WormGearSetCompoundMultibodyDynamicsAnalysis(_5529.GearSetCompoundMultibodyDynamicsAnalysis):
    """WormGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5459.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5592.WormGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5593.WormGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5459.WormGearSetMultibodyDynamicsAnalysis]':
