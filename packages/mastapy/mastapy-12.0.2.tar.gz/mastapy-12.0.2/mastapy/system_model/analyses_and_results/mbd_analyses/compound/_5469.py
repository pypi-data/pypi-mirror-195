...
class AbstractAssemblyCompoundMultibodyDynamicsAnalysis(_5548.PartCompoundMultibodyDynamicsAnalysis):
    """AbstractAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5317.AbstractAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5317.AbstractAssemblyMultibodyDynamicsAnalysis]':
