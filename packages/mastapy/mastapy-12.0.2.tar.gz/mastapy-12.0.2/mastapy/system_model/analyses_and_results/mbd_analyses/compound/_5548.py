...
class PartCompoundMultibodyDynamicsAnalysis(_7474.PartCompoundAnalysis):
    """PartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5407.PartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5407.PartMultibodyDynamicsAnalysis]':
