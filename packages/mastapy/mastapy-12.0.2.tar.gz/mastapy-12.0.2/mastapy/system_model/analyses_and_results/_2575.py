...
from mastapy import _7487, _7481
...
class SingleAnalysis(_7481.MarshalByRefObjectPermanent):
    """SingleAnalysis
    ...
    def perform_analysis_with_progress(self, task_progress: '_7487.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2164.DesignEntity') -> '_2606.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2606.DesignEntityAnalysis') -> '_2606.DesignEntityAnalysis':
        """ 'ResultsFor' is the original name of this method.
