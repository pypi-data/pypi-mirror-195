...
class AbstractShaftCompoundSteadyStateSynchronousResponse(_3068.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    """AbstractShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2935.AbstractShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2935.AbstractShaftSteadyStateSynchronousResponse]':
