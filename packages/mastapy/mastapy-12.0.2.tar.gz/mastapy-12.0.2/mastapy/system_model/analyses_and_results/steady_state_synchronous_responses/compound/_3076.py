...
class BeltDriveCompoundSteadyStateSynchronousResponse(_3164.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """BeltDriveCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2943.BeltDriveSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2943.BeltDriveSteadyStateSynchronousResponse]':
