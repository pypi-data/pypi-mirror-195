...
class GearSetCompoundSteadyStateSynchronousResponse(_3164.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """GearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2993.GearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2993.GearSetSteadyStateSynchronousResponse]':
