...
class RingPinsCompoundSteadyStateSynchronousResponse(_3143.MountableComponentCompoundSteadyStateSynchronousResponse):
    """RingPinsCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3023.RingPinsSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3023.RingPinsSteadyStateSynchronousResponse]':
