...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3062, _3060, _2993
...
class WormGearSetSteadyStateSynchronousResponse(_2993.GearSetSteadyStateSynchronousResponse):
    """WormGearSetSteadyStateSynchronousResponse
    ...
    @property
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3062.WormGearSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3060.WormGearMeshSteadyStateSynchronousResponse]':
