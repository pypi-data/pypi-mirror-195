...
class ConnectorCompoundSteadyStateSynchronousResponse(_3143.MountableComponentCompoundSteadyStateSynchronousResponse):
    """ConnectorCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2969.ConnectorSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2969.ConnectorSteadyStateSynchronousResponse]':
