...
class ClutchCompoundSteadyStateSynchronousResponse(_3103.CouplingCompoundSteadyStateSynchronousResponse):
    """ClutchCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2956.ClutchSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2956.ClutchSteadyStateSynchronousResponse]':
