...
class RollingRingConnectionCompoundSteadyStateSynchronousResponse(_3131.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3026.RollingRingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3026.RollingRingConnectionSteadyStateSynchronousResponse]':
