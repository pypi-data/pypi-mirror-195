...
class InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse(_3101.ConnectionCompoundSteadyStateSynchronousResponse):
    """InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2999.InterMountableComponentConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2999.InterMountableComponentConnectionSteadyStateSynchronousResponse]':
