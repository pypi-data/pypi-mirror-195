...
class OilSealCompoundSteadyStateSynchronousResponse(_3102.ConnectorCompoundSteadyStateSynchronousResponse):
    """OilSealCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3012.OilSealSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3012.OilSealSteadyStateSynchronousResponse]':
