...
class GuideDxfModelCompoundSteadyStateSynchronousResponse(_3091.ComponentCompoundSteadyStateSynchronousResponse):
    """GuideDxfModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2995.GuideDxfModelSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2995.GuideDxfModelSteadyStateSynchronousResponse]':
