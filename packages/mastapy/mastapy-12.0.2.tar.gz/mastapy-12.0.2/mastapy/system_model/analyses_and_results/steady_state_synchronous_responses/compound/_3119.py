...
class FaceGearCompoundSteadyStateSynchronousResponse(_3124.GearCompoundSteadyStateSynchronousResponse):
    """FaceGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2989.FaceGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2989.FaceGearSteadyStateSynchronousResponse]':
