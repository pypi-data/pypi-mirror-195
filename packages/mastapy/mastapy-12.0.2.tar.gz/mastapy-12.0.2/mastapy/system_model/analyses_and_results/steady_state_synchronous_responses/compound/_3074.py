...
class BearingCompoundSteadyStateSynchronousResponse(_3102.ConnectorCompoundSteadyStateSynchronousResponse):
    """BearingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2941.BearingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2941.BearingSteadyStateSynchronousResponse]':
