...
class SpringDamperCompoundSteadyStateSynchronousResponse(_3103.CouplingCompoundSteadyStateSynchronousResponse):
    """SpringDamperCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3038.SpringDamperSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3038.SpringDamperSteadyStateSynchronousResponse]':
