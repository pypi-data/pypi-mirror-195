...
class DatumCompoundSteadyStateSynchronousResponse(_3091.ComponentCompoundSteadyStateSynchronousResponse):
    """DatumCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2984.DatumSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2984.DatumSteadyStateSynchronousResponse]':
