...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2998, _2996, _2938
...
class HypoidGearSetSteadyStateSynchronousResponse(_2938.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse):
    """HypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response(self) -> 'List[_2998.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2996.HypoidGearMeshSteadyStateSynchronousResponse]':
