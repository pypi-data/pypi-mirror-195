...
class KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse(_3098.ConicalGearCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3002.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3002.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse]':
