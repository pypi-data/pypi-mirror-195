...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3008, _3006, _3001
...
class KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponse(_3001.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3008.KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3006.KlingelnbergCycloPalloidSpiralBevelGearMeshSteadyStateSynchronousResponse]':
