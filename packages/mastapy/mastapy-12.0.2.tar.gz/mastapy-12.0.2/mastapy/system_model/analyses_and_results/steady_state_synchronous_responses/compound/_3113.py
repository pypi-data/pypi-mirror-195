...
class CylindricalGearCompoundSteadyStateSynchronousResponse(_3124.GearCompoundSteadyStateSynchronousResponse):
    """CylindricalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2982.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2982.CylindricalGearSteadyStateSynchronousResponse]':
