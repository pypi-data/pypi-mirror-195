...
class CVTCompoundSteadyStateSynchronousResponseAtASpeed(_3594.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed):
    """CVTCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3496.CVTSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3496.CVTSteadyStateSynchronousResponseAtASpeed]':
