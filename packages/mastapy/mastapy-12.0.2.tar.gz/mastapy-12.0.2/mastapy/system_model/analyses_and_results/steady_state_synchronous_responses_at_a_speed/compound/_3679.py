...
class ShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3585.AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed):
    """ShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3550.ShaftSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3550.ShaftSteadyStateSynchronousResponseAtASpeed]':
