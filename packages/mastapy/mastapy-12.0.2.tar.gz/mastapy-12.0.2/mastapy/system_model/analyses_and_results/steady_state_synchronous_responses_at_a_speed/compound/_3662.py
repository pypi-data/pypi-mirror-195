...
class OilSealCompoundSteadyStateSynchronousResponseAtASpeed(_3620.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """OilSealCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3532.OilSealSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3532.OilSealSteadyStateSynchronousResponseAtASpeed]':
