...
class ConnectorCompoundSteadyStateSynchronousResponseAtASpeed(_3661.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConnectorCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3490.ConnectorSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3490.ConnectorSteadyStateSynchronousResponseAtASpeed]':
