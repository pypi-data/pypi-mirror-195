...
class ConnectionSteadyStateSynchronousResponseAtASpeed(_7469.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed(self) -> '_3559.SteadyStateSynchronousResponseAtASpeed':
