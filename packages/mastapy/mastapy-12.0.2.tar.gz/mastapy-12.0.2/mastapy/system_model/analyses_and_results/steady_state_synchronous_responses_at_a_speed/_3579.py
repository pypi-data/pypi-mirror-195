...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3580, _3578, _3513
...
class WormGearSetSteadyStateSynchronousResponseAtASpeed(_3513.GearSetSteadyStateSynchronousResponseAtASpeed):
    """WormGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def worm_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3580.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3578.WormGearMeshSteadyStateSynchronousResponseAtASpeed]':
