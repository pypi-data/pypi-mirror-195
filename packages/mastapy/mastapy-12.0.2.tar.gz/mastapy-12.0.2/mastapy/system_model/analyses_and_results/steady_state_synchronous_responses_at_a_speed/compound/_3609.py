...
class ComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3663.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """ComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3479.ComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3479.ComponentSteadyStateSynchronousResponseAtASpeed]':
