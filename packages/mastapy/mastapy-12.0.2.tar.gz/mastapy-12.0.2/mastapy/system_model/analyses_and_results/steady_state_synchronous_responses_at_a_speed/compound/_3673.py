...
class RingPinsCompoundSteadyStateSynchronousResponseAtASpeed(_3661.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """RingPinsCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3543.RingPinsSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3543.RingPinsSteadyStateSynchronousResponseAtASpeed]':
