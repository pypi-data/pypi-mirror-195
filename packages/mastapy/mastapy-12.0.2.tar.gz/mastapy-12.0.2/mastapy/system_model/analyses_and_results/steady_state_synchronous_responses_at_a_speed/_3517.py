...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3518, _3516, _3459
...
class HypoidGearSetSteadyStateSynchronousResponseAtASpeed(_3459.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3518.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3516.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
