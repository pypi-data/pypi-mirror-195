...
class FaceGearCompoundSteadyStateSynchronousResponseAtASpeed(_3642.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3509.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3509.FaceGearSteadyStateSynchronousResponseAtASpeed]':
