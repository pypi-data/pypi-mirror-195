...
from mastapy.system_model.analyses_and_results.static_loads import _6912, _6913, _6825
...
class WormGearSetLoadCase(_6825.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6912.WormGearLoadCase]':
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6912.WormGearLoadCase]':
    ...
    @property
    def worm_meshes_load_case(self) -> 'List[_6913.WormGearMeshLoadCase]':
