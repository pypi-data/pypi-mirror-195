...
from mastapy.system_model.analyses_and_results.static_loads import _6855, _6831, _6808
...
class HarmonicLoadDataExcelImport(_6831.HarmonicLoadDataImportBase['_6808.ElectricMachineHarmonicLoadExcelImportOptions']):
    """HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6855.NamedSpeed]':
