...
from mastapy.system_model.analyses_and_results.static_loads import _6848, _6849, _6844
...
class KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase(_6844.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6848.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_load_case(self) -> 'List[_6848.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_load_case(self) -> 'List[_6849.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase]':
