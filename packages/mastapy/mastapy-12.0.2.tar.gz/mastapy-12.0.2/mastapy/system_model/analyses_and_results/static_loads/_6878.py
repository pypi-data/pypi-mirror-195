...
class RootAssemblyLoadCase(_6749.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1543.PIDControlSettings':
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6795.CylindricalGearSetLoadCase]':
