...
from mastapy.system_model.analyses_and_results.static_loads import _6753, _6754, _6760
...
class BevelDifferentialGearSetLoadCase(_6760.BevelGearSetLoadCase):
    """BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6753.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6753.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6754.BevelDifferentialGearMeshLoadCase]':
