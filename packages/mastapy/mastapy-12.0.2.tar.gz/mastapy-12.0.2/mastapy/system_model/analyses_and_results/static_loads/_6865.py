...
from mastapy.system_model.analyses_and_results.static_loads import _6864, _6854
...
class PlanetCarrierLoadCase(_6854.MountableComponentLoadCase):
    """PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6864.PlanetarySocketManufactureError]':
