...
class PointLoadInputOptions(_1811.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6918.AdditionalForcesObtainedFrom':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_6918.AdditionalForcesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6918.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
