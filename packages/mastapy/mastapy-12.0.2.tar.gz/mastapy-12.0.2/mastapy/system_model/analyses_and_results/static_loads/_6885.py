...
from mastapy.system_model.analyses_and_results.static_loads import _6883, _6884, _6760
...
class SpiralBevelGearSetLoadCase(_6760.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6883.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6883.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6884.SpiralBevelGearMeshLoadCase]':
