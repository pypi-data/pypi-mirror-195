...
from mastapy.system_model.analyses_and_results.static_loads import _6840, _6828, _6809
...
class HarmonicLoadDataFluxImport(_6828.HarmonicLoadDataCSVImport['_6809.ElectricMachineHarmonicLoadFluxImportOptions']):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6840.InnerDiameterReference':
        ...
        return constructor.new_from_mastapy_type(_6840.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6840.InnerDiameterReference'):
