...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6750, _6752, _6755, _6761,
    _6762, _6785, _6763, _6765,
    _6770, _6773, _6787, _6789,
    _6795, _6817, _6816, _6818,
    _6822, _6837, _6847, _6850,
    _6851, _6852, _6856, _6861,
    _6865, _6868, _6869, _6873,
    _6874, _6875, _6879, _6880,
    _6739, _6885, _6888, _6891,
    _6894, _6898, _6903, _6910,
    _6914, _6917, _6737
)
...
class AssemblyLoadCase(_6737.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self) -> 'List[_6750.BearingLoadCase]':
    ...
    @property
    def belt_drives(self) -> 'List[_6752.BeltDriveLoadCase]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6755.BevelDifferentialGearSetLoadCase]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6761.BoltedJointLoadCase]':
    ...
    @property
    def bolts(self) -> 'List[_6762.BoltLoadCase]':
    ...
    @property
    def cv_ts(self) -> 'List[_6785.CVTLoadCase]':
    ...
    @property
    def clutch_connections(self) -> 'List[_6763.ClutchConnectionLoadCase]':
    ...
    @property
    def clutches(self) -> 'List[_6765.ClutchLoadCase]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6770.ConceptCouplingLoadCase]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6773.ConceptGearSetLoadCase]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6787.CycloidalAssemblyLoadCase]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6789.CycloidalDiscLoadCase]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6795.CylindricalGearSetLoadCase]':
    ...
    @property
    def fe_parts(self) -> 'List[_6817.FEPartLoadCase]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6816.FaceGearSetLoadCase]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6818.FlexiblePinAssemblyLoadCase]':
    ...
    @property
    def gear_meshes(self) -> 'List[_6822.GearMeshLoadCase]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6837.HypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6847.KlingelnbergCycloPalloidHypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6850.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]':
    ...
    @property
    def mass_discs(self) -> 'List[_6851.MassDiscLoadCase]':
    ...
    @property
    def measurement_components(self) -> 'List[_6852.MeasurementComponentLoadCase]':
    ...
    @property
    def oil_seals(self) -> 'List[_6856.OilSealLoadCase]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6861.PartToPartShearCouplingLoadCase]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6865.PlanetCarrierLoadCase]':
    ...
    @property
    def point_loads(self) -> 'List[_6868.PointLoadLoadCase]':
    ...
    @property
    def ring_pins(self) -> 'List[_6873.RingPinsLoadCase]':
    ...
    @property
    def ring_pins_to_cycloidal_disc_connections(self) -> 'List[_6874.RingPinsToDiscConnectionLoadCase]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6875.RollingRingAssemblyLoadCase]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6879.ShaftHubConnectionLoadCase]':
    ...
    @property
    def shafts(self) -> 'List[_6880.ShaftLoadCase]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_6739.AbstractShaftOrHousingLoadCase]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6885.SpiralBevelGearSetLoadCase]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6888.SpringDamperLoadCase]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6891.StraightBevelDiffGearSetLoadCase]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6894.StraightBevelGearSetLoadCase]':
    ...
    @property
    def synchronisers(self) -> 'List[_6898.SynchroniserLoadCase]':
    ...
    @property
    def torque_converters(self) -> 'List[_6903.TorqueConverterLoadCase]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6910.UnbalancedMassLoadCase]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6914.WormGearSetLoadCase]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6917.ZerolBevelGearSetLoadCase]':
