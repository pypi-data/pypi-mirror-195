...
class GearSetHarmonicLoadData(_1348.HarmonicLoadDataBase):
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6823.GearMeshTEOrderType':
        ...
        return constructor.new_from_mastapy_type(_6823.GearMeshTEOrderType)(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6823.GearMeshTEOrderType'):
