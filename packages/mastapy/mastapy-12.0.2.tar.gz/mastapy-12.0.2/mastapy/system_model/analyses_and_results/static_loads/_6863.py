...
class PlanetaryGearSetLoadCase(_6795.CylindricalGearSetLoadCase):
    """PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1556.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1556.LoadCaseOverrideOption'):
