...
class ClutchConnectionLoadCase(_6781.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self) -> '_1500.Vector2DListAccessor':
    ...
    def clutch_pressures(self, value: '_1500.Vector2DListAccessor'):
