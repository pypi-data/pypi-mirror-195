...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6921, _6920, _6923, _6924,
    _6932, _6919, _6926, _6922,
    _6925, _6930, _6933
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def boost_pressure_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def force_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def import_type(self) -> '_6838.ImportType':
        ...
        return constructor.new_from_mastapy_type(_6838.ImportType)(value) if value is not None else None

    @import_type.setter
    def import_type(self, value: '_6838.ImportType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ImportType = value

    @property
    def moment_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def speed_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def torque_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def design_state_options(self) -> '_6920.DesignStateOptions':
    ...
    @property
    def gear_ratio_options(self) -> '_6923.GearRatioInputOptions':
    ...
    @property
    def load_case_name_inputs(self) -> '_6924.LoadCaseNameOptions':
    ...
    @property
    def time_step_input(self) -> '_6932.TimeStepInputOptions':
    ...
    @property
    def boost_pressure_inputs(self) -> 'List[_6919.BoostPressureLoadCaseInputOptions]':
    ...
    @property
    def file_inputs(self) -> 'List[_6926.MultiTimeSeriesDataInputFileOptions]':
    ...
    @property
    def force_inputs(self) -> 'List[_6922.ForceInputOptions]':
    ...
    @property
    def moment_inputs(self) -> 'List[_6925.MomentInputOptions]':
    ...
    @property
    def speed_inputs(self) -> 'List[_6930.SpeedInputOptions]':
    ...
    @property
    def torque_inputs(self) -> 'List[_6933.TorqueInputOptions]':
    ...
    @property
    def columns(self) -> 'List[_1782.ColumnTitle]':
