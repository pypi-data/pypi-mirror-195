...
class GearSetLoadCase(_6882.SpecialisedAssemblyLoadCase):
    """GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5379.GearMeshStiffnessModel':
        ...
        return constructor.new_from_mastapy_type(_5379.GearMeshStiffnessModel)(value) if value is not None else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5379.GearMeshStiffnessModel'):
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6941.AdvancedTimeSteppingAnalysisForModulationOptions':
    ...
    @property
    def gears(self) -> 'List[_6820.GearLoadCase]':
    ...
    @property
    def gears_without_clones(self) -> 'List[_6820.GearLoadCase]':
    ...
    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6822.GearMeshLoadCase]':
