...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5649, _5650, _5696
...
class ConceptGearSetHarmonicAnalysis(_5696.GearSetHarmonicAnalysis):
    """ConceptGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5649.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def concept_gears_harmonic_analysis(self) -> 'List[_5649.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5650.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_harmonic_analysis(self) -> 'List[_5650.ConceptGearMeshHarmonicAnalysis]':
