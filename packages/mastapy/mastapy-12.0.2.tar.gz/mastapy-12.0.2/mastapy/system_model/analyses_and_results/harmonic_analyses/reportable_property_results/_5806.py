...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5808, _5788
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5808.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
    ...
    @property
    def result_at_reference_speed(self) -> '_5788.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic':
    ...
    @property
    def data_points(self) -> 'List[_5788.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic]':
