...
class CylindricalGearMeshHarmonicAnalysis(_5693.GearMeshHarmonicAnalysis):
    """CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7250.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def system_deflection_results(self) -> '_2689.CylindricalGearMeshSystemDeflection':
