...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5797, _5804
...
class ResultsForOrderIncludingSurfaces(_5804.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5797.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
