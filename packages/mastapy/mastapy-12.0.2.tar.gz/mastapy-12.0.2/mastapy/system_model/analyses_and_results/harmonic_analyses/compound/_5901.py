...
class RingPinsCompoundHarmonicAnalysis(_5889.MountableComponentCompoundHarmonicAnalysis):
    """RingPinsCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5734.RingPinsHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5734.RingPinsHarmonicAnalysis]':
