...
class MountableComponentCompoundHarmonicAnalysis(_5837.ComponentCompoundHarmonicAnalysis):
    """MountableComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5720.MountableComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5720.MountableComponentHarmonicAnalysis]':
