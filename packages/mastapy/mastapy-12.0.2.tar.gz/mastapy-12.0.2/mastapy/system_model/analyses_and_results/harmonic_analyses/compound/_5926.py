...
class SynchroniserHalfCompoundHarmonicAnalysis(_5927.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5760.SynchroniserHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5760.SynchroniserHalfHarmonicAnalysis]':
