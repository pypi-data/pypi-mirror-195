...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5755, _5756, _5637
...
class StraightBevelGearSetHarmonicAnalysis(_5637.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5755.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_harmonic_analysis(self) -> 'List[_5755.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5756.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis(self) -> 'List[_5756.StraightBevelGearMeshHarmonicAnalysis]':
