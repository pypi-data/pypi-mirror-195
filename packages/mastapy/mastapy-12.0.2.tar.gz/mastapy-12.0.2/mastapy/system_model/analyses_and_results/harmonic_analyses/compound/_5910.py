...
class SpecialisedAssemblyCompoundHarmonicAnalysis(_5812.AbstractAssemblyCompoundHarmonicAnalysis):
    """SpecialisedAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5744.SpecialisedAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5744.SpecialisedAssemblyHarmonicAnalysis]':
