...
class SpringDamperCompoundHarmonicAnalysis(_5849.CouplingCompoundHarmonicAnalysis):
    """SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5751.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5751.SpringDamperHarmonicAnalysis]':
