...
class ShaftCompoundHarmonicAnalysis(_5813.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5740.ShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5740.ShaftHarmonicAnalysis]':
