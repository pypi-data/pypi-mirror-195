...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5801, _5810, _5803
...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self) -> '_5801.ResultsForMultipleOrdersForGroups':
    ...
    @property
    def excitations(self) -> 'List[_5810.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]':
    ...
    @property
    def orders_for_combined_excitations(self) -> 'List[_5803.ResultsForOrderIncludingGroups]':
    ...
    @property
    def orders_for_combined_excitations_from_same_parts(self) -> 'List[_5803.ResultsForOrderIncludingGroups]':
