...
class UnbalancedMassCompoundHarmonicAnalysis(_5934.VirtualComponentCompoundHarmonicAnalysis):
    """UnbalancedMassCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5769.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5769.UnbalancedMassHarmonicAnalysis]':
