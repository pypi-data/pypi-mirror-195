...
class FEPartHarmonicAnalysisResultsPropertyAccessor(_5798.HarmonicAnalysisResultsPropertyAccessor):
    """FEPartHarmonicAnalysisResultsPropertyAccessor
    ...
    @property
    def combined_orders(self) -> '_5800.ResultsForMultipleOrdersForFESurface':
    ...
    @property
    def excitations(self) -> 'List[_5791.FEPartSingleWhineAnalysisResultsPropertyAccessor]':
    ...
    @property
    def orders_for_combined_excitations(self) -> 'List[_5805.ResultsForOrderIncludingSurfaces]':
    ...
    @property
    def orders_for_combined_excitations_from_same_parts(self) -> 'List[_5805.ResultsForOrderIncludingSurfaces]':
