...
class AbstractShaftOrHousingCompoundHarmonicAnalysis(_5837.ComponentCompoundHarmonicAnalysis):
    """AbstractShaftOrHousingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5621.AbstractShaftOrHousingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5621.AbstractShaftOrHousingHarmonicAnalysis]':
