...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5705, _5706, _5625
...
class HypoidGearSetHarmonicAnalysis(_5625.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5705.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_harmonic_analysis(self) -> 'List[_5705.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5706.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis(self) -> 'List[_5706.HypoidGearMeshHarmonicAnalysis]':
