...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5794, _5799
...
class ResultsForMultipleOrdersForGroups(_5799.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5794.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
