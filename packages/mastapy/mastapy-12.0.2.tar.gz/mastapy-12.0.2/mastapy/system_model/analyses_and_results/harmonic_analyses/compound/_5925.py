...
class SynchroniserCompoundHarmonicAnalysis(_5910.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """SynchroniserCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5761.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5761.SynchroniserHarmonicAnalysis]':
