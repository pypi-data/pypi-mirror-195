...
class ShaftToMountableComponentConnectionHarmonicAnalysis(_5622.AbstractShaftToMountableComponentConnectionHarmonicAnalysis):
    """ShaftToMountableComponentConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2755.ShaftToMountableComponentConnectionSystemDeflection':
