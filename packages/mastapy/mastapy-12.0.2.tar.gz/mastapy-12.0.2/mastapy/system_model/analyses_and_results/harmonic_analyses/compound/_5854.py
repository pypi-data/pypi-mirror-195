...
class CVTPulleyCompoundHarmonicAnalysis(_5900.PulleyCompoundHarmonicAnalysis):
    """CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5662.CVTPulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5662.CVTPulleyHarmonicAnalysis]':
