...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5911, _5912, _5830
...
class SpiralBevelGearSetCompoundHarmonicAnalysis(_5830.BevelGearSetCompoundHarmonicAnalysis):
    """SpiralBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5748.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5911.SpiralBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5912.SpiralBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5748.SpiralBevelGearSetHarmonicAnalysis]':
