...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import (
    _5820, _5822, _5825, _5832,
    _5831, _5853, _5833, _5838,
    _5843, _5855, _5857, _5861,
    _5868, _5867, _5869, _5876,
    _5883, _5886, _5887, _5888,
    _5890, _5892, _5897, _5898,
    _5899, _5901, _5903, _5908,
    _5907, _5913, _5914, _5919,
    _5922, _5925, _5929, _5933,
    _5937, _5940, _5812
)
...
class AssemblyCompoundHarmonicAnalysis(_5812.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5626.AssemblyHarmonicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5820.BearingCompoundHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5822.BeltDriveCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5825.BevelDifferentialGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5832.BoltedJointCompoundHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5831.BoltCompoundHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5853.CVTCompoundHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5833.ClutchCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5838.ConceptCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5843.ConceptGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5855.CycloidalAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5857.CycloidalDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5861.CylindricalGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5868.FEPartCompoundHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5867.FaceGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5869.FlexiblePinAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5876.HypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5883.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5886.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5887.MassDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5888.MeasurementComponentCompoundHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5890.OilSealCompoundHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5892.PartToPartShearCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5897.PlanetCarrierCompoundHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5898.PointLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5899.PowerLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5901.RingPinsCompoundHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5903.RollingRingAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5908.ShaftHubConnectionCompoundHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5907.ShaftCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5913.SpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5914.SpringDamperCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5919.StraightBevelDiffGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5922.StraightBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5925.SynchroniserCompoundHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5929.TorqueConverterCompoundHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5933.UnbalancedMassCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5937.WormGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5940.ZerolBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5626.AssemblyHarmonicAnalysis]':
