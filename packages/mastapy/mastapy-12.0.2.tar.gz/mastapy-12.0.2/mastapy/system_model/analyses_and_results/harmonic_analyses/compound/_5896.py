...
class PlanetaryGearSetCompoundHarmonicAnalysis(_5861.CylindricalGearSetCompoundHarmonicAnalysis):
    """PlanetaryGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5728.PlanetaryGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5728.PlanetaryGearSetHarmonicAnalysis]':
