...
class ConnectorCompoundHarmonicAnalysis(_5889.MountableComponentCompoundHarmonicAnalysis):
    """ConnectorCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5656.ConnectorHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5656.ConnectorHarmonicAnalysis]':
