...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5823, _5824, _5830
...
class BevelDifferentialGearSetCompoundHarmonicAnalysis(_5830.BevelGearSetCompoundHarmonicAnalysis):
    """BevelDifferentialGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5632.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_harmonic_analysis(self) -> 'List[_5823.BevelDifferentialGearCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_harmonic_analysis(self) -> 'List[_5824.BevelDifferentialGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5632.BevelDifferentialGearSetHarmonicAnalysis]':
