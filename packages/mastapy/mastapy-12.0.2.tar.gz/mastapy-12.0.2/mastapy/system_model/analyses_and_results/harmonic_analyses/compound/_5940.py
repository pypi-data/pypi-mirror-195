...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5938, _5939, _5830
...
class ZerolBevelGearSetCompoundHarmonicAnalysis(_5830.BevelGearSetCompoundHarmonicAnalysis):
    """ZerolBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5776.ZerolBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5938.ZerolBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5939.ZerolBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5776.ZerolBevelGearSetHarmonicAnalysis]':
