...
class ConnectionCompoundHarmonicAnalysis(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5655.ConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5655.ConnectionHarmonicAnalysis]':
