...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5874, _5875, _5818
...
class HypoidGearSetCompoundHarmonicAnalysis(_5818.AGMAGleasonConicalGearSetCompoundHarmonicAnalysis):
    """HypoidGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5707.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5874.HypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5875.HypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5707.HypoidGearSetHarmonicAnalysis]':
