...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5733, _5690, _5745
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def response_cache_level(self) -> '_5733.ResponseCacheLevel':
        ...
        return constructor.new_from_mastapy_type(_5733.ResponseCacheLevel)(value) if value is not None else None

    @response_cache_level.setter
    def response_cache_level(self, value: '_5733.ResponseCacheLevel'):
    ...
    @property
    def excitation_selection(self) -> '_5780.ExcitationSourceSelectionGroup':
    ...
    @property
    def modal_analysis_options(self) -> '_4601.ModalAnalysisOptions':
