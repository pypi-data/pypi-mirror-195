...
class AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5847.ConnectionCompoundHarmonicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5622.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5622.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
