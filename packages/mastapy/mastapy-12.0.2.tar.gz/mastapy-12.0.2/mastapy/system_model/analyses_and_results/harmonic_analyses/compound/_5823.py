...
class BevelDifferentialGearCompoundHarmonicAnalysis(_5828.BevelGearCompoundHarmonicAnalysis):
    """BevelDifferentialGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5630.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5630.BevelDifferentialGearHarmonicAnalysis]':
