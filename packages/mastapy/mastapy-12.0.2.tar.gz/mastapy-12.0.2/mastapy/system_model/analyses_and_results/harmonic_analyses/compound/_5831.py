...
class BoltCompoundHarmonicAnalysis(_5837.ComponentCompoundHarmonicAnalysis):
    """BoltCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5639.BoltHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5639.BoltHarmonicAnalysis]':
