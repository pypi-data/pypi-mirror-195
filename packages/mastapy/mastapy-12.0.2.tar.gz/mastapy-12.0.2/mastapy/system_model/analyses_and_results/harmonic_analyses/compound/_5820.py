...
class BearingCompoundHarmonicAnalysis(_5848.ConnectorCompoundHarmonicAnalysis):
    """BearingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5627.BearingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5627.BearingHarmonicAnalysis]':
