...
class AbstractShaftCompoundHarmonicAnalysis(_5814.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    """AbstractShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5620.AbstractShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5620.AbstractShaftHarmonicAnalysis]':
