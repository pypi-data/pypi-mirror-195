...
class ConceptCouplingCompoundHarmonicAnalysis(_5849.CouplingCompoundHarmonicAnalysis):
    """ConceptCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5648.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5648.ConceptCouplingHarmonicAnalysis]':
