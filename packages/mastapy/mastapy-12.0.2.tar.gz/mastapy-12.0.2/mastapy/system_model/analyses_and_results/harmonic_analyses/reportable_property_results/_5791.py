...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5805, _5811
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5811.SingleWhineAnalysisResultsPropertyAccessor):
    """FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5805.ResultsForOrderIncludingSurfaces]':
