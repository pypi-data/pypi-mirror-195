...
class CylindricalPlanetGearCompoundHarmonicAnalysis(_5859.CylindricalGearCompoundHarmonicAnalysis):
    """CylindricalPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5670.CylindricalPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5670.CylindricalPlanetGearHarmonicAnalysis]':
