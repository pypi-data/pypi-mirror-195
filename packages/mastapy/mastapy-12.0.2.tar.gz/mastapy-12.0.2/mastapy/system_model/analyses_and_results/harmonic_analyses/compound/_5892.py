...
class PartToPartShearCouplingCompoundHarmonicAnalysis(_5849.CouplingCompoundHarmonicAnalysis):
    """PartToPartShearCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5725.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5725.PartToPartShearCouplingHarmonicAnalysis]':
