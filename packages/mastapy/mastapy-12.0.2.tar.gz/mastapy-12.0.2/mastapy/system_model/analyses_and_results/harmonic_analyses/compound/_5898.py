...
class PointLoadCompoundHarmonicAnalysis(_5934.VirtualComponentCompoundHarmonicAnalysis):
    """PointLoadCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5730.PointLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5730.PointLoadHarmonicAnalysis]':
