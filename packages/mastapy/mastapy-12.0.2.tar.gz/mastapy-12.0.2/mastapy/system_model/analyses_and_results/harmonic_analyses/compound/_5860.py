...
class CylindricalGearMeshCompoundHarmonicAnalysis(_5871.GearMeshCompoundHarmonicAnalysis):
    """CylindricalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5668.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5668.CylindricalGearMeshHarmonicAnalysis]':
