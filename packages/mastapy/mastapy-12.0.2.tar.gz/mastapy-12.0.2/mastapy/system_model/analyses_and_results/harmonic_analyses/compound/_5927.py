...
class SynchroniserPartCompoundHarmonicAnalysis(_5851.CouplingHalfCompoundHarmonicAnalysis):
    """SynchroniserPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5762.SynchroniserPartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5762.SynchroniserPartHarmonicAnalysis]':
