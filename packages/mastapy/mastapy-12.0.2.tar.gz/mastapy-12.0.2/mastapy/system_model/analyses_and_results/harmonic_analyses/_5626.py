...
from mastapy.system_model.analyses_and_results.harmonic_analyses import (
    _5627, _5629, _5632, _5638,
    _5639, _5661, _5642, _5648,
    _5651, _5663, _5665, _5669,
    _5688, _5687, _5689, _5707,
    _5714, _5717, _5696, _5718,
    _5719, _5721, _5725, _5729,
    _5730, _5731, _5734, _5736,
    _5741, _5740, _5748, _5751,
    _5754, _5757, _5761, _5765,
    _5769, _5773, _5776, _5618
)
...
class AssemblyHarmonicAnalysis(_5618.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5627.BearingHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5629.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5632.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5638.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5639.BoltHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5661.CVTHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5642.ClutchHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5648.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5651.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5663.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5665.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5669.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5688.FEPartHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5687.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5689.FlexiblePinAssemblyHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5707.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5714.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5717.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_5696.GearSetHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5718.MassDiscHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5719.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5721.OilSealHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5725.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5729.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5730.PointLoadHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5731.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5734.RingPinsHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5736.RollingRingAssemblyHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5741.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5740.ShaftHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5748.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5751.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5754.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5757.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5761.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5765.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5769.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5773.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5776.ZerolBevelGearSetHarmonicAnalysis]':
