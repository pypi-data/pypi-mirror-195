...
class ConicalGearMeshCompoundHarmonicAnalysis(_5871.GearMeshCompoundHarmonicAnalysis):
    """ConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5653.ConicalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5653.ConicalGearMeshHarmonicAnalysis]':
