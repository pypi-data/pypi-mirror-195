...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5865, _5866, _5872
...
class FaceGearSetCompoundHarmonicAnalysis(_5872.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5687.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def face_gears_compound_harmonic_analysis(self) -> 'List[_5865.FaceGearCompoundHarmonicAnalysis]':
    ...
    @property
    def face_meshes_compound_harmonic_analysis(self) -> 'List[_5866.FaceGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5687.FaceGearSetHarmonicAnalysis]':
