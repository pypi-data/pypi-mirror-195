...
class RollingRingCompoundHarmonicAnalysis(_5851.CouplingHalfCompoundHarmonicAnalysis):
    """RollingRingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5738.RollingRingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5738.RollingRingHarmonicAnalysis]':
