...
class ClutchHalfCompoundHarmonicAnalysis(_5851.CouplingHalfCompoundHarmonicAnalysis):
    """ClutchHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5641.ClutchHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5641.ClutchHalfHarmonicAnalysis]':
