...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5920, _5921, _5830
...
class StraightBevelGearSetCompoundHarmonicAnalysis(_5830.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5757.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5920.StraightBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5921.StraightBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5757.StraightBevelGearSetHarmonicAnalysis]':
