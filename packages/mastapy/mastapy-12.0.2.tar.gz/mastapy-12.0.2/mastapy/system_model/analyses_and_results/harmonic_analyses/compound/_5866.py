...
class FaceGearMeshCompoundHarmonicAnalysis(_5871.GearMeshCompoundHarmonicAnalysis):
    """FaceGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5686.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5686.FaceGearMeshHarmonicAnalysis]':
