...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5779
...
class ExcitationSourceSelectionGroup(_5779.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5779.ExcitationSourceSelectionBase]':
