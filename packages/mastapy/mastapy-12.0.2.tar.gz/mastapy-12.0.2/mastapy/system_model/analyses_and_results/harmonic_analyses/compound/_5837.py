...
class ComponentCompoundHarmonicAnalysis(_5891.PartCompoundHarmonicAnalysis):
    """ComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5645.ComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5645.ComponentHarmonicAnalysis]':
