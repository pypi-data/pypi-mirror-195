...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5704, _5620
...
class ShaftHarmonicAnalysis(_5620.AbstractShaftHarmonicAnalysis):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4622.ShaftModalAnalysis':
    ...
    @property
    def export(self) -> '_5704.HarmonicAnalysisShaftExportOptions':
    ...
    @property
    def system_deflection_results(self) -> '_2754.ShaftSystemDeflection':
