...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysis(_5850.CouplingConnectionCompoundHarmonicAnalysis):
    """PartToPartShearCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5723.PartToPartShearCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5723.PartToPartShearCouplingConnectionHarmonicAnalysis]':
