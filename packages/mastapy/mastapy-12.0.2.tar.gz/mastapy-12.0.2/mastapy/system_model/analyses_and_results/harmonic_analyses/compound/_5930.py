...
class TorqueConverterConnectionCompoundHarmonicAnalysis(_5850.CouplingConnectionCompoundHarmonicAnalysis):
    """TorqueConverterConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5764.TorqueConverterConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5764.TorqueConverterConnectionHarmonicAnalysis]':
