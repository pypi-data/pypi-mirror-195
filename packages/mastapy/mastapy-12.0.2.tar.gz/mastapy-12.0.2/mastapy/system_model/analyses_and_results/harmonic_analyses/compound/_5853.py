...
class CVTCompoundHarmonicAnalysis(_5822.BeltDriveCompoundHarmonicAnalysis):
    """CVTCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5661.CVTHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5661.CVTHarmonicAnalysis]':
