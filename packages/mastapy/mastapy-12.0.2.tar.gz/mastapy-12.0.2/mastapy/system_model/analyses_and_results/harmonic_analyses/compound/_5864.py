...
class ExternalCADModelCompoundHarmonicAnalysis(_5837.ComponentCompoundHarmonicAnalysis):
    """ExternalCADModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5684.ExternalCADModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5684.ExternalCADModelHarmonicAnalysis]':
