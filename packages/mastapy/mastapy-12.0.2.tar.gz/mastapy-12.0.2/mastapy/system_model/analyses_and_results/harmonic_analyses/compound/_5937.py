...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5935, _5936, _5872
...
class WormGearSetCompoundHarmonicAnalysis(_5872.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5773.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis(self) -> 'List[_5935.WormGearCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis(self) -> 'List[_5936.WormGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5773.WormGearSetHarmonicAnalysis]':
