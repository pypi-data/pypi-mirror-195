...
class WormGearMeshCompoundHarmonicAnalysis(_5871.GearMeshCompoundHarmonicAnalysis):
    """WormGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5772.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5772.WormGearMeshHarmonicAnalysis]':
