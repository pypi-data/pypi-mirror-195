...
class ConceptCouplingHalfCompoundHarmonicAnalysis(_5851.CouplingHalfCompoundHarmonicAnalysis):
    """ConceptCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5647.ConceptCouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5647.ConceptCouplingHalfHarmonicAnalysis]':
