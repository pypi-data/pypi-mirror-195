...
class WormGearMeshCompoundPowerFlow(_4172.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4107.WormGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4107.WormGearMeshPowerFlow]':
