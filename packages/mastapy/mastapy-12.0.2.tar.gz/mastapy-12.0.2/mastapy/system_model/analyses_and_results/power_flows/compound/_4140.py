...
class ConceptCouplingConnectionCompoundPowerFlow(_4151.CouplingConnectionCompoundPowerFlow):
    """ConceptCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4006.ConceptCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4006.ConceptCouplingConnectionPowerFlow]':
