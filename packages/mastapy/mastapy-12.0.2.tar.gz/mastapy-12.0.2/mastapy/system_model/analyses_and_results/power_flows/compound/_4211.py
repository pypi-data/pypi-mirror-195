...
class SpecialisedAssemblyCompoundPowerFlow(_4113.AbstractAssemblyCompoundPowerFlow):
    """SpecialisedAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4081.SpecialisedAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4081.SpecialisedAssemblyPowerFlow]':
