...
class PulleyCompoundPowerFlow(_4152.CouplingHalfCompoundPowerFlow):
    """PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4071.PulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4071.PulleyPowerFlow]':
