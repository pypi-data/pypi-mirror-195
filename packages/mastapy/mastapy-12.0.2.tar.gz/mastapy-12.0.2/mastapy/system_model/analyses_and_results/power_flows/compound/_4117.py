...
class AGMAGleasonConicalGearCompoundPowerFlow(_4145.ConicalGearCompoundPowerFlow):
    """AGMAGleasonConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3985.AGMAGleasonConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3985.AGMAGleasonConicalGearPowerFlow]':
