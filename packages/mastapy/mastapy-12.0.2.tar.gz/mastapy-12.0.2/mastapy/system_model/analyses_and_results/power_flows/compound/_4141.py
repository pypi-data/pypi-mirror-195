...
class ConceptCouplingHalfCompoundPowerFlow(_4152.CouplingHalfCompoundPowerFlow):
    """ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4007.ConceptCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4007.ConceptCouplingHalfPowerFlow]':
