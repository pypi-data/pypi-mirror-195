...
class ConicalGearMeshCompoundPowerFlow(_4172.GearMeshCompoundPowerFlow):
    """ConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4012.ConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4012.ConicalGearMeshPowerFlow]':
