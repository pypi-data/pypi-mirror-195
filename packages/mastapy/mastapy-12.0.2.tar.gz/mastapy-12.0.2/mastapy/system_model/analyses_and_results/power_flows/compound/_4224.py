...
class StraightBevelPlanetGearCompoundPowerFlow(_4218.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4094.StraightBevelPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4094.StraightBevelPlanetGearPowerFlow]':
