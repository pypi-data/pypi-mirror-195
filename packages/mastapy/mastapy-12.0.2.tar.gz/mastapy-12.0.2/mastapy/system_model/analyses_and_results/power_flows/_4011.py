...
from mastapy.system_model.analyses_and_results.power_flows import _4010, _4009, _4041
...
class ConceptGearSetPowerFlow(_4041.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4010.ConceptGearPowerFlow]':
    ...
    @property
    def concept_gears_power_flow(self) -> 'List[_4010.ConceptGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4009.ConceptGearMeshPowerFlow]':
    ...
    @property
    def concept_meshes_power_flow(self) -> 'List[_4009.ConceptGearMeshPowerFlow]':
