...
class SynchroniserHalfCompoundPowerFlow(_4228.SynchroniserPartCompoundPowerFlow):
    """SynchroniserHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4096.SynchroniserHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4096.SynchroniserHalfPowerFlow]':
