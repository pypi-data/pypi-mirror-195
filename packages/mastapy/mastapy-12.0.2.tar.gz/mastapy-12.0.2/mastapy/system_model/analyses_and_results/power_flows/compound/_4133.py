...
class BoltedJointCompoundPowerFlow(_4211.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3999.BoltedJointPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3999.BoltedJointPowerFlow]':
