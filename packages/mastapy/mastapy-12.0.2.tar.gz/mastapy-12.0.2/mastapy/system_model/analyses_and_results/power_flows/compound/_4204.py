...
class RollingRingAssemblyCompoundPowerFlow(_4211.SpecialisedAssemblyCompoundPowerFlow):
    """RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4074.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4074.RollingRingAssemblyPowerFlow]':
