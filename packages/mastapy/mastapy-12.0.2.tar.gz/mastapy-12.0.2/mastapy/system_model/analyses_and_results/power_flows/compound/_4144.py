...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4142, _4143, _4173
...
class ConceptGearSetCompoundPowerFlow(_4173.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4011.ConceptGearSetPowerFlow]':
    ...
    @property
    def concept_gears_compound_power_flow(self) -> 'List[_4142.ConceptGearCompoundPowerFlow]':
    ...
    @property
    def concept_meshes_compound_power_flow(self) -> 'List[_4143.ConceptGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4011.ConceptGearSetPowerFlow]':
