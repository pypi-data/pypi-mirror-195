...
class WormGearCompoundPowerFlow(_4171.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4108.WormGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4108.WormGearPowerFlow]':
