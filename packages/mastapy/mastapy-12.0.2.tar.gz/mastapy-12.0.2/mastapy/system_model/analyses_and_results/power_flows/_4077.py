...
from mastapy.system_model.analyses_and_results.power_flows import _4068, _3987
...
class RootAssemblyPowerFlow(_3987.AssemblyPowerFlow):
    """RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_4068.PowerFlow':
