...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4239, _4240, _4131
...
class ZerolBevelGearSetCompoundPowerFlow(_4131.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4112.ZerolBevelGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_compound_power_flow(self) -> 'List[_4239.ZerolBevelGearCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_compound_power_flow(self) -> 'List[_4240.ZerolBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4112.ZerolBevelGearSetPowerFlow]':
