...
class StraightBevelDiffGearMeshCompoundPowerFlow(_4130.BevelGearMeshCompoundPowerFlow):
    """StraightBevelDiffGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4088.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4088.StraightBevelDiffGearMeshPowerFlow]':
