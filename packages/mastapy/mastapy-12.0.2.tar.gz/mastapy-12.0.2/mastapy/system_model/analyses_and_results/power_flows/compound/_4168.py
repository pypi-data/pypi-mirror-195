...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4166, _4167, _4173
...
class FaceGearSetCompoundPowerFlow(_4173.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4036.FaceGearSetPowerFlow]':
    ...
    @property
    def face_gears_compound_power_flow(self) -> 'List[_4166.FaceGearCompoundPowerFlow]':
    ...
    @property
    def face_meshes_compound_power_flow(self) -> 'List[_4167.FaceGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4036.FaceGearSetPowerFlow]':
