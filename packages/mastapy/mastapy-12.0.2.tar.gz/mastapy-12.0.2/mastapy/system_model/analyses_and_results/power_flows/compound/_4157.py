...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4137
...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_4137.CoaxialConnectionCompoundPowerFlow):
    """CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4024.CycloidalDiscCentralBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4024.CycloidalDiscCentralBearingConnectionPowerFlow]':
