...
class BevelGearCompoundPowerFlow(_4117.AGMAGleasonConicalGearCompoundPowerFlow):
    """BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3997.BevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3997.BevelGearPowerFlow]':
