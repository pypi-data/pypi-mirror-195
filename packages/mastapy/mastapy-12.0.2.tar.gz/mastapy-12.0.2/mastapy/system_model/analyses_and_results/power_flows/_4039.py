...
from mastapy.system_model.analyses_and_results.power_flows import _4100, _4046
...
class GearMeshPowerFlow(_4046.InterMountableComponentConnectionPowerFlow):
    """GearMeshPowerFlow
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_4100.ToothPassingHarmonic]':
