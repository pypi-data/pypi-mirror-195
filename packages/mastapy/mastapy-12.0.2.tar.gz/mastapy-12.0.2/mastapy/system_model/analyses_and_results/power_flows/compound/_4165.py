...
class ExternalCADModelCompoundPowerFlow(_4138.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4033.ExternalCADModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4033.ExternalCADModelPowerFlow]':
