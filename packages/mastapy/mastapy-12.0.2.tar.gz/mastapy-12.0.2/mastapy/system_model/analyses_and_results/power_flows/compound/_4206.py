...
class RollingRingConnectionCompoundPowerFlow(_4178.InterMountableComponentConnectionCompoundPowerFlow):
    """RollingRingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4075.RollingRingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4075.RollingRingConnectionPowerFlow]':
