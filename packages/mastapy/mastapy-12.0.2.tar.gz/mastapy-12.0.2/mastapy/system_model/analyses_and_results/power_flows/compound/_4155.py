...
class CVTPulleyCompoundPowerFlow(_4201.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4022.CVTPulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4022.CVTPulleyPowerFlow]':
