...
class MountableComponentCompoundPowerFlow(_4138.ComponentCompoundPowerFlow):
    """MountableComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4058.MountableComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4058.MountableComponentPowerFlow]':
