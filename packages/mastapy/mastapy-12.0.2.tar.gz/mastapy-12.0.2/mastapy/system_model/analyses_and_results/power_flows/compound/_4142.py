...
class ConceptGearCompoundPowerFlow(_4171.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4010.ConceptGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4010.ConceptGearPowerFlow]':
