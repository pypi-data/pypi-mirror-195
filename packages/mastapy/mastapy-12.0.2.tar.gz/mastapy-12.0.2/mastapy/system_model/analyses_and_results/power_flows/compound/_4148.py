...
class ConnectionCompoundPowerFlow(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4015.ConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4015.ConnectionPowerFlow]':
