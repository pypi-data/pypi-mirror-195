...
from mastapy.system_model.analyses_and_results.power_flows import _4092, _4091, _3998
...
class StraightBevelGearSetPowerFlow(_3998.BevelGearSetPowerFlow):
    """StraightBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4092.StraightBevelGearPowerFlow]':
    ...
    @property
    def straight_bevel_gears_power_flow(self) -> 'List[_4092.StraightBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4091.StraightBevelGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_power_flow(self) -> 'List[_4091.StraightBevelGearMeshPowerFlow]':
