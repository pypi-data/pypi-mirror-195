...
class PartToPartShearCouplingConnectionCompoundPowerFlow(_4151.CouplingConnectionCompoundPowerFlow):
    """PartToPartShearCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4061.PartToPartShearCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4061.PartToPartShearCouplingConnectionPowerFlow]':
