...
class ShaftHubConnectionCompoundPowerFlow(_4149.ConnectorCompoundPowerFlow):
    """ShaftHubConnectionCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4078.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4078.ShaftHubConnectionPowerFlow]':
