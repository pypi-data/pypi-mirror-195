...
class ConicalGearSetCompoundPowerFlow(_4173.GearSetCompoundPowerFlow):
    """ConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4014.ConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4014.ConicalGearSetPowerFlow]':
