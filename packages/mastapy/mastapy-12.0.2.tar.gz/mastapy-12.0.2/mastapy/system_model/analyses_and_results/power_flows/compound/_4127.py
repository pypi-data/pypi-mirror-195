...
class BevelDifferentialPlanetGearCompoundPowerFlow(_4124.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3994.BevelDifferentialPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3994.BevelDifferentialPlanetGearPowerFlow]':
