...
from mastapy.system_model.analyses_and_results.power_flows import _4029, _4028, _4041
...
class CylindricalGearSetPowerFlow(_4041.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4029.CylindricalGearPowerFlow]':
    ...
    @property
    def cylindrical_gears_power_flow(self) -> 'List[_4029.CylindricalGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4028.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def cylindrical_meshes_power_flow(self) -> 'List[_4028.CylindricalGearMeshPowerFlow]':
