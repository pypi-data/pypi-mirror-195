...
class SpringDamperCompoundPowerFlow(_4150.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4087.SpringDamperPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4087.SpringDamperPowerFlow]':
