...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4185, _4186, _4181
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow(_4181.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4055.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_power_flow(self) -> 'List[_4185.KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4186.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4055.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
