...
class BearingCompoundPowerFlow(_4149.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3988.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3988.BearingPowerFlow]':
