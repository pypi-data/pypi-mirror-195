...
class BeltDriveCompoundPowerFlow(_4211.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3990.BeltDrivePowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3990.BeltDrivePowerFlow]':
