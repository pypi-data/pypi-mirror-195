...
class ConnectorCompoundPowerFlow(_4190.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4016.ConnectorPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4016.ConnectorPowerFlow]':
