...
class TorqueConverterTurbineCompoundPowerFlow(_4152.CouplingHalfCompoundPowerFlow):
    """TorqueConverterTurbineCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4104.TorqueConverterTurbinePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4104.TorqueConverterTurbinePowerFlow]':
