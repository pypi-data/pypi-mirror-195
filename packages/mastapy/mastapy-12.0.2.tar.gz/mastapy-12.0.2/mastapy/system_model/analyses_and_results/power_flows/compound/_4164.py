...
class DatumCompoundPowerFlow(_4138.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4032.DatumPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4032.DatumPowerFlow]':
