...
class ShaftCompoundPowerFlow(_4114.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4079.ShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4079.ShaftPowerFlow]':
