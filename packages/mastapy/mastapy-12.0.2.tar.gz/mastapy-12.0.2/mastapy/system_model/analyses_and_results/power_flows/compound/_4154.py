...
class CVTCompoundPowerFlow(_4123.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4021.CVTPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4021.CVTPowerFlow]':
