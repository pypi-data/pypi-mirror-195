...
class CouplingHalfCompoundPowerFlow(_4190.MountableComponentCompoundPowerFlow):
    """CouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4018.CouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4018.CouplingHalfPowerFlow]':
