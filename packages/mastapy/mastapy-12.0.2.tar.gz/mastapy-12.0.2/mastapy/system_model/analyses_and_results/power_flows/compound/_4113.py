...
class AbstractAssemblyCompoundPowerFlow(_4192.PartCompoundPowerFlow):
    """AbstractAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3980.AbstractAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3980.AbstractAssemblyPowerFlow]':
