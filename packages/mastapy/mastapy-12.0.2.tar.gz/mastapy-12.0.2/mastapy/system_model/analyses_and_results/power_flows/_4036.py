...
from mastapy.system_model.analyses_and_results.power_flows import _4035, _4034, _4041
...
class FaceGearSetPowerFlow(_4041.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4035.FaceGearPowerFlow]':
    ...
    @property
    def face_gears_power_flow(self) -> 'List[_4035.FaceGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4034.FaceGearMeshPowerFlow]':
    ...
    @property
    def face_meshes_power_flow(self) -> 'List[_4034.FaceGearMeshPowerFlow]':
