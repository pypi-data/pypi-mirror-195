...
class CylindricalPlanetGearCompoundPowerFlow(_4160.CylindricalGearCompoundPowerFlow):
    """CylindricalPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4031.CylindricalPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4031.CylindricalPlanetGearPowerFlow]':
