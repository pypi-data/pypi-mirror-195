...
from mastapy.system_model.analyses_and_results.power_flows import _4096, _4081
...
class SynchroniserPowerFlow(_4081.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4096.SynchroniserHalfPowerFlow]':
