...
class RingPinsCompoundPowerFlow(_4190.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4072.RingPinsPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4072.RingPinsPowerFlow]':
