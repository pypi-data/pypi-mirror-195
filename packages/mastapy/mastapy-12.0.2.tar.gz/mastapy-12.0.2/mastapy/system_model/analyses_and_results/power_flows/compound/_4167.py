...
class FaceGearMeshCompoundPowerFlow(_4172.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4034.FaceGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4034.FaceGearMeshPowerFlow]':
