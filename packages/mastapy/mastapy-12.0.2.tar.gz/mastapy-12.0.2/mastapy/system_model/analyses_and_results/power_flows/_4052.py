...
from mastapy.system_model.analyses_and_results.power_flows import _4051, _4050, _4049
...
class KlingelnbergCycloPalloidHypoidGearSetPowerFlow(_4049.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4051.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_power_flow(self) -> 'List[_4051.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4050.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_power_flow(self) -> 'List[_4050.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
