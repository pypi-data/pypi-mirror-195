...
class PartToPartShearCouplingCompoundPowerFlow(_4150.CouplingCompoundPowerFlow):
    """PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4063.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4063.PartToPartShearCouplingPowerFlow]':
