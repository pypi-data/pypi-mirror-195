...
from mastapy.system_model.analyses_and_results.power_flows import _4089, _4088, _3998
...
class StraightBevelDiffGearSetPowerFlow(_3998.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4089.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_power_flow(self) -> 'List[_4089.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4088.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_power_flow(self) -> 'List[_4088.StraightBevelDiffGearMeshPowerFlow]':
