...
class GearMeshCompoundPowerFlow(_4178.InterMountableComponentConnectionCompoundPowerFlow):
    """GearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4039.GearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4039.GearMeshPowerFlow]':
