...
class AbstractShaftCompoundPowerFlow(_4115.AbstractShaftOrHousingCompoundPowerFlow):
    """AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3982.AbstractShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3982.AbstractShaftPowerFlow]':
