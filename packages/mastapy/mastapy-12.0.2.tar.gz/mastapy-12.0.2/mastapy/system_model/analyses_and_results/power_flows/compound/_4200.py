...
class PowerLoadCompoundPowerFlow(_4235.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4070.PowerLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4070.PowerLoadPowerFlow]':
