...
class KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow(_4147.ConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4049.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4049.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
