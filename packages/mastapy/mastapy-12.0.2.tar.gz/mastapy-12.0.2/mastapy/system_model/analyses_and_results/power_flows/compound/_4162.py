...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4160, _4161, _4173
...
class CylindricalGearSetCompoundPowerFlow(_4173.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4030.CylindricalGearSetPowerFlow]':
    ...
    @property
    def cylindrical_gears_compound_power_flow(self) -> 'List[_4160.CylindricalGearCompoundPowerFlow]':
    ...
    @property
    def cylindrical_meshes_compound_power_flow(self) -> 'List[_4161.CylindricalGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4030.CylindricalGearSetPowerFlow]':
