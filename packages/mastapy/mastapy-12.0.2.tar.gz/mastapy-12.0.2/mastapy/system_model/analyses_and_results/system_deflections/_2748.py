...
class RollingRingConnectionSystemDeflection(_2717.InterMountableComponentConnectionSystemDeflection):
    """RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4075.RollingRingConnectionPowerFlow':
