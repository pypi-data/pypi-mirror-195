...
class WormGearMeshCompoundSystemDeflection(_2861.GearMeshCompoundSystemDeflection):
    """WormGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2786.WormGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2786.WormGearMeshSystemDeflection]':
