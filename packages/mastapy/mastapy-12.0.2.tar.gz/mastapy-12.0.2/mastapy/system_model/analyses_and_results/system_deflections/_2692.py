...
from mastapy.system_model.analyses_and_results.power_flows import _4030, _4065
from mastapy.system_model.analyses_and_results.system_deflections import _2695, _2689, _2710
...
class CylindricalGearSetSystemDeflection(_2710.GearSetSystemDeflection):
    """CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4030.CylindricalGearSetPowerFlow':
        ...
        if _4030.CylindricalGearSetPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2695.CylindricalGearSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2689.CylindricalGearMeshSystemDeflection]':
