...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2871, _2872, _2870
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection(_2870.KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2722.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_system_deflection(self) -> 'List[_2871.KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_system_deflection(self) -> 'List[_2872.KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2722.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
