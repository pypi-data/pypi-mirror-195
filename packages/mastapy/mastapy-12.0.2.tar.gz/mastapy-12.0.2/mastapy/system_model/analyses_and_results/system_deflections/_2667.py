...
class ConceptCouplingConnectionSystemDeflection(_2679.CouplingConnectionSystemDeflection):
    """ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4006.ConceptCouplingConnectionPowerFlow':
