...
from mastapy.system_model.analyses_and_results.system_deflections import _2783, _2785
...
class PowerLoadSystemDeflection(_2785.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4070.PowerLoadPowerFlow':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2783.TransmissionErrorResult]':
