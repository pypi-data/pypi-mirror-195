...
class BoltCompoundSystemDeflection(_2826.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2660.BoltSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2660.BoltSystemDeflection]':
