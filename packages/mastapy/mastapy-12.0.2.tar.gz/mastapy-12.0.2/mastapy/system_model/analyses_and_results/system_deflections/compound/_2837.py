...
class ConnectorCompoundSystemDeflection(_2879.MountableComponentCompoundSystemDeflection):
    """ConnectorCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2678.ConnectorSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2678.ConnectorSystemDeflection]':
