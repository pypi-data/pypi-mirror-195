...
class CouplingHalfCompoundSystemDeflection(_2879.MountableComponentCompoundSystemDeflection):
    """CouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2680.CouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2680.CouplingHalfSystemDeflection]':
