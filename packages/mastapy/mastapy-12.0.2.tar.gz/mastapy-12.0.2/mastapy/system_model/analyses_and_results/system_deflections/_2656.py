...
class BevelGearMeshSystemDeflection(_2644.AGMAGleasonConicalGearMeshSystemDeflection):
    """BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3996.BevelGearMeshPowerFlow':
