...
from mastapy.system_model.analyses_and_results.power_flows import _3992, _3994, _3995
...
class BevelDifferentialGearSystemDeflection(_2658.BevelGearSystemDeflection):
    """BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3992.BevelDifferentialGearPowerFlow':
