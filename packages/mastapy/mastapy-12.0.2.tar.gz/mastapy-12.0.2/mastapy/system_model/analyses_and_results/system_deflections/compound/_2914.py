...
class StraightBevelPlanetGearCompoundSystemDeflection(_2908.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2769.StraightBevelPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2769.StraightBevelPlanetGearSystemDeflection]':
