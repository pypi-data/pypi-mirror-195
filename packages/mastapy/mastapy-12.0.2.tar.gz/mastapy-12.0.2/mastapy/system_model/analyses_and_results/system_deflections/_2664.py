...
from mastapy.system_model.analyses_and_results.power_flows import _4004, _4024
...
class CoaxialConnectionSystemDeflection(_2755.ShaftToMountableComponentConnectionSystemDeflection):
    """CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4004.CoaxialConnectionPowerFlow':
