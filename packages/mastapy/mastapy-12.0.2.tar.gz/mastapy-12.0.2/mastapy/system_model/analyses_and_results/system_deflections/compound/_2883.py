...
class PartToPartShearCouplingConnectionCompoundSystemDeflection(_2839.CouplingConnectionCompoundSystemDeflection):
    """PartToPartShearCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2736.PartToPartShearCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2736.PartToPartShearCouplingConnectionSystemDeflection]':
