...
class VirtualComponentSystemDeflection(_2732.MountableComponentSystemDeflection):
    """VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4106.VirtualComponentPowerFlow':
