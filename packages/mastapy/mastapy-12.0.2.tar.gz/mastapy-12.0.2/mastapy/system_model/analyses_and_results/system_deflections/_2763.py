...
class StraightBevelDiffGearMeshSystemDeflection(_2656.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4088.StraightBevelDiffGearMeshPowerFlow':
