...
class WormGearCompoundSystemDeflection(_2860.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2788.WormGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2788.WormGearSystemDeflection]':
