...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2902, _2903, _2819
...
class SpiralBevelGearSetCompoundSystemDeflection(_2819.BevelGearSetCompoundSystemDeflection):
    """SpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2758.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2902.SpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2903.SpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2758.SpiralBevelGearSetSystemDeflection]':
