...
class GuideDxfModelCompoundSystemDeflection(_2826.ComponentCompoundSystemDeflection):
    """GuideDxfModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2712.GuideDxfModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2712.GuideDxfModelSystemDeflection]':
