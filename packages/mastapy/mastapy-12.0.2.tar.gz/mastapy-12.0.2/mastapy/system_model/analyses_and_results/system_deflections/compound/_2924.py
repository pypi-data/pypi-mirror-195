...
class UnbalancedMassCompoundSystemDeflection(_2925.VirtualComponentCompoundSystemDeflection):
    """UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2784.UnbalancedMassSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2784.UnbalancedMassSystemDeflection]':
