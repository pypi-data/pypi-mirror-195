...
class MountableComponentCompoundSystemDeflection(_2826.ComponentCompoundSystemDeflection):
    """MountableComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2732.MountableComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2732.MountableComponentSystemDeflection]':
