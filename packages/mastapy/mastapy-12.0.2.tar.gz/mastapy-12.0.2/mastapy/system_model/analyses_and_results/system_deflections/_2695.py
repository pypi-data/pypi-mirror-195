...
from mastapy.system_model.analyses_and_results.power_flows import _4029, _4031
from mastapy.system_model.analyses_and_results.system_deflections import _2699, _2711
...
class CylindricalGearSystemDeflection(_2711.GearSystemDeflection):
    """CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4029.CylindricalGearPowerFlow':
    ...
    @property
    def cylindrical_gear_system_deflections_in_meshes(self) -> 'List[_2699.CylindricalMeshedGearSystemDeflection]':
