...
class SpecialisedAssemblyCompoundSystemDeflection(_2801.AbstractAssemblyCompoundSystemDeflection):
    """SpecialisedAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2756.SpecialisedAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2756.SpecialisedAssemblySystemDeflection]':
