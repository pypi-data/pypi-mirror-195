...
from mastapy.system_model.analyses_and_results.system_deflections import _2736, _2681
...
class PartToPartShearCouplingSystemDeflection(_2681.CouplingSystemDeflection):
    """PartToPartShearCouplingSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6861.PartToPartShearCouplingLoadCase':
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2736.PartToPartShearCouplingConnectionSystemDeflection':
    ...
    @property
    def power_flow_results(self) -> '_4063.PartToPartShearCouplingPowerFlow':
