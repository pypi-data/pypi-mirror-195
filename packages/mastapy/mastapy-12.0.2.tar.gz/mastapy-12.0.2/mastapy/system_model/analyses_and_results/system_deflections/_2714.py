...
from mastapy.system_model.analyses_and_results.system_deflections import _2715, _2713, _2645
...
class HypoidGearSetSystemDeflection(_2645.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4045.HypoidGearSetPowerFlow':
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2715.HypoidGearSystemDeflection]':
    ...
    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2713.HypoidGearMeshSystemDeflection]':
