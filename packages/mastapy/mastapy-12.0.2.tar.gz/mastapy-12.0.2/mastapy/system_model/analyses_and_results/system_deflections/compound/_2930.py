...
class ZerolBevelGearMeshCompoundSystemDeflection(_2818.BevelGearMeshCompoundSystemDeflection):
    """ZerolBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2789.ZerolBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2789.ZerolBevelGearMeshSystemDeflection]':
