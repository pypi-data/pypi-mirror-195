...
from mastapy.system_model.analyses_and_results.system_deflections import _2653, _2651, _2657
...
class BevelDifferentialGearSetSystemDeflection(_2657.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3993.BevelDifferentialGearSetPowerFlow':
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2653.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2651.BevelDifferentialGearMeshSystemDeflection]':
