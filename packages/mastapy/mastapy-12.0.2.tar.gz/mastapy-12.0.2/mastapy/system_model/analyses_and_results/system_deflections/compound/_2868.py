...
class KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection(_2833.ConicalGearCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2720.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2720.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
