...
class InterMountableComponentConnectionCompoundSystemDeflection(_2836.ConnectionCompoundSystemDeflection):
    """InterMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2717.InterMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2717.InterMountableComponentConnectionSystemDeflection]':
