...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2864, _2865, _2807
...
class HypoidGearSetCompoundSystemDeflection(_2807.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    """HypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2714.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_system_deflection(self) -> 'List[_2864.HypoidGearCompoundSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_system_deflection(self) -> 'List[_2865.HypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2714.HypoidGearSetSystemDeflection]':
