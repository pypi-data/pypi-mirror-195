...
class ConceptGearMeshCompoundSystemDeflection(_2861.GearMeshCompoundSystemDeflection):
    """ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2670.ConceptGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2670.ConceptGearMeshSystemDeflection]':
