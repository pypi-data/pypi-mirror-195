...
class ShaftHubConnectionCompoundSystemDeflection(_2837.ConnectorCompoundSystemDeflection):
    """ShaftHubConnectionCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2751.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2751.ShaftHubConnectionSystemDeflection]':
