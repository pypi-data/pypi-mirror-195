...
class PartCompoundSystemDeflection(_7474.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2735.PartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2735.PartSystemDeflection]':
