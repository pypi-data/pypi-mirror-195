...
class BevelDifferentialGearMeshCompoundSystemDeflection(_2818.BevelGearMeshCompoundSystemDeflection):
    """BevelDifferentialGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2651.BevelDifferentialGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2651.BevelDifferentialGearMeshSystemDeflection]':
