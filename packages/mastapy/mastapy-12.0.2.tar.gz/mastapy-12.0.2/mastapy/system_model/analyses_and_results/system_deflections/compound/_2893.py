...
class RollingRingAssemblyCompoundSystemDeflection(_2901.SpecialisedAssemblyCompoundSystemDeflection):
    """RollingRingAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2747.RollingRingAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2747.RollingRingAssemblySystemDeflection]':
