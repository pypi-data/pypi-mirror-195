...
class ConicalGearSetCompoundSystemDeflection(_2862.GearSetCompoundSystemDeflection):
    """ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2675.ConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2675.ConicalGearSetSystemDeflection]':
