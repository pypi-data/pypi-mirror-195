...
from mastapy.system_model.analyses_and_results.system_deflections import _2649, _2756
...
class BeltDriveSystemDeflection(_2756.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3990.BeltDrivePowerFlow':
        ...
        if _3990.BeltDrivePowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def belts(self) -> 'List[_2649.BeltConnectionSystemDeflection]':
