...
class BevelDifferentialGearCompoundSystemDeflection(_2817.BevelGearCompoundSystemDeflection):
    """BevelDifferentialGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2653.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2653.BevelDifferentialGearSystemDeflection]':
