...
class SpiralBevelGearMeshCompoundSystemDeflection(_2818.BevelGearMeshCompoundSystemDeflection):
    """SpiralBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2757.SpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2757.SpiralBevelGearMeshSystemDeflection]':
