...
class CylindricalGearMeshCompoundSystemDeflection(_2861.GearMeshCompoundSystemDeflection):
    """CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2691.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2691.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
