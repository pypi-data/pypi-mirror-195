...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2825
...
class CycloidalDiscCentralBearingConnectionCompoundSystemDeflection(_2825.CoaxialConnectionCompoundSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2686.CycloidalDiscCentralBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2686.CycloidalDiscCentralBearingConnectionSystemDeflection]':
