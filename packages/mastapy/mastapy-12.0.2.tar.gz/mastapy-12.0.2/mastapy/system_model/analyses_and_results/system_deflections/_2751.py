...
class ShaftHubConnectionSystemDeflection(_2678.ConnectorSystemDeflection):
    """ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_design(self) -> '_2553.ShaftHubConnection':
    ...
    @property
    def component_load_case(self) -> '_6879.ShaftHubConnectionLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4078.ShaftHubConnectionPowerFlow':
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1904.BearingStiffnessMatrixReporter':
    ...
    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1904.BearingStiffnessMatrixReporter':
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2800.SplineFlankContactReporting]':
    ...
    @property
    def right_flank_contacts(self) -> 'List[_2800.SplineFlankContactReporting]':
    ...
    @property
    def tip_contacts(self) -> 'List[_2800.SplineFlankContactReporting]':
