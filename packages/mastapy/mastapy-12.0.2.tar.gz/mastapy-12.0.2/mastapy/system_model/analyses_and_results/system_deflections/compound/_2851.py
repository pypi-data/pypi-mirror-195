...
class CylindricalPlanetGearCompoundSystemDeflection(_2848.CylindricalGearCompoundSystemDeflection):
    """CylindricalPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2700.CylindricalPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2700.CylindricalPlanetGearSystemDeflection]':
