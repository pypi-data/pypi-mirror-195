...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2853, _2808
...
from mastapy.utility_gui.charts import _1829
...
class RootAssemblyCompoundSystemDeflection(_2808.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    @property
    def duty_cycle_efficiency_results(self) -> '_2853.DutyCycleEfficiencyResults':
    ...
    @property
    def root_assembly_compound_power_flow(self) -> '_4207.RootAssemblyCompoundPowerFlow':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2750.RootAssemblySystemDeflection]':
    ...
    @property
    def bearing_race_f_es(self) -> 'List[_2364.RaceBearingFESystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2750.RootAssemblySystemDeflection]':
    ...
    def peak_to_peak_transmission_error_chart(self, mesh_duty_cycles: 'List[_1091.CylindricalGearMeshMicroGeometryDutyCycle]', header: 'str', x_axis_title: 'str', y_axis_title: 'str') -> '_1829.TwoDChartDefinition':
