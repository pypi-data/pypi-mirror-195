...
class SynchroniserPartCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """SynchroniserPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2772.SynchroniserPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2772.SynchroniserPartSystemDeflection]':
