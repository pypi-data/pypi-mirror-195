...
class RollingRingConnectionCompoundSystemDeflection(_2867.InterMountableComponentConnectionCompoundSystemDeflection):
    """RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2748.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2748.RollingRingConnectionSystemDeflection]':
