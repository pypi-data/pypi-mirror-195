...
class DatumCompoundSystemDeflection(_2826.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2701.DatumSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2701.DatumSystemDeflection]':
