...
class PlanetaryConnectionCompoundSystemDeflection(_2900.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    """PlanetaryConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2739.PlanetaryConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2739.PlanetaryConnectionSystemDeflection]':
