...
class AGMAGleasonConicalGearCompoundSystemDeflection(_2833.ConicalGearCompoundSystemDeflection):
    """AGMAGleasonConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2646.AGMAGleasonConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2646.AGMAGleasonConicalGearSystemDeflection]':
