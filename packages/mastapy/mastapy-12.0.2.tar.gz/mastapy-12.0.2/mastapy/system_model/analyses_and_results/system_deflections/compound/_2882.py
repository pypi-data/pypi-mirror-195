...
class PartToPartShearCouplingCompoundSystemDeflection(_2838.CouplingCompoundSystemDeflection):
    """PartToPartShearCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2738.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2738.PartToPartShearCouplingSystemDeflection]':
