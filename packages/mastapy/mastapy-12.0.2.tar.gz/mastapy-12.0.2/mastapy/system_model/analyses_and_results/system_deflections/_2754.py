...
from mastapy.system_model.analyses_and_results.system_deflections import _2752, _2753, _2642
...
class ShaftSystemDeflection(_2642.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6880.ShaftLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4079.ShaftPowerFlow':
    ...
    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2752.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2752.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2752.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def mounted_components_applying_torque(self) -> 'List[_1527.ForceResults]':
    ...
    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2752.ShaftSectionEndResultsSystemDeflection]':
    ...
    @property
    def shaft_section_results(self) -> 'List[_2753.ShaftSectionSystemDeflection]':
