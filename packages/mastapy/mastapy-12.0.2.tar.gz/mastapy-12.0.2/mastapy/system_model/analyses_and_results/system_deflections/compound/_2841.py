...
class CVTBeltConnectionCompoundSystemDeflection(_2810.BeltConnectionCompoundSystemDeflection):
    """CVTBeltConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2682.CVTBeltConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2682.CVTBeltConnectionSystemDeflection]':
