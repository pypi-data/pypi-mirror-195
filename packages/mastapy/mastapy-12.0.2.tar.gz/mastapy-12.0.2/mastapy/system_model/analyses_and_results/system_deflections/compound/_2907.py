...
class SpringDamperHalfCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """SpringDamperHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2761.SpringDamperHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2761.SpringDamperHalfSystemDeflection]':
