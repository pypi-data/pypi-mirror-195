...
class BevelGearCompoundSystemDeflection(_2805.AGMAGleasonConicalGearCompoundSystemDeflection):
    """BevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2658.BevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2658.BevelGearSystemDeflection]':
