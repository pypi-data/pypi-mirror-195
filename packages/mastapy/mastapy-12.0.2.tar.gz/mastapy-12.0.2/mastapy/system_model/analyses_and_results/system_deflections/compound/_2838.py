...
class CouplingCompoundSystemDeflection(_2901.SpecialisedAssemblyCompoundSystemDeflection):
    """CouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2681.CouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2681.CouplingSystemDeflection]':
