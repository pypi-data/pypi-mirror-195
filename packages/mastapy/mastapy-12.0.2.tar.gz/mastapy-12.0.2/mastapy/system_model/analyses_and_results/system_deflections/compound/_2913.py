...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2911, _2912, _2819
...
class StraightBevelGearSetCompoundSystemDeflection(_2819.BevelGearSetCompoundSystemDeflection):
    """StraightBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2767.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_system_deflection(self) -> 'List[_2911.StraightBevelGearCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_system_deflection(self) -> 'List[_2912.StraightBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2767.StraightBevelGearSetSystemDeflection]':
