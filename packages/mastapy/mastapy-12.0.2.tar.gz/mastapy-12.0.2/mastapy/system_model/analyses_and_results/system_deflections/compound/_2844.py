...
class CycloidalAssemblyCompoundSystemDeflection(_2901.SpecialisedAssemblyCompoundSystemDeflection):
    """CycloidalAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2685.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2685.CycloidalAssemblySystemDeflection]':
