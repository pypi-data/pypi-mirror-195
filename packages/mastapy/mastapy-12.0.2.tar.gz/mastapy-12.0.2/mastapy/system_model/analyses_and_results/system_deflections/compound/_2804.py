...
class AbstractShaftToMountableComponentConnectionCompoundSystemDeflection(_2836.ConnectionCompoundSystemDeflection):
    """AbstractShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2643.AbstractShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2643.AbstractShaftToMountableComponentConnectionSystemDeflection]':
