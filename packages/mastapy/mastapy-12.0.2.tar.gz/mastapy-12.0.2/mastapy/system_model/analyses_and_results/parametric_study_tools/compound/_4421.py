...
class ConicalGearCompoundParametricStudyTool(_4447.GearCompoundParametricStudyTool):
    """ConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4275.ConicalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4275.ConicalGearParametricStudyTool]':
