...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4512, _4513, _4449
...
class WormGearSetCompoundParametricStudyTool(_4449.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4385.WormGearSetParametricStudyTool]':
    ...
    @property
    def worm_gears_compound_parametric_study_tool(self) -> 'List[_4512.WormGearCompoundParametricStudyTool]':
    ...
    @property
    def worm_meshes_compound_parametric_study_tool(self) -> 'List[_4513.WormGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4385.WormGearSetParametricStudyTool]':
