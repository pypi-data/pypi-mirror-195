...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4272, _4271, _4309
...
class ConceptGearSetParametricStudyTool(_4309.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4272.ConceptGearParametricStudyTool]':
    ...
    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4271.ConceptGearMeshParametricStudyTool]':
