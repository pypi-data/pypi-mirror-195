...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    @property
    def results_for_all_gear_sets(self) -> '_4297.DutyCycleResultsForAllGearSets':
    ...
    @property
    def results_for_root_assembly(self) -> '_4298.DutyCycleResultsForRootAssembly':
    ...
    @property
    def results_for_all_bearings(self) -> 'List[_4299.DutyCycleResultsForSingleBearing]':
    ...
    @property
    def results_for_all_shafts(self) -> 'List[_4300.DutyCycleResultsForSingleShaft]':
