...
class RingPinsToDiscConnectionCompoundParametricStudyTool(_4454.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RingPinsToDiscConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4350.RingPinsToDiscConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4350.RingPinsToDiscConnectionParametricStudyTool]':
