...
class TorqueConverterConnectionCompoundParametricStudyTool(_4427.CouplingConnectionCompoundParametricStudyTool):
    """TorqueConverterConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4377.TorqueConverterConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4377.TorqueConverterConnectionParametricStudyTool]':
