...
class ShaftToMountableComponentConnectionCompoundParametricStudyTool(_4392.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """ShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4357.ShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4357.ShaftToMountableComponentConnectionParametricStudyTool]':
