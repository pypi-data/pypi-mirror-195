...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4312, _4311, _4248
...
class HypoidGearSetParametricStudyTool(_4248.AGMAGleasonConicalGearSetParametricStudyTool):
    """HypoidGearSetParametricStudyTool
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_4312.HypoidGearParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_4311.HypoidGearMeshParametricStudyTool]':
