...
class SpiralBevelGearCompoundParametricStudyTool(_4405.BevelGearCompoundParametricStudyTool):
    """SpiralBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4360.SpiralBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4360.SpiralBevelGearParametricStudyTool]':
