...
class ZerolBevelGearCompoundParametricStudyTool(_4405.BevelGearCompoundParametricStudyTool):
    """ZerolBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4387.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4387.ZerolBevelGearParametricStudyTool]':
