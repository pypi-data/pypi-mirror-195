...
class VirtualComponentCompoundParametricStudyTool(_4466.MountableComponentCompoundParametricStudyTool):
    """VirtualComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4382.VirtualComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4382.VirtualComponentParametricStudyTool]':
