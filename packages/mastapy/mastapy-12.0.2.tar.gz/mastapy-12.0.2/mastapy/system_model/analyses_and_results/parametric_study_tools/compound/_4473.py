...
class PlanetaryGearSetCompoundParametricStudyTool(_4438.CylindricalGearSetCompoundParametricStudyTool):
    """PlanetaryGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4344.PlanetaryGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4344.PlanetaryGearSetParametricStudyTool]':
