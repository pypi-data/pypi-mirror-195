...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4494, _4495, _4407
...
class StraightBevelDiffGearSetCompoundParametricStudyTool(_4407.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelDiffGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4367.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gears_compound_parametric_study_tool(self) -> 'List[_4494.StraightBevelDiffGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_parametric_study_tool(self) -> 'List[_4495.StraightBevelDiffGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4367.StraightBevelDiffGearSetParametricStudyTool]':
