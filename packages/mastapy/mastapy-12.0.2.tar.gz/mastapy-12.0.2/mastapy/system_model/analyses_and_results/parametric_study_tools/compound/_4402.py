...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4400, _4401, _4407
...
class BevelDifferentialGearSetCompoundParametricStudyTool(_4407.BevelGearSetCompoundParametricStudyTool):
    """BevelDifferentialGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4255.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bevel_differential_gears_compound_parametric_study_tool(self) -> 'List[_4400.BevelDifferentialGearCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_compound_parametric_study_tool(self) -> 'List[_4401.BevelDifferentialGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4255.BevelDifferentialGearSetParametricStudyTool]':
