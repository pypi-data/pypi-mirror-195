...
class RollingRingConnectionCompoundParametricStudyTool(_4454.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RollingRingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4352.RollingRingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4352.RollingRingConnectionParametricStudyTool]':
