...
class PartToPartShearCouplingCompoundParametricStudyTool(_4426.CouplingCompoundParametricStudyTool):
    """PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4342.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4342.PartToPartShearCouplingParametricStudyTool]':
