...
class DatumCompoundParametricStudyTool(_4414.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4293.DatumParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4293.DatumParametricStudyTool]':
