...
class StraightBevelDiffGearCompoundParametricStudyTool(_4405.BevelGearCompoundParametricStudyTool):
    """StraightBevelDiffGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4366.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4366.StraightBevelDiffGearParametricStudyTool]':
