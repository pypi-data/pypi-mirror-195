...
class FlexiblePinAssemblyCompoundParametricStudyTool(_4487.SpecialisedAssemblyCompoundParametricStudyTool):
    """FlexiblePinAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4306.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4306.FlexiblePinAssemblyParametricStudyTool]':
