...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4254, _4253, _4260
...
class BevelDifferentialGearSetParametricStudyTool(_4260.BevelGearSetParametricStudyTool):
    """BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4254.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4253.BevelDifferentialGearMeshParametricStudyTool]':
