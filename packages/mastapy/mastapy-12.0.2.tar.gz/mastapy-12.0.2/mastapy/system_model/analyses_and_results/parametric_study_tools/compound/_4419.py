...
class ConceptGearMeshCompoundParametricStudyTool(_4448.GearMeshCompoundParametricStudyTool):
    """ConceptGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4271.ConceptGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4271.ConceptGearMeshParametricStudyTool]':
