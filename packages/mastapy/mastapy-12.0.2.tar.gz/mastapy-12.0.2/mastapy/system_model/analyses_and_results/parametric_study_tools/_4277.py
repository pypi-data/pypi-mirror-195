...
class ConnectionParametricStudyTool(_7466.ConnectionAnalysisCase):
    """ConnectionParametricStudyTool
    ...
    @property
    def data_logger(self) -> '_1814.DataLoggerWithCharts':
    ...
    @property
    def parametric_study_tool(self) -> '_4334.ParametricStudyTool':
