...
class CylindricalPlanetGearCompoundParametricStudyTool(_4436.CylindricalGearCompoundParametricStudyTool):
    """CylindricalPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4292.CylindricalPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4292.CylindricalPlanetGearParametricStudyTool]':
