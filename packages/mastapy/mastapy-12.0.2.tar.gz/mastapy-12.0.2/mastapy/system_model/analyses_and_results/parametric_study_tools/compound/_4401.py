...
class BevelDifferentialGearMeshCompoundParametricStudyTool(_4406.BevelGearMeshCompoundParametricStudyTool):
    """BevelDifferentialGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4253.BevelDifferentialGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4253.BevelDifferentialGearMeshParametricStudyTool]':
