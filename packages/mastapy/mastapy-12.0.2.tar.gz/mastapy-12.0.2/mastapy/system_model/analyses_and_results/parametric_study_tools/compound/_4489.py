...
class SpiralBevelGearMeshCompoundParametricStudyTool(_4406.BevelGearMeshCompoundParametricStudyTool):
    """SpiralBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4359.SpiralBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4359.SpiralBevelGearMeshParametricStudyTool]':
