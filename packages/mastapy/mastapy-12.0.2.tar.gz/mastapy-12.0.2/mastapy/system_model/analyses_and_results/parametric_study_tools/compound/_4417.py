...
class ConceptCouplingHalfCompoundParametricStudyTool(_4428.CouplingHalfCompoundParametricStudyTool):
    """ConceptCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4269.ConceptCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4269.ConceptCouplingHalfParametricStudyTool]':
