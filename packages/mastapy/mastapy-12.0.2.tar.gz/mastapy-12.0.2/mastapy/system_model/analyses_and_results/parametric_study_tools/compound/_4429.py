...
class CVTBeltConnectionCompoundParametricStudyTool(_4398.BeltConnectionCompoundParametricStudyTool):
    """CVTBeltConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4282.CVTBeltConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4282.CVTBeltConnectionParametricStudyTool]':
