...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4418, _4419, _4449
...
class ConceptGearSetCompoundParametricStudyTool(_4449.GearSetCompoundParametricStudyTool):
    """ConceptGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4273.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def concept_gears_compound_parametric_study_tool(self) -> 'List[_4418.ConceptGearCompoundParametricStudyTool]':
    ...
    @property
    def concept_meshes_compound_parametric_study_tool(self) -> 'List[_4419.ConceptGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4273.ConceptGearSetParametricStudyTool]':
