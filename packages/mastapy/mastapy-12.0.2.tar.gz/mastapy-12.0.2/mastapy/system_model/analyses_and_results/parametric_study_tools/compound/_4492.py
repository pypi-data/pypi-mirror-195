...
class SpringDamperConnectionCompoundParametricStudyTool(_4427.CouplingConnectionCompoundParametricStudyTool):
    """SpringDamperConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4362.SpringDamperConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4362.SpringDamperConnectionParametricStudyTool]':
