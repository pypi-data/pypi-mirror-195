...
class CoaxialConnectionCompoundParametricStudyTool(_4486.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CoaxialConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4266.CoaxialConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4266.CoaxialConnectionParametricStudyTool]':
