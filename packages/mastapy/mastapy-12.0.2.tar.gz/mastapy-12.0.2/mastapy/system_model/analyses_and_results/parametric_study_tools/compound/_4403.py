...
class BevelDifferentialPlanetGearCompoundParametricStudyTool(_4400.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4256.BevelDifferentialPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4256.BevelDifferentialPlanetGearParametricStudyTool]':
