...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4303, _4302, _4309
...
class FaceGearSetParametricStudyTool(_4309.GearSetParametricStudyTool):
    """FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4303.FaceGearParametricStudyTool]':
    ...
    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4302.FaceGearMeshParametricStudyTool]':
