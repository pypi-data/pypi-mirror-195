...
class ConceptCouplingCompoundParametricStudyTool(_4426.CouplingCompoundParametricStudyTool):
    """ConceptCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4270.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4270.ConceptCouplingParametricStudyTool]':
