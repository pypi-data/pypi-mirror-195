...
class FaceGearMeshCompoundParametricStudyTool(_4448.GearMeshCompoundParametricStudyTool):
    """FaceGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4302.FaceGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4302.FaceGearMeshParametricStudyTool]':
