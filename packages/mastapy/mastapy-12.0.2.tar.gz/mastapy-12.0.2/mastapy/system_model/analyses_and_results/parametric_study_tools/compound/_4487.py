...
class SpecialisedAssemblyCompoundParametricStudyTool(_4389.AbstractAssemblyCompoundParametricStudyTool):
    """SpecialisedAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4358.SpecialisedAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4358.SpecialisedAssemblyParametricStudyTool]':
