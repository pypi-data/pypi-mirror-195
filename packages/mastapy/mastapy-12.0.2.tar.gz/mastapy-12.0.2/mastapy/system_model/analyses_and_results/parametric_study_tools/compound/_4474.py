...
class PlanetCarrierCompoundParametricStudyTool(_4466.MountableComponentCompoundParametricStudyTool):
    """PlanetCarrierCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4345.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4345.PlanetCarrierParametricStudyTool]':
