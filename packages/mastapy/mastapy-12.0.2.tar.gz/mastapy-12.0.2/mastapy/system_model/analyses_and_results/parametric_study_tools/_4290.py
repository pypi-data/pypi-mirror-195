...
class CylindricalGearParametricStudyTool(_4308.GearParametricStudyTool):
    """CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2695.CylindricalGearSystemDeflection]':
