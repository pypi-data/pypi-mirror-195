...
class PlanetaryConnectionCompoundParametricStudyTool(_4486.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """PlanetaryConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4343.PlanetaryConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4343.PlanetaryConnectionParametricStudyTool]':
