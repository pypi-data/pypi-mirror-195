...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4488, _4489, _4407
...
class SpiralBevelGearSetCompoundParametricStudyTool(_4407.BevelGearSetCompoundParametricStudyTool):
    """SpiralBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4361.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4488.SpiralBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4489.SpiralBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4361.SpiralBevelGearSetParametricStudyTool]':
