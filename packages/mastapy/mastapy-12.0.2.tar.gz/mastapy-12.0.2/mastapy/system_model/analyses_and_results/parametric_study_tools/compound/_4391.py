...
class AbstractShaftOrHousingCompoundParametricStudyTool(_4414.ComponentCompoundParametricStudyTool):
    """AbstractShaftOrHousingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4243.AbstractShaftOrHousingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4243.AbstractShaftOrHousingParametricStudyTool]':
