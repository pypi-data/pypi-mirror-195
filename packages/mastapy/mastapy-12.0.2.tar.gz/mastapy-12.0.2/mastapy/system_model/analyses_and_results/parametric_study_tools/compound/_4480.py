...
class RollingRingAssemblyCompoundParametricStudyTool(_4487.SpecialisedAssemblyCompoundParametricStudyTool):
    """RollingRingAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4351.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4351.RollingRingAssemblyParametricStudyTool]':
