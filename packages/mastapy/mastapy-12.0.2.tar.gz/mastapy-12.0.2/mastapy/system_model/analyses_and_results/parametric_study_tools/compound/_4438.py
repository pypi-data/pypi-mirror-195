...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4436, _4437, _4449
...
class CylindricalGearSetCompoundParametricStudyTool(_4449.GearSetCompoundParametricStudyTool):
    """CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4291.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_4436.CylindricalGearCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_4437.CylindricalGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4291.CylindricalGearSetParametricStudyTool]':
