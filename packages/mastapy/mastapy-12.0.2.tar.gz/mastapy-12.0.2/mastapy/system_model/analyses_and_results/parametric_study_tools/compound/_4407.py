...
class BevelGearSetCompoundParametricStudyTool(_4395.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    """BevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4260.BevelGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4260.BevelGearSetParametricStudyTool]':
