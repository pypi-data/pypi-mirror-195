...
class AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool(_4424.ConnectionCompoundParametricStudyTool):
    """AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4245.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4245.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
