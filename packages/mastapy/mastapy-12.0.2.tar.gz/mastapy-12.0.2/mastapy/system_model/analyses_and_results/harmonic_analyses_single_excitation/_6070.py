...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6068, _6069, _5959
...
class ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation(_5959.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6068.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6069.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
