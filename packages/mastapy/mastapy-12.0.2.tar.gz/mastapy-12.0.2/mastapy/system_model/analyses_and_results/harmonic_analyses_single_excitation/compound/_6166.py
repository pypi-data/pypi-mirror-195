...
class ShaftCompoundHarmonicAnalysisOfSingleExcitation(_6072.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    """ShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6037.ShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6037.ShaftHarmonicAnalysisOfSingleExcitation]':
