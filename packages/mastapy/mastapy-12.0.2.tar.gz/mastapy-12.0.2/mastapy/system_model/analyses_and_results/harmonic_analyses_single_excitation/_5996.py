...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5994, _5995, _6001
...
class FaceGearSetHarmonicAnalysisOfSingleExcitation(_6001.GearSetHarmonicAnalysisOfSingleExcitation):
    """FaceGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def face_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5994.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5995.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
