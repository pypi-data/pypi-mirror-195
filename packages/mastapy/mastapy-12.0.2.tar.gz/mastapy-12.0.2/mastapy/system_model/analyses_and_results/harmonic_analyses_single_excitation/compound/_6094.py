...
class ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation(_6110.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5963.ClutchHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5963.ClutchHalfHarmonicAnalysisOfSingleExcitation]':
