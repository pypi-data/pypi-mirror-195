...
class AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation(_6073.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5942.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5942.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
