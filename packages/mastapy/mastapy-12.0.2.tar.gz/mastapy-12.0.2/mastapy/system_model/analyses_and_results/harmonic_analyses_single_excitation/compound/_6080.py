...
class BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6136.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5950.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5950.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
