...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6065, _6066, _6001
...
class WormGearSetHarmonicAnalysisOfSingleExcitation(_6001.GearSetHarmonicAnalysisOfSingleExcitation):
    """WormGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def worm_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6065.WormGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6066.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
