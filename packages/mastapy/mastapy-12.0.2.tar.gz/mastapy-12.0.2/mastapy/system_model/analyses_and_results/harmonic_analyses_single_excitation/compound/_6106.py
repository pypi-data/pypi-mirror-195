...
class ConnectionCompoundHarmonicAnalysisOfSingleExcitation(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5976.ConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5976.ConnectionHarmonicAnalysisOfSingleExcitation]':
