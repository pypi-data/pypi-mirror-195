...
class RingPinsCompoundHarmonicAnalysisOfSingleExcitation(_6148.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """RingPinsCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6031.RingPinsHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6031.RingPinsHarmonicAnalysisOfSingleExcitation]':
