...
class SynchroniserCompoundHarmonicAnalysisOfSingleExcitation(_6169.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6056.SynchroniserHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6056.SynchroniserHarmonicAnalysisOfSingleExcitation]':
