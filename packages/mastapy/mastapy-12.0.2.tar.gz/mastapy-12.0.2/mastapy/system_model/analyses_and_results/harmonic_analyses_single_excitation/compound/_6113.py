...
class CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation(_6159.PulleyCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5983.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5983.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
