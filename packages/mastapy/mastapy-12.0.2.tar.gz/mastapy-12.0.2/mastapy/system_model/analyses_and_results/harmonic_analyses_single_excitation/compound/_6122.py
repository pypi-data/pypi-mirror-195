...
class DatumCompoundHarmonicAnalysisOfSingleExcitation(_6096.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """DatumCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5992.DatumHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5992.DatumHarmonicAnalysisOfSingleExcitation]':
