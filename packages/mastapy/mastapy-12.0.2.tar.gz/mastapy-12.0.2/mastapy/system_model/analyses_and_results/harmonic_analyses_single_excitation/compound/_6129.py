...
class GearCompoundHarmonicAnalysisOfSingleExcitation(_6148.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """GearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5999.GearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5999.GearHarmonicAnalysisOfSingleExcitation]':
