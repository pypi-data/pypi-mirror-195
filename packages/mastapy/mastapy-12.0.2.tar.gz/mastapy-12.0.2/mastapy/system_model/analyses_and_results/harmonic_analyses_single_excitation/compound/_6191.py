...
class TorqueConverterTurbineCompoundHarmonicAnalysisOfSingleExcitation(_6110.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterTurbineCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6062.TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6062.TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation]':
