...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3856, _3857, _3863
...
class BevelDifferentialGearSetCompoundStabilityAnalysis(_3863.BevelGearSetCompoundStabilityAnalysis):
    """BevelDifferentialGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3725.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_stability_analysis(self) -> 'List[_3856.BevelDifferentialGearCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_stability_analysis(self) -> 'List[_3857.BevelDifferentialGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3725.BevelDifferentialGearSetStabilityAnalysis]':
