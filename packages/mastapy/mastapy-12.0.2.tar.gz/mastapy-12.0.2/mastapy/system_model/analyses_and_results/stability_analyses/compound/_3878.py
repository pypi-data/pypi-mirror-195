...
class ConicalGearMeshCompoundStabilityAnalysis(_3904.GearMeshCompoundStabilityAnalysis):
    """ConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3745.ConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3745.ConicalGearMeshStabilityAnalysis]':
