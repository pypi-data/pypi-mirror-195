...
class AbstractShaftOrHousingCompoundStabilityAnalysis(_3870.ComponentCompoundStabilityAnalysis):
    """AbstractShaftOrHousingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3714.AbstractShaftOrHousingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3714.AbstractShaftOrHousingStabilityAnalysis]':
