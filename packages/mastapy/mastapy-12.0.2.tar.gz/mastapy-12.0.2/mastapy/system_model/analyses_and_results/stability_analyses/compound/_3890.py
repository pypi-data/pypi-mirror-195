...
class CycloidalDiscCompoundStabilityAnalysis(_3846.AbstractShaftCompoundStabilityAnalysis):
    """CycloidalDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3760.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3760.CycloidalDiscStabilityAnalysis]':
