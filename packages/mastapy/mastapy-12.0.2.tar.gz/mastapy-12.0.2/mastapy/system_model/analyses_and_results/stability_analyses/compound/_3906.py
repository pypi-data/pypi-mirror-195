...
class GuideDxfModelCompoundStabilityAnalysis(_3870.ComponentCompoundStabilityAnalysis):
    """GuideDxfModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3775.GuideDxfModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3775.GuideDxfModelStabilityAnalysis]':
