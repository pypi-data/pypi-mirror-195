...
class ConicalGearCompoundStabilityAnalysis(_3903.GearCompoundStabilityAnalysis):
    """ConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3747.ConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3747.ConicalGearStabilityAnalysis]':
