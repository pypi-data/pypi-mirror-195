...
class AbstractAssemblyCompoundStabilityAnalysis(_3924.PartCompoundStabilityAnalysis):
    """AbstractAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3713.AbstractAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3713.AbstractAssemblyStabilityAnalysis]':
