...
class StraightBevelGearCompoundStabilityAnalysis(_3861.BevelGearCompoundStabilityAnalysis):
    """StraightBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3826.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3826.StraightBevelGearStabilityAnalysis]':
