...
class FlexiblePinAssemblyCompoundStabilityAnalysis(_3943.SpecialisedAssemblyCompoundStabilityAnalysis):
    """FlexiblePinAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3771.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3771.FlexiblePinAssemblyStabilityAnalysis]':
