...
class MeasurementComponentCompoundStabilityAnalysis(_3967.VirtualComponentCompoundStabilityAnalysis):
    """MeasurementComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3790.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3790.MeasurementComponentStabilityAnalysis]':
