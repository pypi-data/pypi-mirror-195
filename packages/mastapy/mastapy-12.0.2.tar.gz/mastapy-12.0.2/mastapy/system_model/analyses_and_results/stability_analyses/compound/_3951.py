...
class StraightBevelDiffGearMeshCompoundStabilityAnalysis(_3862.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelDiffGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3821.StraightBevelDiffGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3821.StraightBevelDiffGearMeshStabilityAnalysis]':
