...
class ShaftHubConnectionCompoundStabilityAnalysis(_3881.ConnectorCompoundStabilityAnalysis):
    """ShaftHubConnectionCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3809.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3809.ShaftHubConnectionStabilityAnalysis]':
