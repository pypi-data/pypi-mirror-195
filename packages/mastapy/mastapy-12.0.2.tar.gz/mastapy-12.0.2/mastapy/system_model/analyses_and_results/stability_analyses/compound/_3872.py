...
class ConceptCouplingConnectionCompoundStabilityAnalysis(_3883.CouplingConnectionCompoundStabilityAnalysis):
    """ConceptCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3739.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3739.ConceptCouplingConnectionStabilityAnalysis]':
