...
class ShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3848.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """ShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3811.ShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3811.ShaftToMountableComponentConnectionStabilityAnalysis]':
