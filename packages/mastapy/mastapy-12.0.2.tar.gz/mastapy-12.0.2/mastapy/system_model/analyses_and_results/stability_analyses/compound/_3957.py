...
class StraightBevelSunGearCompoundStabilityAnalysis(_3950.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3828.StraightBevelSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3828.StraightBevelSunGearStabilityAnalysis]':
