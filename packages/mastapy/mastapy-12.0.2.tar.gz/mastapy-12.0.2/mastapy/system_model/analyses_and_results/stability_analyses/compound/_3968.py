...
class WormGearCompoundStabilityAnalysis(_3903.GearCompoundStabilityAnalysis):
    """WormGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3841.WormGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3841.WormGearStabilityAnalysis]':
