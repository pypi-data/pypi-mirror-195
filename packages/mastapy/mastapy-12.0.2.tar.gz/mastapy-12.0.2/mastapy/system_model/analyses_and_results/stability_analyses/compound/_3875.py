...
class ConceptGearMeshCompoundStabilityAnalysis(_3904.GearMeshCompoundStabilityAnalysis):
    """ConceptGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3742.ConceptGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3742.ConceptGearMeshStabilityAnalysis]':
