...
class UnbalancedMassCompoundStabilityAnalysis(_3967.VirtualComponentCompoundStabilityAnalysis):
    """UnbalancedMassCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3837.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3837.UnbalancedMassStabilityAnalysis]':
