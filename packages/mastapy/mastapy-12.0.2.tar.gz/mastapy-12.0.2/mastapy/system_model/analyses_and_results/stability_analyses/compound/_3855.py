...
class BeltDriveCompoundStabilityAnalysis(_3943.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BeltDriveCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3723.BeltDriveStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3723.BeltDriveStabilityAnalysis]':
