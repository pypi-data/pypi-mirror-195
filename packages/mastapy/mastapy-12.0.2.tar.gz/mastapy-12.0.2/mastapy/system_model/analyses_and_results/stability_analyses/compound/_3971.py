...
class ZerolBevelGearCompoundStabilityAnalysis(_3861.BevelGearCompoundStabilityAnalysis):
    """ZerolBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3844.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3844.ZerolBevelGearStabilityAnalysis]':
