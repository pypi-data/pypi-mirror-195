...
class ConicalGearSetCompoundStabilityAnalysis(_3905.GearSetCompoundStabilityAnalysis):
    """ConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3746.ConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3746.ConicalGearSetStabilityAnalysis]':
