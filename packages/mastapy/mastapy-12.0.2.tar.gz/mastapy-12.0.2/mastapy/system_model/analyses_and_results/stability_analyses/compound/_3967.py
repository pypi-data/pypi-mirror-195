...
class VirtualComponentCompoundStabilityAnalysis(_3922.MountableComponentCompoundStabilityAnalysis):
    """VirtualComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3838.VirtualComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3838.VirtualComponentStabilityAnalysis]':
