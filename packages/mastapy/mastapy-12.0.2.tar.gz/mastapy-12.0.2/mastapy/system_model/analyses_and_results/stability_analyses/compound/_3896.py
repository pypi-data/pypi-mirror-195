...
class DatumCompoundStabilityAnalysis(_3870.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3765.DatumStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3765.DatumStabilityAnalysis]':
