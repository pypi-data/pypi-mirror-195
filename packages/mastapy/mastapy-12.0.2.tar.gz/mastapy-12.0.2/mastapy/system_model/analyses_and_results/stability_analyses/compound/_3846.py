...
class AbstractShaftCompoundStabilityAnalysis(_3847.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """AbstractShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3715.AbstractShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3715.AbstractShaftStabilityAnalysis]':
