...
class BevelDifferentialPlanetGearCompoundStabilityAnalysis(_3856.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3727.BevelDifferentialPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3727.BevelDifferentialPlanetGearStabilityAnalysis]':
