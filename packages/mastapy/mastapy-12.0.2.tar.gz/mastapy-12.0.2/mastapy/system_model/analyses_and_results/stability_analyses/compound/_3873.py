...
class ConceptCouplingHalfCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """ConceptCouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3740.ConceptCouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3740.ConceptCouplingHalfStabilityAnalysis]':
