...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3874, _3875, _3905
...
class ConceptGearSetCompoundStabilityAnalysis(_3905.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3743.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def concept_gears_compound_stability_analysis(self) -> 'List[_3874.ConceptGearCompoundStabilityAnalysis]':
    ...
    @property
    def concept_meshes_compound_stability_analysis(self) -> 'List[_3875.ConceptGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3743.ConceptGearSetStabilityAnalysis]':
