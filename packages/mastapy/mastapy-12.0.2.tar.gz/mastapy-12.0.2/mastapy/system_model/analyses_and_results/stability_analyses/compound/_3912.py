...
class KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis(_3878.ConicalGearMeshCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3780.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3780.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
