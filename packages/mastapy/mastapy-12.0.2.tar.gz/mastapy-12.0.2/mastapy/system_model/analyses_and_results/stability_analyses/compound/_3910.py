...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3880.ConnectionCompoundStabilityAnalysis):
    """InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3779.InterMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3779.InterMountableComponentConnectionStabilityAnalysis]':
