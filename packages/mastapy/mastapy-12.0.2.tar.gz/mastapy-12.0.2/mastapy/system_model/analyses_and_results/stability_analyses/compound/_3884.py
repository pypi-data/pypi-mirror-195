...
class CouplingHalfCompoundStabilityAnalysis(_3922.MountableComponentCompoundStabilityAnalysis):
    """CouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3751.CouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3751.CouplingHalfStabilityAnalysis]':
