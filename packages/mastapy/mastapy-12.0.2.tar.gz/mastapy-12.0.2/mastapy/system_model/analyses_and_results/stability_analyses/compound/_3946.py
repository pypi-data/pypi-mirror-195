...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3944, _3945, _3863
...
class SpiralBevelGearSetCompoundStabilityAnalysis(_3863.BevelGearSetCompoundStabilityAnalysis):
    """SpiralBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3814.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_stability_analysis(self) -> 'List[_3944.SpiralBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_stability_analysis(self) -> 'List[_3945.SpiralBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3814.SpiralBevelGearSetStabilityAnalysis]':
