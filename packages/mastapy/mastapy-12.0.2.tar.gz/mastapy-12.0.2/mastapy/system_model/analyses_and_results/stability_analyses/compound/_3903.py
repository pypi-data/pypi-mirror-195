...
class GearCompoundStabilityAnalysis(_3922.MountableComponentCompoundStabilityAnalysis):
    """GearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3774.GearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3774.GearStabilityAnalysis]':
