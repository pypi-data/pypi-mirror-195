...
class TorqueConverterCompoundStabilityAnalysis(_3882.CouplingCompoundStabilityAnalysis):
    """TorqueConverterCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3835.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3835.TorqueConverterStabilityAnalysis]':
