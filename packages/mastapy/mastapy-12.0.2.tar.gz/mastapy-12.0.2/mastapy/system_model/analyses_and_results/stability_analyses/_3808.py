...
from mastapy.system_model.analyses_and_results.stability_analyses import _2597, _3720
...
class RootAssemblyStabilityAnalysis(_3720.AssemblyStabilityAnalysis):
    """RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2597.StabilityAnalysis':
