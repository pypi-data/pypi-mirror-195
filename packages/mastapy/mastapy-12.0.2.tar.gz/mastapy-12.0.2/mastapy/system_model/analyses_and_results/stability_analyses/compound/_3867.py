...
class ClutchConnectionCompoundStabilityAnalysis(_3883.CouplingConnectionCompoundStabilityAnalysis):
    """ClutchConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3734.ClutchConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3734.ClutchConnectionStabilityAnalysis]':
