...
class BoltedJointCompoundStabilityAnalysis(_3943.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BoltedJointCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3732.BoltedJointStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3732.BoltedJointStabilityAnalysis]':
