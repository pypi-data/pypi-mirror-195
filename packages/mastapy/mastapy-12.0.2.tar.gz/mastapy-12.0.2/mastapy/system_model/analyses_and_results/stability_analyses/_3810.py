...
from mastapy.system_model.analyses_and_results.stability_analyses import _3753, _3715
...
class ShaftStabilityAnalysis(_3715.AbstractShaftStabilityAnalysis):
    """ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3753.CriticalSpeed]':
