...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3898, _3899, _3905
...
class FaceGearSetCompoundStabilityAnalysis(_3905.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3768.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def face_gears_compound_stability_analysis(self) -> 'List[_3898.FaceGearCompoundStabilityAnalysis]':
    ...
    @property
    def face_meshes_compound_stability_analysis(self) -> 'List[_3899.FaceGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3768.FaceGearSetStabilityAnalysis]':
