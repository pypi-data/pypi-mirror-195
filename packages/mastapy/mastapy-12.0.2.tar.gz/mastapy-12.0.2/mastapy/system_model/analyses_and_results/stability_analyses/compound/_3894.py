...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3892, _3893, _3905
...
class CylindricalGearSetCompoundStabilityAnalysis(_3905.GearSetCompoundStabilityAnalysis):
    """CylindricalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3762.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_stability_analysis(self) -> 'List[_3892.CylindricalGearCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_stability_analysis(self) -> 'List[_3893.CylindricalGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3762.CylindricalGearSetStabilityAnalysis]':
