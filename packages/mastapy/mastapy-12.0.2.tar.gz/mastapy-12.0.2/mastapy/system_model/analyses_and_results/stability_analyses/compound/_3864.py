...
class BoltCompoundStabilityAnalysis(_3870.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3733.BoltStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3733.BoltStabilityAnalysis]':
