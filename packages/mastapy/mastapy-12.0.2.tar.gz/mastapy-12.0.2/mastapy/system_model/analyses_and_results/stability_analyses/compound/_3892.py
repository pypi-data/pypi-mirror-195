...
class CylindricalGearCompoundStabilityAnalysis(_3903.GearCompoundStabilityAnalysis):
    """CylindricalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3763.CylindricalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3763.CylindricalGearStabilityAnalysis]':
