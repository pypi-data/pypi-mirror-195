...
class SpringDamperHalfCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """SpringDamperHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3817.SpringDamperHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3817.SpringDamperHalfStabilityAnalysis]':
