...
class SpecialisedAssemblyCompoundStabilityAnalysis(_3845.AbstractAssemblyCompoundStabilityAnalysis):
    """SpecialisedAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3812.SpecialisedAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3812.SpecialisedAssemblyStabilityAnalysis]':
