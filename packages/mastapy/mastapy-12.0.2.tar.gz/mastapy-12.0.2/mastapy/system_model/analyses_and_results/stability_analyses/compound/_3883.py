...
class CouplingConnectionCompoundStabilityAnalysis(_3910.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """CouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3750.CouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3750.CouplingConnectionStabilityAnalysis]':
