...
class SpiralBevelGearCompoundStabilityAnalysis(_3861.BevelGearCompoundStabilityAnalysis):
    """SpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3815.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3815.SpiralBevelGearStabilityAnalysis]':
