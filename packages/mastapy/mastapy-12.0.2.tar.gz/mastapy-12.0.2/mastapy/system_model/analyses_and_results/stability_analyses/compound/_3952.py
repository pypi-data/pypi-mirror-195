...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3950, _3951, _3863
...
class StraightBevelDiffGearSetCompoundStabilityAnalysis(_3863.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelDiffGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3822.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_stability_analysis(self) -> 'List[_3950.StraightBevelDiffGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_stability_analysis(self) -> 'List[_3951.StraightBevelDiffGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3822.StraightBevelDiffGearSetStabilityAnalysis]':
