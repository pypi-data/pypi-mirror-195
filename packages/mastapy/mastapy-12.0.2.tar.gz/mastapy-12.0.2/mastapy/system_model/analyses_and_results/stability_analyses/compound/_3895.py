...
class CylindricalPlanetGearCompoundStabilityAnalysis(_3892.CylindricalGearCompoundStabilityAnalysis):
    """CylindricalPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3764.CylindricalPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3764.CylindricalPlanetGearStabilityAnalysis]':
