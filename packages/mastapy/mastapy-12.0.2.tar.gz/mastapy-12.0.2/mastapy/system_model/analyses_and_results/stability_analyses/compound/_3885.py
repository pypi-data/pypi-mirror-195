...
class CVTBeltConnectionCompoundStabilityAnalysis(_3854.BeltConnectionCompoundStabilityAnalysis):
    """CVTBeltConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3754.CVTBeltConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3754.CVTBeltConnectionStabilityAnalysis]':
