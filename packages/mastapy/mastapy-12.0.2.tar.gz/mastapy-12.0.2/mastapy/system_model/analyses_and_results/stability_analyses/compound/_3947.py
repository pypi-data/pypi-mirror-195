...
class SpringDamperCompoundStabilityAnalysis(_3882.CouplingCompoundStabilityAnalysis):
    """SpringDamperCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3818.SpringDamperStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3818.SpringDamperStabilityAnalysis]':
