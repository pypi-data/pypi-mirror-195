...
from mastapy.system_model.analyses_and_results.stability_analyses import _3763, _3761, _3773
...
class CylindricalGearSetStabilityAnalysis(_3773.GearSetStabilityAnalysis):
    """CylindricalGearSetStabilityAnalysis
    ...
    @property
    def cylindrical_gears_stability_analysis(self) -> 'List[_3763.CylindricalGearStabilityAnalysis]':
    ...
    @property
    def cylindrical_meshes_stability_analysis(self) -> 'List[_3761.CylindricalGearMeshStabilityAnalysis]':
