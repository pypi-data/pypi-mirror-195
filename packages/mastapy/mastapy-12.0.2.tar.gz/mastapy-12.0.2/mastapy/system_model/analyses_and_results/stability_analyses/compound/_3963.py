...
class TorqueConverterConnectionCompoundStabilityAnalysis(_3883.CouplingConnectionCompoundStabilityAnalysis):
    """TorqueConverterConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3833.TorqueConverterConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3833.TorqueConverterConnectionStabilityAnalysis]':
