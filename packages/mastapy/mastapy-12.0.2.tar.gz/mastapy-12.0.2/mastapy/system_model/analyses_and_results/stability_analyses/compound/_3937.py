...
class RollingRingCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """RollingRingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3807.RollingRingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3807.RollingRingStabilityAnalysis]':
