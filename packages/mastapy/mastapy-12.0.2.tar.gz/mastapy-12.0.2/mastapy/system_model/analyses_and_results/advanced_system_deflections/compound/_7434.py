...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_7351.BevelGearMeshCompoundAdvancedSystemDeflection):
    """SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7304.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7304.SpiralBevelGearMeshAdvancedSystemDeflection]':
