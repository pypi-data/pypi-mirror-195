...
class CouplingHalfCompoundAdvancedSystemDeflection(_7411.MountableComponentCompoundAdvancedSystemDeflection):
    """CouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7241.CouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7241.CouplingHalfAdvancedSystemDeflection]':
