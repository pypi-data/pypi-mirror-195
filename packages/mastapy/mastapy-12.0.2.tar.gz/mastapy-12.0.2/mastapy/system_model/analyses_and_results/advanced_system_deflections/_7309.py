...
class StraightBevelDiffGearAdvancedSystemDeflection(_7217.BevelGearAdvancedSystemDeflection):
    """StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2765.StraightBevelDiffGearSystemDeflection]':
