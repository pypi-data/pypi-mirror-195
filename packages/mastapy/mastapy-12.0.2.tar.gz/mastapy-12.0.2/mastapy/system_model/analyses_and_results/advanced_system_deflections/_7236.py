...
from mastapy.math_utility.convergence import _1542, _1541
...
class ConnectionAdvancedSystemDeflection(_7469.ConnectionStaticLoadAnalysisCase):
    """ConnectionAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_7202.AdvancedSystemDeflection':
    ...
    @property
    def data_logger(self) -> '_1542.DataLogger':
        ...
        if _1542.DataLogger.TYPE not in temp.__class__.__mro__:
