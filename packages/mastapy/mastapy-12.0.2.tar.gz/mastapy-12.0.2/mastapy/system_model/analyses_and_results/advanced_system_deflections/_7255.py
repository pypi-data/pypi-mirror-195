...
class ExternalCADModelAdvancedSystemDeflection(_7226.ComponentAdvancedSystemDeflection):
    """ExternalCADModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2702.ExternalCADModelSystemDeflection]':
