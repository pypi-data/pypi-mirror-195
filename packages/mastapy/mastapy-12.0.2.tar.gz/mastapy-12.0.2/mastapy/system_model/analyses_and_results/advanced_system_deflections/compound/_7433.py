...
class SpiralBevelGearCompoundAdvancedSystemDeflection(_7350.BevelGearCompoundAdvancedSystemDeflection):
    """SpiralBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7303.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7303.SpiralBevelGearAdvancedSystemDeflection]':
