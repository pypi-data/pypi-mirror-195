...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7250, _7252, _7261
...
class CylindricalGearAdvancedSystemDeflection(_7261.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6791.CylindricalGearLoadCase':
        ...
        if _6791.CylindricalGearLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7250.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7252.CylindricalMeshedGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7252.CylindricalMeshedGearAdvancedSystemDeflection]':
