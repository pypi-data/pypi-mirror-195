...
class SpiralBevelGearMeshAdvancedSystemDeflection(_7218.BevelGearMeshAdvancedSystemDeflection):
    """SpiralBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2757.SpiralBevelGearMeshSystemDeflection]':
