...
class TorqueConverterConnectionCompoundAdvancedSystemDeflection(_7372.CouplingConnectionCompoundAdvancedSystemDeflection):
    """TorqueConverterConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7322.TorqueConverterConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7322.TorqueConverterConnectionAdvancedSystemDeflection]':
