...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7439, _7440, _7352
...
class StraightBevelDiffGearSetCompoundAdvancedSystemDeflection(_7352.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7311.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_system_deflection(self) -> 'List[_7439.StraightBevelDiffGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_advanced_system_deflection(self) -> 'List[_7440.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7311.StraightBevelDiffGearSetAdvancedSystemDeflection]':
