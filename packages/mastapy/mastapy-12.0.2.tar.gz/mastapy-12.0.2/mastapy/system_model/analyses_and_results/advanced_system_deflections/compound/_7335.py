...
class AbstractShaftCompoundAdvancedSystemDeflection(_7336.AbstractShaftOrHousingCompoundAdvancedSystemDeflection):
    """AbstractShaftCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7199.AbstractShaftAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7199.AbstractShaftAdvancedSystemDeflection]':
