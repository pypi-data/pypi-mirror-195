...
class PlanetCarrierAdvancedSystemDeflection(_7281.MountableComponentAdvancedSystemDeflection):
    """PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2740.PlanetCarrierSystemDeflection]':
