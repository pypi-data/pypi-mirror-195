...
class SynchroniserHalfAdvancedSystemDeflection(_7319.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2771.SynchroniserHalfSystemDeflection]':
