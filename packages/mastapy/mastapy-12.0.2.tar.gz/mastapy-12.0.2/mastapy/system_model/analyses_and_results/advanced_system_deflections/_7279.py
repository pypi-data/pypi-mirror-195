...
class MassDiscAdvancedSystemDeflection(_7327.VirtualComponentAdvancedSystemDeflection):
    """MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2729.MassDiscSystemDeflection]':
