...
class WormGearCompoundAdvancedSystemDeflection(_7392.GearCompoundAdvancedSystemDeflection):
    """WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7328.WormGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7328.WormGearAdvancedSystemDeflection]':
