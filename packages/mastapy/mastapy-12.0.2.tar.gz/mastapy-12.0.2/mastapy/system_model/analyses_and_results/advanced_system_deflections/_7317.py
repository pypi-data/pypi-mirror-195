...
class SynchroniserAdvancedSystemDeflection(_7302.SpecialisedAssemblyAdvancedSystemDeflection):
    """SynchroniserAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2774.SynchroniserSystemDeflection]':
