...
class PlanetaryConnectionCompoundAdvancedSystemDeflection(_7431.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """PlanetaryConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7287.PlanetaryConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7287.PlanetaryConnectionAdvancedSystemDeflection]':
