...
class SpecialisedAssemblyCompoundAdvancedSystemDeflection(_7334.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """SpecialisedAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7302.SpecialisedAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7302.SpecialisedAssemblyAdvancedSystemDeflection]':
