...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7363, _7364, _7394
...
class ConceptGearSetCompoundAdvancedSystemDeflection(_7394.GearSetCompoundAdvancedSystemDeflection):
    """ConceptGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7232.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def concept_gears_compound_advanced_system_deflection(self) -> 'List[_7363.ConceptGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_advanced_system_deflection(self) -> 'List[_7364.ConceptGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7232.ConceptGearSetAdvancedSystemDeflection]':
