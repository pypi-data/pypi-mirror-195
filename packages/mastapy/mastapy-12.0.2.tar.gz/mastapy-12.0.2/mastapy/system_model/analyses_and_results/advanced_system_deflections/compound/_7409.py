...
class MassDiscCompoundAdvancedSystemDeflection(_7456.VirtualComponentCompoundAdvancedSystemDeflection):
    """MassDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7279.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7279.MassDiscAdvancedSystemDeflection]':
