...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7249, _7238, _7262
...
class CylindricalGearMeshAdvancedSystemDeflection(_7262.GearMeshAdvancedSystemDeflection):
    """CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_1478.FourierSeries':
    ...
    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_7249.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2690.CylindricalGearMeshSystemDeflectionTimestep]':
    ...
    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_7238.ContactChartPerToothPass]':
