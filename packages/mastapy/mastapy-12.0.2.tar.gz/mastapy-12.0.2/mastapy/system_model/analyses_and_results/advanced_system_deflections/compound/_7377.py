...
class CycloidalAssemblyCompoundAdvancedSystemDeflection(_7432.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """CycloidalAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7245.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7245.CycloidalAssemblyAdvancedSystemDeflection]':
