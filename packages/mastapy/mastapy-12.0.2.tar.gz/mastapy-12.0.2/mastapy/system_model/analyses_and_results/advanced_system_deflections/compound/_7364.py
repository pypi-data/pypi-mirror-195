...
class ConceptGearMeshCompoundAdvancedSystemDeflection(_7393.GearMeshCompoundAdvancedSystemDeflection):
    """ConceptGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7231.ConceptGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7231.ConceptGearMeshAdvancedSystemDeflection]':
