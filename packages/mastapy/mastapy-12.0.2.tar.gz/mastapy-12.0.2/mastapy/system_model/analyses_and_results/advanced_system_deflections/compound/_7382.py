...
class CylindricalGearMeshCompoundAdvancedSystemDeflection(_7393.GearMeshCompoundAdvancedSystemDeflection):
    """CylindricalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7250.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7250.CylindricalGearMeshAdvancedSystemDeflection]':
