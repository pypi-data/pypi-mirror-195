...
class CoaxialConnectionAdvancedSystemDeflection(_7301.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """CoaxialConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2664.CoaxialConnectionSystemDeflection]':
