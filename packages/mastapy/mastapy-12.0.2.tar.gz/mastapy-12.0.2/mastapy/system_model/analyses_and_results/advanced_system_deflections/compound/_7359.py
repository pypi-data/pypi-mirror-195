...
class ComponentCompoundAdvancedSystemDeflection(_7413.PartCompoundAdvancedSystemDeflection):
    """ComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7226.ComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7226.ComponentAdvancedSystemDeflection]':
