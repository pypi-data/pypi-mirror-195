...
class ConceptGearMeshAdvancedSystemDeflection(_7262.GearMeshAdvancedSystemDeflection):
    """ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2670.ConceptGearMeshSystemDeflection]':
