...
class StraightBevelGearMeshAdvancedSystemDeflection(_7218.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2766.StraightBevelGearMeshSystemDeflection]':
