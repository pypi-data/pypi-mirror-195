...
class PointLoadAdvancedSystemDeflection(_7327.VirtualComponentAdvancedSystemDeflection):
    """PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2741.PointLoadSystemDeflection]':
