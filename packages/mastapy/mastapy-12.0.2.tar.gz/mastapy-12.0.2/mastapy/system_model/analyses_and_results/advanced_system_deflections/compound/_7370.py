...
class ConnectorCompoundAdvancedSystemDeflection(_7411.MountableComponentCompoundAdvancedSystemDeflection):
    """ConnectorCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7237.ConnectorAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7237.ConnectorAdvancedSystemDeflection]':
