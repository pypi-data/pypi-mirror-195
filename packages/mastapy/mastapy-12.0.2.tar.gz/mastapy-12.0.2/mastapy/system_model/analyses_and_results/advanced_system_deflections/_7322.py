...
class TorqueConverterConnectionAdvancedSystemDeflection(_7240.CouplingConnectionAdvancedSystemDeflection):
    """TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2778.TorqueConverterConnectionSystemDeflection]':
