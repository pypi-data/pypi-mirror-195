...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7303, _7304, _7219
...
class SpiralBevelGearSetAdvancedSystemDeflection(_7219.BevelGearSetAdvancedSystemDeflection):
    """SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_7303.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_7304.SpiralBevelGearMeshAdvancedSystemDeflection]':
