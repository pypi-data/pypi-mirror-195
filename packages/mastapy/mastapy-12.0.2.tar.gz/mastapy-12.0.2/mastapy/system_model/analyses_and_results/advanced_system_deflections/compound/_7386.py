...
class ExternalCADModelCompoundAdvancedSystemDeflection(_7359.ComponentCompoundAdvancedSystemDeflection):
    """ExternalCADModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7255.ExternalCADModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7255.ExternalCADModelAdvancedSystemDeflection]':
