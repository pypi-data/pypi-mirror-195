...
class ShaftHubConnectionAdvancedSystemDeflection(_7237.ConnectorAdvancedSystemDeflection):
    """ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2751.ShaftHubConnectionSystemDeflection]':
