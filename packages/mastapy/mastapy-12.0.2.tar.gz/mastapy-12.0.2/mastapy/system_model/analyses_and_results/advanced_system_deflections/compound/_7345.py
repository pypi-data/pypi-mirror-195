...
class BevelDifferentialGearCompoundAdvancedSystemDeflection(_7350.BevelGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7212.BevelDifferentialGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7212.BevelDifferentialGearAdvancedSystemDeflection]':
