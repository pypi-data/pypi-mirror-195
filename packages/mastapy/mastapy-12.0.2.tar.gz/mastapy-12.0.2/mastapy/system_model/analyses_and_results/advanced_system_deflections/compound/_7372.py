...
class CouplingConnectionCompoundAdvancedSystemDeflection(_7399.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7240.CouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7240.CouplingConnectionAdvancedSystemDeflection]':
