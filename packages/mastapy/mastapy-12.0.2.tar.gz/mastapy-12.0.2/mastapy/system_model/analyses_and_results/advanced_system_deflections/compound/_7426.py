...
class RollingRingCompoundAdvancedSystemDeflection(_7373.CouplingHalfCompoundAdvancedSystemDeflection):
    """RollingRingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7295.RollingRingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7295.RollingRingAdvancedSystemDeflection]':
