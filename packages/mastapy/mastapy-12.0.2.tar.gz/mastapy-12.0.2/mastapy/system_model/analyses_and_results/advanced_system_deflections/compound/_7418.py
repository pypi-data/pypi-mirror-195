...
class PlanetaryGearSetCompoundAdvancedSystemDeflection(_7383.CylindricalGearSetCompoundAdvancedSystemDeflection):
    """PlanetaryGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7288.PlanetaryGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7288.PlanetaryGearSetAdvancedSystemDeflection]':
