...
class SpringDamperConnectionCompoundAdvancedSystemDeflection(_7372.CouplingConnectionCompoundAdvancedSystemDeflection):
    """SpringDamperConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7307.SpringDamperConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7307.SpringDamperConnectionAdvancedSystemDeflection]':
