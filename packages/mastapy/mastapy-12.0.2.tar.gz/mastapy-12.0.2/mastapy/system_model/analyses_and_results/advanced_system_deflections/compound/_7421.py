...
class PowerLoadCompoundAdvancedSystemDeflection(_7456.VirtualComponentCompoundAdvancedSystemDeflection):
    """PowerLoadCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7291.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7291.PowerLoadAdvancedSystemDeflection]':
