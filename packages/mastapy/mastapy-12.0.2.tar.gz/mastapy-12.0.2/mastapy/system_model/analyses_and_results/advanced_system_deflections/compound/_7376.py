...
class CVTPulleyCompoundAdvancedSystemDeflection(_7422.PulleyCompoundAdvancedSystemDeflection):
    """CVTPulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7244.CVTPulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7244.CVTPulleyAdvancedSystemDeflection]':
