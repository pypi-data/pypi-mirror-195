...
class ConceptGearAdvancedSystemDeflection(_7261.GearAdvancedSystemDeflection):
    """ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2672.ConceptGearSystemDeflection]':
