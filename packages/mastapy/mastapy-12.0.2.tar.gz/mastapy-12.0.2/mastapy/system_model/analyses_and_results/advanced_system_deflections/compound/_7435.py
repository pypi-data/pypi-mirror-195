...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7433, _7434, _7352
...
class SpiralBevelGearSetCompoundAdvancedSystemDeflection(_7352.BevelGearSetCompoundAdvancedSystemDeflection):
    """SpiralBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7305.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7433.SpiralBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7434.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7305.SpiralBevelGearSetAdvancedSystemDeflection]':
