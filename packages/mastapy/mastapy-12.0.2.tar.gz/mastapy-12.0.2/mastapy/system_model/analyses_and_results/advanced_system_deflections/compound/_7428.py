...
class RootAssemblyCompoundAdvancedSystemDeflection(_7341.AssemblyCompoundAdvancedSystemDeflection):
    """RootAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7298.RootAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7298.RootAssemblyAdvancedSystemDeflection]':
