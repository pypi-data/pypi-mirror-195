...
class TorqueConverterTurbineCompoundAdvancedSystemDeflection(_7373.CouplingHalfCompoundAdvancedSystemDeflection):
    """TorqueConverterTurbineCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7324.TorqueConverterTurbineAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7324.TorqueConverterTurbineAdvancedSystemDeflection]':
