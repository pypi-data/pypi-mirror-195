...
class CVTBeltConnectionCompoundAdvancedSystemDeflection(_7343.BeltConnectionCompoundAdvancedSystemDeflection):
    """CVTBeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7243.CVTBeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7243.CVTBeltConnectionAdvancedSystemDeflection]':
