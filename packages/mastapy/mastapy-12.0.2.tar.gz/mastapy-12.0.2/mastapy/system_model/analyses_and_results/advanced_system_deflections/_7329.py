...
class WormGearMeshAdvancedSystemDeflection(_7262.GearMeshAdvancedSystemDeflection):
    """WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2786.WormGearMeshSystemDeflection]':
