...
class PlanetaryConnectionAdvancedSystemDeflection(_7301.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """PlanetaryConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2739.PlanetaryConnectionSystemDeflection]':
