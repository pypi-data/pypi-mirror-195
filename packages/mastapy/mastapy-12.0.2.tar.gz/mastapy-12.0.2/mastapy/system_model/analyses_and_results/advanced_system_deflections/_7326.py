...
class UnbalancedMassAdvancedSystemDeflection(_7327.VirtualComponentAdvancedSystemDeflection):
    """UnbalancedMassAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2784.UnbalancedMassSystemDeflection]':
