...
class AbstractAssemblyCompoundAdvancedSystemDeflection(_7413.PartCompoundAdvancedSystemDeflection):
    """AbstractAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7198.AbstractAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7198.AbstractAssemblyAdvancedSystemDeflection]':
