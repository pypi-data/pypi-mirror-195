...
class RollingRingAssemblyAdvancedSystemDeflection(_7302.SpecialisedAssemblyAdvancedSystemDeflection):
    """RollingRingAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2747.RollingRingAssemblySystemDeflection]':
