...
class ClutchCompoundAdvancedSystemDeflection(_7371.CouplingCompoundAdvancedSystemDeflection):
    """ClutchCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7222.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7222.ClutchAdvancedSystemDeflection]':
