...
class StraightBevelPlanetGearCompoundAdvancedSystemDeflection(_7439.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7315.StraightBevelPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7315.StraightBevelPlanetGearAdvancedSystemDeflection]':
