...
class CycloidalAssemblyAdvancedSystemDeflection(_7302.SpecialisedAssemblyAdvancedSystemDeflection):
    """CycloidalAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2685.CycloidalAssemblySystemDeflection]':
