...
class TorqueConverterCompoundAdvancedSystemDeflection(_7371.CouplingCompoundAdvancedSystemDeflection):
    """TorqueConverterCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7321.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7321.TorqueConverterAdvancedSystemDeflection]':
