...
class StraightBevelGearMeshCompoundAdvancedSystemDeflection(_7351.BevelGearMeshCompoundAdvancedSystemDeflection):
    """StraightBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7313.StraightBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7313.StraightBevelGearMeshAdvancedSystemDeflection]':
