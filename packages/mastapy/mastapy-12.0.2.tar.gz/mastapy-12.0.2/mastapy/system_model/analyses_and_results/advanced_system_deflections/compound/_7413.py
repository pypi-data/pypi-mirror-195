...
class PartCompoundAdvancedSystemDeflection(_7474.PartCompoundAnalysis):
    """PartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7283.PartAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7283.PartAdvancedSystemDeflection]':
