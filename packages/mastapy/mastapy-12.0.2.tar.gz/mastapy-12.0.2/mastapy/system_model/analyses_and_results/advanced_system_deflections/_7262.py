...
class GearMeshAdvancedSystemDeflection(_7268.InterMountableComponentConnectionAdvancedSystemDeflection):
    """GearMeshAdvancedSystemDeflection
    ...
    @property
    def misalignment_fourier_series_for_first_tooth_passing_period(self) -> '_1478.FourierSeries':
