...
class GuideDxfModelCompoundAdvancedSystemDeflection(_7359.ComponentCompoundAdvancedSystemDeflection):
    """GuideDxfModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7264.GuideDxfModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7264.GuideDxfModelAdvancedSystemDeflection]':
