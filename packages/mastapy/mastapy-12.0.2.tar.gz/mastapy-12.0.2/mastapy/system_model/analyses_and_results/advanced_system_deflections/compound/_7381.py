...
class CylindricalGearCompoundAdvancedSystemDeflection(_7392.GearCompoundAdvancedSystemDeflection):
    """CylindricalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7249.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7249.CylindricalGearAdvancedSystemDeflection]':
