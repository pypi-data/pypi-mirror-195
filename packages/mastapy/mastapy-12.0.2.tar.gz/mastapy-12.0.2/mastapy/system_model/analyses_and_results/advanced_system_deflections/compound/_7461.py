...
class ZerolBevelGearMeshCompoundAdvancedSystemDeflection(_7351.BevelGearMeshCompoundAdvancedSystemDeflection):
    """ZerolBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7332.ZerolBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7332.ZerolBevelGearMeshAdvancedSystemDeflection]':
