...
class ZerolBevelGearAdvancedSystemDeflection(_7217.BevelGearAdvancedSystemDeflection):
    """ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2791.ZerolBevelGearSystemDeflection]':
