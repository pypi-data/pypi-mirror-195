...
class ZerolBevelGearCompoundModalAnalysis(_4687.BevelGearCompoundModalAnalysis):
    """ZerolBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4657.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4657.ZerolBevelGearModalAnalysis]':
