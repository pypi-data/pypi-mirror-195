...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4724, _4725, _4731
...
class FaceGearSetCompoundModalAnalysis(_4731.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4576.FaceGearSetModalAnalysis]':
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_4724.FaceGearCompoundModalAnalysis]':
    ...
    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_4725.FaceGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4576.FaceGearSetModalAnalysis]':
