...
from mastapy.system_model.analyses_and_results.modal_analyses import _4548, _4547, _4582
...
class ConceptGearSetModalAnalysis(_4582.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4548.ConceptGearModalAnalysis]':
    ...
    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4547.ConceptGearMeshModalAnalysis]':
