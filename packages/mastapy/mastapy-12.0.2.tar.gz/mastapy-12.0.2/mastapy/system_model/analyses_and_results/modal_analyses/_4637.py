...
from mastapy.system_model.analyses_and_results.modal_analyses import _4636, _4635, _4536
...
class StraightBevelGearSetModalAnalysis(_4536.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4636.StraightBevelGearModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4635.StraightBevelGearMeshModalAnalysis]':
