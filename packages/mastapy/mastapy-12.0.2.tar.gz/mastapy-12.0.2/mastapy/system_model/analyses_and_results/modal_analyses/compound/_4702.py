...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4700, _4701, _4731
...
class ConceptGearSetCompoundModalAnalysis(_4731.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4549.ConceptGearSetModalAnalysis]':
    ...
    @property
    def concept_gears_compound_modal_analysis(self) -> 'List[_4700.ConceptGearCompoundModalAnalysis]':
    ...
    @property
    def concept_meshes_compound_modal_analysis(self) -> 'List[_4701.ConceptGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4549.ConceptGearSetModalAnalysis]':
