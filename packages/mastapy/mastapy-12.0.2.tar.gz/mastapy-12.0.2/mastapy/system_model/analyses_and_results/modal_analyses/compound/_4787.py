...
class SynchroniserSleeveCompoundModalAnalysis(_4786.SynchroniserPartCompoundModalAnalysis):
    """SynchroniserSleeveCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4643.SynchroniserSleeveModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4643.SynchroniserSleeveModalAnalysis]':
