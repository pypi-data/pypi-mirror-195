...
class StraightBevelPlanetGearCompoundModalAnalysis(_4776.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4638.StraightBevelPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4638.StraightBevelPlanetGearModalAnalysis]':
