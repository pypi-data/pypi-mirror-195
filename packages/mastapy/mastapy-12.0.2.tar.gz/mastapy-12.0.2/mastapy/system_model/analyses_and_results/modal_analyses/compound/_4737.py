...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis(_4703.ConicalGearCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4589.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4589.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
