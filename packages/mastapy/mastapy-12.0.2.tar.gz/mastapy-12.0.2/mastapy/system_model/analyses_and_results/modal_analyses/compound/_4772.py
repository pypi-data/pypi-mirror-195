...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4770, _4771, _4689
...
class SpiralBevelGearSetCompoundModalAnalysis(_4689.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4628.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_4770.SpiralBevelGearCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_4771.SpiralBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4628.SpiralBevelGearSetModalAnalysis]':
