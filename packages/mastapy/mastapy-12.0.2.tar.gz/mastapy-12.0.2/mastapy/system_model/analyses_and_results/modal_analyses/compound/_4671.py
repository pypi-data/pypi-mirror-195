...
class AbstractAssemblyCompoundModalAnalysis(_4750.PartCompoundModalAnalysis):
    """AbstractAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4518.AbstractAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4518.AbstractAssemblyModalAnalysis]':
