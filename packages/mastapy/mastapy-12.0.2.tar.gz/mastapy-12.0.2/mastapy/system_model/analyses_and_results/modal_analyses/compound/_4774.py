...
class SpringDamperConnectionCompoundModalAnalysis(_4709.CouplingConnectionCompoundModalAnalysis):
    """SpringDamperConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4629.SpringDamperConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4629.SpringDamperConnectionModalAnalysis]':
