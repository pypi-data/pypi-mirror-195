...
class PartToPartShearCouplingConnectionCompoundModalAnalysis(_4709.CouplingConnectionCompoundModalAnalysis):
    """PartToPartShearCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4606.PartToPartShearCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4606.PartToPartShearCouplingConnectionModalAnalysis]':
