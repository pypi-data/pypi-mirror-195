...
class AbstractShaftCompoundModalAnalysis(_4673.AbstractShaftOrHousingCompoundModalAnalysis):
    """AbstractShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4519.AbstractShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4519.AbstractShaftModalAnalysis]':
