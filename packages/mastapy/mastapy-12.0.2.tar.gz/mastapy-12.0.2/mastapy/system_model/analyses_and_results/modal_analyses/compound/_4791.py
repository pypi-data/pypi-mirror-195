...
class TorqueConverterTurbineCompoundModalAnalysis(_4710.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4647.TorqueConverterTurbineModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4647.TorqueConverterTurbineModalAnalysis]':
