...
class ConceptCouplingCompoundModalAnalysis(_4708.CouplingCompoundModalAnalysis):
    """ConceptCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4546.ConceptCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4546.ConceptCouplingModalAnalysis]':
