...
class BevelDifferentialSunGearCompoundModalAnalysis(_4682.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4533.BevelDifferentialSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4533.BevelDifferentialSunGearModalAnalysis]':
