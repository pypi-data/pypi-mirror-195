...
class FaceGearMeshCompoundModalAnalysis(_4730.GearMeshCompoundModalAnalysis):
    """FaceGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4574.FaceGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4574.FaceGearMeshModalAnalysis]':
