...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4776, _4777, _4689
...
class StraightBevelDiffGearSetCompoundModalAnalysis(_4689.BevelGearSetCompoundModalAnalysis):
    """StraightBevelDiffGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4634.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis(self) -> 'List[_4776.StraightBevelDiffGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis(self) -> 'List[_4777.StraightBevelDiffGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4634.StraightBevelDiffGearSetModalAnalysis]':
