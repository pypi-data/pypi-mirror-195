...
class ConnectionCompoundModalAnalysis(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4553.ConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4553.ConnectionModalAnalysis]':
