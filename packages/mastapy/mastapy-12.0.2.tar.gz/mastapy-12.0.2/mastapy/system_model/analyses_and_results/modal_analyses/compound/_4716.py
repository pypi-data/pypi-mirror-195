...
class CycloidalDiscCompoundModalAnalysis(_4672.AbstractShaftCompoundModalAnalysis):
    """CycloidalDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4564.CycloidalDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4564.CycloidalDiscModalAnalysis]':
