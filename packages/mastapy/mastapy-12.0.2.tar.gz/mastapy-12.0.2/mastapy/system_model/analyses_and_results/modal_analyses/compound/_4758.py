...
class PowerLoadCompoundModalAnalysis(_4793.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4613.PowerLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4613.PowerLoadModalAnalysis]':
