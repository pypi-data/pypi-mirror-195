...
class RootAssemblyCompoundModalAnalysis(_4678.AssemblyCompoundModalAnalysis):
    """RootAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4620.RootAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4620.RootAssemblyModalAnalysis]':
