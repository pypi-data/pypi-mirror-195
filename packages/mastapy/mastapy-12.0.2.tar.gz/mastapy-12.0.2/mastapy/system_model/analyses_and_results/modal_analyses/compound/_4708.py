...
class CouplingCompoundModalAnalysis(_4769.SpecialisedAssemblyCompoundModalAnalysis):
    """CouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4558.CouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4558.CouplingModalAnalysis]':
