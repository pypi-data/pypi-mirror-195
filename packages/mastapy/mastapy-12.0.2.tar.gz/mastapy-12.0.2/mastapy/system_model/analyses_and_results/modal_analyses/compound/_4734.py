...
class HypoidGearMeshCompoundModalAnalysis(_4676.AGMAGleasonConicalGearMeshCompoundModalAnalysis):
    """HypoidGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4584.HypoidGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4584.HypoidGearMeshModalAnalysis]':
