...
class BevelDifferentialGearCompoundModalAnalysis(_4687.BevelGearCompoundModalAnalysis):
    """BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4530.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4530.BevelDifferentialGearModalAnalysis]':
