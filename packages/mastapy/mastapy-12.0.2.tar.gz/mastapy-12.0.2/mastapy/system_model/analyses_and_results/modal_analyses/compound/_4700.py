...
class ConceptGearCompoundModalAnalysis(_4729.GearCompoundModalAnalysis):
    """ConceptGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4548.ConceptGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4548.ConceptGearModalAnalysis]':
