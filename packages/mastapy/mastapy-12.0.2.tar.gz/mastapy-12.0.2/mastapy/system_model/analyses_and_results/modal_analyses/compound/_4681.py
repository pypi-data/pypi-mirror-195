...
class BeltDriveCompoundModalAnalysis(_4769.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4528.BeltDriveModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4528.BeltDriveModalAnalysis]':
