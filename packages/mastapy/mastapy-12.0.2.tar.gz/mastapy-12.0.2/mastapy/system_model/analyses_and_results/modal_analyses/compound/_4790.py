...
class TorqueConverterPumpCompoundModalAnalysis(_4710.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4646.TorqueConverterPumpModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4646.TorqueConverterPumpModalAnalysis]':
