...
from mastapy.system_model.analyses_and_results.modal_analyses import _4575, _4574, _4582
...
class FaceGearSetModalAnalysis(_4582.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4575.FaceGearModalAnalysis]':
    ...
    @property
    def face_meshes_modal_analysis(self) -> 'List[_4574.FaceGearMeshModalAnalysis]':
