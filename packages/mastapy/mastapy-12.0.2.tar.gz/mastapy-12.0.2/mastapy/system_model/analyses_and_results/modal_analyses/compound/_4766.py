...
class ShaftCompoundModalAnalysis(_4672.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4622.ShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4622.ShaftModalAnalysis]':
