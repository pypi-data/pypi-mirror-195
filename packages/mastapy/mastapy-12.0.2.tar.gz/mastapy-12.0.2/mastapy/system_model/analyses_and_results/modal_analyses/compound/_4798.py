...
class ZerolBevelGearMeshCompoundModalAnalysis(_4688.BevelGearMeshCompoundModalAnalysis):
    """ZerolBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4656.ZerolBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4656.ZerolBevelGearMeshModalAnalysis]':
