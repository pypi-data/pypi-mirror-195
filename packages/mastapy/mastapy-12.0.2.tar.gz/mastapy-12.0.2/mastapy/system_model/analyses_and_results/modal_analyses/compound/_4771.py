...
class SpiralBevelGearMeshCompoundModalAnalysis(_4688.BevelGearMeshCompoundModalAnalysis):
    """SpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4626.SpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4626.SpiralBevelGearMeshModalAnalysis]':
