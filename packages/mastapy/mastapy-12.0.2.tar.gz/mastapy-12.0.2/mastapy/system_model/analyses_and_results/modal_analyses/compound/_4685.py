...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4682.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4532.BevelDifferentialPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4532.BevelDifferentialPlanetGearModalAnalysis]':
