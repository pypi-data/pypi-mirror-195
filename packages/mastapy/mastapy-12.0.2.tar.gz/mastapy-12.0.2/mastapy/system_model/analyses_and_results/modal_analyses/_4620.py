...
from mastapy.system_model.analyses_and_results.modal_analyses import _2590, _4525
...
class RootAssemblyModalAnalysis(_4525.AssemblyModalAnalysis):
    """RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2590.ModalAnalysis':
