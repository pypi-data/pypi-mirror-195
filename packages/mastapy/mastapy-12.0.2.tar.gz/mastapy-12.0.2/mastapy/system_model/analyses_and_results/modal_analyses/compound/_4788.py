...
class TorqueConverterCompoundModalAnalysis(_4708.CouplingCompoundModalAnalysis):
    """TorqueConverterCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4645.TorqueConverterModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4645.TorqueConverterModalAnalysis]':
