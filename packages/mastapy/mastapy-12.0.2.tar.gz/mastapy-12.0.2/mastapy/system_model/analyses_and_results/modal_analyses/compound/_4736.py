...
class InterMountableComponentConnectionCompoundModalAnalysis(_4706.ConnectionCompoundModalAnalysis):
    """InterMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4587.InterMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4587.InterMountableComponentConnectionModalAnalysis]':
