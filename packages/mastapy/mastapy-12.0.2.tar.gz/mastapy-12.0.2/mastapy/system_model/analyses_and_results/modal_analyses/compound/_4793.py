...
class VirtualComponentCompoundModalAnalysis(_4748.MountableComponentCompoundModalAnalysis):
    """VirtualComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4649.VirtualComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4649.VirtualComponentModalAnalysis]':
