...
from mastapy.system_model.analyses_and_results.system_deflections import _2647, _2750
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4526, _4528, _4531, _4537,
    _4538, _4560, _4541, _4546,
    _4549, _4562, _4564, _4568,
    _4577, _4576, _4578, _4586,
    _4593, _4596, _4597, _4598,
    _4603, _4608, _4611, _4612,
    _4613, _4615, _4617, _4621,
    _4622, _4628, _4631, _4634,
    _4637, _4641, _4645, _4648,
    _4655, _4658, _4518
)
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4659
...
class AssemblyModalAnalysis(_4518.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2647.AssemblySystemDeflection':
    ...
    @property
    def bearings(self) -> 'List[_4526.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4528.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4531.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4537.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4538.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4560.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4659.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4541.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4546.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4549.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4562.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4564.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4568.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4577.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4576.FaceGearSetModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4578.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4577.FEPartModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4586.HypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4593.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4596.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4597.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4598.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4603.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4608.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4611.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4612.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4613.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4615.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4617.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4621.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4622.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4628.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4631.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4634.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4637.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4641.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4645.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4648.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4655.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4658.ZerolBevelGearSetModalAnalysis]':
