...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4669, _4667, _4670
...
class PartModalAnalysis(_7476.PartStaticLoadAnalysisCase):
    """PartModalAnalysis
    ...
    @property
    def gear_mesh_excitation_details(self) -> 'List[_4667.RigidlyConnectedDesignEntityGroupModalAnalysis]':
    ...
    @property
    def results_for_modes(self) -> 'List[_4670.SingleModeResults]':
    ...
    @property
    def shaft_excitation_details(self) -> 'List[_4667.RigidlyConnectedDesignEntityGroupModalAnalysis]':
    ...
    def create_viewable(self) -> '_2208.ModalAnalysisViewable':
