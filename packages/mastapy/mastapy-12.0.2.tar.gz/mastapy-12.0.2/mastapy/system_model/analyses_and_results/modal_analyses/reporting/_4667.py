...
from mastapy.utility.modal_analysis import _1763
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2607.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1763.DesignEntityExcitationDescription]':
