...
class StraightBevelDiffGearCompoundModalAnalysis(_4687.BevelGearCompoundModalAnalysis):
    """StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4633.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4633.StraightBevelDiffGearModalAnalysis]':
