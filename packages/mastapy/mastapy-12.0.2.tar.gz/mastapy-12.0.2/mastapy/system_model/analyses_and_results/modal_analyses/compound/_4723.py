...
class ExternalCADModelCompoundModalAnalysis(_4696.ComponentCompoundModalAnalysis):
    """ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4573.ExternalCADModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4573.ExternalCADModelModalAnalysis]':
