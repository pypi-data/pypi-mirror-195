...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4740, _4741, _4739
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(_4739.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4593.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis(self) -> 'List[_4740.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis(self) -> 'List[_4741.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4593.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
