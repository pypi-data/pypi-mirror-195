...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysis(_4706.ConnectionCompoundModalAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4521.AbstractShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4521.AbstractShaftToMountableComponentConnectionModalAnalysis]':
