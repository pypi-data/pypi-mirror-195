...
class PulleyCompoundModalAnalysis(_4710.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4614.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4614.PulleyModalAnalysis]':
