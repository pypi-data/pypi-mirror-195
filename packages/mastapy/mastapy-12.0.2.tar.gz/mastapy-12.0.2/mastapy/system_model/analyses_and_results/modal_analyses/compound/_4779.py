...
class StraightBevelGearCompoundModalAnalysis(_4687.BevelGearCompoundModalAnalysis):
    """StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4636.StraightBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4636.StraightBevelGearModalAnalysis]':
