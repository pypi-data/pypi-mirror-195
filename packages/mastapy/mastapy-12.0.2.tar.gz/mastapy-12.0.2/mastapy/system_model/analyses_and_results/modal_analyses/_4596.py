...
from mastapy.system_model.analyses_and_results.modal_analyses import _4595, _4594, _4590
...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis(_4590.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_modal_analysis(self) -> 'List[_4595.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_modal_analysis(self) -> 'List[_4594.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
