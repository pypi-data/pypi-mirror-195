...
class SynchroniserPartCompoundModalAnalysis(_4710.CouplingHalfCompoundModalAnalysis):
    """SynchroniserPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4642.SynchroniserPartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4642.SynchroniserPartModalAnalysis]':
