...
class ShaftHubConnectionCompoundModalAnalysis(_4707.ConnectorCompoundModalAnalysis):
    """ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4621.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4621.ShaftHubConnectionModalAnalysis]':
