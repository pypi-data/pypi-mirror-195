...
class CVTBeltConnectionCompoundModalAnalysis(_4680.BeltConnectionCompoundModalAnalysis):
    """CVTBeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4559.CVTBeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4559.CVTBeltConnectionModalAnalysis]':
