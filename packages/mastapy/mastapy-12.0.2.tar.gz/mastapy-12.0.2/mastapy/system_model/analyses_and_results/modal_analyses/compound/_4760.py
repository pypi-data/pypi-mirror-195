...
class RingPinsCompoundModalAnalysis(_4748.MountableComponentCompoundModalAnalysis):
    """RingPinsCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4615.RingPinsModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4615.RingPinsModalAnalysis]':
