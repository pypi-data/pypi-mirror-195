...
class CylindricalGearMeshCompoundModalAnalysis(_4730.GearMeshCompoundModalAnalysis):
    """CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4566.CylindricalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4566.CylindricalGearMeshModalAnalysis]':
