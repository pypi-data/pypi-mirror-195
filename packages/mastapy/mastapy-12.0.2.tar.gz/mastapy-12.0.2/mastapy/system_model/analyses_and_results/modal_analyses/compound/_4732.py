...
class GuideDxfModelCompoundModalAnalysis(_4696.ComponentCompoundModalAnalysis):
    """GuideDxfModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4583.GuideDxfModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4583.GuideDxfModelModalAnalysis]':
