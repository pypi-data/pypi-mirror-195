...
class GearCompoundModalAnalysis(_4748.MountableComponentCompoundModalAnalysis):
    """GearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4581.GearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4581.GearModalAnalysis]':
