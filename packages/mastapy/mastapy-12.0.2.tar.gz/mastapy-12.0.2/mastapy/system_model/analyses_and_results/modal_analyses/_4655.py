...
from mastapy.system_model.analyses_and_results.modal_analyses import _4654, _4653, _4582
...
class WormGearSetModalAnalysis(_4582.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4654.WormGearModalAnalysis]':
    ...
    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4653.WormGearMeshModalAnalysis]':
