...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def chart_type(self) -> '_4571.DynamicsResponse3DChartType':
        ...
        return constructor.new_from_mastapy_type(_4571.DynamicsResponse3DChartType)(value) if value is not None else None

    @chart_type.setter
    def chart_type(self, value: '_4571.DynamicsResponse3DChartType'):
    ...
    @property
    def connected_component_type(self) -> '_5777.ConnectedComponentType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5777.ConnectedComponentType)(value) if value is not None else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5777.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def coordinate_system(self) -> '_4555.CoordinateSystemForWhine':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4555.CoordinateSystemForWhine)(value) if value is not None else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4555.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def translation_or_rotation(self) -> '_1499.TranslationRotation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1499.TranslationRotation)(value) if value is not None else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1499.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def vector_magnitude_method(self) -> '_1485.ComplexMagnitudeMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1485.ComplexMagnitudeMethod)(value) if value is not None else None

    @vector_magnitude_method.setter
    def vector_magnitude_method(self, value: '_1485.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.VectorMagnitudeMethod = value

    @property
    def whine_waterfall_export_option(self) -> '_4651.WhineWaterfallExportOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4651.WhineWaterfallExportOption)(value) if value is not None else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4651.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.WhineWaterfallExportOption = value

    @property
    def data_scaling(self) -> '_1536.DataScalingOptions':
    ...
    @property
    def frequency_options(self) -> '_5690.FrequencyOptionsForHarmonicAnalysisResults':
    ...
    @property
    def modal_contribution_view_options(self) -> '_2221.ModalContributionViewOptions':
    ...
    @property
    def mode_view_options(self) -> '_2219.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
    ...
    @property
    def order_cuts_chart_settings(self) -> '_4604.OrderCutsChartSettings':
    ...
    @property
    def reference_speed_options(self) -> '_5745.SpeedOptionsForHarmonicAnalysisResults':
    ...
    @property
    def result_location_selection_groups(self) -> '_5785.ResultLocationSelectionGroups':
    ...
    @property
    def selected_excitations(self) -> '_5780.ExcitationSourceSelectionGroup':
    ...
    @property
    def waterfall_chart_settings(self) -> '_4650.WaterfallChartSettings':
    ...
    @property
    def active_result_locations(self) -> 'List[_5786.ResultNodeSelection]':
    ...
    @property
    def degrees_of_freedom(self) -> 'List[_1807.EnumWithBool[_1492.ResultOptionsFor3DVector]]':
