...
class CouplingHalfCompoundModalAnalysis(_4748.MountableComponentCompoundModalAnalysis):
    """CouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4557.CouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4557.CouplingHalfModalAnalysis]':
