...
class RollingRingCompoundModalAnalysis(_4710.CouplingHalfCompoundModalAnalysis):
    """RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4619.RollingRingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4619.RollingRingModalAnalysis]':
