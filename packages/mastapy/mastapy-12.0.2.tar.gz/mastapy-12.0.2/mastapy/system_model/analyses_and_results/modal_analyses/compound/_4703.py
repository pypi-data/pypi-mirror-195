...
class ConicalGearCompoundModalAnalysis(_4729.GearCompoundModalAnalysis):
    """ConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4551.ConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4551.ConicalGearModalAnalysis]':
