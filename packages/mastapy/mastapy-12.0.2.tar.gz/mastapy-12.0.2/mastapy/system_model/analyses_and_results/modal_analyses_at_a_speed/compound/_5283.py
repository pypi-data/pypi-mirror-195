...
class ShaftCompoundModalAnalysisAtASpeed(_5189.AbstractShaftCompoundModalAnalysisAtASpeed):
    """ShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5155.ShaftModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5155.ShaftModalAnalysisAtASpeed]':
