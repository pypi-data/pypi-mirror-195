...
class ConceptGearMeshCompoundModalAnalysisAtASpeed(_5247.GearMeshCompoundModalAnalysisAtASpeed):
    """ConceptGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5088.ConceptGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5088.ConceptGearMeshModalAnalysisAtASpeed]':
