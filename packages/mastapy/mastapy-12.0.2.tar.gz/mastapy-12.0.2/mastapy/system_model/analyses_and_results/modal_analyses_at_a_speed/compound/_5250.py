...
class HypoidGearCompoundModalAnalysisAtASpeed(_5192.AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed):
    """HypoidGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5122.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5122.HypoidGearModalAnalysisAtASpeed]':
