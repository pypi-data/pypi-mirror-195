...
class RingPinsCompoundModalAnalysisAtASpeed(_5265.MountableComponentCompoundModalAnalysisAtASpeed):
    """RingPinsCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5148.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5148.RingPinsModalAnalysisAtASpeed]':
