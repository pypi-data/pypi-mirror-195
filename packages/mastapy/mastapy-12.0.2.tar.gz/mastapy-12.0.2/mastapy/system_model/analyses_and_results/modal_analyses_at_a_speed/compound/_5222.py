...
class ConicalGearSetCompoundModalAnalysisAtASpeed(_5248.GearSetCompoundModalAnalysisAtASpeed):
    """ConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5093.ConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5093.ConicalGearSetModalAnalysisAtASpeed]':
