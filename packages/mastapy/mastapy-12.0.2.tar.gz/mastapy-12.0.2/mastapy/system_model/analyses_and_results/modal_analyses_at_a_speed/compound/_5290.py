...
class SpringDamperCompoundModalAnalysisAtASpeed(_5225.CouplingCompoundModalAnalysisAtASpeed):
    """SpringDamperCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5163.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5163.SpringDamperModalAnalysisAtASpeed]':
