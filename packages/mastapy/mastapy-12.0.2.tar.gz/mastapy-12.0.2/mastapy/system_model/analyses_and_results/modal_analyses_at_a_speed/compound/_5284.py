...
class ShaftHubConnectionCompoundModalAnalysisAtASpeed(_5224.ConnectorCompoundModalAnalysisAtASpeed):
    """ShaftHubConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5154.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5154.ShaftHubConnectionModalAnalysisAtASpeed]':
