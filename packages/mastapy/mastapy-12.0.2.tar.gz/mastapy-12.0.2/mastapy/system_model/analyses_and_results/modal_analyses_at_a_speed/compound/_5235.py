...
class CylindricalGearCompoundModalAnalysisAtASpeed(_5246.GearCompoundModalAnalysisAtASpeed):
    """CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5107.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5107.CylindricalGearModalAnalysisAtASpeed]':
