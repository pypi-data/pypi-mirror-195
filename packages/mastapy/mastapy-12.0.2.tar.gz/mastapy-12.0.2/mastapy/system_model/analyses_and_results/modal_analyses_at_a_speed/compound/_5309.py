...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_5310.VirtualComponentCompoundModalAnalysisAtASpeed):
    """UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5180.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5180.UnbalancedMassModalAnalysisAtASpeed]':
