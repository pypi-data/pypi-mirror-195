...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5122, _5121, _5065
...
class HypoidGearSetModalAnalysisAtASpeed(_5065.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    """HypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_5122.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_5121.HypoidGearMeshModalAnalysisAtASpeed]':
