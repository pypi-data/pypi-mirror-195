...
class TorqueConverterConnectionCompoundModalAnalysisAtASpeed(_5226.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """TorqueConverterConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5176.TorqueConverterConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5176.TorqueConverterConnectionModalAnalysisAtASpeed]':
