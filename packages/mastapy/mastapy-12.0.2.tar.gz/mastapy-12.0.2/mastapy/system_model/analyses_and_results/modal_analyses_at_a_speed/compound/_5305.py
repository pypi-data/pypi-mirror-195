...
class TorqueConverterCompoundModalAnalysisAtASpeed(_5225.CouplingCompoundModalAnalysisAtASpeed):
    """TorqueConverterCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5177.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5177.TorqueConverterModalAnalysisAtASpeed]':
