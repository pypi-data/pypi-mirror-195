...
class BoltCompoundModalAnalysisAtASpeed(_5213.ComponentCompoundModalAnalysisAtASpeed):
    """BoltCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5079.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5079.BoltModalAnalysisAtASpeed]':
