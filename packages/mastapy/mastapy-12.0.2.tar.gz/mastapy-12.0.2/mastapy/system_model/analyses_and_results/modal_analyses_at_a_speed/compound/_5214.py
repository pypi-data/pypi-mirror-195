...
class ConceptCouplingCompoundModalAnalysisAtASpeed(_5225.CouplingCompoundModalAnalysisAtASpeed):
    """ConceptCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5087.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5087.ConceptCouplingModalAnalysisAtASpeed]':
