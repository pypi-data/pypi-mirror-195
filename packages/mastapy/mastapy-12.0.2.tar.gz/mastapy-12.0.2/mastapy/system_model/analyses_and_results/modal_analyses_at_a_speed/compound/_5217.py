...
class ConceptGearCompoundModalAnalysisAtASpeed(_5246.GearCompoundModalAnalysisAtASpeed):
    """ConceptGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5089.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5089.ConceptGearModalAnalysisAtASpeed]':
