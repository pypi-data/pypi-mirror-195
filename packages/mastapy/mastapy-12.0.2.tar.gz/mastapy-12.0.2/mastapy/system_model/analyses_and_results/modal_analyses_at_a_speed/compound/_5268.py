...
class PartToPartShearCouplingCompoundModalAnalysisAtASpeed(_5225.CouplingCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5141.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5141.PartToPartShearCouplingModalAnalysisAtASpeed]':
