...
class WormGearMeshCompoundModalAnalysisAtASpeed(_5247.GearMeshCompoundModalAnalysisAtASpeed):
    """WormGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5182.WormGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5182.WormGearMeshModalAnalysisAtASpeed]':
