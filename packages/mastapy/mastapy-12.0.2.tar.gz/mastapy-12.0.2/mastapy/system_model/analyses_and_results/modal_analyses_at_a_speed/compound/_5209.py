...
class ClutchCompoundModalAnalysisAtASpeed(_5225.CouplingCompoundModalAnalysisAtASpeed):
    """ClutchCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5082.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5082.ClutchModalAnalysisAtASpeed]':
