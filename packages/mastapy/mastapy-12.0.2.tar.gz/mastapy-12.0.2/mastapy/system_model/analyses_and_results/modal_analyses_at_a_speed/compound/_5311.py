...
class WormGearCompoundModalAnalysisAtASpeed(_5246.GearCompoundModalAnalysisAtASpeed):
    """WormGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5183.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5183.WormGearModalAnalysisAtASpeed]':
