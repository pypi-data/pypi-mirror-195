...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import (
    _5067, _5069, _5072, _5078,
    _5079, _5100, _5082, _5087,
    _5090, _5102, _5104, _5108,
    _5115, _5114, _5116, _5123,
    _5130, _5133, _5134, _5135,
    _5137, _5141, _5144, _5145,
    _5146, _5148, _5150, _5154,
    _5155, _5160, _5163, _5166,
    _5169, _5173, _5177, _5180,
    _5184, _5187, _5059
)
...
class AssemblyModalAnalysisAtASpeed(_5059.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self) -> 'List[_5067.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5069.BeltDriveModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5072.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5078.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5079.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5100.CVTModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5082.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5087.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5090.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5102.CycloidalAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5104.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5108.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5115.FEPartModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5114.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5116.FlexiblePinAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5123.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5130.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5133.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5134.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5135.MeasurementComponentModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5137.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5141.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5144.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5145.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5146.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5148.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5150.RollingRingAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5154.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5155.ShaftModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5160.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5163.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5166.StraightBevelDiffGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5169.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5173.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5177.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5180.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5184.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5187.ZerolBevelGearSetModalAnalysisAtASpeed]':
