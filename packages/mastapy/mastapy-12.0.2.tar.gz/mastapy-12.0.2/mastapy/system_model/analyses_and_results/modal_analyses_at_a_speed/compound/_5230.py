...
class CVTPulleyCompoundModalAnalysisAtASpeed(_5276.PulleyCompoundModalAnalysisAtASpeed):
    """CVTPulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5101.CVTPulleyModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5101.CVTPulleyModalAnalysisAtASpeed]':
