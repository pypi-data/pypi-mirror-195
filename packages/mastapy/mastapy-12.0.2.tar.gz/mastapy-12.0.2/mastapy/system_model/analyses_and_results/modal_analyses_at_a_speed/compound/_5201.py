...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5199, _5200, _5206
...
class BevelDifferentialGearSetCompoundModalAnalysisAtASpeed(_5206.BevelGearSetCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5072.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5199.BevelDifferentialGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5200.BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5072.BevelDifferentialGearSetModalAnalysisAtASpeed]':
