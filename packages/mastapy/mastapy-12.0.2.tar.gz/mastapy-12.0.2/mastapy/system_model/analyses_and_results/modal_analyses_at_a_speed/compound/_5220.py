...
class ConicalGearCompoundModalAnalysisAtASpeed(_5246.GearCompoundModalAnalysisAtASpeed):
    """ConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5092.ConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5092.ConicalGearModalAnalysisAtASpeed]':
