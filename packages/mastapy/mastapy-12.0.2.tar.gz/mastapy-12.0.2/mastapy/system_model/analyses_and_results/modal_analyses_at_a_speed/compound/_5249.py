...
class GuideDxfModelCompoundModalAnalysisAtASpeed(_5213.ComponentCompoundModalAnalysisAtASpeed):
    """GuideDxfModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5120.GuideDxfModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5120.GuideDxfModelModalAnalysisAtASpeed]':
