...
class SpringDamperHalfCompoundModalAnalysisAtASpeed(_5227.CouplingHalfCompoundModalAnalysisAtASpeed):
    """SpringDamperHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5162.SpringDamperHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5162.SpringDamperHalfModalAnalysisAtASpeed]':
