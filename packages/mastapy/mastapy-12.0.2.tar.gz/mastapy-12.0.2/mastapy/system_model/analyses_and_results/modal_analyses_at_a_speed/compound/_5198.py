...
class BeltDriveCompoundModalAnalysisAtASpeed(_5286.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """BeltDriveCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5069.BeltDriveModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5069.BeltDriveModalAnalysisAtASpeed]':
