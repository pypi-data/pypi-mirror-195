...
class RollingRingConnectionCompoundModalAnalysisAtASpeed(_5253.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """RollingRingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5151.RollingRingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5151.RollingRingConnectionModalAnalysisAtASpeed]':
