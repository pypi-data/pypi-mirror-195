...
class ComponentCompoundModalAnalysisAtASpeed(_5267.PartCompoundModalAnalysisAtASpeed):
    """ComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5084.ComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5084.ComponentModalAnalysisAtASpeed]':
