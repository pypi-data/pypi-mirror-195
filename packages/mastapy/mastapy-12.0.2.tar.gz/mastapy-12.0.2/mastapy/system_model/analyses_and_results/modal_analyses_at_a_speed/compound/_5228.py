...
class CVTBeltConnectionCompoundModalAnalysisAtASpeed(_5197.BeltConnectionCompoundModalAnalysisAtASpeed):
    """CVTBeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5099.CVTBeltConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5099.CVTBeltConnectionModalAnalysisAtASpeed]':
