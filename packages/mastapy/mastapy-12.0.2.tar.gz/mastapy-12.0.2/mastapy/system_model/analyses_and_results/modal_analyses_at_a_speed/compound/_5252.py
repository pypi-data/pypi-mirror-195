...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5250, _5251, _5194
...
class HypoidGearSetCompoundModalAnalysisAtASpeed(_5194.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    """HypoidGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5123.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5250.HypoidGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5251.HypoidGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5123.HypoidGearSetModalAnalysisAtASpeed]':
