...
class ConnectionCompoundModalAnalysisAtASpeed(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5094.ConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5094.ConnectionModalAnalysisAtASpeed]':
