...
class CouplingConnectionCompoundModalAnalysisAtASpeed(_5253.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5096.CouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5096.CouplingConnectionModalAnalysisAtASpeed]':
