...
class FlexiblePinAnalysisStopStartAnalysis(_6201.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self) -> '_2754.ShaftSystemDeflection':
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2754.ShaftSystemDeflection':
