...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6200
...
class WindTurbineCertificationReport(_6200.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2430.RootAssembly':
    ...
    @property
    def extreme_load_case_static_analysis(self) -> '_2750.RootAssemblySystemDeflection':
    ...
    @property
    def ldd_static_analysis(self) -> '_2896.RootAssemblyCompoundSystemDeflection':
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2750.RootAssemblySystemDeflection':
