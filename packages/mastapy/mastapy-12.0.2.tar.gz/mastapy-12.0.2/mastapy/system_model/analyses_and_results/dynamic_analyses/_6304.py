...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2581, _6216
...
class RootAssemblyDynamicAnalysis(_6216.AssemblyDynamicAnalysis):
    """RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2581.DynamicAnalysis':
