...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6315, _6316, _6227
...
class StraightBevelDiffGearSetDynamicAnalysis(_6227.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6315.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6316.StraightBevelDiffGearMeshDynamicAnalysis]':
