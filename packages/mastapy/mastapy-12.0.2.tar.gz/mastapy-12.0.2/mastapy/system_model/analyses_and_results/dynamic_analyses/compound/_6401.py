...
class HypoidGearCompoundDynamicAnalysis(_6343.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    """HypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6272.HypoidGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6272.HypoidGearDynamicAnalysis]':
