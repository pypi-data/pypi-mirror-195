...
from mastapy.system_model.analyses_and_results.dynamic_analyses import (
    _6217, _6219, _6222, _6229,
    _6228, _6250, _6231, _6236,
    _6240, _6252, _6254, _6258,
    _6266, _6265, _6267, _6274,
    _6281, _6284, _6285, _6286,
    _6288, _6291, _6295, _6296,
    _6297, _6299, _6301, _6306,
    _6305, _6311, _6313, _6317,
    _6320, _6323, _6328, _6331,
    _6335, _6338, _6209
)
...
class AssemblyDynamicAnalysis(_6209.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6217.BearingDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6219.BeltDriveDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6222.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6229.BoltedJointDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6228.BoltDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6250.CVTDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6231.ClutchDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6236.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6240.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6252.CycloidalAssemblyDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6254.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6258.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6266.FEPartDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6265.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6267.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6274.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6281.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6284.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6285.MassDiscDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6286.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6288.OilSealDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6291.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6295.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6296.PointLoadDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6297.PowerLoadDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6299.RingPinsDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6301.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6306.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6305.ShaftDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6311.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6313.SpringDamperDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6317.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6320.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6323.SynchroniserDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6328.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6331.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6335.WormGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6338.ZerolBevelGearSetDynamicAnalysis]':
