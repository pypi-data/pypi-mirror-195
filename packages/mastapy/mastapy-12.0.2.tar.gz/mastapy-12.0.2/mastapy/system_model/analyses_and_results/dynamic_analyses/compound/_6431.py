...
class RollingRingCompoundDynamicAnalysis(_6378.CouplingHalfCompoundDynamicAnalysis):
    """RollingRingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6303.RollingRingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6303.RollingRingDynamicAnalysis]':
