...
class SpringDamperCompoundDynamicAnalysis(_6376.CouplingCompoundDynamicAnalysis):
    """SpringDamperCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6313.SpringDamperDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6313.SpringDamperDynamicAnalysis]':
