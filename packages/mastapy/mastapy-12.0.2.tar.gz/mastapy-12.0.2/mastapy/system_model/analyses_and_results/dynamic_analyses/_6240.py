...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6238, _6239, _6270
...
class ConceptGearSetDynamicAnalysis(_6270.GearSetDynamicAnalysis):
    """ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_6238.ConceptGearDynamicAnalysis]':
    ...
    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_6239.ConceptGearMeshDynamicAnalysis]':
