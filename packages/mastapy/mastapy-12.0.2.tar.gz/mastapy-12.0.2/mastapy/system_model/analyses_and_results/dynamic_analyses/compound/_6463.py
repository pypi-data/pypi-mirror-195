...
class WormGearMeshCompoundDynamicAnalysis(_6398.GearMeshCompoundDynamicAnalysis):
    """WormGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6334.WormGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6334.WormGearMeshDynamicAnalysis]':
