...
class SpecialisedAssemblyCompoundDynamicAnalysis(_6339.AbstractAssemblyCompoundDynamicAnalysis):
    """SpecialisedAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6308.SpecialisedAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6308.SpecialisedAssemblyDynamicAnalysis]':
