...
class CVTBeltConnectionCompoundDynamicAnalysis(_6348.BeltConnectionCompoundDynamicAnalysis):
    """CVTBeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6249.CVTBeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6249.CVTBeltConnectionDynamicAnalysis]':
