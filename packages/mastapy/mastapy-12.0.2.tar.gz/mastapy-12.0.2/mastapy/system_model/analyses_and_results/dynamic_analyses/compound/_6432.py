...
class RollingRingConnectionCompoundDynamicAnalysis(_6404.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RollingRingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6302.RollingRingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6302.RollingRingConnectionDynamicAnalysis]':
