...
class ConnectorCompoundDynamicAnalysis(_6416.MountableComponentCompoundDynamicAnalysis):
    """ConnectorCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6245.ConnectorDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6245.ConnectorDynamicAnalysis]':
