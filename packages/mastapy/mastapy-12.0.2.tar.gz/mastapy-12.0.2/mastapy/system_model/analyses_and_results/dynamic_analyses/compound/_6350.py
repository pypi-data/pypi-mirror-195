...
class BevelDifferentialGearCompoundDynamicAnalysis(_6355.BevelGearCompoundDynamicAnalysis):
    """BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6220.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6220.BevelDifferentialGearDynamicAnalysis]':
