...
class BeltDriveCompoundDynamicAnalysis(_6437.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BeltDriveCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6219.BeltDriveDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6219.BeltDriveDynamicAnalysis]':
