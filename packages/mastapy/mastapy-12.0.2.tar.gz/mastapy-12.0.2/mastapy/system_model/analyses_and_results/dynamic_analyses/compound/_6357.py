...
class BevelGearSetCompoundDynamicAnalysis(_6345.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    """BevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6227.BevelGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6227.BevelGearSetDynamicAnalysis]':
