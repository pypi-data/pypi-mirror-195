...
class ComponentCompoundDynamicAnalysis(_6418.PartCompoundDynamicAnalysis):
    """ComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6234.ComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6234.ComponentDynamicAnalysis]':
