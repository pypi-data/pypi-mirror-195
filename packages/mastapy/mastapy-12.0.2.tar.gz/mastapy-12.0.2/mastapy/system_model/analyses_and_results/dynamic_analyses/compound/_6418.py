...
class PartCompoundDynamicAnalysis(_7474.PartCompoundAnalysis):
    """PartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6289.PartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6289.PartDynamicAnalysis]':
