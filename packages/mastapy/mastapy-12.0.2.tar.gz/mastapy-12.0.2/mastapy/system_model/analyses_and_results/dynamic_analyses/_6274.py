...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6272, _6273, _6215
...
class HypoidGearSetDynamicAnalysis(_6215.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    @property
    def hypoid_gears_dynamic_analysis(self) -> 'List[_6272.HypoidGearDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_dynamic_analysis(self) -> 'List[_6273.HypoidGearMeshDynamicAnalysis]':
