...
class StraightBevelSunGearCompoundDynamicAnalysis(_6444.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6322.StraightBevelSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6322.StraightBevelSunGearDynamicAnalysis]':
