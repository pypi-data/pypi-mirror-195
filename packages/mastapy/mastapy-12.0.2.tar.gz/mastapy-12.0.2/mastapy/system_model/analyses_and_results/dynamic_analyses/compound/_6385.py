...
class CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis(_6342.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6255.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6255.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
