...
class RingPinsCompoundDynamicAnalysis(_6416.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6299.RingPinsDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6299.RingPinsDynamicAnalysis]':
