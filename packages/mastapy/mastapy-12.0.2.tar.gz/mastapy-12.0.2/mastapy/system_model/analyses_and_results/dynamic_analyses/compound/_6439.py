...
class SpiralBevelGearMeshCompoundDynamicAnalysis(_6356.BevelGearMeshCompoundDynamicAnalysis):
    """SpiralBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6310.SpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6310.SpiralBevelGearMeshDynamicAnalysis]':
