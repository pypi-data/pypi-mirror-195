...
class FaceGearCompoundDynamicAnalysis(_6397.GearCompoundDynamicAnalysis):
    """FaceGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6263.FaceGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6263.FaceGearDynamicAnalysis]':
