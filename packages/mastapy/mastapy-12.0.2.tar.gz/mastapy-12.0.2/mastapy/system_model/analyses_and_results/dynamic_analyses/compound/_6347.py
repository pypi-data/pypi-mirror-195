...
class BearingCompoundDynamicAnalysis(_6375.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6217.BearingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6217.BearingDynamicAnalysis]':
