...
class SynchroniserPartCompoundDynamicAnalysis(_6378.CouplingHalfCompoundDynamicAnalysis):
    """SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6325.SynchroniserPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6325.SynchroniserPartDynamicAnalysis]':
