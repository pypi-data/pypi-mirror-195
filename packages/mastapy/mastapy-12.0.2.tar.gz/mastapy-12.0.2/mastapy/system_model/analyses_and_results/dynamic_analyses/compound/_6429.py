...
class RingPinsToDiscConnectionCompoundDynamicAnalysis(_6404.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RingPinsToDiscConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6300.RingPinsToDiscConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6300.RingPinsToDiscConnectionDynamicAnalysis]':
