...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6465, _6466, _6357
...
class ZerolBevelGearSetCompoundDynamicAnalysis(_6357.BevelGearSetCompoundDynamicAnalysis):
    """ZerolBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6338.ZerolBevelGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6465.ZerolBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6466.ZerolBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6338.ZerolBevelGearSetDynamicAnalysis]':
