...
class PulleyCompoundDynamicAnalysis(_6378.CouplingHalfCompoundDynamicAnalysis):
    """PulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6298.PulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6298.PulleyDynamicAnalysis]':
