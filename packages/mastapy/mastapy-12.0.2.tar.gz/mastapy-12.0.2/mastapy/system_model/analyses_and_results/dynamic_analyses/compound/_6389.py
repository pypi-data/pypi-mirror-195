...
class CylindricalPlanetGearCompoundDynamicAnalysis(_6386.CylindricalGearCompoundDynamicAnalysis):
    """CylindricalPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6259.CylindricalPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6259.CylindricalPlanetGearDynamicAnalysis]':
