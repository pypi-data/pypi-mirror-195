...
class BevelDifferentialSunGearCompoundDynamicAnalysis(_6350.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6224.BevelDifferentialSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6224.BevelDifferentialSunGearDynamicAnalysis]':
