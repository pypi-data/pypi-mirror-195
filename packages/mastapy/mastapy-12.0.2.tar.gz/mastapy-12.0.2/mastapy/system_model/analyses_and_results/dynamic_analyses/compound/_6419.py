...
class PartToPartShearCouplingCompoundDynamicAnalysis(_6376.CouplingCompoundDynamicAnalysis):
    """PartToPartShearCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6291.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6291.PartToPartShearCouplingDynamicAnalysis]':
