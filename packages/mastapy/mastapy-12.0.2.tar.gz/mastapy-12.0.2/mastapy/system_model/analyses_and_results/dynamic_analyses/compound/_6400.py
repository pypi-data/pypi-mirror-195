...
class GuideDxfModelCompoundDynamicAnalysis(_6364.ComponentCompoundDynamicAnalysis):
    """GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6271.GuideDxfModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6271.GuideDxfModelDynamicAnalysis]':
