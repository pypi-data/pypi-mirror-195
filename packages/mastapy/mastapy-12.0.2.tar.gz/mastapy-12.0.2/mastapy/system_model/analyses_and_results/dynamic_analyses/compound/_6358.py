...
class BoltCompoundDynamicAnalysis(_6364.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6228.BoltDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6228.BoltDynamicAnalysis]':
