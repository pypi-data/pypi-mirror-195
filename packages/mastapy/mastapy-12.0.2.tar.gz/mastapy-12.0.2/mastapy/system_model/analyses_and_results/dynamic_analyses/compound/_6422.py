...
class PlanetaryConnectionCompoundDynamicAnalysis(_6436.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """PlanetaryConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6293.PlanetaryConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6293.PlanetaryConnectionDynamicAnalysis]':
