...
class ConceptCouplingCompoundDynamicAnalysis(_6376.CouplingCompoundDynamicAnalysis):
    """ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6236.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6236.ConceptCouplingDynamicAnalysis]':
