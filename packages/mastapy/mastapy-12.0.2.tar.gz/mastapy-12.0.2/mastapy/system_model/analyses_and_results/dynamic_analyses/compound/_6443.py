...
class SpringDamperHalfCompoundDynamicAnalysis(_6378.CouplingHalfCompoundDynamicAnalysis):
    """SpringDamperHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6314.SpringDamperHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6314.SpringDamperHalfDynamicAnalysis]':
