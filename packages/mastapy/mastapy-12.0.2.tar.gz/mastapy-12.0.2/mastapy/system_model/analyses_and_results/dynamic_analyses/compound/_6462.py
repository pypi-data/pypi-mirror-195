...
class WormGearCompoundDynamicAnalysis(_6397.GearCompoundDynamicAnalysis):
    """WormGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6333.WormGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6333.WormGearDynamicAnalysis]':
