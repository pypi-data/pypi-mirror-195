...
class PartToPartShearCouplingConnectionCompoundDynamicAnalysis(_6377.CouplingConnectionCompoundDynamicAnalysis):
    """PartToPartShearCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6290.PartToPartShearCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6290.PartToPartShearCouplingConnectionDynamicAnalysis]':
