...
class ZerolBevelGearMeshCompoundDynamicAnalysis(_6356.BevelGearMeshCompoundDynamicAnalysis):
    """ZerolBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6337.ZerolBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6337.ZerolBevelGearMeshDynamicAnalysis]':
