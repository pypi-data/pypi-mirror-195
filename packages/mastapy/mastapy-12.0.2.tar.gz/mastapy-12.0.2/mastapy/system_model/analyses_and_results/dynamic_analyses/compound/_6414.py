...
class MassDiscCompoundDynamicAnalysis(_6461.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6285.MassDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6285.MassDiscDynamicAnalysis]':
