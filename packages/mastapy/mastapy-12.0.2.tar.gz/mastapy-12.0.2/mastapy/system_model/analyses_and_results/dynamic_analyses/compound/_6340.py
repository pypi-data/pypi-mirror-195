...
class AbstractShaftCompoundDynamicAnalysis(_6341.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """AbstractShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6210.AbstractShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6210.AbstractShaftDynamicAnalysis]':
