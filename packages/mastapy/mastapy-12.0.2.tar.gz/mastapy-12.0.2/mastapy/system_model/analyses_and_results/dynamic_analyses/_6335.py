...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6333, _6334, _6270
...
class WormGearSetDynamicAnalysis(_6270.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_6333.WormGearDynamicAnalysis]':
    ...
    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_6334.WormGearMeshDynamicAnalysis]':
