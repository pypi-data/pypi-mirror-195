...
class SpiralBevelGearCompoundDynamicAnalysis(_6355.BevelGearCompoundDynamicAnalysis):
    """SpiralBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6309.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6309.SpiralBevelGearDynamicAnalysis]':
