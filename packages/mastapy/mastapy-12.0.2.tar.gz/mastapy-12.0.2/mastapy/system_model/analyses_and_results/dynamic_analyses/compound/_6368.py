...
class ConceptGearCompoundDynamicAnalysis(_6397.GearCompoundDynamicAnalysis):
    """ConceptGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6238.ConceptGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6238.ConceptGearDynamicAnalysis]':
