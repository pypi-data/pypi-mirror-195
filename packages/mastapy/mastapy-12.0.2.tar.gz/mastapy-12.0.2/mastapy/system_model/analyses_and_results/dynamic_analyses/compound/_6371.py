...
class ConicalGearCompoundDynamicAnalysis(_6397.GearCompoundDynamicAnalysis):
    """ConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6241.ConicalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6241.ConicalGearDynamicAnalysis]':
