...
class ClutchConnectionCompoundDynamicAnalysis(_6377.CouplingConnectionCompoundDynamicAnalysis):
    """ClutchConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6230.ClutchConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6230.ClutchConnectionDynamicAnalysis]':
