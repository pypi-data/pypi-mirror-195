...
class BevelDifferentialGearMeshCompoundDynamicAnalysis(_6356.BevelGearMeshCompoundDynamicAnalysis):
    """BevelDifferentialGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6221.BevelDifferentialGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6221.BevelDifferentialGearMeshDynamicAnalysis]':
