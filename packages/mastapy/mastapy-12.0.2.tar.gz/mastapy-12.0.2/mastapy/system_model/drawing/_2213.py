...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1784.BearingForceArrowOption':
        ...
        return constructor.new_from_mastapy_type(_1784.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1784.BearingForceArrowOption'):
