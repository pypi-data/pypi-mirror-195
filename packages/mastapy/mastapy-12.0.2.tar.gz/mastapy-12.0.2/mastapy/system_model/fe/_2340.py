...
from mastapy.system_model.fe import (
    _2314, _2320, _2368, _2345,
    _2316, _2341, _2352, _2338,
    _2353, _2342, _2366, _2348,
    _2349, _2350, _2351
)
from mastapy._internal.implicit import list_with_selected_item, overridable, enum_with_selected_value
from mastapy.system_model.part_model import _2400, _2404, _2409
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.units_and_measurements import _1577
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self) -> '_2314.AlignmentMethod':
        ...
        return constructor.new_from_mastapy_type(_2314.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2314.AlignmentMethod'):
    ...
    @property
    def bearing_node_alignment(self) -> '_2320.BearingNodeAlignmentOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2320.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2320.BearingNodeAlignmentOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_using_axial_node_positions(self) -> '_2316.AlignmentUsingAxialNodePositions':
    ...
    @property
    def alignment_to_component(self) -> '_2181.RelativeComponentAlignment[_2400.Component]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2400.Component](temp) if temp is not None else None
    ...
    @property
    def export(self) -> '_2341.FESubstructureExportOptions':
    ...
    @property
    def gear_meshing_options(self) -> 'List[_2352.GearMeshingOptions]':
    ...
    @property
    def geometries(self) -> 'List[_2338.FEStiffnessGeometry]':
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2353.IndependentMastaCreatedCondensationNode]':
    ...
    @property
    def links(self) -> 'List[_2375.FELink]':
    ...
    @property
    def replaced_shafts(self) -> 'List[_2438.Shaft]':
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2366.ReplacedShaftSelectionHelper]':
    ...
    @property
    def thermal_expansion_displacements(self) -> 'List[_1530.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1530.VectorWithLinearAndAngularComponents]':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2348.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2349.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2350.FESubstructureWithSelectionForModalAnalysis':
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2351.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_165.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7487.TaskProgress'] = None):
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1577.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1577.Unit', force_unit: '_1577.Unit'):
    ...
    def links_for(self, node: '_2342.FESubstructureNode') -> 'List[_2375.FELink]':
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7487.TaskProgress'):
        """ 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def load_stl_geometry(self, length_unit: '_1577.Unit', file_name: 'str'):
