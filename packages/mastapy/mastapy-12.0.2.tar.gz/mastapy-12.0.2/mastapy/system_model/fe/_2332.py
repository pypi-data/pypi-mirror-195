...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_2331.ElectricMachineDataSet]':
    ...
    def add_electric_machine_data_set(self, name: 'str') -> '_2331.ElectricMachineDataSet':
    ...
    def add_electric_machine_data_set_from_masta_dynamic_force_analysis(self, analysis: '_1310.IHaveDynamicForceResults', slice_index: 'int') -> '_2331.ElectricMachineDataSet':
