...
class FESubstructureWithSelection(_2318.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2340.FESubstructure':
    ...
    @property
    def element_face_groups(self) -> 'List[_2333.ElementFaceGroupWithSelection]':
    ...
    @property
    def node_groups(self) -> 'List[_2358.NodeGroupWithSelection]':
