...
from mastapy.system_model.fe import _2357, _2347
...
class FESubstructureWithSelectionForStaticAnalysis(_2347.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2357.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2357.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def displacement_results(self) -> 'List[_1530.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def force_results(self) -> 'List[_1530.VectorWithLinearAndAngularComponents]':
