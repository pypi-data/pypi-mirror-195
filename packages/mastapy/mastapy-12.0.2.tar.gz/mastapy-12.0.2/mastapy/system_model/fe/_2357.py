...
from mastapy.system_model.fe import _2329, _2330
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_angular(self) -> 'List[_2329.DegreeOfFreedomBoundaryConditionAngular]':
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2330.DegreeOfFreedomBoundaryConditionLinear]':
