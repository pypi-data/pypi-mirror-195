...
class FELinkWithSelection(_0.APIBase):
    ...
    @property
    def link_of_type_electric_machine_stator_fe_link(self) -> '_2376.ElectricMachineStatorFELink':
    ...
    @property
    def link_of_type_gear_mesh_fe_link(self) -> '_2378.GearMeshFELink':
    ...
    @property
    def link_of_type_gear_with_duplicated_meshes_fe_link(self) -> '_2379.GearWithDuplicatedMeshesFELink':
    ...
    @property
    def link_of_type_multi_angle_connection_fe_link(self) -> '_2380.MultiAngleConnectionFELink':
    ...
    @property
    def link_of_type_multi_node_connector_fe_link(self) -> '_2381.MultiNodeConnectorFELink':
    ...
    @property
    def link_of_type_multi_node_fe_link(self) -> '_2382.MultiNodeFELink':
    ...
    @property
    def link_of_type_planetary_connector_multi_node_fe_link(self) -> '_2383.PlanetaryConnectorMultiNodeFELink':
    ...
    @property
    def link_of_type_planet_based_fe_link(self) -> '_2384.PlanetBasedFELink':
    ...
    @property
    def link_of_type_planet_carrier_fe_link(self) -> '_2385.PlanetCarrierFELink':
    ...
    @property
    def link_of_type_point_load_fe_link(self) -> '_2386.PointLoadFELink':
    ...
    @property
    def link_of_type_rolling_ring_connection_fe_link(self) -> '_2387.RollingRingConnectionFELink':
    ...
    @property
    def link_of_type_shaft_hub_connection_fe_link(self) -> '_2388.ShaftHubConnectionFELink':
    ...
    @property
    def link_of_type_single_node_fe_link(self) -> '_2389.SingleNodeFELink':
