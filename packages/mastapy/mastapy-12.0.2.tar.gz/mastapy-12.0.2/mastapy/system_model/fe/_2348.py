...
class FESubstructureWithSelectionComponents(_2347.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    @property
    def beam_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_204.ElementPropertiesBeam]]':
    ...
    @property
    def component_links(self) -> 'List[_2377.FELinkWithSelection]':
    ...
    @property
    def contact_pairs(self) -> 'List[_2325.ContactPairWithSelection]':
    ...
    @property
    def coordinate_systems(self) -> 'List[_2326.CoordinateSystemWithSelection]':
    ...
    @property
    def interface_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_205.ElementPropertiesInterface]]':
    ...
    @property
    def links_for_electric_machine(self) -> 'List[_2377.FELinkWithSelection]':
    ...
    @property
    def links_for_selected_component(self) -> 'List[_2377.FELinkWithSelection]':
    ...
    @property
    def mass_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_206.ElementPropertiesMass]]':
    ...
    @property
    def materials(self) -> 'List[_2356.MaterialPropertiesWithSelection]':
    ...
    @property
    def other_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_203.ElementPropertiesBase]]':
    ...
    @property
    def rigid_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_207.ElementPropertiesRigid]]':
    ...
    @property
    def shell_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_208.ElementPropertiesShell]]':
    ...
    @property
    def solid_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_209.ElementPropertiesSolid]]':
    ...
    @property
    def spring_dashpot_element_properties(self) -> 'List[_2334.ElementPropertiesWithSelection[_210.ElementPropertiesSpringDashpot]]':
