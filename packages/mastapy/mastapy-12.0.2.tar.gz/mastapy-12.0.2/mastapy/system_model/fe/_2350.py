...
from mastapy.system_model.fe import _2344, _2347
...
class FESubstructureWithSelectionForModalAnalysis(_2347.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2344.FESubstructureNodeModeShapes]':
