...
class Shaft(_2392.AbstractShaft):
    """Shaft
    ...
    @property
    def guide_image(self) -> '_2412.GuideImage':
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2340.FESubstructure':
    ...
    def mount_component(self, component: '_2420.MountableComponent', offset: 'float'):
