...
from mastapy.system_model.part_model.gears import _2486, _2485
...
class ConicalGear(_2485.Gear):
    ...
    @property
    def orientation(self) -> '_2486.GearOrientations':
        ...
        return constructor.new_from_mastapy_type(_2486.GearOrientations)(value) if value is not None else None

    @orientation.setter
    def orientation(self, value: '_2486.GearOrientations'):
