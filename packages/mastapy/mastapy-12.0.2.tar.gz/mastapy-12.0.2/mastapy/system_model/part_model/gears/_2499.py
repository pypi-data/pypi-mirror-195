...
from mastapy.system_model.part_model.gears import _2498, _2475
...
class SpiralBevelGearSet(_2475.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2498.SpiralBevelGear]':
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_2281.SpiralBevelGearMesh]':
