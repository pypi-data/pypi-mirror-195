...
from mastapy.system_model.part_model.gears import _2480, _2487
...
class CylindricalGearSet(_2487.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2518.SuperchargerRotorSet':
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_2267.CylindricalGearMesh]':
