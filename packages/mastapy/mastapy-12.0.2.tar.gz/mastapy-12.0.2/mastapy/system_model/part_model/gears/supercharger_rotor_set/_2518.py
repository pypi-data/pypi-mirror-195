...
class SuperchargerRotorSet(_1794.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self) -> '_1827.ThreeDChartDefinition':
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2520.YVariableForImportedData':
        ...
        return constructor.new_from_mastapy_type(_2520.YVariableForImportedData)(value) if value is not None else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2520.YVariableForImportedData'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.YVariableForImportedData = value

    @property
    def boost_pressure(self) -> '_2510.BoostPressureInputOptions':
    ...
    @property
    def file(self) -> '_2513.RotorSetDataInputFileOptions':
    ...
    @property
    def input_power(self) -> '_2511.InputPowerInputOptions':
    ...
    @property
    def pressure_ratio(self) -> '_2512.PressureRatioInputOptions':
    ...
    @property
    def rotor_speed(self) -> '_2515.RotorSpeedInputOptions':
    ...
    @property
    def measured_points(self) -> 'List[_2514.RotorSetMeasuredPoint]':
