...
from mastapy.system_model.part_model.gears import _2495, _2492
...
class KlingelnbergCycloPalloidSpiralBevelGearSet(_2492.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidSpiralBevelGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_2495.KlingelnbergCycloPalloidSpiralBevelGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_2278.KlingelnbergCycloPalloidSpiralBevelGearMesh]':
