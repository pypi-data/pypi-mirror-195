...
from mastapy.system_model.part_model.gears import _2474, _2475
...
class BevelDifferentialGearSet(_2475.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2474.BevelGear]':
    ...
    @property
    def bevel_meshes(self) -> 'List[_2261.BevelGearMesh]':
