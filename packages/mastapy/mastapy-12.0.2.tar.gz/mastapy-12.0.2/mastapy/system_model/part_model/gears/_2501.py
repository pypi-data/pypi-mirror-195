...
from mastapy.system_model.part_model.gears import _2500, _2475
...
class StraightBevelDiffGearSet(_2475.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2500.StraightBevelDiffGear]':
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_2283.StraightBevelDiffGearMesh]':
