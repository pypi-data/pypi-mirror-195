...
from mastapy.system_model.part_model.gears import _2476, _2487
...
class ConceptGearSet(_2487.GearSet):
    """ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2476.ConceptGear]':
    ...
    @property
    def concept_meshes(self) -> 'List[_2263.ConceptGearMesh]':
