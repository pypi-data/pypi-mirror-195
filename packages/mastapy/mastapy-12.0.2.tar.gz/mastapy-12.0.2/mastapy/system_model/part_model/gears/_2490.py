...
from mastapy.system_model.part_model.gears import _2489, _2469
...
class HypoidGearSet(_2469.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def hypoid_gears(self) -> 'List[_2489.HypoidGear]':
    ...
    @property
    def hypoid_meshes(self) -> 'List[_2273.HypoidGearMesh]':
