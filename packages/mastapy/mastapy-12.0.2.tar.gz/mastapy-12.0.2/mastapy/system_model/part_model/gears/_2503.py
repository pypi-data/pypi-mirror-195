...
from mastapy.system_model.part_model.gears import _2502, _2475
...
class StraightBevelGearSet(_2475.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2502.StraightBevelGear]':
    ...
    @property
    def straight_bevel_meshes(self) -> 'List[_2285.StraightBevelGearMesh]':
