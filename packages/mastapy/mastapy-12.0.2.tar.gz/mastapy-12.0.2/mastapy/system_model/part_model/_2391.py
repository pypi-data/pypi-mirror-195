...
from mastapy.system_model.part_model import _2400, _2424
...
class AbstractAssembly(_2424.Part):
    """AbstractAssembly
    ...
    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2400.Component]':
    ...
    @property
    def components_with_zero_mass_properties(self) -> 'List[_2400.Component]':
