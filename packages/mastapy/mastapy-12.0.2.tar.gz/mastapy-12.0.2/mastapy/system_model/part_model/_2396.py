...
from mastapy.bearings.tolerances import (
    _1866, _1867, _1876, _1870,
    _1883, _1869, _1880, _1875,
    _1885, _1887
)
from mastapy.bearings import (
    _1836, _1849, _1840, _1832
)
from mastapy.materials.efficiency import _286
from mastapy.utility.report import _1753
from mastapy._internal.python_net import python_net_import
from mastapy.bearings.bearing_results import _1923, _1905, _1924
from mastapy.system_model.part_model import (
    _2395, _2429, _2397, _2401,
    _2403
)
...
from mastapy.bearings.bearing_designs.rolling import (
    ...
    _2100, _2101, _2103, _2109,
    _2110, _2111, _2115, _2120,
    _2121, _2122, _2123, _2126,
    _2127, _2130, _2131, _2132,
    _2133, _2134, _2135
)
from mastapy.bearings.bearing_designs.fluid_film import (
    _2148, _2150, _2152, _2154,
    _2155, _2156
)
from mastapy.bearings.bearing_designs.concept import _2158, _2159, _2160
...
class Bearing(_2403.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1867.BearingToleranceDefinitionOptions':
        ...
        return constructor.new_from_mastapy_type(_1867.BearingToleranceDefinitionOptions)(value) if value is not None else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1867.BearingToleranceDefinitionOptions'):
    ...
    @property
    def damping_options(self) -> '_1836.BearingDampingMatrixOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1836.BearingDampingMatrixOption)(value) if value is not None else None

    @damping_options.setter
    def damping_options(self, value: '_1836.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def inner_fitting_chart(self) -> '_1753.SimpleChartDefinition':
    ...
    @property
    def journal_bearing_type(self) -> '_1849.JournalBearingType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1849.JournalBearingType)(value) if value is not None else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1849.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def orientation(self) -> '_1923.Orientations':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1923.Orientations)(value) if value is not None else None

    @orientation.setter
    def orientation(self, value: '_1923.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def outer_fitting_chart(self) -> '_1753.SimpleChartDefinition':
    ...
    @property
    def axial_internal_clearance_tolerance(self) -> '_2395.AxialInternalClearanceTolerance':
    ...
    @property
    def detail(self) -> '_2091.BearingDesign':
        ...
        if _2091.BearingDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_detailed_bearing(self) -> '_2092.DetailedBearing':
        ...
        if _2092.DetailedBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_2093.DummyRollingBearing':
        ...
        if _2093.DummyRollingBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_linear_bearing(self) -> '_2094.LinearBearing':
        ...
        if _2094.LinearBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_linear_bearing(self) -> '_2095.NonLinearBearing':
        ...
        if _2095.NonLinearBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_2096.AngularContactBallBearing':
        ...
        if _2096.AngularContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_2097.AngularContactThrustBallBearing':
        ...
        if _2097.AngularContactThrustBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_2098.AsymmetricSphericalRollerBearing':
        ...
        if _2098.AsymmetricSphericalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_2099.AxialThrustCylindricalRollerBearing':
        ...
        if _2099.AxialThrustCylindricalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_2100.AxialThrustNeedleRollerBearing':
        ...
        if _2100.AxialThrustNeedleRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_ball_bearing(self) -> '_2101.BallBearing':
        ...
        if _2101.BallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_2103.BarrelRollerBearing':
        ...
        if _2103.BarrelRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_2109.CrossedRollerBearing':
        ...
        if _2109.CrossedRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_2110.CylindricalRollerBearing':
        ...
        if _2110.CylindricalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_2111.DeepGrooveBallBearing':
        ...
        if _2111.DeepGrooveBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_2115.FourPointContactBallBearing':
        ...
        if _2115.FourPointContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_2120.MultiPointContactBallBearing':
        ...
        if _2120.MultiPointContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_needle_roller_bearing(self) -> '_2121.NeedleRollerBearing':
        ...
        if _2121.NeedleRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_2122.NonBarrelRollerBearing':
        ...
        if _2122.NonBarrelRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_roller_bearing(self) -> '_2123.RollerBearing':
        ...
        if _2123.RollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_rolling_bearing(self) -> '_2126.RollingBearing':
        ...
        if _2126.RollingBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_2127.SelfAligningBallBearing':
        ...
        if _2127.SelfAligningBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_2130.SphericalRollerBearing':
        ...
        if _2130.SphericalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_2131.SphericalRollerThrustBearing':
        ...
        if _2131.SphericalRollerThrustBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_taper_roller_bearing(self) -> '_2132.TaperRollerBearing':
        ...
        if _2132.TaperRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_2133.ThreePointContactBallBearing':
        ...
        if _2133.ThreePointContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_2134.ThrustBallBearing':
        ...
        if _2134.ThrustBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_2135.ToroidalRollerBearing':
        ...
        if _2135.ToroidalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_2148.PadFluidFilmBearing':
        ...
        if _2148.PadFluidFilmBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_2150.PlainGreaseFilledJournalBearing':
        ...
        if _2150.PlainGreaseFilledJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_journal_bearing(self) -> '_2152.PlainJournalBearing':
        ...
        if _2152.PlainJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_2154.PlainOilFedJournalBearing':
        ...
        if _2154.PlainOilFedJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_2155.TiltingPadJournalBearing':
        ...
        if _2155.TiltingPadJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_2156.TiltingPadThrustBearing':
        ...
        if _2156.TiltingPadThrustBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_2158.ConceptAxialClearanceBearing':
        ...
        if _2158.ConceptAxialClearanceBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_2159.ConceptClearanceBearing':
        ...
        if _2159.ConceptClearanceBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_2160.ConceptRadialClearanceBearing':
        ...
        if _2160.ConceptRadialClearanceBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def force_at_zero_displacement(self) -> '_1530.VectorWithLinearAndAngularComponents':
    ...
    @property
    def friction_coefficients(self) -> '_2032.RollingBearingFrictionCoefficients':
    ...
    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1876.OuterSupportTolerance':
    ...
    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1870.InnerSupportTolerance':
    ...
    @property
    def inner_support_detail(self) -> '_1883.SupportDetail':
    ...
    @property
    def left_support_detail(self) -> '_1883.SupportDetail':
    ...
    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1876.OuterSupportTolerance':
    ...
    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1870.InnerSupportTolerance':
    ...
    @property
    def outer_support_detail(self) -> '_1883.SupportDetail':
    ...
    @property
    def radial_internal_clearance_tolerance(self) -> '_2429.RadialInternalClearanceTolerance':
    ...
    @property
    def right_support_detail(self) -> '_1883.SupportDetail':
    ...
    @property
    def ring_tolerance_inner(self) -> '_1869.InnerRingTolerance':
    ...
    @property
    def ring_tolerance_left(self) -> '_1880.RingTolerance':
        ...
        if _1880.RingTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1869.InnerRingTolerance':
        ...
        if _1869.InnerRingTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1875.OuterRingTolerance':
        ...
        if _1875.OuterRingTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ring_tolerance_outer(self) -> '_1875.OuterRingTolerance':
    ...
    @property
    def ring_tolerance_right(self) -> '_1880.RingTolerance':
    ...
    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1869.InnerRingTolerance':
    ...
    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1875.OuterRingTolerance':
    ...
    @property
    def simple_bearing_detail_property(self) -> '_2091.BearingDesign':
    ...
    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_2092.DetailedBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_2093.DummyRollingBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_2094.LinearBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_2095.NonLinearBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_2096.AngularContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_2097.AngularContactThrustBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_2098.AsymmetricSphericalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_2099.AxialThrustCylindricalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_2100.AxialThrustNeedleRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_2101.BallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_2103.BarrelRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_2109.CrossedRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_2110.CylindricalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_2111.DeepGrooveBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_2115.FourPointContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_2120.MultiPointContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_2121.NeedleRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_2122.NonBarrelRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_2123.RollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_2126.RollingBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_2127.SelfAligningBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_2130.SphericalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_2131.SphericalRollerThrustBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_2132.TaperRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_2133.ThreePointContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_2134.ThrustBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_2135.ToroidalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_2148.PadFluidFilmBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_2150.PlainGreaseFilledJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_2152.PlainJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_2154.PlainOilFedJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_2155.TiltingPadJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_2156.TiltingPadThrustBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_2158.ConceptAxialClearanceBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_2159.ConceptClearanceBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_2160.ConceptRadialClearanceBearing':
    ...
    @property
    def support_tolerance_inner(self) -> '_1870.InnerSupportTolerance':
    ...
    @property
    def support_tolerance_left(self) -> '_1885.SupportTolerance':
        ...
        if _1885.SupportTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1870.InnerSupportTolerance':
        ...
        if _1870.InnerSupportTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1876.OuterSupportTolerance':
        ...
        if _1876.OuterSupportTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def support_tolerance_outer(self) -> '_1876.OuterSupportTolerance':
    ...
    @property
    def support_tolerance_right(self) -> '_1885.SupportTolerance':
    ...
    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1870.InnerSupportTolerance':
    ...
    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1876.OuterSupportTolerance':
    ...
    @property
    def mounting(self) -> 'List[_2397.BearingRaceMountingOptions]':
    ...
    @property
    def tolerance_combinations(self) -> 'List[_1887.ToleranceCombination]':
    ...
    def set_detail_from_catalogue(self, catalogue: '_1832.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2438.Shaft', offset: Optional['float'] = float('nan')) -> '_2401.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2438.Shaft', offset: Optional['float'] = float('nan')) -> '_2401.ComponentsConnectedResult':
