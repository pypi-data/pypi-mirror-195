...
from mastapy.system_model.part_model import _2417, _2392
...
class CycloidalDisc(_2392.AbstractShaft):
    """CycloidalDisc
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2297.CycloidalDiscPlanetaryBearingSocket]':
