...
class ConceptCoupling(_2538.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self) -> '_1500.Vector2DListAccessor':
    ...
    def efficiency_vs_speed_ratio(self, value: '_1500.Vector2DListAccessor'):
