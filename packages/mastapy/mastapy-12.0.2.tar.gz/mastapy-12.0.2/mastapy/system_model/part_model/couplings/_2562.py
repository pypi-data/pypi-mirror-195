...
from mastapy.system_model.part_model.couplings import _2563, _2565, _2538
...
class TorqueConverter(_2538.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self) -> '_2563.TorqueConverterPump':
    ...
    @property
    def turbine(self) -> '_2565.TorqueConverterTurbine':
