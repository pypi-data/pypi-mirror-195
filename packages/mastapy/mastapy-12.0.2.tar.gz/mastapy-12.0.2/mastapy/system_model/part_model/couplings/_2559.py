...
from mastapy.system_model.part_model.couplings import _2558, _2560
...
class SynchroniserHalf(_2560.SynchroniserPart):
    """SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2558.SynchroniserCone]':
