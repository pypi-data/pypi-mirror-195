...
class ShaftHubConnection(_2403.Connector):
    """ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2547.RigidConnectorTiltStiffnessTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2547.RigidConnectorTiltStiffnessTypes)(value) if value is not None else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2547.RigidConnectorTiltStiffnessTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank_lead_relief(self) -> '_2554.SplineLeadRelief':
    ...
    @property
    def right_flank_lead_relief(self) -> '_2554.SplineLeadRelief':
    ...
    @property
    def lead_reliefs(self) -> 'List[_2554.SplineLeadRelief]':
    ...
    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2548.RigidConnectorToothLocation]':
