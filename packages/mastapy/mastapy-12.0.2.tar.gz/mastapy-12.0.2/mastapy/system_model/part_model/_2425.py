...
from mastapy.system_model.part_model import _2417, _2420
...
class PlanetCarrier(_2420.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def load_sharing_settings(self) -> '_2417.LoadSharingSettings':
    ...
    @property
    def planetary_sockets(self) -> 'List[_2246.PlanetarySocket]':
    ...
    def attach_carrier_shaft(self, shaft: '_2438.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2438.Shaft', offset: Optional['float'] = float('nan')):
