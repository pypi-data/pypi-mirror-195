...
from mastapy.system_model.import_export import _2199
...
class Part(_2164.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self) -> '_1483.MassProperties':
    ...
    @property
    def mass_properties_from_design_including_planetary_duplicates(self) -> '_1483.MassProperties':
    ...
    @property
    def local_connections(self) -> 'List[_2230.Connection]':
    ...
    def connections_to(self, part: 'Part') -> 'List[_2230.Connection]':
    ...
    def copy_to(self, container: '_2390.Assembly') -> 'Part':
    ...
    def create_geometry_export_options(self) -> '_2199.GeometryExportOptions':
