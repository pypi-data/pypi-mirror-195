...
from mastapy.system_model.part_model.part_groups import _2443, _2445, _2442
...
class ParallelPartGroup(_2442.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2443.ConcentricPartGroup]':
    ...
    @property
    def design_measurements(self) -> 'List[_2445.DesignMeasurements]':
