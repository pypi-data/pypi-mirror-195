...
from mastapy.system_model.part_model.part_groups import _2444, _2442
...
class ConcentricPartGroup(_2442.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2444.ConcentricPartGroupParallelToThis]':
