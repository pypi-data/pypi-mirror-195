...
from mastapy.system_model.part_model import _2405, _2437, _2435
from mastapy.math_utility.measured_data import _1532
from mastapy.system_model import _2180
...
class PowerLoad(_2435.VirtualComponent):
    """PowerLoad
    ...
    @property
    def electric_machine_search_region_specification_method(self) -> '_2405.ElectricMachineSearchRegionSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_2405.ElectricMachineSearchRegionSpecificationMethod)(value) if value is not None else None

    @electric_machine_search_region_specification_method.setter
    def electric_machine_search_region_specification_method(self, value: '_2405.ElectricMachineSearchRegionSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ElectricMachineSearchRegionSpecificationMethod = value

    @property
    def engine_fuel_consumption_grid(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def engine_fuel_consumption_grid(self, value: '_1532.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.EngineFuelConsumptionGrid = value

    @property
    def engine_torque_grid(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def engine_torque_grid(self, value: '_1532.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def single_blade_details(self) -> '_2437.WindTurbineSingleBladeDetails':
