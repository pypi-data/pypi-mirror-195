...
from mastapy.system_model import _2168, _2172
from mastapy.system_model.analyses_and_results.load_case_groups import _5603
...
class DutyCycleImporter(_0.APIBase):
    ...
    @property
    def design_state_destinations(self) -> 'List[_2168.DutyCycleImporterDesignEntityMatch[_5603.DesignState]]':
    ...
    @property
    def duty_cycles_to_import(self) -> 'List[_2172.IncludeDutyCycleOption]':
    ...
    @property
    def point_load_destinations(self) -> 'List[_2168.DutyCycleImporterDesignEntityMatch[_2427.PointLoad]]':
    ...
    @property
    def power_load_destinations(self) -> 'List[_2168.DutyCycleImporterDesignEntityMatch[_2428.PowerLoad]]':
