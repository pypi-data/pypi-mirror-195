...
from mastapy.system_model.part_model.gears import _2481, _2497, _2480
...
class CylindricalGearMesh(_2271.GearMesh):
    """CylindricalGearMesh
    ...
    @property
    def centre_distance_range(self) -> '_1531.ShortLengthRange':
    ...
    @property
    def cylindrical_gear_set(self) -> '_2481.CylindricalGearSet':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2480.CylindricalGear]':
