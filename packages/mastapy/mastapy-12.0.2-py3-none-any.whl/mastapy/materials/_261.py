...
class LubricationDetail(_1794.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def density_vs_temperature(self) -> '_1500.Vector2DListAccessor':
    ...
    def density_vs_temperature(self, value: '_1500.Vector2DListAccessor'):
