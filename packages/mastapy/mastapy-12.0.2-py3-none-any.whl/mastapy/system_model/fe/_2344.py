...
from mastapy.system_model.fe import _2342, _2343
...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    def condensation_node(self) -> '_2342.FESubstructureNode':
    ...
    @property
    def mode_shapes_at_condensation_node(self) -> 'List[_2343.FESubstructureNodeModeShape]':
