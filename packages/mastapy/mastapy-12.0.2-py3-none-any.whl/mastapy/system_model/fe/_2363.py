...
from mastapy.system_model.fe import _2315, _2322
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2315.AlignmentMethodForRaceBearing':
        ...
        return constructor.new_from_mastapy_type(_2315.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2315.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2322.BearingRaceNodeLink]':
