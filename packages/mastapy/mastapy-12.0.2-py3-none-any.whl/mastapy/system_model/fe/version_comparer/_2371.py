...
from mastapy.system_model.fe.version_comparer import _2373, _2369
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_2373.LoadCasesToRun':
        ...
        return constructor.new_from_mastapy_type(_2373.LoadCasesToRun)(value) if value is not None else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2373.LoadCasesToRun'):
    ...
    @property
    def design_results(self) -> 'List[_2369.DesignResults]':
