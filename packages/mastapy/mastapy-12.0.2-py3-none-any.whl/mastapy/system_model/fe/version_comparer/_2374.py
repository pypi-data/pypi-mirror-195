...
from mastapy.math_utility.measured_vectors import _1530, _1528
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1530.VectorWithLinearAndAngularComponents':
    ...
    @property
    def new_result(self) -> '_1528.NodeResults':
    ...
    @property
    def original_result(self) -> '_1528.NodeResults':
