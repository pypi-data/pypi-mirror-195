...
from mastapy.system_model.part_model.gears import _2506, _2487
...
class WormGearSet(_2487.GearSet):
    """WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2506.WormGear]':
    ...
    @property
    def worm_meshes(self) -> 'List[_2287.WormGearMesh]':
