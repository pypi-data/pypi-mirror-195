...
from mastapy.system_model.part_model.gears import _2493, _2492
...
class KlingelnbergCycloPalloidHypoidGearSet(_2492.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidHypoidGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears(self) -> 'List[_2493.KlingelnbergCycloPalloidHypoidGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_2277.KlingelnbergCycloPalloidHypoidGearMesh]':
