...
from mastapy.system_model.part_model.part_groups import _2446
...
class RootAssembly(_2390.Assembly):
    """RootAssembly
    ...
    @property
    def parallel_part_groups(self) -> 'List[_2446.ParallelPartGroup]':
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2441.SpecifiedParallelPartGroupDrawingOrder]':
