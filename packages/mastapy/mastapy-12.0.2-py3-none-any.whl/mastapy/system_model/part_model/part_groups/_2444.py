...
from mastapy.system_model.part_model.part_groups import _2442, _2443, _2446
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2442.ConcentricOrParallelPartGroup':
        ...
        if _2442.ConcentricOrParallelPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2443.ConcentricPartGroup':
        ...
        if _2443.ConcentricPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2446.ParallelPartGroup':
        ...
        if _2446.ParallelPartGroup.TYPE not in temp.__class__.__mro__:
