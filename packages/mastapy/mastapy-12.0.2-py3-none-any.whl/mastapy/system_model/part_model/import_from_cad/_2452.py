...
from mastapy.system_model.part_model.import_from_cad import _2458, _2459
...
class ConnectorFromCAD(_2459.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2458.HousedOrMounted':
        ...
        return constructor.new_from_mastapy_type(_2458.HousedOrMounted)(value) if value is not None else None

    @mounting.setter
    def mounting(self, value: '_2458.HousedOrMounted'):
