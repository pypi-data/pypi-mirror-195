...
class OilSeal(_2403.Connector):
    ...
    @property
    def drag_torque_vs_rotational_speed(self) -> '_1500.Vector2DListAccessor':
    ...
    def drag_torque_vs_rotational_speed(self, value: '_1500.Vector2DListAccessor'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1923.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1923.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
