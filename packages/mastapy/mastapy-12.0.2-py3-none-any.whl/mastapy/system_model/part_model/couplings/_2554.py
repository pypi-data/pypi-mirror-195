...
from mastapy.math_utility.stiffness_calculators import _1502
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1502.IndividualContactPosition':
        ...
        return constructor.new_from_mastapy_type(_1502.IndividualContactPosition)(value) if value is not None else None
    ...
    @property
    def microgeometry_clearance_chart(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def crowning(self) -> '_2540.CrowningSpecification':
