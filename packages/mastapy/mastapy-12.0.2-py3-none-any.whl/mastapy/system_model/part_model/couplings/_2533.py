...
from mastapy.system_model.part_model.couplings import _2535, _2538
...
class Clutch(_2538.Coupling):
    ...
    @property
    def angular_speed_temperature_grid(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def angular_speed_temperature_grid(self, value: '_1532.GriddedSurfaceAccessor'):
    ...
    @property
    def clutch_type(self) -> '_2535.ClutchType':
        ...
        return constructor.new_from_mastapy_type(_2535.ClutchType)(value) if value is not None else None

    @clutch_type.setter
    def clutch_type(self, value: '_2535.ClutchType'):
    ...
    @property
    def flow_rate_vs_speed(self) -> '_1500.Vector2DListAccessor':
    ...
    def flow_rate_vs_speed(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def linear_speed_temperature_grid(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def linear_speed_temperature_grid(self, value: '_1532.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def spring_type(self) -> '_5343.ClutchSpringType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5343.ClutchSpringType)(value) if value is not None else None

    @spring_type.setter
    def spring_type(self, value: '_5343.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_2300.ClutchConnection':
