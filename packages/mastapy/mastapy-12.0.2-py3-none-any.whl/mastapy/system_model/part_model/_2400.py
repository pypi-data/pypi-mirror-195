...
from mastapy.system_model.connections_and_sockets import (
    _2228, _2230, _2254, _2249
)
from mastapy.system_model.part_model import _2401, _2424
...
class Component(_2424.Part):
    ...
    @property
    def component_connections(self) -> 'List[_2228.ComponentConnection]':
    ...
    def can_delete_connection(self, connection: '_2230.Connection') -> 'bool':
    ...
    def connect_to(self, component: 'Component') -> '_2401.ComponentsConnectedResult':
    ...
    def connect_to_socket(self, socket: '_2254.Socket') -> '_2401.ComponentsConnectedResult':
        """ 'ConnectTo' is the original name of this method.
    ...
    def diameter_at_middle_of_connection(self, connection: '_2230.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2230.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2254.Socket]':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2254.Socket') -> 'List[_2254.Socket]':
        """ 'PossibleSocketsToConnectWith' is the original name of this method.
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2249.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1465.CoordinateSystem3D') -> '_2249.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2249.RealignmentResult':
    ...
    def socket_named(self, socket_name: 'str') -> '_2254.Socket':
    ...
    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2401.ComponentsConnectedResult':
