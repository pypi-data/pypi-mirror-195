...
class PlanetCarrierSettings(_1561.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    @property
    def planet_pin_manufacturing_errors_coordinate_system(self) -> '_2176.PlanetPinManufacturingErrorsCoordinateSystem':
        ...
        return constructor.new_from_mastapy_type(_2176.PlanetPinManufacturingErrorsCoordinateSystem)(value) if value is not None else None

    @planet_pin_manufacturing_errors_coordinate_system.setter
    def planet_pin_manufacturing_errors_coordinate_system(self, value: '_2176.PlanetPinManufacturingErrorsCoordinateSystem'):
