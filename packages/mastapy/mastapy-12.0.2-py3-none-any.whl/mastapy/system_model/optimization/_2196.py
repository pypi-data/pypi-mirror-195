...
from mastapy.system_model.optimization import _2197, _2195
...
TStep = TypeVar('TStep', bound='_2195.OptimizationStep')


class OptimizationStrategy(_2197.OptimizationStrategyBase, Generic[TStep]):
    """OptimizationStrategy
