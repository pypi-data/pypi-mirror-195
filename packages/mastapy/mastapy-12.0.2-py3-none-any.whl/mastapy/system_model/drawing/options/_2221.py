...
from mastapy.math_utility.measured_ranges import _1531
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5783, _5782
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_method(self) -> '_5783.ModalContributionFilteringMethod':
        ...
        return constructor.new_from_mastapy_type(_5783.ModalContributionFilteringMethod)(value) if value is not None else None

    @filtering_method.setter
    def filtering_method(self, value: '_5783.ModalContributionFilteringMethod'):
    ...
    @property
    def index_range(self) -> '_1555.IntegerRange':
    ...
    @index_range.setter
    def index_range(self, value: '_1555.IntegerRange'):
        value = value.wrapped if value else None
        self.wrapped.IndexRange = value

    @property
    def modes_to_display(self) -> '_5782.ModalContributionDisplayMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5782.ModalContributionDisplayMethod)(value) if value is not None else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5782.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
