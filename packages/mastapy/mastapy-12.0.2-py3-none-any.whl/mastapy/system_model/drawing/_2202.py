...
from mastapy.system_model.drawing import _2214
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2754.ShaftSystemDeflection':
    ...
    @property
    def node_results(self) -> 'List[_2214.ShaftDeflectionDrawingNodeItem]':
