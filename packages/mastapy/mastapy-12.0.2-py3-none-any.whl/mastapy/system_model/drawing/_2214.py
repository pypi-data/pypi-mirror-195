...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self) -> '_1526.ForceAndDisplacementResults':
    ...
    @property
    def section_to_the_left_side(self) -> '_2753.ShaftSectionSystemDeflection':
    ...
    @property
    def section_to_the_right_side(self) -> '_2753.ShaftSectionSystemDeflection':
