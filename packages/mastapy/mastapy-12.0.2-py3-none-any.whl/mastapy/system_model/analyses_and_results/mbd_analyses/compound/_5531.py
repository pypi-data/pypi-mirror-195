...
class HypoidGearCompoundMultibodyDynamicsAnalysis(_5473.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """HypoidGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5384.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5384.HypoidGearMultibodyDynamicsAnalysis]':
