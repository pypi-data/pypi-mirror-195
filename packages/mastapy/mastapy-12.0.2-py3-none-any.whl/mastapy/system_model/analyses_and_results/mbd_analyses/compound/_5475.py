...
class AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis(_5503.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5323.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5323.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
