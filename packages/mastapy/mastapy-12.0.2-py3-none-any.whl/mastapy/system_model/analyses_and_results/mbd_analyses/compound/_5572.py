...
class SpringDamperConnectionCompoundMultibodyDynamicsAnalysis(_5507.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """SpringDamperConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5433.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5433.SpringDamperConnectionMultibodyDynamicsAnalysis]':
