...
class FaceGearCompoundMultibodyDynamicsAnalysis(_5527.GearCompoundMultibodyDynamicsAnalysis):
    """FaceGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5374.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5374.FaceGearMultibodyDynamicsAnalysis]':
