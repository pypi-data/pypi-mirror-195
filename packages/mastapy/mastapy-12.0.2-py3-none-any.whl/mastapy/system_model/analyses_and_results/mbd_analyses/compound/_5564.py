...
class ShaftCompoundMultibodyDynamicsAnalysis(_5470.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """ShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5426.ShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5426.ShaftMultibodyDynamicsAnalysis]':
