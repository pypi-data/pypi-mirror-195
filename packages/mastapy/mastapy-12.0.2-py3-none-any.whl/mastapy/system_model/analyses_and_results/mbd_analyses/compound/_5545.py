...
class MeasurementComponentCompoundMultibodyDynamicsAnalysis(_5591.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """MeasurementComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5404.MeasurementComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5404.MeasurementComponentMultibodyDynamicsAnalysis]':
