...
class ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis(_5508.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5347.ConceptCouplingHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5347.ConceptCouplingHalfMultibodyDynamicsAnalysis]':
