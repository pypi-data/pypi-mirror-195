...
class CVTBeltConnectionCompoundMultibodyDynamicsAnalysis(_5478.BeltConnectionCompoundMultibodyDynamicsAnalysis):
    """CVTBeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5360.CVTBeltConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5360.CVTBeltConnectionMultibodyDynamicsAnalysis]':
