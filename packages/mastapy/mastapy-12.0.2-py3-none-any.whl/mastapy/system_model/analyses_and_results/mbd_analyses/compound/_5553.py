...
class PlanetaryGearSetCompoundMultibodyDynamicsAnalysis(_5518.CylindricalGearSetCompoundMultibodyDynamicsAnalysis):
    """PlanetaryGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5412.PlanetaryGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5412.PlanetaryGearSetMultibodyDynamicsAnalysis]':
