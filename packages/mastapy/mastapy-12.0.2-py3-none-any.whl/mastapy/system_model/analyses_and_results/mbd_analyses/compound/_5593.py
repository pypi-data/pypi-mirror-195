...
class WormGearMeshCompoundMultibodyDynamicsAnalysis(_5528.GearMeshCompoundMultibodyDynamicsAnalysis):
    """WormGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5457.WormGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5457.WormGearMeshMultibodyDynamicsAnalysis]':
