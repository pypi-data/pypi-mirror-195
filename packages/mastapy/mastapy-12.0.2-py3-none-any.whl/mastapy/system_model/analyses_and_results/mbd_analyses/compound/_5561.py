...
class RollingRingCompoundMultibodyDynamicsAnalysis(_5508.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """RollingRingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5421.RollingRingMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5421.RollingRingMultibodyDynamicsAnalysis]':
