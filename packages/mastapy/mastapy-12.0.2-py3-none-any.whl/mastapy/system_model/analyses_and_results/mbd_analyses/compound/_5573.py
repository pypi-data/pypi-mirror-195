...
class SpringDamperHalfCompoundMultibodyDynamicsAnalysis(_5508.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """SpringDamperHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5434.SpringDamperHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5434.SpringDamperHalfMultibodyDynamicsAnalysis]':
