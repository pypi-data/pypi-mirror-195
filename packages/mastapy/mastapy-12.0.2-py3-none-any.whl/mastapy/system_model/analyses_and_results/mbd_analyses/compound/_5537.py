...
class KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis(_5503.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5393.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5393.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
