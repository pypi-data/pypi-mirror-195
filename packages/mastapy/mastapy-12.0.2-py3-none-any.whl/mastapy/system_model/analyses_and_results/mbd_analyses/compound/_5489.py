...
class BoltedJointCompoundMultibodyDynamicsAnalysis(_5567.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BoltedJointCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5338.BoltedJointMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5338.BoltedJointMultibodyDynamicsAnalysis]':
