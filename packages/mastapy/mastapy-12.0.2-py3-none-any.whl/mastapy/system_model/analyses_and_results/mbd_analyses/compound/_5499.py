...
class ConceptGearMeshCompoundMultibodyDynamicsAnalysis(_5528.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConceptGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5349.ConceptGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5349.ConceptGearMeshMultibodyDynamicsAnalysis]':
