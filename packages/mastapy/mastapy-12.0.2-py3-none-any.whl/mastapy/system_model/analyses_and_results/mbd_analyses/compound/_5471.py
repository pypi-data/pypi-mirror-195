...
class AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis(_5494.ComponentCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5319.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5319.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
