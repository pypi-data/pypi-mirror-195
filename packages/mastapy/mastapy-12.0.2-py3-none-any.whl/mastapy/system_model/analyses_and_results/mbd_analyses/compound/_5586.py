...
class TorqueConverterCompoundMultibodyDynamicsAnalysis(_5506.CouplingCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5450.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5450.TorqueConverterMultibodyDynamicsAnalysis]':
