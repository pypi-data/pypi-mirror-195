...
class ConceptGearCompoundMultibodyDynamicsAnalysis(_5527.GearCompoundMultibodyDynamicsAnalysis):
    """ConceptGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5350.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5350.ConceptGearMultibodyDynamicsAnalysis]':
