...
class CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis(_5516.CylindricalGearCompoundMultibodyDynamicsAnalysis):
    """CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5370.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5370.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
