...
class CylindricalGearCompoundMultibodyDynamicsAnalysis(_5527.GearCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5368.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5368.CylindricalGearMultibodyDynamicsAnalysis]':
