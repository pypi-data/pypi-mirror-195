...
class ExternalCADModelCompoundMultibodyDynamicsAnalysis(_5494.ComponentCompoundMultibodyDynamicsAnalysis):
    """ExternalCADModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5372.ExternalCADModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5372.ExternalCADModelMultibodyDynamicsAnalysis]':
