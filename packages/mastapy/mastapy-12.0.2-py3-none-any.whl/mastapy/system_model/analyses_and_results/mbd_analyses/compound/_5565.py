...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5505.ConnectorCompoundMultibodyDynamicsAnalysis):
    """ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5425.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5425.ShaftHubConnectionMultibodyDynamicsAnalysis]':
