...
class RollingRingAssemblyCompoundMultibodyDynamicsAnalysis(_5567.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """RollingRingAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5419.RollingRingAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5419.RollingRingAssemblyMultibodyDynamicsAnalysis]':
