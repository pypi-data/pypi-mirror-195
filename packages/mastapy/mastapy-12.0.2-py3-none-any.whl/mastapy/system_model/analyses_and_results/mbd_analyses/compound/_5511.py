...
class CVTPulleyCompoundMultibodyDynamicsAnalysis(_5557.PulleyCompoundMultibodyDynamicsAnalysis):
    """CVTPulleyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5362.CVTPulleyMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5362.CVTPulleyMultibodyDynamicsAnalysis]':
