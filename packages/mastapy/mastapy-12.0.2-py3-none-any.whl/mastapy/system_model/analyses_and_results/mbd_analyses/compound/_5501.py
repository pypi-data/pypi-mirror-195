...
class ConicalGearCompoundMultibodyDynamicsAnalysis(_5527.GearCompoundMultibodyDynamicsAnalysis):
    """ConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5353.ConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5353.ConicalGearMultibodyDynamicsAnalysis]':
