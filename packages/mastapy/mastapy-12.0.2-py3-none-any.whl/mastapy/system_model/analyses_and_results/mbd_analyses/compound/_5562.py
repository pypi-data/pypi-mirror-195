...
class RollingRingConnectionCompoundMultibodyDynamicsAnalysis(_5534.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """RollingRingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5420.RollingRingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5420.RollingRingConnectionMultibodyDynamicsAnalysis]':
