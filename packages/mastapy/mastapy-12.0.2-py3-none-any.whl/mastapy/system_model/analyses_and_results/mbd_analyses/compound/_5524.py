...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5522, _5523, _5529
...
class FaceGearSetCompoundMultibodyDynamicsAnalysis(_5529.GearSetCompoundMultibodyDynamicsAnalysis):
    """FaceGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5375.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5522.FaceGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5523.FaceGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5375.FaceGearSetMultibodyDynamicsAnalysis]':
