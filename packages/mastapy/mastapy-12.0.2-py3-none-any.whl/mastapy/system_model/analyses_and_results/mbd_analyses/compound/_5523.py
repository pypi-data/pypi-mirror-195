...
class FaceGearMeshCompoundMultibodyDynamicsAnalysis(_5528.GearMeshCompoundMultibodyDynamicsAnalysis):
    """FaceGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5373.FaceGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5373.FaceGearMeshMultibodyDynamicsAnalysis]':
