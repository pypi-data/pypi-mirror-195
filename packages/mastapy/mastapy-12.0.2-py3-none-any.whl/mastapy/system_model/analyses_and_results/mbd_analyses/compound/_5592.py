...
class WormGearCompoundMultibodyDynamicsAnalysis(_5527.GearCompoundMultibodyDynamicsAnalysis):
    """WormGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5458.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5458.WormGearMultibodyDynamicsAnalysis]':
