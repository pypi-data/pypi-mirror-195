...
class ConceptCouplingCompoundMultibodyDynamicsAnalysis(_5506.CouplingCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5348.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5348.ConceptCouplingMultibodyDynamicsAnalysis]':
