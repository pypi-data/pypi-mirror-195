...
class FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis(_5567.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5377.FlexiblePinAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5377.FlexiblePinAssemblyMultibodyDynamicsAnalysis]':
