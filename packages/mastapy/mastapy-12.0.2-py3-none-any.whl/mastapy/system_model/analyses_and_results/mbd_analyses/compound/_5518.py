...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5516, _5517, _5529
...
class CylindricalGearSetCompoundMultibodyDynamicsAnalysis(_5529.GearSetCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5369.CylindricalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5516.CylindricalGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5517.CylindricalGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5369.CylindricalGearSetMultibodyDynamicsAnalysis]':
