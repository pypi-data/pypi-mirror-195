...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5384, _5383, _5323
...
class HypoidGearSetMultibodyDynamicsAnalysis(_5323.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis):
    """HypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5384.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5384.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5383.HypoidGearMeshMultibodyDynamicsAnalysis]':
