...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5452, _5357
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5357.CouplingConnectionMultibodyDynamicsAnalysis):
    """TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5452.TorqueConverterStatus':
        ...
        return constructor.new_from_mastapy_type(_5452.TorqueConverterStatus)(value) if value is not None else None
