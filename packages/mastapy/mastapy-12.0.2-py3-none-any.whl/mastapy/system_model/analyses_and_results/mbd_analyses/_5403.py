...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5389, _5423, _5428
...
class MBDRunUpAnalysisOptions(_7464.AbstractAnalysisOptions['_6736.TimeSeriesLoadCase']):
    """MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5389.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new_from_mastapy_type(_5389.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5389.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def run_up_driving_mode(self) -> '_5423.RunUpDrivingMode':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5423.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5423.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5428.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5428.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5428.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
