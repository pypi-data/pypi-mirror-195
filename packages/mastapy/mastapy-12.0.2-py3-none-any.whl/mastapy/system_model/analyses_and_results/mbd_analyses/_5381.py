...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5380, _5378, _5429
...
class GearSetMultibodyDynamicsAnalysis(_5429.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5380.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5378.GearMeshMultibodyDynamicsAnalysis]':
