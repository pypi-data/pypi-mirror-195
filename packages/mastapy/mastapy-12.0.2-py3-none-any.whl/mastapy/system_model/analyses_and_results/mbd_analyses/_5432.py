...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5431, _5430, _5337
...
class SpiralBevelGearSetMultibodyDynamicsAnalysis(_5337.BevelGearSetMultibodyDynamicsAnalysis):
    """SpiralBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5431.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5431.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5430.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
