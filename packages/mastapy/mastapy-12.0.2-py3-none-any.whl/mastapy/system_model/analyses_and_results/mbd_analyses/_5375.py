...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5374, _5373, _5381
...
class FaceGearSetMultibodyDynamicsAnalysis(_5381.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5374.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_multibody_dynamics_analysis(self) -> 'List[_5374.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_multibody_dynamics_analysis(self) -> 'List[_5373.FaceGearMeshMultibodyDynamicsAnalysis]':
