...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5416, _5429
...
class BeltDriveMultibodyDynamicsAnalysis(_5429.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5416.PulleyMultibodyDynamicsAnalysis]':
