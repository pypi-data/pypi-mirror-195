...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5465, _5467
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5356.ConnectorMultibodyDynamicsAnalysis):
    """ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5465.DynamicForceVector3DResult':
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5467.DynamicTorqueVector3DResult':
