...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6503, _6504, _6536
...
class ConceptGearSetCriticalSpeedAnalysis(_6536.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6503.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6504.ConceptGearMeshCriticalSpeedAnalysis]':
