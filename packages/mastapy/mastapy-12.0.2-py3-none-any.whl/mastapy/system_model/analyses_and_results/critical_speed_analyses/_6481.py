...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import (
    _6482, _6484, _6487, _6494,
    _6493, _6517, _6496, _6501,
    _6505, _6519, _6521, _6525,
    _6532, _6531, _6533, _6540,
    _6547, _6550, _6551, _6552,
    _6554, _6557, _6561, _6562,
    _6563, _6565, _6567, _6572,
    _6571, _6577, _6579, _6583,
    _6586, _6589, _6594, _6597,
    _6601, _6604, _6474
)
...
class AssemblyCriticalSpeedAnalysis(_6474.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6482.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6484.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6487.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6494.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6493.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6517.CVTCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6496.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6501.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6505.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6519.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6521.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6525.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6532.FEPartCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6531.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6533.FlexiblePinAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6540.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6547.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6550.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6551.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6552.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6554.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6557.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6561.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6562.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6563.PowerLoadCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6565.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6567.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6572.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6571.ShaftCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6577.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6579.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6583.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6586.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6589.SynchroniserCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6594.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6597.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6601.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6604.ZerolBevelGearSetCriticalSpeedAnalysis]':
