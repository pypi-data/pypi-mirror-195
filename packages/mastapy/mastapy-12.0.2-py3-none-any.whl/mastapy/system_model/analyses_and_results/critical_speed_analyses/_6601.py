...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6599, _6600, _6536
...
class WormGearSetCriticalSpeedAnalysis(_6536.GearSetCriticalSpeedAnalysis):
    """WormGearSetCriticalSpeedAnalysis
    ...
    @property
    def worm_gears_critical_speed_analysis(self) -> 'List[_6599.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_critical_speed_analysis(self) -> 'List[_6600.WormGearMeshCriticalSpeedAnalysis]':
