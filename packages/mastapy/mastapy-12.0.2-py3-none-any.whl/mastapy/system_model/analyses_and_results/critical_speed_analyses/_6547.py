...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6545, _6546, _6544
...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(_6544.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_critical_speed_analysis(self) -> 'List[_6545.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_critical_speed_analysis(self) -> 'List[_6546.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]':
