...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6529, _6530, _6536
...
class FaceGearSetCriticalSpeedAnalysis(_6536.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    @property
    def face_gears_critical_speed_analysis(self) -> 'List[_6529.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_critical_speed_analysis(self) -> 'List[_6530.FaceGearMeshCriticalSpeedAnalysis]':
