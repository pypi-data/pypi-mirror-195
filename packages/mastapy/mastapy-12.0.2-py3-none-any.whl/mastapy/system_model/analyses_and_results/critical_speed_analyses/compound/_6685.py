...
class PartToPartShearCouplingCompoundCriticalSpeedAnalysis(_6642.CouplingCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6557.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6557.PartToPartShearCouplingCriticalSpeedAnalysis]':
