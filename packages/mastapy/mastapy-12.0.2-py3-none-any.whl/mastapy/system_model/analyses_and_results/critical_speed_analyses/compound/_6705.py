...
class SpiralBevelGearMeshCompoundCriticalSpeedAnalysis(_6622.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6576.SpiralBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6576.SpiralBevelGearMeshCriticalSpeedAnalysis]':
