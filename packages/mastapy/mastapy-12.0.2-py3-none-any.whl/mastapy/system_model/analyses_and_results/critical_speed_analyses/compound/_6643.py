...
class CouplingConnectionCompoundCriticalSpeedAnalysis(_6670.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6511.CouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6511.CouplingConnectionCriticalSpeedAnalysis]':
