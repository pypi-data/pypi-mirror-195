...
class AbstractShaftOrHousingCompoundCriticalSpeedAnalysis(_6630.ComponentCompoundCriticalSpeedAnalysis):
    """AbstractShaftOrHousingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6476.AbstractShaftOrHousingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6476.AbstractShaftOrHousingCriticalSpeedAnalysis]':
