...
class CylindricalGearCompoundCriticalSpeedAnalysis(_6663.GearCompoundCriticalSpeedAnalysis):
    """CylindricalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6523.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6523.CylindricalGearCriticalSpeedAnalysis]':
