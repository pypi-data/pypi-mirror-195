...
class CoaxialConnectionCompoundCriticalSpeedAnalysis(_6702.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CoaxialConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6498.CoaxialConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6498.CoaxialConnectionCriticalSpeedAnalysis]':
