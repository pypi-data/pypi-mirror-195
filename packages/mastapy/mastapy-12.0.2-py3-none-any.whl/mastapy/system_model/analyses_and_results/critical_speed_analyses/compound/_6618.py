...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6616, _6617, _6623
...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(_6623.BevelGearSetCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6487.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_critical_speed_analysis(self) -> 'List[_6616.BevelDifferentialGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_critical_speed_analysis(self) -> 'List[_6617.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6487.BevelDifferentialGearSetCriticalSpeedAnalysis]':
