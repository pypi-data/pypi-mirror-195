...
class BevelGearMeshCompoundCriticalSpeedAnalysis(_6610.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """BevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6491.BevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6491.BevelGearMeshCriticalSpeedAnalysis]':
