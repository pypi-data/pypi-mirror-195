...
class CycloidalDiscCompoundCriticalSpeedAnalysis(_6606.AbstractShaftCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6521.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6521.CycloidalDiscCriticalSpeedAnalysis]':
