...
class KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis(_6671.KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6545.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6545.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
