...
class ShaftHubConnectionCompoundCriticalSpeedAnalysis(_6641.ConnectorCompoundCriticalSpeedAnalysis):
    """ShaftHubConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6572.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6572.ShaftHubConnectionCriticalSpeedAnalysis]':
