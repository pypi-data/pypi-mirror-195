...
class ComponentCompoundCriticalSpeedAnalysis(_6684.PartCompoundCriticalSpeedAnalysis):
    """ComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6499.ComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6499.ComponentCriticalSpeedAnalysis]':
