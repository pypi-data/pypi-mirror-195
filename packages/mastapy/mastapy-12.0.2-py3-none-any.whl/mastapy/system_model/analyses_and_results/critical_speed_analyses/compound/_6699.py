...
class RootAssemblyCompoundCriticalSpeedAnalysis(_6612.AssemblyCompoundCriticalSpeedAnalysis):
    """RootAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6570.RootAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6570.RootAssemblyCriticalSpeedAnalysis]':
