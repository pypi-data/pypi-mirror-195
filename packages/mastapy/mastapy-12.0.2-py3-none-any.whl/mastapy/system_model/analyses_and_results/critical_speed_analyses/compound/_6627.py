...
class ClutchConnectionCompoundCriticalSpeedAnalysis(_6643.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ClutchConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6495.ClutchConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6495.ClutchConnectionCriticalSpeedAnalysis]':
