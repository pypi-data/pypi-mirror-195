...
class ZerolBevelGearCompoundCriticalSpeedAnalysis(_6621.BevelGearCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6602.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6602.ZerolBevelGearCriticalSpeedAnalysis]':
