...
class VirtualComponentCompoundCriticalSpeedAnalysis(_6682.MountableComponentCompoundCriticalSpeedAnalysis):
    """VirtualComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6598.VirtualComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6598.VirtualComponentCriticalSpeedAnalysis]':
