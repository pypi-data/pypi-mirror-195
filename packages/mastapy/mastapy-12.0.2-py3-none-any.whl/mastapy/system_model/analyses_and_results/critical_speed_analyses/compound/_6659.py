...
class FaceGearMeshCompoundCriticalSpeedAnalysis(_6664.GearMeshCompoundCriticalSpeedAnalysis):
    """FaceGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6530.FaceGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6530.FaceGearMeshCriticalSpeedAnalysis]':
