...
class CVTBeltConnectionCompoundCriticalSpeedAnalysis(_6614.BeltConnectionCompoundCriticalSpeedAnalysis):
    """CVTBeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6516.CVTBeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6516.CVTBeltConnectionCriticalSpeedAnalysis]':
