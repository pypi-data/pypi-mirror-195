...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6667, _6668, _6611
...
class HypoidGearSetCompoundCriticalSpeedAnalysis(_6611.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """HypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6540.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6667.HypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6668.HypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6540.HypoidGearSetCriticalSpeedAnalysis]':
