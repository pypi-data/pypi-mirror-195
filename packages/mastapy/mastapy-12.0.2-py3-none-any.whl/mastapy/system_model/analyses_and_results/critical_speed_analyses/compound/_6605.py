...
class AbstractAssemblyCompoundCriticalSpeedAnalysis(_6684.PartCompoundCriticalSpeedAnalysis):
    """AbstractAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6474.AbstractAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6474.AbstractAssemblyCriticalSpeedAnalysis]':
