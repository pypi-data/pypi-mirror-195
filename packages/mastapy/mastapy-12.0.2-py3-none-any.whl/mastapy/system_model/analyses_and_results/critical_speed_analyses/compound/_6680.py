...
class MassDiscCompoundCriticalSpeedAnalysis(_6727.VirtualComponentCompoundCriticalSpeedAnalysis):
    """MassDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6551.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6551.MassDiscCriticalSpeedAnalysis]':
