...
class PlanetaryConnectionCompoundCriticalSpeedAnalysis(_6702.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """PlanetaryConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6559.PlanetaryConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6559.PlanetaryConnectionCriticalSpeedAnalysis]':
