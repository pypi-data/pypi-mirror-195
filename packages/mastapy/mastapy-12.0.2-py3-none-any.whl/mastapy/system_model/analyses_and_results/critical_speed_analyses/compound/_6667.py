...
class HypoidGearCompoundCriticalSpeedAnalysis(_6609.AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis):
    """HypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6538.HypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6538.HypoidGearCriticalSpeedAnalysis]':
