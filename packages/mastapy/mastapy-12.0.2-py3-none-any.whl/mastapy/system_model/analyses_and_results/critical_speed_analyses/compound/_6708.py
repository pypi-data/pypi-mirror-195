...
class SpringDamperConnectionCompoundCriticalSpeedAnalysis(_6643.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """SpringDamperConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6578.SpringDamperConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6578.SpringDamperConnectionCriticalSpeedAnalysis]':
