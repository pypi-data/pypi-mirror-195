...
class FaceGearCompoundCriticalSpeedAnalysis(_6663.GearCompoundCriticalSpeedAnalysis):
    """FaceGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6529.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6529.FaceGearCriticalSpeedAnalysis]':
