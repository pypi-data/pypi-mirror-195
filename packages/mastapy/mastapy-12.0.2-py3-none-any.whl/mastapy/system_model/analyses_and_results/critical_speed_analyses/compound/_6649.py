...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6629
...
class CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis(_6629.CoaxialConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6520.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6520.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
