...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6621.BevelGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6485.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6485.BevelDifferentialGearCriticalSpeedAnalysis]':
