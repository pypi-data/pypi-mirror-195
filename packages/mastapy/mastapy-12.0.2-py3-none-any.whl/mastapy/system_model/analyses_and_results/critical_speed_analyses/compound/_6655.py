...
class CylindricalPlanetGearCompoundCriticalSpeedAnalysis(_6652.CylindricalGearCompoundCriticalSpeedAnalysis):
    """CylindricalPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6526.CylindricalPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6526.CylindricalPlanetGearCriticalSpeedAnalysis]':
