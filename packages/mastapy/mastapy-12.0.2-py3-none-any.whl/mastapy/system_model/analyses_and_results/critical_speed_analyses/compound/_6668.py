...
class HypoidGearMeshCompoundCriticalSpeedAnalysis(_6610.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """HypoidGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6539.HypoidGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6539.HypoidGearMeshCriticalSpeedAnalysis]':
