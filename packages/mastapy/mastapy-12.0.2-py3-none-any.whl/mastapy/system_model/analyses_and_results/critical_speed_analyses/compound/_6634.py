...
class ConceptGearCompoundCriticalSpeedAnalysis(_6663.GearCompoundCriticalSpeedAnalysis):
    """ConceptGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6503.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6503.ConceptGearCriticalSpeedAnalysis]':
