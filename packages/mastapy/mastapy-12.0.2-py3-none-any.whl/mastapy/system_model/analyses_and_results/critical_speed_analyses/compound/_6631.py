...
class ConceptCouplingCompoundCriticalSpeedAnalysis(_6642.CouplingCompoundCriticalSpeedAnalysis):
    """ConceptCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6501.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6501.ConceptCouplingCriticalSpeedAnalysis]':
