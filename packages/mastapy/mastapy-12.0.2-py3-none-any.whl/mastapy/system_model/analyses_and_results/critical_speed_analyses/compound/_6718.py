...
class SynchroniserCompoundCriticalSpeedAnalysis(_6703.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """SynchroniserCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6589.SynchroniserCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6589.SynchroniserCriticalSpeedAnalysis]':
