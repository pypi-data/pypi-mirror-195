...
class ExternalCADModelCompoundCriticalSpeedAnalysis(_6630.ComponentCompoundCriticalSpeedAnalysis):
    """ExternalCADModelCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6528.ExternalCADModelCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6528.ExternalCADModelCriticalSpeedAnalysis]':
