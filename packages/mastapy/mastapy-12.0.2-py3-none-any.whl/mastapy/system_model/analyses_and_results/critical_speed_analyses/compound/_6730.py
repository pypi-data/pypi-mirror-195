...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6728, _6729, _6665
...
class WormGearSetCompoundCriticalSpeedAnalysis(_6665.GearSetCompoundCriticalSpeedAnalysis):
    """WormGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6601.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gears_compound_critical_speed_analysis(self) -> 'List[_6728.WormGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_compound_critical_speed_analysis(self) -> 'List[_6729.WormGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6601.WormGearSetCriticalSpeedAnalysis]':
