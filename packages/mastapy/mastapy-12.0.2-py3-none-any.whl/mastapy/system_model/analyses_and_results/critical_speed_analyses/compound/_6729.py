...
class WormGearMeshCompoundCriticalSpeedAnalysis(_6664.GearMeshCompoundCriticalSpeedAnalysis):
    """WormGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6600.WormGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6600.WormGearMeshCriticalSpeedAnalysis]':
