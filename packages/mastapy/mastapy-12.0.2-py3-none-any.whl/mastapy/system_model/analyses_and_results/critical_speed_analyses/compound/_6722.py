...
class TorqueConverterCompoundCriticalSpeedAnalysis(_6642.CouplingCompoundCriticalSpeedAnalysis):
    """TorqueConverterCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6594.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6594.TorqueConverterCriticalSpeedAnalysis]':
