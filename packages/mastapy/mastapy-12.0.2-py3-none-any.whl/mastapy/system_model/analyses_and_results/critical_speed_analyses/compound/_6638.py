...
class ConicalGearMeshCompoundCriticalSpeedAnalysis(_6664.GearMeshCompoundCriticalSpeedAnalysis):
    """ConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6507.ConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6507.ConicalGearMeshCriticalSpeedAnalysis]':
