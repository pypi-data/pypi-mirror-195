...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6584, _6585, _6492
...
class StraightBevelGearSetCriticalSpeedAnalysis(_6492.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_gears_critical_speed_analysis(self) -> 'List[_6584.StraightBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_critical_speed_analysis(self) -> 'List[_6585.StraightBevelGearMeshCriticalSpeedAnalysis]':
