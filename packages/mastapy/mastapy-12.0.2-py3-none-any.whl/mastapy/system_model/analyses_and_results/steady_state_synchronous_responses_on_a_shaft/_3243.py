...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3244, _3242, _3254
...
class CylindricalGearSetSteadyStateSynchronousResponseOnAShaft(_3254.GearSetSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3244.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3242.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
