...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3250, _3248, _3254
...
class FaceGearSetSteadyStateSynchronousResponseOnAShaft(_3254.GearSetSteadyStateSynchronousResponseOnAShaft):
    """FaceGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def face_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3250.FaceGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3248.FaceGearMeshSteadyStateSynchronousResponseOnAShaft]':
