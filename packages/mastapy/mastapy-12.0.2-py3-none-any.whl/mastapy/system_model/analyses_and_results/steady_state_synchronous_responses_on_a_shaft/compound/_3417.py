...
class RollingRingCompoundSteadyStateSynchronousResponseOnAShaft(_3364.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """RollingRingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3288.RollingRingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3288.RollingRingSteadyStateSynchronousResponseOnAShaft]':
