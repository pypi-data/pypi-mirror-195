...
class BevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_3329.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3213.BevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3213.BevelGearSteadyStateSynchronousResponseOnAShaft]':
