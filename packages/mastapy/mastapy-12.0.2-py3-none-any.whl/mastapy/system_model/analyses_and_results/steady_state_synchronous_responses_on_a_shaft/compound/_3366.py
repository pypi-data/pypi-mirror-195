...
class CVTCompoundSteadyStateSynchronousResponseOnAShaft(_3335.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft):
    """CVTCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3237.CVTSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3237.CVTSteadyStateSynchronousResponseOnAShaft]':
