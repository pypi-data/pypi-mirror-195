...
class BoltCompoundSteadyStateSynchronousResponseOnAShaft(_3350.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """BoltCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3215.BoltSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3215.BoltSteadyStateSynchronousResponseOnAShaft]':
