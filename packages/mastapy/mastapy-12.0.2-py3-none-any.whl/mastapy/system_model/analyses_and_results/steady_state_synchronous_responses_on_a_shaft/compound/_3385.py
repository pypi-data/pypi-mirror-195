...
class GearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3423.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3254.GearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3254.GearSetSteadyStateSynchronousResponseOnAShaft]':
