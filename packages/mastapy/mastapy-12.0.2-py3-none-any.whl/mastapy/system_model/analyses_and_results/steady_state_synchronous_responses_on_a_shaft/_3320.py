...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3321, _3319, _3254
...
class WormGearSetSteadyStateSynchronousResponseOnAShaft(_3254.GearSetSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def worm_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3321.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3319.WormGearMeshSteadyStateSynchronousResponseOnAShaft]':
