...
class ConnectionSteadyStateSynchronousResponseOnAShaft(_7469.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft(self) -> '_3300.SteadyStateSynchronousResponseOnAShaft':
