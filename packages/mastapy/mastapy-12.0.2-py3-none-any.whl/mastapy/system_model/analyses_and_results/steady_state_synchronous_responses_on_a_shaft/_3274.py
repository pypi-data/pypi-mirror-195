...
class PartSteadyStateSynchronousResponseOnAShaft(_7476.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self) -> '_2216.SteadyStateSynchronousResponseViewable':
