...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3259, _3257, _3200
...
class HypoidGearSetSteadyStateSynchronousResponseOnAShaft(_3200.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseOnAShaft):
    """HypoidGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3259.HypoidGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3257.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft]':
