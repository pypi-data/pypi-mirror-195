...
from mastapy.system_model.analyses_and_results.system_deflections import _2772, _2771, _2773
...
class SynchroniserPartHarmonicAnalysis(_5658.CouplingHalfHarmonicAnalysis):
    """SynchroniserPartHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2772.SynchroniserPartSystemDeflection':
