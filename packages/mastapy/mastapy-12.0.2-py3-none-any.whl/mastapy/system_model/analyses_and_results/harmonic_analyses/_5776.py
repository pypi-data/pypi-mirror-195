...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5774, _5775, _5637
...
class ZerolBevelGearSetHarmonicAnalysis(_5637.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5774.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis(self) -> 'List[_5774.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5775.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis(self) -> 'List[_5775.ZerolBevelGearMeshHarmonicAnalysis]':
