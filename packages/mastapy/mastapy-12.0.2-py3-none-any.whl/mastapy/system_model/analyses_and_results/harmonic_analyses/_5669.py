...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5667, _5668, _5696
...
class CylindricalGearSetHarmonicAnalysis(_5696.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5667.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5667.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5668.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5668.CylindricalGearMeshHarmonicAnalysis]':
