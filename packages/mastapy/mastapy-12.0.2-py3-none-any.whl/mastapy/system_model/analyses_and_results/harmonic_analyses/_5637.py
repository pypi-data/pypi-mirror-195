...
class BevelGearSetHarmonicAnalysis(_5625.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """BevelGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2657.BevelGearSetSystemDeflection':
