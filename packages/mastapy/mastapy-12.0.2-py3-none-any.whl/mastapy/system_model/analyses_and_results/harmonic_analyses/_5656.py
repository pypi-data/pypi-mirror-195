...
class ConnectorHarmonicAnalysis(_5720.MountableComponentHarmonicAnalysis):
    """ConnectorHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2678.ConnectorSystemDeflection':
