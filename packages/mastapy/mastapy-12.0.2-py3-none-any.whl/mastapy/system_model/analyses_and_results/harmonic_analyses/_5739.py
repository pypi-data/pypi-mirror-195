...
class RootAssemblyHarmonicAnalysis(_5626.AssemblyHarmonicAnalysis):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5703.HarmonicAnalysisRootAssemblyExportOptions':
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2587.HarmonicAnalysis':
