...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5771, _5772, _5696
...
class WormGearSetHarmonicAnalysis(_5696.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5771.WormGearHarmonicAnalysis]':
    ...
    @property
    def worm_gears_harmonic_analysis(self) -> 'List[_5771.WormGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5772.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_harmonic_analysis(self) -> 'List[_5772.WormGearMeshHarmonicAnalysis]':
