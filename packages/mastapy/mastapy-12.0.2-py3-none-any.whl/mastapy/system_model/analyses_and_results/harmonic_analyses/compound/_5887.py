...
class MassDiscCompoundHarmonicAnalysis(_5934.VirtualComponentCompoundHarmonicAnalysis):
    """MassDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5718.MassDiscHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5718.MassDiscHarmonicAnalysis]':
