...
class PartCompoundHarmonicAnalysis(_7474.PartCompoundAnalysis):
    """PartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5722.PartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5722.PartHarmonicAnalysis]':
