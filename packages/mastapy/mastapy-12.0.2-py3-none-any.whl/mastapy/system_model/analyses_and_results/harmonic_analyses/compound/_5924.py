...
class StraightBevelSunGearCompoundHarmonicAnalysis(_5917.StraightBevelDiffGearCompoundHarmonicAnalysis):
    """StraightBevelSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5759.StraightBevelSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5759.StraightBevelSunGearHarmonicAnalysis]':
