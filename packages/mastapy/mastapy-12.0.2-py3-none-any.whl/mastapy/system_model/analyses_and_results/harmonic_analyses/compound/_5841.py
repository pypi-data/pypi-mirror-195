...
class ConceptGearCompoundHarmonicAnalysis(_5870.GearCompoundHarmonicAnalysis):
    """ConceptGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5649.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5649.ConceptGearHarmonicAnalysis]':
