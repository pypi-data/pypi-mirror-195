...
class GuideDxfModelCompoundHarmonicAnalysis(_5837.ComponentCompoundHarmonicAnalysis):
    """GuideDxfModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5698.GuideDxfModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5698.GuideDxfModelHarmonicAnalysis]':
