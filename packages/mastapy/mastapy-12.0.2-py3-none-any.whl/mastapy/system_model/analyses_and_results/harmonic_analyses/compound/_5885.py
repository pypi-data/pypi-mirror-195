...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundHarmonicAnalysis(_5879.KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5716.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5716.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
