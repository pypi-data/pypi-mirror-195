...
class BevelGearCompoundHarmonicAnalysis(_5816.AGMAGleasonConicalGearCompoundHarmonicAnalysis):
    """BevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5635.BevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5635.BevelGearHarmonicAnalysis]':
