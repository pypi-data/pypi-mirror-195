...
class TorqueConverterCompoundHarmonicAnalysis(_5849.CouplingCompoundHarmonicAnalysis):
    """TorqueConverterCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5765.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5765.TorqueConverterHarmonicAnalysis]':
