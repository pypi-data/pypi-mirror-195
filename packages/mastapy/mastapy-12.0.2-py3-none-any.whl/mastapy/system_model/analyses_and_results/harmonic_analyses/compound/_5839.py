...
class ConceptCouplingConnectionCompoundHarmonicAnalysis(_5850.CouplingConnectionCompoundHarmonicAnalysis):
    """ConceptCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5646.ConceptCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5646.ConceptCouplingConnectionHarmonicAnalysis]':
