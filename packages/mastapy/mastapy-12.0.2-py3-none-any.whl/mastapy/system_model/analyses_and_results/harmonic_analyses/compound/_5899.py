...
class PowerLoadCompoundHarmonicAnalysis(_5934.VirtualComponentCompoundHarmonicAnalysis):
    """PowerLoadCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5731.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5731.PowerLoadHarmonicAnalysis]':
