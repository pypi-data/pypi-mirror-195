...
class BevelDifferentialGearMeshCompoundHarmonicAnalysis(_5829.BevelGearMeshCompoundHarmonicAnalysis):
    """BevelDifferentialGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5631.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5631.BevelDifferentialGearMeshHarmonicAnalysis]':
