...
class ShaftHubConnectionCompoundHarmonicAnalysis(_5848.ConnectorCompoundHarmonicAnalysis):
    """ShaftHubConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5741.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5741.ShaftHubConnectionHarmonicAnalysis]':
