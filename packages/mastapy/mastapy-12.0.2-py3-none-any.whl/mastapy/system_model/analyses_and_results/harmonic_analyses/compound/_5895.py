...
class PlanetaryConnectionCompoundHarmonicAnalysis(_5909.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """PlanetaryConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5727.PlanetaryConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5727.PlanetaryConnectionHarmonicAnalysis]':
