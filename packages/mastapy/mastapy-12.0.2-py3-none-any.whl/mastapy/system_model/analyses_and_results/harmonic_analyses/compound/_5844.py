...
class ConicalGearCompoundHarmonicAnalysis(_5870.GearCompoundHarmonicAnalysis):
    """ConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5652.ConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5652.ConicalGearHarmonicAnalysis]':
