...
class HypoidGearMeshCompoundHarmonicAnalysis(_5817.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis):
    """HypoidGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5706.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5706.HypoidGearMeshHarmonicAnalysis]':
