...
class OilSealCompoundHarmonicAnalysis(_5848.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5721.OilSealHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5721.OilSealHarmonicAnalysis]':
