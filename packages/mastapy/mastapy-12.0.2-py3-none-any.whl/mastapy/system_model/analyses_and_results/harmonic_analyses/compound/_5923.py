...
class StraightBevelPlanetGearCompoundHarmonicAnalysis(_5917.StraightBevelDiffGearCompoundHarmonicAnalysis):
    """StraightBevelPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5758.StraightBevelPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5758.StraightBevelPlanetGearHarmonicAnalysis]':
