...
class HypoidGearCompoundHarmonicAnalysis(_5816.AGMAGleasonConicalGearCompoundHarmonicAnalysis):
    """HypoidGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5705.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5705.HypoidGearHarmonicAnalysis]':
