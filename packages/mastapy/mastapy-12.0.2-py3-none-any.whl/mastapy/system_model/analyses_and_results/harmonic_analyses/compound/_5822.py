...
class BeltDriveCompoundHarmonicAnalysis(_5910.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BeltDriveCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5629.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5629.BeltDriveHarmonicAnalysis]':
