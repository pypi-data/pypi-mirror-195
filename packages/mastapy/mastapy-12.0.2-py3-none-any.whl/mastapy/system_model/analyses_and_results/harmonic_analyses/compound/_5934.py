...
class VirtualComponentCompoundHarmonicAnalysis(_5889.MountableComponentCompoundHarmonicAnalysis):
    """VirtualComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5770.VirtualComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5770.VirtualComponentHarmonicAnalysis]':
