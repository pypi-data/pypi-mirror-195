...
class ZerolBevelGearMeshCompoundHarmonicAnalysis(_5829.BevelGearMeshCompoundHarmonicAnalysis):
    """ZerolBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5775.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5775.ZerolBevelGearMeshHarmonicAnalysis]':
