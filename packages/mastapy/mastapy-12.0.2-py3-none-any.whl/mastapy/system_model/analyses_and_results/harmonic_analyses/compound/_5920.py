...
class StraightBevelGearCompoundHarmonicAnalysis(_5828.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5755.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5755.StraightBevelGearHarmonicAnalysis]':
