...
class PlanetCarrierCompoundHarmonicAnalysis(_5889.MountableComponentCompoundHarmonicAnalysis):
    """PlanetCarrierCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5729.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5729.PlanetCarrierHarmonicAnalysis]':
