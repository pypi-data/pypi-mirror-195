...
class SpringDamperConnectionCompoundHarmonicAnalysis(_5850.CouplingConnectionCompoundHarmonicAnalysis):
    """SpringDamperConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5749.SpringDamperConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5749.SpringDamperConnectionHarmonicAnalysis]':
