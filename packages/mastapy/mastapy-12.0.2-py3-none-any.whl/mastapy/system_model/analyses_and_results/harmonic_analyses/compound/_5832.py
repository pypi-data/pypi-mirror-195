...
class BoltedJointCompoundHarmonicAnalysis(_5910.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BoltedJointCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5638.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5638.BoltedJointHarmonicAnalysis]':
