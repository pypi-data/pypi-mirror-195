...
class RingPinsToDiscConnectionCompoundHarmonicAnalysis(_5877.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """RingPinsToDiscConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5735.RingPinsToDiscConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5735.RingPinsToDiscConnectionHarmonicAnalysis]':
