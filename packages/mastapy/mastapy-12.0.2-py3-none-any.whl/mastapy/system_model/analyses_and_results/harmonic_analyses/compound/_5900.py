...
class PulleyCompoundHarmonicAnalysis(_5851.CouplingHalfCompoundHarmonicAnalysis):
    """PulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5732.PulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5732.PulleyHarmonicAnalysis]':
