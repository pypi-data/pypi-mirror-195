...
class CoaxialConnectionCompoundHarmonicAnalysis(_5909.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5643.CoaxialConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5643.CoaxialConnectionHarmonicAnalysis]':
