...
class TorqueConverterPumpCompoundHarmonicAnalysis(_5851.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterPumpCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5766.TorqueConverterPumpHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5766.TorqueConverterPumpHarmonicAnalysis]':
