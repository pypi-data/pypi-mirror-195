...
class AbstractAssemblyCompoundHarmonicAnalysis(_5891.PartCompoundHarmonicAnalysis):
    """AbstractAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5618.AbstractAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5618.AbstractAssemblyHarmonicAnalysis]':
