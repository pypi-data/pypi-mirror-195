...
class WormGearCompoundHarmonicAnalysis(_5870.GearCompoundHarmonicAnalysis):
    """WormGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5771.WormGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5771.WormGearHarmonicAnalysis]':
