...
class ConceptGearMeshCompoundHarmonicAnalysis(_5871.GearMeshCompoundHarmonicAnalysis):
    """ConceptGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5650.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5650.ConceptGearMeshHarmonicAnalysis]':
