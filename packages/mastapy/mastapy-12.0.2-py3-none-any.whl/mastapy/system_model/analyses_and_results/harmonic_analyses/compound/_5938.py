...
class ZerolBevelGearCompoundHarmonicAnalysis(_5828.BevelGearCompoundHarmonicAnalysis):
    """ZerolBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5774.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5774.ZerolBevelGearHarmonicAnalysis]':
