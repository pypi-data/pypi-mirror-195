...
class CouplingHalfCompoundHarmonicAnalysis(_5889.MountableComponentCompoundHarmonicAnalysis):
    """CouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5658.CouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5658.CouplingHalfHarmonicAnalysis]':
