...
class MeasurementComponentCompoundHarmonicAnalysis(_5934.VirtualComponentCompoundHarmonicAnalysis):
    """MeasurementComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5719.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5719.MeasurementComponentHarmonicAnalysis]':
