...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5804, _5787
...
class SingleWhineAnalysisResultsPropertyAccessor(_5787.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5804.ResultsForOrderIncludingNodes]':
