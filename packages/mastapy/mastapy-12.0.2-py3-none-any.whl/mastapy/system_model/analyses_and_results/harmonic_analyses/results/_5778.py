...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5781, _5779
...
class ExcitationSourceSelection(_5779.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5781.HarmonicSelection]':
