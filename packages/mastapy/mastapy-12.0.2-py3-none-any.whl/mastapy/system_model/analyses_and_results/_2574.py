...
class CompoundAnalysis(_7481.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    def perform_analysis_with_progress(self, progress: '_7487.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2164.DesignEntity') -> 'Iterable[_7471.DesignEntityCompoundAnalysis]':
