...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5988, _5989, _6001
...
class CylindricalGearSetHarmonicAnalysisOfSingleExcitation(_6001.GearSetHarmonicAnalysisOfSingleExcitation):
    """CylindricalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def cylindrical_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5988.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5989.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
