...
class PointLoadCompoundHarmonicAnalysisOfSingleExcitation(_6193.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PointLoadCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6028.PointLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6028.PointLoadHarmonicAnalysisOfSingleExcitation]':
