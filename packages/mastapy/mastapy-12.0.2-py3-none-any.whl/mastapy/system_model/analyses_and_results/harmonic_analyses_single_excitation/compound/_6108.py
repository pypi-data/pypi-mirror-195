...
class CouplingCompoundHarmonicAnalysisOfSingleExcitation(_6169.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """CouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5980.CouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5980.CouplingHarmonicAnalysisOfSingleExcitation]':
