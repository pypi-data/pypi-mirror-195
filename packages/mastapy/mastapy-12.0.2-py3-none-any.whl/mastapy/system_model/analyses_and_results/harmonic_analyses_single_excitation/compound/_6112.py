...
class CVTCompoundHarmonicAnalysisOfSingleExcitation(_6081.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5982.CVTHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5982.CVTHarmonicAnalysisOfSingleExcitation]':
