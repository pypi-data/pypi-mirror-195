...
class BearingCompoundHarmonicAnalysisOfSingleExcitation(_6107.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """BearingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5949.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5949.BearingHarmonicAnalysisOfSingleExcitation]':
