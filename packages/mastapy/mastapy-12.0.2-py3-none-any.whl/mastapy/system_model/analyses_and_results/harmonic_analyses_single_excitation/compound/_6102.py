...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6100, _6101, _6131
...
class ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6131.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5972.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6100.ConceptGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6101.ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5972.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
