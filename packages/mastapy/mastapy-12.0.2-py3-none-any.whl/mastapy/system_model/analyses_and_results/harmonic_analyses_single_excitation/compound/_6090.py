...
class BoltCompoundHarmonicAnalysisOfSingleExcitation(_6096.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """BoltCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5961.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5961.BoltHarmonicAnalysisOfSingleExcitation]':
