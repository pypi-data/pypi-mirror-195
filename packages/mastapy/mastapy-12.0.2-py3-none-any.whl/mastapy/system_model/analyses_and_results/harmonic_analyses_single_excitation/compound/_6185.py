...
class SynchroniserHalfCompoundHarmonicAnalysisOfSingleExcitation(_6186.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6055.SynchroniserHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6055.SynchroniserHalfHarmonicAnalysisOfSingleExcitation]':
