...
class BoltedJointCompoundHarmonicAnalysisOfSingleExcitation(_6169.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """BoltedJointCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5960.BoltedJointHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5960.BoltedJointHarmonicAnalysisOfSingleExcitation]':
