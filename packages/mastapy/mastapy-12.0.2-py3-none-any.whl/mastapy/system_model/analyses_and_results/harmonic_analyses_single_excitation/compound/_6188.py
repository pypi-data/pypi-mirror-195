...
class TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation(_6108.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6060.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6060.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
