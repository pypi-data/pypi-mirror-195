...
from mastapy.system_model.analyses_and_results.static_loads import _6878, _6734
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self) -> 'List[_6878.RootAssemblyLoadCase]':
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7487.TaskProgress') -> 'List[_6734.LoadCase]':
    ...
    def perform_pst_with_progress(self, progress: '_7487.TaskProgress'):
