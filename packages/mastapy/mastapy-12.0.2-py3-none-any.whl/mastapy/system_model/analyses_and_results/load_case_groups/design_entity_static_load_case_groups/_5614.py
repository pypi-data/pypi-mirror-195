...
TConnection = TypeVar('TConnection', bound='_2230.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6779.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5615.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    """ConnectionStaticLoadCaseGroup
