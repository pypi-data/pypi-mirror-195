...
TReal = TypeVar('TReal', bound='_2400.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6767.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5617.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    """ComponentStaticLoadCaseGroup
