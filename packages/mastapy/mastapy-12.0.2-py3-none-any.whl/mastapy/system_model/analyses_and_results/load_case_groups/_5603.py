...
from mastapy.system_model.analyses_and_results.load_case_groups import _5601, _5602, _5598
...
class DesignState(_5598.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self) -> 'List[_5601.ClutchEngagementStatus]':
    ...
    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5602.ConceptSynchroGearEngagementStatus]':
    ...
    def clutch_engagement_status_for(self, clutch_connection: '_2300.ClutchConnection') -> '_5601.ClutchEngagementStatus':
    ...
    def concept_synchro_gear_engagement_status_for(self, gear: '_2480.CylindricalGear') -> '_5602.ConceptSynchroGearEngagementStatus':
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6735.StaticLoadCase':
