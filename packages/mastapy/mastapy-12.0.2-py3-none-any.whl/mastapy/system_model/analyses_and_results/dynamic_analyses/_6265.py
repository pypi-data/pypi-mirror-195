...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6263, _6264, _6270
...
class FaceGearSetDynamicAnalysis(_6270.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6263.FaceGearDynamicAnalysis]':
    ...
    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6264.FaceGearMeshDynamicAnalysis]':
