...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6220, _6221, _6227
...
class BevelDifferentialGearSetDynamicAnalysis(_6227.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6220.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6221.BevelDifferentialGearMeshDynamicAnalysis]':
