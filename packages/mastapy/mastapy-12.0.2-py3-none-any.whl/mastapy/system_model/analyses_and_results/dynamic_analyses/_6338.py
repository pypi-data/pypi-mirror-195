...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6336, _6337, _6227
...
class ZerolBevelGearSetDynamicAnalysis(_6227.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6336.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6337.ZerolBevelGearMeshDynamicAnalysis]':
