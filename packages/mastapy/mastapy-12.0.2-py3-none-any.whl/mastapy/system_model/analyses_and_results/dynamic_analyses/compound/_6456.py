...
class TorqueConverterCompoundDynamicAnalysis(_6376.CouplingCompoundDynamicAnalysis):
    """TorqueConverterCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6328.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6328.TorqueConverterDynamicAnalysis]':
