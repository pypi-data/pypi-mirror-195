...
class AbstractAssemblyCompoundDynamicAnalysis(_6418.PartCompoundDynamicAnalysis):
    """AbstractAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6209.AbstractAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6209.AbstractAssemblyDynamicAnalysis]':
