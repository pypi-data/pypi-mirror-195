...
class RootAssemblyCompoundDynamicAnalysis(_6346.AssemblyCompoundDynamicAnalysis):
    """RootAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6304.RootAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6304.RootAssemblyDynamicAnalysis]':
