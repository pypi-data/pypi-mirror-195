...
class StraightBevelPlanetGearCompoundDynamicAnalysis(_6444.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6321.StraightBevelPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6321.StraightBevelPlanetGearDynamicAnalysis]':
