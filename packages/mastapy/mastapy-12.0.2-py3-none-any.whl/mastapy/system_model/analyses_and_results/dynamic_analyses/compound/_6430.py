...
class RollingRingAssemblyCompoundDynamicAnalysis(_6437.SpecialisedAssemblyCompoundDynamicAnalysis):
    """RollingRingAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6301.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6301.RollingRingAssemblyDynamicAnalysis]':
