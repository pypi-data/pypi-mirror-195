...
class BoltedJointCompoundDynamicAnalysis(_6437.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BoltedJointCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6229.BoltedJointDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6229.BoltedJointDynamicAnalysis]':
