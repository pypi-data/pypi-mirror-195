...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6401, _6402, _6345
...
class HypoidGearSetCompoundDynamicAnalysis(_6345.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    """HypoidGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6274.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_dynamic_analysis(self) -> 'List[_6401.HypoidGearCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_dynamic_analysis(self) -> 'List[_6402.HypoidGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6274.HypoidGearSetDynamicAnalysis]':
