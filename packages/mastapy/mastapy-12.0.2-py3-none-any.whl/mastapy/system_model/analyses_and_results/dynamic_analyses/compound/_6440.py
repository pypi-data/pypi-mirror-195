...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6438, _6439, _6357
...
class SpiralBevelGearSetCompoundDynamicAnalysis(_6357.BevelGearSetCompoundDynamicAnalysis):
    """SpiralBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6311.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6438.SpiralBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6439.SpiralBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6311.SpiralBevelGearSetDynamicAnalysis]':
