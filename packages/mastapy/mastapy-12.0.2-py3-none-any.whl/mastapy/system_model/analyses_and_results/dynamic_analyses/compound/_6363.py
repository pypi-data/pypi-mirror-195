...
class CoaxialConnectionCompoundDynamicAnalysis(_6436.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CoaxialConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6233.CoaxialConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6233.CoaxialConnectionDynamicAnalysis]':
