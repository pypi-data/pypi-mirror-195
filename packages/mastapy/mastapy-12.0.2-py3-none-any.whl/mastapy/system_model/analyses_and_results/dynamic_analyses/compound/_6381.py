...
class CVTPulleyCompoundDynamicAnalysis(_6427.PulleyCompoundDynamicAnalysis):
    """CVTPulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6251.CVTPulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6251.CVTPulleyDynamicAnalysis]':
