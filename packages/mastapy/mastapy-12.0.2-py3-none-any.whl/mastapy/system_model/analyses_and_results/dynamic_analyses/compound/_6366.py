...
class ConceptCouplingConnectionCompoundDynamicAnalysis(_6377.CouplingConnectionCompoundDynamicAnalysis):
    """ConceptCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6235.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6235.ConceptCouplingConnectionDynamicAnalysis]':
