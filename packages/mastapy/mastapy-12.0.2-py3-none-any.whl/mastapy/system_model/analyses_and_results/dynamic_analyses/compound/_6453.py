...
class SynchroniserHalfCompoundDynamicAnalysis(_6454.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6324.SynchroniserHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6324.SynchroniserHalfDynamicAnalysis]':
