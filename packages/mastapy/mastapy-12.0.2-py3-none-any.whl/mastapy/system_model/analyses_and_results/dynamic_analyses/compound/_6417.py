...
class OilSealCompoundDynamicAnalysis(_6375.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6288.OilSealDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6288.OilSealDynamicAnalysis]':
