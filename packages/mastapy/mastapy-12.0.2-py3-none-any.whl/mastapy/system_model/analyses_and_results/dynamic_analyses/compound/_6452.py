...
class SynchroniserCompoundDynamicAnalysis(_6437.SpecialisedAssemblyCompoundDynamicAnalysis):
    """SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6323.SynchroniserDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6323.SynchroniserDynamicAnalysis]':
