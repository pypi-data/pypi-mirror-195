...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import (
    _6347, _6349, _6352, _6359,
    _6358, _6380, _6360, _6365,
    _6370, _6382, _6384, _6388,
    _6395, _6394, _6396, _6403,
    _6410, _6413, _6414, _6415,
    _6417, _6419, _6424, _6425,
    _6426, _6428, _6430, _6435,
    _6434, _6440, _6441, _6446,
    _6449, _6452, _6456, _6460,
    _6464, _6467, _6339
)
...
class AssemblyCompoundDynamicAnalysis(_6339.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6216.AssemblyDynamicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6347.BearingCompoundDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6349.BeltDriveCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6352.BevelDifferentialGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6359.BoltedJointCompoundDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6358.BoltCompoundDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6380.CVTCompoundDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6360.ClutchCompoundDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6365.ConceptCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6370.ConceptGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6382.CycloidalAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6384.CycloidalDiscCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6388.CylindricalGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6395.FEPartCompoundDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6394.FaceGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6396.FlexiblePinAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6403.HypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6410.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6413.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6414.MassDiscCompoundDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6415.MeasurementComponentCompoundDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6417.OilSealCompoundDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6419.PartToPartShearCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6424.PlanetCarrierCompoundDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6425.PointLoadCompoundDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6426.PowerLoadCompoundDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6428.RingPinsCompoundDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6430.RollingRingAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6435.ShaftHubConnectionCompoundDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6434.ShaftCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6440.SpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6441.SpringDamperCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6446.StraightBevelDiffGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6449.StraightBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6452.SynchroniserCompoundDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6456.TorqueConverterCompoundDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6460.UnbalancedMassCompoundDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6464.WormGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6467.ZerolBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6216.AssemblyDynamicAnalysis]':
