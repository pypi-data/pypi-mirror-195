...
class CVTCompoundDynamicAnalysis(_6349.BeltDriveCompoundDynamicAnalysis):
    """CVTCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6250.CVTDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6250.CVTDynamicAnalysis]':
