...
class MeasurementComponentCompoundDynamicAnalysis(_6461.VirtualComponentCompoundDynamicAnalysis):
    """MeasurementComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6286.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6286.MeasurementComponentDynamicAnalysis]':
