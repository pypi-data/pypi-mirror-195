...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6392, _6393, _6399
...
class FaceGearSetCompoundDynamicAnalysis(_6399.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6265.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_6392.FaceGearCompoundDynamicAnalysis]':
    ...
    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_6393.FaceGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6265.FaceGearSetDynamicAnalysis]':
