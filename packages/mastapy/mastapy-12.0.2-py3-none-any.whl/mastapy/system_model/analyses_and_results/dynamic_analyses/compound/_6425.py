...
class PointLoadCompoundDynamicAnalysis(_6461.VirtualComponentCompoundDynamicAnalysis):
    """PointLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6296.PointLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6296.PointLoadDynamicAnalysis]':
