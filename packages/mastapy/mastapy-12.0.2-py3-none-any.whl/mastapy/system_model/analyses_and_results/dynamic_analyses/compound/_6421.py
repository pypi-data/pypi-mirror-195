...
class PartToPartShearCouplingHalfCompoundDynamicAnalysis(_6378.CouplingHalfCompoundDynamicAnalysis):
    """PartToPartShearCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6292.PartToPartShearCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6292.PartToPartShearCouplingHalfDynamicAnalysis]':
