...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6355.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6315.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6315.StraightBevelDiffGearDynamicAnalysis]':
