...
class VirtualComponentCompoundDynamicAnalysis(_6416.MountableComponentCompoundDynamicAnalysis):
    """VirtualComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6332.VirtualComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6332.VirtualComponentDynamicAnalysis]':
