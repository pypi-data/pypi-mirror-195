...
class PlanetCarrierCompoundDynamicAnalysis(_6416.MountableComponentCompoundDynamicAnalysis):
    """PlanetCarrierCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6295.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6295.PlanetCarrierDynamicAnalysis]':
