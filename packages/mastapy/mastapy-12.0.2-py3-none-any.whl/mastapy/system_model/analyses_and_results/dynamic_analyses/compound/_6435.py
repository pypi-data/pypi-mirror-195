...
class ShaftHubConnectionCompoundDynamicAnalysis(_6375.ConnectorCompoundDynamicAnalysis):
    """ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6306.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6306.ShaftHubConnectionDynamicAnalysis]':
