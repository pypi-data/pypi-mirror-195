...
class ConicalGearMeshCompoundDynamicAnalysis(_6398.GearMeshCompoundDynamicAnalysis):
    """ConicalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6242.ConicalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6242.ConicalGearMeshDynamicAnalysis]':
