...
class ConicalGearSetCompoundDynamicAnalysis(_6399.GearSetCompoundDynamicAnalysis):
    """ConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6243.ConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6243.ConicalGearSetDynamicAnalysis]':
