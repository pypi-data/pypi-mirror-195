...
class StraightBevelGearCompoundDynamicAnalysis(_6355.BevelGearCompoundDynamicAnalysis):
    """StraightBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6318.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6318.StraightBevelGearDynamicAnalysis]':
