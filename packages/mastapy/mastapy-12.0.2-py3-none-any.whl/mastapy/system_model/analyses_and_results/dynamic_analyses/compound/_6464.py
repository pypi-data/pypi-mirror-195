...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6462, _6463, _6399
...
class WormGearSetCompoundDynamicAnalysis(_6399.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6335.WormGearSetDynamicAnalysis]':
    ...
    @property
    def worm_gears_compound_dynamic_analysis(self) -> 'List[_6462.WormGearCompoundDynamicAnalysis]':
    ...
    @property
    def worm_meshes_compound_dynamic_analysis(self) -> 'List[_6463.WormGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6335.WormGearSetDynamicAnalysis]':
