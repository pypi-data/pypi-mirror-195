...
class FlexiblePinAssemblyCompoundDynamicAnalysis(_6437.SpecialisedAssemblyCompoundDynamicAnalysis):
    """FlexiblePinAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6267.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6267.FlexiblePinAssemblyDynamicAnalysis]':
