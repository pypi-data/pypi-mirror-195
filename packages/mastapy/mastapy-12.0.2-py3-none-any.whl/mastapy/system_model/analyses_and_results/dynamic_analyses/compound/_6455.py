...
class SynchroniserSleeveCompoundDynamicAnalysis(_6454.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6326.SynchroniserSleeveDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6326.SynchroniserSleeveDynamicAnalysis]':
