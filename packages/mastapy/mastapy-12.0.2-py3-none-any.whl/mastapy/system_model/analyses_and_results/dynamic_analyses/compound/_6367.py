...
class ConceptCouplingHalfCompoundDynamicAnalysis(_6378.CouplingHalfCompoundDynamicAnalysis):
    """ConceptCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6237.ConceptCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6237.ConceptCouplingHalfDynamicAnalysis]':
