...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6364.ComponentCompoundDynamicAnalysis):
    """AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6211.AbstractShaftOrHousingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6211.AbstractShaftOrHousingDynamicAnalysis]':
