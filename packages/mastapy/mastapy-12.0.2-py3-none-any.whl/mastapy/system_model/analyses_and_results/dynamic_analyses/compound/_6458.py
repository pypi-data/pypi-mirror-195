...
class TorqueConverterPumpCompoundDynamicAnalysis(_6378.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6329.TorqueConverterPumpDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6329.TorqueConverterPumpDynamicAnalysis]':
