...
class PlanetaryGearSetCompoundDynamicAnalysis(_6388.CylindricalGearSetCompoundDynamicAnalysis):
    """PlanetaryGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6294.PlanetaryGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6294.PlanetaryGearSetDynamicAnalysis]':
