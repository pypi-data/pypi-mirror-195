...
class PowerLoadCompoundDynamicAnalysis(_6461.VirtualComponentCompoundDynamicAnalysis):
    """PowerLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6297.PowerLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6297.PowerLoadDynamicAnalysis]':
