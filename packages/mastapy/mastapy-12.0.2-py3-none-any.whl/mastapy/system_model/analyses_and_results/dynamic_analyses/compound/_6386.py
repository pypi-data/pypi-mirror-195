...
class CylindricalGearCompoundDynamicAnalysis(_6397.GearCompoundDynamicAnalysis):
    """CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6256.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6256.CylindricalGearDynamicAnalysis]':
