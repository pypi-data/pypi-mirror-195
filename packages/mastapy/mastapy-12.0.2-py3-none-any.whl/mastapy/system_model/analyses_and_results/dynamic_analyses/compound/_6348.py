...
class BeltConnectionCompoundDynamicAnalysis(_6404.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """BeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6218.BeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6218.BeltConnectionDynamicAnalysis]':
