...
class SpringDamperConnectionCompoundDynamicAnalysis(_6377.CouplingConnectionCompoundDynamicAnalysis):
    """SpringDamperConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6312.SpringDamperConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6312.SpringDamperConnectionDynamicAnalysis]':
