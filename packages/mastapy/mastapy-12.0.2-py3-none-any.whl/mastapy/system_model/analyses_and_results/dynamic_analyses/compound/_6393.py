...
class FaceGearMeshCompoundDynamicAnalysis(_6398.GearMeshCompoundDynamicAnalysis):
    """FaceGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6264.FaceGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6264.FaceGearMeshDynamicAnalysis]':
