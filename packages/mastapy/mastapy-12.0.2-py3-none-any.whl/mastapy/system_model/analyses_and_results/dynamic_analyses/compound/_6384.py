...
class CycloidalDiscCompoundDynamicAnalysis(_6340.AbstractShaftCompoundDynamicAnalysis):
    """CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6254.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6254.CycloidalDiscDynamicAnalysis]':
