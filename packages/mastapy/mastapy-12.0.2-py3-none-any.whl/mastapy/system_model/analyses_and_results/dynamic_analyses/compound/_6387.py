...
class CylindricalGearMeshCompoundDynamicAnalysis(_6398.GearMeshCompoundDynamicAnalysis):
    """CylindricalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6257.CylindricalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6257.CylindricalGearMeshDynamicAnalysis]':
