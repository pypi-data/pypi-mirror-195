...
class CouplingHalfCompoundDynamicAnalysis(_6416.MountableComponentCompoundDynamicAnalysis):
    """CouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6248.CouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6248.CouplingHalfDynamicAnalysis]':
