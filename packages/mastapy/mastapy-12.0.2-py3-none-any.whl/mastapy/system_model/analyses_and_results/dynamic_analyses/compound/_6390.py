...
class DatumCompoundDynamicAnalysis(_6364.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6260.DatumDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6260.DatumDynamicAnalysis]':
