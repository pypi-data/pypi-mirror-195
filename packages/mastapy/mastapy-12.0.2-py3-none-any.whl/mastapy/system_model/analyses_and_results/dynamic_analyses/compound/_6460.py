...
class UnbalancedMassCompoundDynamicAnalysis(_6461.VirtualComponentCompoundDynamicAnalysis):
    """UnbalancedMassCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6331.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6331.UnbalancedMassDynamicAnalysis]':
