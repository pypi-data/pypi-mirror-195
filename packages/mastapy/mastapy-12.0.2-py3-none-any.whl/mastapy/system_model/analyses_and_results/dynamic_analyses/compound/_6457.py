...
class TorqueConverterConnectionCompoundDynamicAnalysis(_6377.CouplingConnectionCompoundDynamicAnalysis):
    """TorqueConverterConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6327.TorqueConverterConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6327.TorqueConverterConnectionDynamicAnalysis]':
