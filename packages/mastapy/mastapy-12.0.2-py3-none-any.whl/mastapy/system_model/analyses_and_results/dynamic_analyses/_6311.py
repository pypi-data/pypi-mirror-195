...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6309, _6310, _6227
...
class SpiralBevelGearSetDynamicAnalysis(_6227.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6309.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6310.SpiralBevelGearMeshDynamicAnalysis]':
