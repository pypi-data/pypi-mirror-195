...
from mastapy.system_model.analyses_and_results.modal_analyses import _2584
...
class ConnectionDynamicAnalysis(_7468.ConnectionFEAnalysis):
    """ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_2581.DynamicAnalysis':
