...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6256, _6257, _6270
...
class CylindricalGearSetDynamicAnalysis(_6270.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_6256.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_6257.CylindricalGearMeshDynamicAnalysis]':
