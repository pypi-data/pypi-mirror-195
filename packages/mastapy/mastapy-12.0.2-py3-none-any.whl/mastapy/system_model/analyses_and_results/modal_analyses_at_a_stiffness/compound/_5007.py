...
class MountableComponentCompoundModalAnalysisAtAStiffness(_4955.ComponentCompoundModalAnalysisAtAStiffness):
    """MountableComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4878.MountableComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4878.MountableComponentModalAnalysisAtAStiffness]':
