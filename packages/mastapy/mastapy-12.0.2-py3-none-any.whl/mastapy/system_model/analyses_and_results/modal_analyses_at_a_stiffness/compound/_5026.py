...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(_4966.ConnectorCompoundModalAnalysisAtAStiffness):
    """ShaftHubConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4896.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4896.ShaftHubConnectionModalAnalysisAtAStiffness]':
