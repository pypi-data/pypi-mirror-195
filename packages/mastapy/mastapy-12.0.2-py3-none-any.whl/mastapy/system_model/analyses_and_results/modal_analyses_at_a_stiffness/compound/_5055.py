...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5053, _5054, _4990
...
class WormGearSetCompoundModalAnalysisAtAStiffness(_4990.GearSetCompoundModalAnalysisAtAStiffness):
    """WormGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4926.WormGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5053.WormGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5054.WormGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4926.WormGearSetModalAnalysisAtAStiffness]':
