...
class ConnectorCompoundModalAnalysisAtAStiffness(_5007.MountableComponentCompoundModalAnalysisAtAStiffness):
    """ConnectorCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4836.ConnectorModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4836.ConnectorModalAnalysisAtAStiffness]':
