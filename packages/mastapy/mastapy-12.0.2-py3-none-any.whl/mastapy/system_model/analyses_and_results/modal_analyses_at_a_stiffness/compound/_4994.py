...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4992, _4993, _4936
...
class HypoidGearSetCompoundModalAnalysisAtAStiffness(_4936.AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness):
    """HypoidGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4865.HypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4992.HypoidGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4993.HypoidGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4865.HypoidGearSetModalAnalysisAtAStiffness]':
