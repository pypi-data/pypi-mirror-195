...
class RootAssemblyCompoundModalAnalysisAtAStiffness(_4937.AssemblyCompoundModalAnalysisAtAStiffness):
    """RootAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4895.RootAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4895.RootAssemblyModalAnalysisAtAStiffness]':
