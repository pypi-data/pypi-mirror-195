...
class CylindricalPlanetGearCompoundModalAnalysisAtAStiffness(_4977.CylindricalGearCompoundModalAnalysisAtAStiffness):
    """CylindricalPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4850.CylindricalPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4850.CylindricalPlanetGearModalAnalysisAtAStiffness]':
