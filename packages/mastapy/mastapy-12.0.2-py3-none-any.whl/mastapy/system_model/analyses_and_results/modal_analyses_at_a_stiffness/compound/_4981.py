...
class DatumCompoundModalAnalysisAtAStiffness(_4955.ComponentCompoundModalAnalysisAtAStiffness):
    """DatumCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4851.DatumModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4851.DatumModalAnalysisAtAStiffness]':
