...
class AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness(_4963.ConicalGearMeshCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4804.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4804.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
