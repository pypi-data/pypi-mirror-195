...
class ConicalGearCompoundModalAnalysisAtAStiffness(_4988.GearCompoundModalAnalysisAtAStiffness):
    """ConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4833.ConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4833.ConicalGearModalAnalysisAtAStiffness]':
