...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(_4955.ComponentCompoundModalAnalysisAtAStiffness):
    """ExternalCADModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4853.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4853.ExternalCADModelModalAnalysisAtAStiffness]':
