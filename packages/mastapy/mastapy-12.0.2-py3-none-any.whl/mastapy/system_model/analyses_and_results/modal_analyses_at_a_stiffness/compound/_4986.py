...
class FEPartCompoundModalAnalysisAtAStiffness(_4932.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """FEPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4857.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4857.FEPartModalAnalysisAtAStiffness]':
