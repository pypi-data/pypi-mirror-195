...
class ConnectionCompoundModalAnalysisAtAStiffness(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4835.ConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4835.ConnectionModalAnalysisAtAStiffness]':
