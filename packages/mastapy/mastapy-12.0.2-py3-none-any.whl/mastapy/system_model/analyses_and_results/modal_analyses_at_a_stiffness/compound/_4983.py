...
class FaceGearCompoundModalAnalysisAtAStiffness(_4988.GearCompoundModalAnalysisAtAStiffness):
    """FaceGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4855.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4855.FaceGearModalAnalysisAtAStiffness]':
