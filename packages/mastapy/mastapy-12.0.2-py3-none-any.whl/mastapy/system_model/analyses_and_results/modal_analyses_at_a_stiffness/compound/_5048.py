...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(_4968.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4918.TorqueConverterConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4918.TorqueConverterConnectionModalAnalysisAtAStiffness]':
