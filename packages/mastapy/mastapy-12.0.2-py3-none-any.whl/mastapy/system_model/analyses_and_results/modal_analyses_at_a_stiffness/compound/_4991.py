...
class GuideDxfModelCompoundModalAnalysisAtAStiffness(_4955.ComponentCompoundModalAnalysisAtAStiffness):
    """GuideDxfModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4862.GuideDxfModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4862.GuideDxfModelModalAnalysisAtAStiffness]':
