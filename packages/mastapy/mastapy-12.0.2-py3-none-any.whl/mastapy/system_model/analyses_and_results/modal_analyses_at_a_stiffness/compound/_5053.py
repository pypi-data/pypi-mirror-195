...
class WormGearCompoundModalAnalysisAtAStiffness(_4988.GearCompoundModalAnalysisAtAStiffness):
    """WormGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4925.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4925.WormGearModalAnalysisAtAStiffness]':
