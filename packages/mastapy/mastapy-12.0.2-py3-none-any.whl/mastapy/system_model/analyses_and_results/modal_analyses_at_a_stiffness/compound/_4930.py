...
class AbstractAssemblyCompoundModalAnalysisAtAStiffness(_5009.PartCompoundModalAnalysisAtAStiffness):
    """AbstractAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4800.AbstractAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4800.AbstractAssemblyModalAnalysisAtAStiffness]':
