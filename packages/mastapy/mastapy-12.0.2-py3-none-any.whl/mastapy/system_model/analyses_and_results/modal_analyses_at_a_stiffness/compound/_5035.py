...
class StraightBevelDiffGearCompoundModalAnalysisAtAStiffness(_4946.BevelGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelDiffGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4907.StraightBevelDiffGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4907.StraightBevelDiffGearModalAnalysisAtAStiffness]':
