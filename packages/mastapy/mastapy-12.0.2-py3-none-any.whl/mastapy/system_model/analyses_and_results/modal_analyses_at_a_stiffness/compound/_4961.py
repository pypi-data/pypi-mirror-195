...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4959, _4960, _4990
...
class ConceptGearSetCompoundModalAnalysisAtAStiffness(_4990.GearSetCompoundModalAnalysisAtAStiffness):
    """ConceptGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4831.ConceptGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4959.ConceptGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4960.ConceptGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4831.ConceptGearSetModalAnalysisAtAStiffness]':
