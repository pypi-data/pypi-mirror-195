...
class ClutchCompoundModalAnalysisAtAStiffness(_4967.CouplingCompoundModalAnalysisAtAStiffness):
    """ClutchCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4823.ClutchModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4823.ClutchModalAnalysisAtAStiffness]':
