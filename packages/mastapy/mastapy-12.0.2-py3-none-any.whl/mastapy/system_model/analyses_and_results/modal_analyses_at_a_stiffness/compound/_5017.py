...
class PowerLoadCompoundModalAnalysisAtAStiffness(_5052.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PowerLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4888.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4888.PowerLoadModalAnalysisAtAStiffness]':
