...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5029, _5030, _4948
...
class SpiralBevelGearSetCompoundModalAnalysisAtAStiffness(_4948.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4902.SpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5029.SpiralBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5030.SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4902.SpiralBevelGearSetModalAnalysisAtAStiffness]':
