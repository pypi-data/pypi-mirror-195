...
class CycloidalDiscCompoundModalAnalysisAtAStiffness(_4931.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4845.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4845.CycloidalDiscModalAnalysisAtAStiffness]':
