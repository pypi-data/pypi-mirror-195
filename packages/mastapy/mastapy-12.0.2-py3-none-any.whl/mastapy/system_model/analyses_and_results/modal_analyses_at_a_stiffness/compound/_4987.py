...
class FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness(_5028.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4858.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4858.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
