...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import (
    _4938, _4940, _4943, _4950,
    _4949, _4971, _4951, _4956,
    _4961, _4973, _4975, _4979,
    _4986, _4985, _4987, _4994,
    _5001, _5004, _5005, _5006,
    _5008, _5010, _5015, _5016,
    _5017, _5019, _5021, _5026,
    _5025, _5031, _5032, _5037,
    _5040, _5043, _5047, _5051,
    _5055, _5058, _4930
)
...
class AssemblyCompoundModalAnalysisAtAStiffness(_4930.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """AssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4807.AssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def bearings(self) -> 'List[_4938.BearingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def belt_drives(self) -> 'List[_4940.BeltDriveCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4943.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4950.BoltedJointCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolts(self) -> 'List[_4949.BoltCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cv_ts(self) -> 'List[_4971.CVTCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def clutches(self) -> 'List[_4951.ClutchCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4956.ConceptCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4961.ConceptGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4973.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4975.CycloidalDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4979.CylindricalGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def fe_parts(self) -> 'List[_4986.FEPartCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4985.FaceGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4987.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4994.HypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5001.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5004.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def mass_discs(self) -> 'List[_5005.MassDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def measurement_components(self) -> 'List[_5006.MeasurementComponentCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def oil_seals(self) -> 'List[_5008.OilSealCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5010.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5015.PlanetCarrierCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def point_loads(self) -> 'List[_5016.PointLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def power_loads(self) -> 'List[_5017.PowerLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def ring_pins(self) -> 'List[_5019.RingPinsCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5021.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5026.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shafts(self) -> 'List[_5025.ShaftCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5031.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5032.SpringDamperCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5037.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5040.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def synchronisers(self) -> 'List[_5043.SynchroniserCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def torque_converters(self) -> 'List[_5047.TorqueConverterCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5051.UnbalancedMassCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5055.WormGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5058.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4807.AssemblyModalAnalysisAtAStiffness]':
