...
class ConceptGearCompoundModalAnalysisAtAStiffness(_4988.GearCompoundModalAnalysisAtAStiffness):
    """ConceptGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4830.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4830.ConceptGearModalAnalysisAtAStiffness]':
