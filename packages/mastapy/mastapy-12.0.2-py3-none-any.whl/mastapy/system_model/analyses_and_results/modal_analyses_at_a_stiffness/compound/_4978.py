...
class CylindricalGearMeshCompoundModalAnalysisAtAStiffness(_4989.GearMeshCompoundModalAnalysisAtAStiffness):
    """CylindricalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4847.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4847.CylindricalGearMeshModalAnalysisAtAStiffness]':
