...
class HypoidGearCompoundModalAnalysisAtAStiffness(_4934.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    """HypoidGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4864.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4864.HypoidGearModalAnalysisAtAStiffness]':
