...
class VirtualComponentCompoundModalAnalysisAtAStiffness(_5007.MountableComponentCompoundModalAnalysisAtAStiffness):
    """VirtualComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4923.VirtualComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4923.VirtualComponentModalAnalysisAtAStiffness]':
