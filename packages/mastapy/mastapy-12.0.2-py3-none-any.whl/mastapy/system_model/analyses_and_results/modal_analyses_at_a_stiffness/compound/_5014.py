...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4979.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    """PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4885.PlanetaryGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4885.PlanetaryGearSetModalAnalysisAtAStiffness]':
