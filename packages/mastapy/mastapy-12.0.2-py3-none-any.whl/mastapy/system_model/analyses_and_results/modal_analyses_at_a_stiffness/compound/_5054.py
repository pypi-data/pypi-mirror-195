...
class WormGearMeshCompoundModalAnalysisAtAStiffness(_4989.GearMeshCompoundModalAnalysisAtAStiffness):
    """WormGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4924.WormGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4924.WormGearMeshModalAnalysisAtAStiffness]':
