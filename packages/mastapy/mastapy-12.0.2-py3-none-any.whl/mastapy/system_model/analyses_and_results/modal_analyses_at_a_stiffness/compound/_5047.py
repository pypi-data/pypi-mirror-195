...
class TorqueConverterCompoundModalAnalysisAtAStiffness(_4967.CouplingCompoundModalAnalysisAtAStiffness):
    """TorqueConverterCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4919.TorqueConverterModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4919.TorqueConverterModalAnalysisAtAStiffness]':
