...
class CVTBeltConnectionCompoundModalAnalysisAtAStiffness(_4939.BeltConnectionCompoundModalAnalysisAtAStiffness):
    """CVTBeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4840.CVTBeltConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4840.CVTBeltConnectionModalAnalysisAtAStiffness]':
