...
class CouplingHalfCompoundModalAnalysisAtAStiffness(_5007.MountableComponentCompoundModalAnalysisAtAStiffness):
    """CouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4838.CouplingHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4838.CouplingHalfModalAnalysisAtAStiffness]':
