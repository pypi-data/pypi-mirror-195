...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4928, _4927, _4818
...
class ZerolBevelGearSetModalAnalysisAtAStiffness(_4818.BevelGearSetModalAnalysisAtAStiffness):
    """ZerolBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4928.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4927.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
