...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4901, _4900, _4818
...
class SpiralBevelGearSetModalAnalysisAtAStiffness(_4818.BevelGearSetModalAnalysisAtAStiffness):
    """SpiralBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4901.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4900.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
