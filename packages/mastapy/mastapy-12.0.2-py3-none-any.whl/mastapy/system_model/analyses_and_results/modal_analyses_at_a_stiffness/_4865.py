...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4864, _4863, _4806
...
class HypoidGearSetModalAnalysisAtAStiffness(_4806.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    """HypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4864.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4863.HypoidGearMeshModalAnalysisAtAStiffness]':
