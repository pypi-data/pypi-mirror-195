...
class CylindricalGearSetLoadCase(_6825.GearSetLoadCase):
    """CylindricalGearSetLoadCase
    ...
    @property
    def reset_micro_geometry(self) -> '_6871.ResetMicroGeometryOptions':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_6871.ResetMicroGeometryOptions)(value) if value is not None else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_6871.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gears(self) -> 'List[_6791.CylindricalGearLoadCase]':
    ...
    @property
    def cylindrical_gears_load_case(self) -> 'List[_6791.CylindricalGearLoadCase]':
    ...
    @property
    def cylindrical_meshes_load_case(self) -> 'List[_6793.CylindricalGearMeshLoadCase]':
    ...
    def get_harmonic_load_data_for_import(self) -> '_6794.CylindricalGearSetHarmonicLoadData':
