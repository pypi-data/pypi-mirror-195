...
from mastapy.system_model.fe import _2317, _2340
...
class FEPartLoadCase(_6739.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2317.AngleSource':
        ...
        return constructor.new_from_mastapy_type(_2317.AngleSource)(value) if value is not None else None
