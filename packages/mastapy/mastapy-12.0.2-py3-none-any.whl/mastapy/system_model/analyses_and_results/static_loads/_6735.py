...
from mastapy.system_model.analyses_and_results import (
    _2601, _2596, _2576, _2587,
    _2595, _2579, _2598, _2590,
    _2580, _2597, _2578, _2584,
    _2638, _2575
)
...
from mastapy.system_model.analyses_and_results.load_case_groups import _5601, _5602, _5603
from mastapy.system_model.analyses_and_results.static_loads import _6748, _6734
...
class StaticLoadCase(_6734.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self) -> '_2601.SystemDeflectionAnalysis':
    ...
    @property
    def power_flow(self) -> '_2596.PowerFlowAnalysis':
    ...
    @property
    def advanced_system_deflection(self) -> '_2576.AdvancedSystemDeflectionAnalysis':
    ...
    @property
    def parametric_study_tool(self) -> '_2595.ParametricStudyToolAnalysis':
    ...
    @property
    def compound_parametric_study_tool(self) -> '_2579.CompoundParametricStudyToolAnalysis':
    ...
    @property
    def steady_state_synchronous_response(self) -> '_2598.SteadyStateSynchronousResponseAnalysis':
    ...
    @property
    def dynamic_model_for_modal_analysis(self) -> '_2584.DynamicModelForModalAnalysis':
    ...
    @property
    def advanced_system_deflection_options(self) -> '_7203.AdvancedSystemDeflectionOptions':
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5702.HarmonicAnalysisOptions':
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2638.TESetUpForDynamicAnalysisOptions':
    ...
    @property
    def clutch_engagements(self) -> 'List[_5601.ClutchEngagementStatus]':
    ...
    @property
    def concept_clutch_engagements(self) -> 'List[_5602.ConceptSynchroGearEngagementStatus]':
    ...
    @property
    def design_state_load_case_group(self) -> '_5603.DesignState':
    ...
    def analysis_of(self, analysis_type: '_6748.AnalysisType') -> '_2575.SingleAnalysis':
    ...
    def duplicate(self, new_design_state_group: '_5603.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
