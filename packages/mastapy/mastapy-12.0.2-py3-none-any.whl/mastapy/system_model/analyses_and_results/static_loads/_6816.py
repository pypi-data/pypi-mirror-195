...
from mastapy.system_model.analyses_and_results.static_loads import _6814, _6815, _6825
...
class FaceGearSetLoadCase(_6825.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6814.FaceGearLoadCase]':
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6814.FaceGearLoadCase]':
    ...
    @property
    def face_meshes_load_case(self) -> 'List[_6815.FaceGearMeshLoadCase]':
