...
from mastapy.system_model.analyses_and_results.static_loads import _6777, _6825
...
class ConicalGearSetLoadCase(_6825.GearSetLoadCase):
    """ConicalGearSetLoadCase
    ...
    def get_harmonic_load_data_for_import(self) -> '_6777.ConicalGearSetHarmonicLoadData':
