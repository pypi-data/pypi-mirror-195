...
from mastapy.system_model.analyses_and_results.static_loads import _6835, _6836, _6746
...
class HypoidGearSetLoadCase(_6746.AGMAGleasonConicalGearSetLoadCase):
    """HypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6835.HypoidGearLoadCase]':
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_6835.HypoidGearLoadCase]':
    ...
    @property
    def hypoid_meshes_load_case(self) -> 'List[_6836.HypoidGearMeshLoadCase]':
