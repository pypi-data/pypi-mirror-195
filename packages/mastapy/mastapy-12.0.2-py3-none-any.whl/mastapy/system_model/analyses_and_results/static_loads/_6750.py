...
from mastapy.bearings.tolerances import _1877, _1883
...
class BearingLoadCase(_6780.ConnectorLoadCase):
    """BearingLoadCase
    ...
    @property
    def bearing_stiffness_model(self) -> '_5327.BearingStiffnessModel':
        ...
        return constructor.new_from_mastapy_type(_5327.BearingStiffnessModel)(value) if value is not None else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5327.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5327.BearingStiffnessModel':
    ...
    @property
    def include_fitting_effects(self) -> '_1556.LoadCaseOverrideOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1556.LoadCaseOverrideOption)(value) if value is not None else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1556.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def include_ring_ovality(self) -> '_1556.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1556.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeRingOvality = value

    @property
    def include_thermal_expansion_effects(self) -> '_1556.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1556.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def inner_ring_detail(self) -> '_1877.RaceDetail':
    ...
    @property
    def left_ring_detail(self) -> '_1877.RaceDetail':
    ...
    @property
    def outer_ring_detail(self) -> '_1877.RaceDetail':
    ...
    @property
    def right_ring_detail(self) -> '_1877.RaceDetail':
