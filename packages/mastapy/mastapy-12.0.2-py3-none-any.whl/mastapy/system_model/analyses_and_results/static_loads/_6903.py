...
class TorqueConverterLoadCase(_6783.CouplingLoadCase):
    """TorqueConverterLoadCase
    ...
    @property
    def lock_up_clutch_pressure_time_profile(self) -> '_1500.Vector2DListAccessor':
    ...
    def lock_up_clutch_pressure_time_profile(self, value: '_1500.Vector2DListAccessor'):
