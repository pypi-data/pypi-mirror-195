...
from mastapy.system_model.analyses_and_results.static_loads import _6889, _6890, _6760
...
class StraightBevelDiffGearSetLoadCase(_6760.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6889.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6889.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6890.StraightBevelDiffGearMeshLoadCase]':
