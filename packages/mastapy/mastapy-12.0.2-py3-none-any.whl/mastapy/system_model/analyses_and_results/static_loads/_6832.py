...
from mastapy.system_model.analyses_and_results.static_loads import _6831, _6810
...
class HarmonicLoadDataImportFromMotorPackages(_6831.HarmonicLoadDataImportBase['T'], Generic[T]):
    """HarmonicLoadDataImportFromMotorPackages
