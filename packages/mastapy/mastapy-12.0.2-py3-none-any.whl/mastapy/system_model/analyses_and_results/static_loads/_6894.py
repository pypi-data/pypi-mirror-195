...
from mastapy.system_model.analyses_and_results.static_loads import _6892, _6893, _6760
...
class StraightBevelGearSetLoadCase(_6760.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6892.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6892.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6893.StraightBevelGearMeshLoadCase]':
