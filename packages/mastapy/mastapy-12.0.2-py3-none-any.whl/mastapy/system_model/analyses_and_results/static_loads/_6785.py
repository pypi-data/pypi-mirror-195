...
from mastapy.system_model.analyses_and_results.static_loads import _6786, _6752
...
class CVTLoadCase(_6752.BeltDriveLoadCase):
    """CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6786.CVTPulleyLoadCase]':
