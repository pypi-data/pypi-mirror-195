...
from mastapy.system_model.analyses_and_results.static_loads import _6798, _6832, _6810
...
class HarmonicLoadDataCSVImport(_6832.HarmonicLoadDataImportFromMotorPackages['T'], Generic[T]):
    """HarmonicLoadDataCSVImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6798.DataFromMotorPackagePerSpeed]':
