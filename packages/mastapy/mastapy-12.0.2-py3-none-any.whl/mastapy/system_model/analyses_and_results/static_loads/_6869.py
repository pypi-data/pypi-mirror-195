...
from mastapy.system_model import _2177, _2179, _2178
from mastapy.math_utility.measured_data import _1532
from mastapy.system_model.fe import _2331
from mastapy.system_model.analyses_and_results.static_loads import _6907, _6801, _6911
...
from mastapy.math_utility.control import _1543
...
class PowerLoadLoadCase(_6911.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @property
    def constant_resistance_coefficient_time_profile(self) -> '_1500.Vector2DListAccessor':
    ...
    def constant_resistance_coefficient_time_profile(self, value: '_1500.Vector2DListAccessor'):
    ...
    @property
    def drag_torque_specification_method(self) -> '_2177.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_2177.PowerLoadDragTorqueSpecificationMethod)(value) if value is not None else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_2177.PowerLoadDragTorqueSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DragTorqueSpecificationMethod = value

    @property
    def drag_torque_vs_speed_and_time(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def drag_torque_vs_speed_and_time(self, value: '_1532.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def engine_throttle_time_profile(self) -> '_1500.Vector2DListAccessor':
    ...
    def engine_throttle_time_profile(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def linear_resistance_coefficient_time_profile(self) -> '_1500.Vector2DListAccessor':
    ...
    def linear_resistance_coefficient_time_profile(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def quadratic_resistance_coefficient_time_profile(self) -> '_1500.Vector2DListAccessor':
    ...
    def quadratic_resistance_coefficient_time_profile(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def speed_vs_time(self) -> '_1500.Vector2DListAccessor':
    ...
    def speed_vs_time(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def target_speed_input_type(self) -> '_2179.PowerLoadPIDControlSpeedInputType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2179.PowerLoadPIDControlSpeedInputType)(value) if value is not None else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_2179.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TargetSpeedInputType = value

    @property
    def target_speed_vs_time(self) -> '_1500.Vector2DListAccessor':
    ...
    def target_speed_vs_time(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def torque_vs_angle(self) -> '_1500.Vector2DListAccessor':
    ...
    def torque_vs_angle(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.TorqueVsAngle = value

    @property
    def torque_vs_angle_and_speed(self) -> '_1532.GriddedSurfaceAccessor':
    ...
    def torque_vs_angle_and_speed(self, value: '_1532.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.TorqueVsAngleAndSpeed = value

    @property
    def torque_vs_time(self) -> '_1500.Vector2DListAccessor':
    ...
    def torque_vs_time(self, value: '_1500.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def wheel_slip_model(self) -> '_5456.WheelSlipType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5456.WheelSlipType)(value) if value is not None else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5456.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_design(self) -> '_2428.PowerLoad':
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1543.PIDControlSettings':
    ...
    @property
    def pid_control_settings(self) -> '_1543.PIDControlSettings':
    ...
    def get_harmonic_load_data_for_import(self) -> '_6801.ElectricMachineHarmonicLoadData':
