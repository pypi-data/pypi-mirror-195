...
from mastapy.system_model.analyses_and_results.static_loads import _6771, _6772, _6825
...
class ConceptGearSetLoadCase(_6825.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6771.ConceptGearLoadCase]':
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6771.ConceptGearLoadCase]':
    ...
    @property
    def concept_meshes_load_case(self) -> 'List[_6772.ConceptGearMeshLoadCase]':
