...
class BevelDifferentialSunGearSystemDeflection(_2653.BevelDifferentialGearSystemDeflection):
    """BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3995.BevelDifferentialSunGearPowerFlow':
