...
from mastapy.system_model.analyses_and_results.system_deflections import _2777, _2727
...
class SystemDeflection(_7472.FEAnalysis):
    """SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2777.SystemDeflectionOptions':
    ...
    @property
    def overall_efficiency_results(self) -> '_2727.LoadCaseOverallEfficiencyResult':
