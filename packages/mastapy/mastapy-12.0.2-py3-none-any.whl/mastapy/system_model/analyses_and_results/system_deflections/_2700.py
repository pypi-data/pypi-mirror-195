...
class CylindricalPlanetGearSystemDeflection(_2697.CylindricalGearSystemDeflectionWithLTCAResults):
    """CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4031.CylindricalPlanetGearPowerFlow':
