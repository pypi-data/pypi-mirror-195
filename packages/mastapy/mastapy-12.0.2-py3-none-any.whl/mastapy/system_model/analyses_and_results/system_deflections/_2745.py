...
from mastapy.system_model.analyses_and_results.system_deflections import _2746, _2717
...
class RingPinsToDiscConnectionSystemDeflection(_2717.InterMountableComponentConnectionSystemDeflection):
    """RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4073.RingPinsToDiscConnectionPowerFlow':
    ...
    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2746.RingPinToDiscContactReporting]':
