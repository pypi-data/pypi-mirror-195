...
class BevelDifferentialGearMeshSystemDeflection(_2656.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3991.BevelDifferentialGearMeshPowerFlow':
