...
class CVTPulleySystemDeflection(_2743.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4022.CVTPulleyPowerFlow':
    ...
    @property
    def fixed_sheave_contact_results(self) -> 'List[_1528.NodeResults]':
    ...
    @property
    def moving_sheave_contact_results(self) -> 'List[_1528.NodeResults]':
