...
class RootAssemblySystemDeflection(_2647.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4077.RootAssemblyPowerFlow':
    ...
    @property
    def system_deflection_inputs(self) -> '_2775.SystemDeflection':
        ...
        if _2775.SystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def shaft_deflection_results(self) -> 'List[_2666.ConcentricPartGroupCombinationSystemDeflectionResults]':
