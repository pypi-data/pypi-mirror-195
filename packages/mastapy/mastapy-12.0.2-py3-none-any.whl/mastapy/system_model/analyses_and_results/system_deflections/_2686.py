...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2664.CoaxialConnectionSystemDeflection):
    """CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4024.CycloidalDiscCentralBearingConnectionPowerFlow':
