...
class PlanetCarrierSystemDeflection(_2732.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4066.PlanetCarrierPowerFlow':
    ...
    @property
    def windup(self) -> 'List[_2796.PlanetCarrierWindup]':
