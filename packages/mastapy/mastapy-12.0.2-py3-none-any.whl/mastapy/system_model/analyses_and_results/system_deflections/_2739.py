...
class PlanetaryConnectionSystemDeflection(_2755.ShaftToMountableComponentConnectionSystemDeflection):
    """PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4064.PlanetaryConnectionPowerFlow':
