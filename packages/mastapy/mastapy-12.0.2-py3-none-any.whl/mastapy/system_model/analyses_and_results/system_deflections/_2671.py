...
from mastapy.system_model.analyses_and_results.system_deflections import _2672, _2670, _2710
...
class ConceptGearSetSystemDeflection(_2710.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4011.ConceptGearSetPowerFlow':
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2672.ConceptGearSystemDeflection]':
    ...
    @property
    def concept_meshes_system_deflection(self) -> 'List[_2670.ConceptGearMeshSystemDeflection]':
