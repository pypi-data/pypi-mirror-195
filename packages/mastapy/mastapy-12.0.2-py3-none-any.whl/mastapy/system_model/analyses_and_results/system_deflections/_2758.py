...
from mastapy.system_model.analyses_and_results.system_deflections import _2759, _2757, _2657
...
class SpiralBevelGearSetSystemDeflection(_2657.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4084.SpiralBevelGearSetPowerFlow':
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2759.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2757.SpiralBevelGearMeshSystemDeflection]':
