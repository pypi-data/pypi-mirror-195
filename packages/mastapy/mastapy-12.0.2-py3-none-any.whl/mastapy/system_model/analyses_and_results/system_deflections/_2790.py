...
from mastapy.system_model.analyses_and_results.system_deflections import _2791, _2789, _2657
...
class ZerolBevelGearSetSystemDeflection(_2657.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4112.ZerolBevelGearSetPowerFlow':
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2791.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2789.ZerolBevelGearMeshSystemDeflection]':
