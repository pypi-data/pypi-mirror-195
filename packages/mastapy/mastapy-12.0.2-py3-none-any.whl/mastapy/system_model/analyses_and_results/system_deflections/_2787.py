...
from mastapy.system_model.analyses_and_results.system_deflections import _2788, _2786, _2710
...
class WormGearSetSystemDeflection(_2710.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4109.WormGearSetPowerFlow':
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2788.WormGearSystemDeflection]':
    ...
    @property
    def worm_meshes_system_deflection(self) -> 'List[_2786.WormGearMeshSystemDeflection]':
