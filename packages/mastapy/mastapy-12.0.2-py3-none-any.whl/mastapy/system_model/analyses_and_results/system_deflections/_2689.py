...
class CylindricalGearMeshSystemDeflection(_2709.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_misalignment_in_transverse_line_of_action(self) -> '_1753.SimpleChartDefinition':
    ...
    @property
    def connection_design(self) -> '_2267.CylindricalGearMesh':
    ...
    @property
    def connection_load_case(self) -> '_6793.CylindricalGearMeshLoadCase':
    ...
    @property
    def gear_a(self) -> '_2695.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2696.CylindricalGearSystemDeflectionTimestep':
    ...
    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2697.CylindricalGearSystemDeflectionWithLTCAResults':
    ...
    @property
    def gear_a_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2700.CylindricalPlanetGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2695.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2696.CylindricalGearSystemDeflectionTimestep':
    ...
    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2697.CylindricalGearSystemDeflectionWithLTCAResults':
    ...
    @property
    def gear_b_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2700.CylindricalPlanetGearSystemDeflection':
    ...
    @property
    def power_flow_results(self) -> '_4028.CylindricalGearMeshPowerFlow':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2695.CylindricalGearSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_system_deflections(self) -> 'List[_2699.CylindricalMeshedGearSystemDeflection]':
    ...
    @property
    def mesh_deflections_left_flank(self) -> 'List[_2795.MeshDeflectionResults]':
    ...
    @property
    def mesh_deflections_right_flank(self) -> 'List[_2795.MeshDeflectionResults]':
