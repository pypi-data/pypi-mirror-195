...
from mastapy.math_utility.measured_vectors import _1530, _1526
...
class FEPartSystemDeflection(_2641.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4037.FEPartPowerFlow':
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1530.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1526.ForceAndDisplacementResults]':
    ...
    @property
    def export(self) -> '_2367.SystemDeflectionFEExportOptions':
