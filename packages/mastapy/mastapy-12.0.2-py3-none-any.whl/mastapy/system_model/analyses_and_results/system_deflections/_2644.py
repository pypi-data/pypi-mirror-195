...
class AGMAGleasonConicalGearMeshSystemDeflection(_2674.ConicalGearMeshSystemDeflection):
    """AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3984.AGMAGleasonConicalGearMeshPowerFlow':
