...
class RigidlyConnectedComponentGroupSystemDeflection(_2607.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1483.MassProperties':
    ...
    @property
    def components(self) -> 'List[_2665.ComponentSystemDeflection]':
