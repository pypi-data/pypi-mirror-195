...
from mastapy.utility.report import _1723
...
class ShaftSystemDeflectionSectionsReport(_1723.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1785.TableAndChartOptions':
        ...
        return constructor.new_from_mastapy_type(_1785.TableAndChartOptions)(value) if value is not None else None

    @display.setter
    def display(self, value: '_1785.TableAndChartOptions'):
