...
from mastapy.system_model.analyses_and_results.system_deflections import _2771, _2756
...
class SynchroniserSystemDeflection(_2756.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4098.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2771.SynchroniserHalfSystemDeflection]':
