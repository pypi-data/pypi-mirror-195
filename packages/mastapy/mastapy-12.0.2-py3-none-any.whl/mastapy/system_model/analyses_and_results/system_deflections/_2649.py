...
from mastapy.system_model.analyses_and_results.power_flows import _3989, _4020
...
class BeltConnectionSystemDeflection(_2717.InterMountableComponentConnectionSystemDeflection):
    """BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3989.BeltConnectionPowerFlow':
        ...
        if _3989.BeltConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
