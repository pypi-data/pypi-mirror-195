...
class PartToPartShearCouplingHalfSystemDeflection(_2680.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4062.PartToPartShearCouplingHalfPowerFlow':
