...
class ClutchHalfCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """ClutchHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2662.ClutchHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2662.ClutchHalfSystemDeflection]':
