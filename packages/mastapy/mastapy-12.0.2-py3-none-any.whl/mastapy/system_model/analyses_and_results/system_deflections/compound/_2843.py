...
class CVTPulleyCompoundSystemDeflection(_2890.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2683.CVTPulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2683.CVTPulleySystemDeflection]':
