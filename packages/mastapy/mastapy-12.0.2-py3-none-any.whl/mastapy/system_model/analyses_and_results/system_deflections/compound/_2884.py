...
class PartToPartShearCouplingHalfCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """PartToPartShearCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2737.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2737.PartToPartShearCouplingHalfSystemDeflection]':
