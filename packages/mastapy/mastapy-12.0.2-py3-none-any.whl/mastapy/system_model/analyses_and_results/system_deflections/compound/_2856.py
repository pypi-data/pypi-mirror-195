...
class FaceGearMeshCompoundSystemDeflection(_2861.GearMeshCompoundSystemDeflection):
    """FaceGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2704.FaceGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2704.FaceGearMeshSystemDeflection]':
