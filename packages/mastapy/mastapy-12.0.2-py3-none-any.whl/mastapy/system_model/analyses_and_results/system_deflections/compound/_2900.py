...
class ShaftToMountableComponentConnectionCompoundSystemDeflection(_2804.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    """ShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2755.ShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2755.ShaftToMountableComponentConnectionSystemDeflection]':
