...
class ConceptCouplingHalfCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """ConceptCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2668.ConceptCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2668.ConceptCouplingHalfSystemDeflection]':
