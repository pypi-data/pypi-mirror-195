...
class AbstractAssemblyCompoundSystemDeflection(_2881.PartCompoundSystemDeflection):
    """AbstractAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2640.AbstractAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2640.AbstractAssemblySystemDeflection]':
