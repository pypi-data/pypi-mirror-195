...
class ZerolBevelGearCompoundSystemDeflection(_2817.BevelGearCompoundSystemDeflection):
    """ZerolBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2791.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2791.ZerolBevelGearSystemDeflection]':
