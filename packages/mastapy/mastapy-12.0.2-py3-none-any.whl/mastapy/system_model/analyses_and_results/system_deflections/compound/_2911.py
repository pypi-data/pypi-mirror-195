...
class StraightBevelGearCompoundSystemDeflection(_2817.BevelGearCompoundSystemDeflection):
    """StraightBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2768.StraightBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2768.StraightBevelGearSystemDeflection]':
