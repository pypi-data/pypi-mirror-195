...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2898, _2802
...
class ShaftCompoundSystemDeflection(_2802.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2898.ShaftDutyCycleSystemDeflection':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2754.ShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2754.ShaftSystemDeflection]':
