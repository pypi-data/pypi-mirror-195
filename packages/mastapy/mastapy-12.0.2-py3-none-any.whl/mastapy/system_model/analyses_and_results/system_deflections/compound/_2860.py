...
class GearCompoundSystemDeflection(_2879.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2711.GearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2711.GearSystemDeflection]':
