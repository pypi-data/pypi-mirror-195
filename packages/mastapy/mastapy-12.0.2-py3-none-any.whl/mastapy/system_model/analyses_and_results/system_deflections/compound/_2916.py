...
class SynchroniserCompoundSystemDeflection(_2901.SpecialisedAssemblyCompoundSystemDeflection):
    """SynchroniserCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2774.SynchroniserSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2774.SynchroniserSystemDeflection]':
