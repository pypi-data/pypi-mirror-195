...
class ExternalCADModelCompoundSystemDeflection(_2826.ComponentCompoundSystemDeflection):
    """ExternalCADModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2702.ExternalCADModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2702.ExternalCADModelSystemDeflection]':
