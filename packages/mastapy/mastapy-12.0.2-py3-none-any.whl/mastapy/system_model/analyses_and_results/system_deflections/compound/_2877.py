...
class MassDiscCompoundSystemDeflection(_2925.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2729.MassDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2729.MassDiscSystemDeflection]':
