...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2855, _2856, _2862
...
class FaceGearSetCompoundSystemDeflection(_2862.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2705.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_compound_system_deflection(self) -> 'List[_2855.FaceGearCompoundSystemDeflection]':
    ...
    @property
    def face_meshes_compound_system_deflection(self) -> 'List[_2856.FaceGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2705.FaceGearSetSystemDeflection]':
