...
class VirtualComponentCompoundSystemDeflection(_2879.MountableComponentCompoundSystemDeflection):
    """VirtualComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2785.VirtualComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2785.VirtualComponentSystemDeflection]':
