...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2848, _2849, _2862
...
class CylindricalGearSetCompoundSystemDeflection(_2862.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2694.CylindricalGearSetSystemDeflectionWithLTCAResults]':
    ...
    @property
    def cylindrical_gears_compound_system_deflection(self) -> 'List[_2848.CylindricalGearCompoundSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_system_deflection(self) -> 'List[_2849.CylindricalGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2694.CylindricalGearSetSystemDeflectionWithLTCAResults]':
