...
class RingPinsToDiscConnectionCompoundSystemDeflection(_2867.InterMountableComponentConnectionCompoundSystemDeflection):
    """RingPinsToDiscConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2745.RingPinsToDiscConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2745.RingPinsToDiscConnectionSystemDeflection]':
