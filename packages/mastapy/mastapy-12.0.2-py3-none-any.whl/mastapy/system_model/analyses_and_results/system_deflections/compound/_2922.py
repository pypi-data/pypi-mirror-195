...
class TorqueConverterPumpCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterPumpCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2779.TorqueConverterPumpSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2779.TorqueConverterPumpSystemDeflection]':
