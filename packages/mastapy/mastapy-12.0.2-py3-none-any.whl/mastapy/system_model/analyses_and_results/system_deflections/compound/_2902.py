...
class SpiralBevelGearCompoundSystemDeflection(_2817.BevelGearCompoundSystemDeflection):
    """SpiralBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2759.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2759.SpiralBevelGearSystemDeflection]':
