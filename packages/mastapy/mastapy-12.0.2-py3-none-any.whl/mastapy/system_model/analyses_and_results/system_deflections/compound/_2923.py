...
class TorqueConverterTurbineCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterTurbineCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2781.TorqueConverterTurbineSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2781.TorqueConverterTurbineSystemDeflection]':
