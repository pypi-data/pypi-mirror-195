...
class MeasurementComponentCompoundSystemDeflection(_2925.VirtualComponentCompoundSystemDeflection):
    """MeasurementComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2730.MeasurementComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2730.MeasurementComponentSystemDeflection]':
