...
class ComponentCompoundSystemDeflection(_2881.PartCompoundSystemDeflection):
    """ComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2665.ComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2665.ComponentSystemDeflection]':
