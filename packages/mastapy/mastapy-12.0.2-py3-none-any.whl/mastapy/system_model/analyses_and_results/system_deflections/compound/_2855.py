...
class FaceGearCompoundSystemDeflection(_2860.GearCompoundSystemDeflection):
    """FaceGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2706.FaceGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2706.FaceGearSystemDeflection]':
