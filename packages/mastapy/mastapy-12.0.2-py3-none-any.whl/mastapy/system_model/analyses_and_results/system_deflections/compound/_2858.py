...
class FEPartCompoundSystemDeflection(_2803.AbstractShaftOrHousingCompoundSystemDeflection):
    """FEPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2707.FEPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2707.FEPartSystemDeflection]':
