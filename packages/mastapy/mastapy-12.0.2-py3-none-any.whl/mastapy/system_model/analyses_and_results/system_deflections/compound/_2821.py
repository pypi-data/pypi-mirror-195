...
class BoltedJointCompoundSystemDeflection(_2901.SpecialisedAssemblyCompoundSystemDeflection):
    """BoltedJointCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2659.BoltedJointSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2659.BoltedJointSystemDeflection]':
