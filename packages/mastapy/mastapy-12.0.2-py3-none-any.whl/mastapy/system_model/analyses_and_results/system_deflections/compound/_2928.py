...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2926, _2927, _2862
...
class WormGearSetCompoundSystemDeflection(_2862.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2787.WormGearSetSystemDeflection]':
    ...
    @property
    def worm_gears_compound_system_deflection(self) -> 'List[_2926.WormGearCompoundSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_system_deflection(self) -> 'List[_2927.WormGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2787.WormGearSetSystemDeflection]':
