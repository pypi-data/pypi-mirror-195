...
class FlexiblePinAssemblyCompoundSystemDeflection(_2901.SpecialisedAssemblyCompoundSystemDeflection):
    """FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2708.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2708.FlexiblePinAssemblySystemDeflection]':
