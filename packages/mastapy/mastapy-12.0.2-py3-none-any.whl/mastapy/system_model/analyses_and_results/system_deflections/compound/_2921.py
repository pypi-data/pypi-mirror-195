...
class TorqueConverterConnectionCompoundSystemDeflection(_2839.CouplingConnectionCompoundSystemDeflection):
    """TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2778.TorqueConverterConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2778.TorqueConverterConnectionSystemDeflection]':
