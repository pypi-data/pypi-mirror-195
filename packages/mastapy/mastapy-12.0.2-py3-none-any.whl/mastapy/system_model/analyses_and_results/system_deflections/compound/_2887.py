...
class PlanetCarrierCompoundSystemDeflection(_2879.MountableComponentCompoundSystemDeflection):
    """PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2740.PlanetCarrierSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2740.PlanetCarrierSystemDeflection]':
