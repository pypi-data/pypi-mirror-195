...
class AbstractShaftCompoundSystemDeflection(_2803.AbstractShaftOrHousingCompoundSystemDeflection):
    """AbstractShaftCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2642.AbstractShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2642.AbstractShaftSystemDeflection]':
