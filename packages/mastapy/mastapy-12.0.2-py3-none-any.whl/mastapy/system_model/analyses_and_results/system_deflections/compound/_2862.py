...
class GearSetCompoundSystemDeflection(_2901.SpecialisedAssemblyCompoundSystemDeflection):
    """GearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2710.GearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2710.GearSetSystemDeflection]':
