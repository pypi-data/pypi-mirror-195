...
class ConceptCouplingCompoundSystemDeflection(_2838.CouplingCompoundSystemDeflection):
    """ConceptCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2669.ConceptCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2669.ConceptCouplingSystemDeflection]':
