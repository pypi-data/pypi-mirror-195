...
class AbstractShaftOrHousingCompoundSystemDeflection(_2826.ComponentCompoundSystemDeflection):
    """AbstractShaftOrHousingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2641.AbstractShaftOrHousingSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2641.AbstractShaftOrHousingSystemDeflection]':
