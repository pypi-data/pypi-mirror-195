...
class RollingRingCompoundSystemDeflection(_2840.CouplingHalfCompoundSystemDeflection):
    """RollingRingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2749.RollingRingSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2749.RollingRingSystemDeflection]':
