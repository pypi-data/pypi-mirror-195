...
class PointLoadCompoundSystemDeflection(_2925.VirtualComponentCompoundSystemDeflection):
    """PointLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2741.PointLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2741.PointLoadSystemDeflection]':
