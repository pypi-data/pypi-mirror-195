...
class HypoidGearCompoundSystemDeflection(_2805.AGMAGleasonConicalGearCompoundSystemDeflection):
    """HypoidGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2715.HypoidGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2715.HypoidGearSystemDeflection]':
