...
class SynchroniserHalfCompoundSystemDeflection(_2918.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2771.SynchroniserHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2771.SynchroniserHalfSystemDeflection]':
