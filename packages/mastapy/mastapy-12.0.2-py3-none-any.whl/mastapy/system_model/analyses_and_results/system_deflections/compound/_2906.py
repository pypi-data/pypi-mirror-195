...
class SpringDamperConnectionCompoundSystemDeflection(_2839.CouplingConnectionCompoundSystemDeflection):
    """SpringDamperConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2760.SpringDamperConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2760.SpringDamperConnectionSystemDeflection]':
