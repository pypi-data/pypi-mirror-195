...
class ConicalGearMeshCompoundSystemDeflection(_2861.GearMeshCompoundSystemDeflection):
    """ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2674.ConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2674.ConicalGearMeshSystemDeflection]':
