...
class RingPinsCompoundSystemDeflection(_2879.MountableComponentCompoundSystemDeflection):
    """RingPinsCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2744.RingPinsSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2744.RingPinsSystemDeflection]':
