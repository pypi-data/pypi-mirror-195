...
class CycloidalDiscCompoundSystemDeflection(_2802.AbstractShaftCompoundSystemDeflection):
    """CycloidalDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2688.CycloidalDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2688.CycloidalDiscSystemDeflection]':
