...
class TorqueConverterCompoundSystemDeflection(_2838.CouplingCompoundSystemDeflection):
    """TorqueConverterCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2780.TorqueConverterSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2780.TorqueConverterSystemDeflection]':
