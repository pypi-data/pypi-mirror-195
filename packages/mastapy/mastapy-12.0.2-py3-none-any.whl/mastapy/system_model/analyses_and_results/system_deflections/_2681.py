...
class CouplingSystemDeflection(_2756.SpecialisedAssemblySystemDeflection):
    """CouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4019.CouplingPowerFlow':
        ...
        if _4019.CouplingPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_clutch_power_flow(self) -> '_4003.ClutchPowerFlow':
        ...
        if _4003.ClutchPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_concept_coupling_power_flow(self) -> '_4008.ConceptCouplingPowerFlow':
        ...
        if _4008.ConceptCouplingPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_part_to_part_shear_coupling_power_flow(self) -> '_4063.PartToPartShearCouplingPowerFlow':
        ...
        if _4063.PartToPartShearCouplingPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spring_damper_power_flow(self) -> '_4087.SpringDamperPowerFlow':
        ...
        if _4087.SpringDamperPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_torque_converter_power_flow(self) -> '_4102.TorqueConverterPowerFlow':
        ...
        if _4102.TorqueConverterPowerFlow.TYPE not in temp.__class__.__mro__:
