...
class StraightBevelPlanetGearSystemDeflection(_2765.StraightBevelDiffGearSystemDeflection):
    """StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4094.StraightBevelPlanetGearPowerFlow':
