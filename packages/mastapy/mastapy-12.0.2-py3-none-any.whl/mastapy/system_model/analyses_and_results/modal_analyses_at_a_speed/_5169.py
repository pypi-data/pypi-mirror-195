...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5168, _5167, _5077
...
class StraightBevelGearSetModalAnalysisAtASpeed(_5077.BevelGearSetModalAnalysisAtASpeed):
    """StraightBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5168.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5167.StraightBevelGearMeshModalAnalysisAtASpeed]':
