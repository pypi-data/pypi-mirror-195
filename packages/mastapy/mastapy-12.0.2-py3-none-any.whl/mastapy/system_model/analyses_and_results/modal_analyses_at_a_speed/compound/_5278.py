...
class RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed(_5253.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5149.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5149.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
