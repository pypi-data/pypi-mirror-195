...
class HypoidGearMeshCompoundModalAnalysisAtASpeed(_5193.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    """HypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5121.HypoidGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5121.HypoidGearMeshModalAnalysisAtASpeed]':
