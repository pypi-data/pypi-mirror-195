...
class MassDiscCompoundModalAnalysisAtASpeed(_5310.VirtualComponentCompoundModalAnalysisAtASpeed):
    """MassDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5134.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5134.MassDiscModalAnalysisAtASpeed]':
