...
class SpringDamperConnectionCompoundModalAnalysisAtASpeed(_5226.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """SpringDamperConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5161.SpringDamperConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5161.SpringDamperConnectionModalAnalysisAtASpeed]':
