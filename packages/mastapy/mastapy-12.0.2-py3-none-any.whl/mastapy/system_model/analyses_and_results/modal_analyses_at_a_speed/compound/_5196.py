...
class BearingCompoundModalAnalysisAtASpeed(_5224.ConnectorCompoundModalAnalysisAtASpeed):
    """BearingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5067.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5067.BearingModalAnalysisAtASpeed]':
