...
class CylindricalPlanetGearCompoundModalAnalysisAtASpeed(_5235.CylindricalGearCompoundModalAnalysisAtASpeed):
    """CylindricalPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5109.CylindricalPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5109.CylindricalPlanetGearModalAnalysisAtASpeed]':
