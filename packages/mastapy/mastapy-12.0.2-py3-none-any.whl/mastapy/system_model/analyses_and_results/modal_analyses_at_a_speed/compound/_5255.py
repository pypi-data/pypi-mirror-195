...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed(_5221.ConicalGearMeshCompoundModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5125.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5125.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
