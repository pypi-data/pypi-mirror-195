...
class CouplingHalfCompoundModalAnalysisAtASpeed(_5265.MountableComponentCompoundModalAnalysisAtASpeed):
    """CouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5097.CouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5097.CouplingHalfModalAnalysisAtASpeed]':
