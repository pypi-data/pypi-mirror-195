...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5311, _5312, _5248
...
class WormGearSetCompoundModalAnalysisAtASpeed(_5248.GearSetCompoundModalAnalysisAtASpeed):
    """WormGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5184.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5311.WormGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5312.WormGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5184.WormGearSetModalAnalysisAtASpeed]':
