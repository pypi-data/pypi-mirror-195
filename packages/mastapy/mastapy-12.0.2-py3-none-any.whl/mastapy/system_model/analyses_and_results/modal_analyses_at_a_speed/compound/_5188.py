...
class AbstractAssemblyCompoundModalAnalysisAtASpeed(_5267.PartCompoundModalAnalysisAtASpeed):
    """AbstractAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5059.AbstractAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5059.AbstractAssemblyModalAnalysisAtASpeed]':
