...
class AbstractShaftCompoundModalAnalysisAtASpeed(_5190.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    """AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5060.AbstractShaftModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5060.AbstractShaftModalAnalysisAtASpeed]':
