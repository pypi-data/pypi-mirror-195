...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(_5247.GearMeshCompoundModalAnalysisAtASpeed):
    """CylindricalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5106.CylindricalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5106.CylindricalGearMeshModalAnalysisAtASpeed]':
