...
class ConnectorCompoundModalAnalysisAtASpeed(_5265.MountableComponentCompoundModalAnalysisAtASpeed):
    """ConnectorCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5095.ConnectorModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5095.ConnectorModalAnalysisAtASpeed]':
