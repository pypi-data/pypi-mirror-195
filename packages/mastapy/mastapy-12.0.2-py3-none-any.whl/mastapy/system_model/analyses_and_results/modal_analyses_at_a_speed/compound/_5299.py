...
class StraightBevelPlanetGearCompoundModalAnalysisAtASpeed(_5293.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5170.StraightBevelPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5170.StraightBevelPlanetGearModalAnalysisAtASpeed]':
