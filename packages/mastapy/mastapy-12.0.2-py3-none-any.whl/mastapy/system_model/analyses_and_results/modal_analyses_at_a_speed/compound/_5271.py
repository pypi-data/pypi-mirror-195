...
class PlanetaryConnectionCompoundModalAnalysisAtASpeed(_5285.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """PlanetaryConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5142.PlanetaryConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5142.PlanetaryConnectionModalAnalysisAtASpeed]':
