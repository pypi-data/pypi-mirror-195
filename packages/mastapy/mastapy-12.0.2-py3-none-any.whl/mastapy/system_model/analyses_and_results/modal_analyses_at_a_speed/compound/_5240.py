...
class ExternalCADModelCompoundModalAnalysisAtASpeed(_5213.ComponentCompoundModalAnalysisAtASpeed):
    """ExternalCADModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5111.ExternalCADModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5111.ExternalCADModelModalAnalysisAtASpeed]':
