...
class AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed(_5220.ConicalGearCompoundModalAnalysisAtASpeed):
    """AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5064.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5064.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
