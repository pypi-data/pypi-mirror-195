...
class BevelGearSetCompoundModalAnalysisAtASpeed(_5194.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    """BevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5077.BevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5077.BevelGearSetModalAnalysisAtASpeed]':
