...
class PlanetCarrierCompoundModalAnalysisAtASpeed(_5265.MountableComponentCompoundModalAnalysisAtASpeed):
    """PlanetCarrierCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5144.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5144.PlanetCarrierModalAnalysisAtASpeed]':
