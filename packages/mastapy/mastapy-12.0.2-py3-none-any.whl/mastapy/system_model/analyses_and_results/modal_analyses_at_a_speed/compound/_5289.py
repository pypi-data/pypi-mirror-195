...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5287, _5288, _5206
...
class SpiralBevelGearSetCompoundModalAnalysisAtASpeed(_5206.BevelGearSetCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5160.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5287.SpiralBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5288.SpiralBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5160.SpiralBevelGearSetModalAnalysisAtASpeed]':
