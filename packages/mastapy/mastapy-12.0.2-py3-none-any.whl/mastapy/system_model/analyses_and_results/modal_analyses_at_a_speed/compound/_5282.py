...
class RootAssemblyCompoundModalAnalysisAtASpeed(_5195.AssemblyCompoundModalAnalysisAtASpeed):
    """RootAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5153.RootAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5153.RootAssemblyModalAnalysisAtASpeed]':
