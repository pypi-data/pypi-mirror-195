...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_5204.BevelGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5071.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5071.BevelDifferentialGearModalAnalysisAtASpeed]':
