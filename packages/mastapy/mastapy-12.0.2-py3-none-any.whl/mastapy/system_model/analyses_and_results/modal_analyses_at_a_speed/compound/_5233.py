...
class CycloidalDiscCompoundModalAnalysisAtASpeed(_5189.AbstractShaftCompoundModalAnalysisAtASpeed):
    """CycloidalDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5104.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5104.CycloidalDiscModalAnalysisAtASpeed]':
