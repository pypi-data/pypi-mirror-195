...
class FaceGearMeshCompoundModalAnalysisAtASpeed(_5247.GearMeshCompoundModalAnalysisAtASpeed):
    """FaceGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5112.FaceGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5112.FaceGearMeshModalAnalysisAtASpeed]':
