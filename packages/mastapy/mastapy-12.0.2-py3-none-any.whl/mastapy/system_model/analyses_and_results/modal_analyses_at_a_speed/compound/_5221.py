...
class ConicalGearMeshCompoundModalAnalysisAtASpeed(_5247.GearMeshCompoundModalAnalysisAtASpeed):
    """ConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5091.ConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5091.ConicalGearMeshModalAnalysisAtASpeed]':
