...
class AbstractShaftOrHousingCompoundModalAnalysisAtASpeed(_5213.ComponentCompoundModalAnalysisAtASpeed):
    """AbstractShaftOrHousingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5061.AbstractShaftOrHousingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5061.AbstractShaftOrHousingModalAnalysisAtASpeed]':
