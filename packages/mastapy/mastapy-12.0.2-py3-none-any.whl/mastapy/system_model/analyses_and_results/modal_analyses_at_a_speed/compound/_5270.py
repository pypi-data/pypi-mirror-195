...
class PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed(_5227.CouplingHalfCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5140.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5140.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
