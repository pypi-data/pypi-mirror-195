...
class FaceGearCompoundModalAnalysisAtASpeed(_5246.GearCompoundModalAnalysisAtASpeed):
    """FaceGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5113.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5113.FaceGearModalAnalysisAtASpeed]':
