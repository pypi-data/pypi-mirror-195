...
class CycloidalAssemblyCompoundModalAnalysisAtASpeed(_5286.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """CycloidalAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5102.CycloidalAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5102.CycloidalAssemblyModalAnalysisAtASpeed]':
