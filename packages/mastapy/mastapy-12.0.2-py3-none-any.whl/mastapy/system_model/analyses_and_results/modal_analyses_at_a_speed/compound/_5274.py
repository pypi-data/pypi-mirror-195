...
class PointLoadCompoundModalAnalysisAtASpeed(_5310.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PointLoadCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5145.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5145.PointLoadModalAnalysisAtASpeed]':
