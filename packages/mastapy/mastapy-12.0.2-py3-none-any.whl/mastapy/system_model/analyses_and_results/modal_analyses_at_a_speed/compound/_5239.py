...
class DatumCompoundModalAnalysisAtASpeed(_5213.ComponentCompoundModalAnalysisAtASpeed):
    """DatumCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5110.DatumModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5110.DatumModalAnalysisAtASpeed]':
