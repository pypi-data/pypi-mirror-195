...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5071, _5070, _5077
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_5077.BevelGearSetModalAnalysisAtASpeed):
    """BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_5071.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_5070.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
