...
class ConnectionSteadyStateSynchronousResponse(_7469.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3039.SteadyStateSynchronousResponse':
