...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3065, _3063, _2950
...
class ZerolBevelGearSetSteadyStateSynchronousResponse(_2950.BevelGearSetSteadyStateSynchronousResponse):
    """ZerolBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3065.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3063.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
