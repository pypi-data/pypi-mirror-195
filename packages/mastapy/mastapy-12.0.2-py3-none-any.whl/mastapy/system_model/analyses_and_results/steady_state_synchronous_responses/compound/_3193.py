...
class ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse(_3083.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3063.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3063.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
