...
class ConnectionCompoundSteadyStateSynchronousResponse(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2968.ConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2968.ConnectionSteadyStateSynchronousResponse]':
