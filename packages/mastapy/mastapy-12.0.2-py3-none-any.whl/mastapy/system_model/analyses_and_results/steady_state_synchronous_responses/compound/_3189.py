...
class WormGearCompoundSteadyStateSynchronousResponse(_3124.GearCompoundSteadyStateSynchronousResponse):
    """WormGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3062.WormGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3062.WormGearSteadyStateSynchronousResponse]':
