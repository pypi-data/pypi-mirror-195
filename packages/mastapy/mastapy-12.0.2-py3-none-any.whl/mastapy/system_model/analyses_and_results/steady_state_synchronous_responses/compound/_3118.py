...
class ExternalCADModelCompoundSteadyStateSynchronousResponse(_3091.ComponentCompoundSteadyStateSynchronousResponse):
    """ExternalCADModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2986.ExternalCADModelSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2986.ExternalCADModelSteadyStateSynchronousResponse]':
