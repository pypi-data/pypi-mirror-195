...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3077, _3078, _3084
...
class BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse(_3084.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2945.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gears_compound_steady_state_synchronous_response(self) -> 'List[_3077.BevelDifferentialGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3078.BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2945.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
