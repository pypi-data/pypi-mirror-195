...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3095, _3096, _3126
...
class ConceptGearSetCompoundSteadyStateSynchronousResponse(_3126.GearSetCompoundSteadyStateSynchronousResponse):
    """ConceptGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2963.ConceptGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gears_compound_steady_state_synchronous_response(self) -> 'List[_3095.ConceptGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3096.ConceptGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2963.ConceptGearSetSteadyStateSynchronousResponse]':
