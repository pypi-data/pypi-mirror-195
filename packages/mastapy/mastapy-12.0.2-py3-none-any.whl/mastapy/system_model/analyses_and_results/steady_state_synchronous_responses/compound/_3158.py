...
class RollingRingCompoundSteadyStateSynchronousResponse(_3105.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """RollingRingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3027.RollingRingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3027.RollingRingSteadyStateSynchronousResponse]':
