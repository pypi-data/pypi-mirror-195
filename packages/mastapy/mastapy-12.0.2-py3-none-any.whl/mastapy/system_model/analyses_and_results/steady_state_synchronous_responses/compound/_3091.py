...
class ComponentCompoundSteadyStateSynchronousResponse(_3145.PartCompoundSteadyStateSynchronousResponse):
    """ComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2958.ComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2958.ComponentSteadyStateSynchronousResponse]':
