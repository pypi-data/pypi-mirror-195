...
class FaceGearMeshCompoundSteadyStateSynchronousResponse(_3125.GearMeshCompoundSteadyStateSynchronousResponse):
    """FaceGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2987.FaceGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2987.FaceGearMeshSteadyStateSynchronousResponse]':
