...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
    _3074, _3076, _3079, _3086,
    _3085, _3107, _3087, _3092,
    _3097, _3109, _3111, _3115,
    _3122, _3121, _3123, _3130,
    _3137, _3140, _3141, _3142,
    _3144, _3146, _3151, _3152,
    _3153, _3155, _3157, _3162,
    _3161, _3167, _3168, _3173,
    _3176, _3179, _3183, _3187,
    _3191, _3194, _3066
)
...
class AssemblyCompoundSteadyStateSynchronousResponse(_3066.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2940.AssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def bearings(self) -> 'List[_3074.BearingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def belt_drives(self) -> 'List[_3076.BeltDriveCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3079.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3086.BoltedJointCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolts(self) -> 'List[_3085.BoltCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cv_ts(self) -> 'List[_3107.CVTCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def clutches(self) -> 'List[_3087.ClutchCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3092.ConceptCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3097.ConceptGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3109.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3111.CycloidalDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3115.CylindricalGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def fe_parts(self) -> 'List[_3122.FEPartCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3121.FaceGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3123.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3130.HypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3137.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3140.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def mass_discs(self) -> 'List[_3141.MassDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def measurement_components(self) -> 'List[_3142.MeasurementComponentCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def oil_seals(self) -> 'List[_3144.OilSealCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3146.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3151.PlanetCarrierCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def point_loads(self) -> 'List[_3152.PointLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def power_loads(self) -> 'List[_3153.PowerLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def ring_pins(self) -> 'List[_3155.RingPinsCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3157.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3162.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shafts(self) -> 'List[_3161.ShaftCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3167.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3168.SpringDamperCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3173.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3176.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def synchronisers(self) -> 'List[_3179.SynchroniserCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def torque_converters(self) -> 'List[_3183.TorqueConverterCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3187.UnbalancedMassCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3191.WormGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3194.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2940.AssemblySteadyStateSynchronousResponse]':
