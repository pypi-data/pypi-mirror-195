...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3119, _3120, _3126
...
class FaceGearSetCompoundSteadyStateSynchronousResponse(_3126.GearSetCompoundSteadyStateSynchronousResponse):
    """FaceGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2988.FaceGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gears_compound_steady_state_synchronous_response(self) -> 'List[_3119.FaceGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3120.FaceGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2988.FaceGearSetSteadyStateSynchronousResponse]':
