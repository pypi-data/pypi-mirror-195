...
class BoltCompoundSteadyStateSynchronousResponse(_3091.ComponentCompoundSteadyStateSynchronousResponse):
    """BoltCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2953.BoltSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2953.BoltSteadyStateSynchronousResponse]':
