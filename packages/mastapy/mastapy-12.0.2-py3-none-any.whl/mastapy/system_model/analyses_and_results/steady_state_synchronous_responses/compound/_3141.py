...
class MassDiscCompoundSteadyStateSynchronousResponse(_3188.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """MassDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3009.MassDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3009.MassDiscSteadyStateSynchronousResponse]':
