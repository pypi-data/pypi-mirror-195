...
class ConceptCouplingCompoundSteadyStateSynchronousResponse(_3103.CouplingCompoundSteadyStateSynchronousResponse):
    """ConceptCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2961.ConceptCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2961.ConceptCouplingSteadyStateSynchronousResponse]':
