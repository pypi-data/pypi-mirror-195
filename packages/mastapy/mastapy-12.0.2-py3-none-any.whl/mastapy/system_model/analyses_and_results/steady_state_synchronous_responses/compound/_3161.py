...
class ShaftCompoundSteadyStateSynchronousResponse(_3067.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """ShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3030.ShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3030.ShaftSteadyStateSynchronousResponse]':
