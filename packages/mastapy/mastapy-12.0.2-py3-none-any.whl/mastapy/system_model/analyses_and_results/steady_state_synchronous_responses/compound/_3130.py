...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3128, _3129, _3072
...
class HypoidGearSetCompoundSteadyStateSynchronousResponse(_3072.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    """HypoidGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2997.HypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gears_compound_steady_state_synchronous_response(self) -> 'List[_3128.HypoidGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3129.HypoidGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2997.HypoidGearSetSteadyStateSynchronousResponse]':
