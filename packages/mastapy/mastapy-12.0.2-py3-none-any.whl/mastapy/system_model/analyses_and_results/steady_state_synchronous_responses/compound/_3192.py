...
class ZerolBevelGearCompoundSteadyStateSynchronousResponse(_3082.BevelGearCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3065.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3065.ZerolBevelGearSteadyStateSynchronousResponse]':
