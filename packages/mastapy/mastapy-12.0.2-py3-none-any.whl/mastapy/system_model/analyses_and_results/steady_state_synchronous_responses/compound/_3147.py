...
class PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse(_3104.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3014.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3014.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
