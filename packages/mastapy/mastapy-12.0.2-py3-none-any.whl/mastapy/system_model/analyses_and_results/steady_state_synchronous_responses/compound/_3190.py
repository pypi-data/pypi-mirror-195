...
class WormGearMeshCompoundSteadyStateSynchronousResponse(_3125.GearMeshCompoundSteadyStateSynchronousResponse):
    """WormGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3060.WormGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3060.WormGearMeshSteadyStateSynchronousResponse]':
