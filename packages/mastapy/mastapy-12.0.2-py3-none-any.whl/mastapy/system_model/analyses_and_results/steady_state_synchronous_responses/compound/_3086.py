...
class BoltedJointCompoundSteadyStateSynchronousResponse(_3164.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """BoltedJointCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2952.BoltedJointSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2952.BoltedJointSteadyStateSynchronousResponse]':
