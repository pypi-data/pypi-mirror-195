...
class PointLoadCompoundSteadyStateSynchronousResponse(_3188.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """PointLoadCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3020.PointLoadSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3020.PointLoadSteadyStateSynchronousResponse]':
