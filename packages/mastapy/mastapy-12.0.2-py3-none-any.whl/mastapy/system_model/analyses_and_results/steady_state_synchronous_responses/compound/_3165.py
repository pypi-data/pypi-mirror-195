...
class SpiralBevelGearCompoundSteadyStateSynchronousResponse(_3082.BevelGearCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3035.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3035.SpiralBevelGearSteadyStateSynchronousResponse]':
