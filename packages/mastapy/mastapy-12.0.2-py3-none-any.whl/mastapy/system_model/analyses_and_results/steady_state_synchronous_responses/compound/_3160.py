...
class RootAssemblyCompoundSteadyStateSynchronousResponse(_3073.AssemblyCompoundSteadyStateSynchronousResponse):
    """RootAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3028.RootAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3028.RootAssemblySteadyStateSynchronousResponse]':
