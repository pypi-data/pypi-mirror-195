...
class PartCompoundSteadyStateSynchronousResponse(_7474.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3013.PartSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3013.PartSteadyStateSynchronousResponse]':
