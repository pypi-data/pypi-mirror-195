...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3189, _3190, _3126
...
class WormGearSetCompoundSteadyStateSynchronousResponse(_3126.GearSetCompoundSteadyStateSynchronousResponse):
    """WormGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3061.WormGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response(self) -> 'List[_3189.WormGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3190.WormGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3061.WormGearSetSteadyStateSynchronousResponse]':
