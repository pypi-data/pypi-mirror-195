...
class ConicalGearCompoundSteadyStateSynchronousResponse(_3124.GearCompoundSteadyStateSynchronousResponse):
    """ConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2967.ConicalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2967.ConicalGearSteadyStateSynchronousResponse]':
