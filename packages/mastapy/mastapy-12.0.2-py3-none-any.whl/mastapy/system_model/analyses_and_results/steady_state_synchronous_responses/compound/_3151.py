...
class PlanetCarrierCompoundSteadyStateSynchronousResponse(_3143.MountableComponentCompoundSteadyStateSynchronousResponse):
    """PlanetCarrierCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3019.PlanetCarrierSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3019.PlanetCarrierSteadyStateSynchronousResponse]':
