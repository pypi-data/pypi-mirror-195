...
class CouplingHalfCompoundSteadyStateSynchronousResponse(_3143.MountableComponentCompoundSteadyStateSynchronousResponse):
    """CouplingHalfCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2971.CouplingHalfSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2971.CouplingHalfSteadyStateSynchronousResponse]':
