...
class HypoidGearCompoundSteadyStateSynchronousResponse(_3070.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """HypoidGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2998.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2998.HypoidGearSteadyStateSynchronousResponse]':
