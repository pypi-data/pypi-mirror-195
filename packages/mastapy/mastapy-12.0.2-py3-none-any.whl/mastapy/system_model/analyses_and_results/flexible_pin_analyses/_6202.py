...
from mastapy.system_model.analyses_and_results.system_deflections import _2708, _2648
...
class FlexiblePinAnalysisConceptLevel(_6201.FlexiblePinAnalysis):
    """FlexiblePinAnalysisConceptLevel
    ...
    @property
    def flexible_pin_extreme_load_case(self) -> '_2708.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def flexible_pin_nominal_load_case(self) -> '_2708.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def planet_bearings_in_nominal_load(self) -> 'List[_2648.BearingSystemDeflection]':
