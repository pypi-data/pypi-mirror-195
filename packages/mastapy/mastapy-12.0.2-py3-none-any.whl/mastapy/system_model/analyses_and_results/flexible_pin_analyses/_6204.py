...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2850, _2886, _2809
...
class FlexiblePinAnalysisGearAndBearingRating(_6201.FlexiblePinAnalysis):
    """FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2850.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2850.CylindricalGearSetCompoundSystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2809.BearingCompoundSystemDeflection]':
