...
class BoltAdvancedTimeSteppingAnalysisForModulation(_6964.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """BoltAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2660.BoltSystemDeflection':
