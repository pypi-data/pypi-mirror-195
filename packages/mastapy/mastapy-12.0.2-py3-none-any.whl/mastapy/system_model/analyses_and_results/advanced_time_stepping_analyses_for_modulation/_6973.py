...
class ConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6999.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2675.ConicalGearSetSystemDeflection':
