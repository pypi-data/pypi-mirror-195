...
class BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation(_7167.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2399.BoltedJoint':
    ...
    @property
    def assembly_design(self) -> '_2399.BoltedJoint':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6959.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6959.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
