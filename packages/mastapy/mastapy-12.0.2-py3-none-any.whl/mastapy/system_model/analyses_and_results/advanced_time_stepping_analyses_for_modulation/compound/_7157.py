...
class PulleyCompoundAdvancedTimeSteppingAnalysisForModulation(_7108.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PulleyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7028.PulleyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7028.PulleyAdvancedTimeSteppingAnalysisForModulation]':
