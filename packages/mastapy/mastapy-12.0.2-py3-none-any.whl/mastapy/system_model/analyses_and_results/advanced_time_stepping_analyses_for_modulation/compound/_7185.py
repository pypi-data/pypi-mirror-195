...
class SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation(_7184.SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7056.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7056.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
