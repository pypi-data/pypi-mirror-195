...
class SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(_7106.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2555.SpringDamper':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7042.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7042.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
