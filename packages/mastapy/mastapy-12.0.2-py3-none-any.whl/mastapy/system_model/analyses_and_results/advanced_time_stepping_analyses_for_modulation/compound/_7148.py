...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7474.PartCompoundAnalysis):
    """PartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7019.PartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7019.PartAdvancedTimeSteppingAnalysisForModulation]':
