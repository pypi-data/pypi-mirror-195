...
class WormGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7127.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """WormGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7063.WormGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7063.WormGearAdvancedTimeSteppingAnalysisForModulation]':
