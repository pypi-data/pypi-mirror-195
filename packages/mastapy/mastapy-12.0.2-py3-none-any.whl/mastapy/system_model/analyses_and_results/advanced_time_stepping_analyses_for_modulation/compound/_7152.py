...
class PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7166.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2245.PlanetaryConnection':
    ...
    @property
    def connection_design(self) -> '_2245.PlanetaryConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7023.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7023.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
