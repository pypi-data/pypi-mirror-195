...
class ShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_7070.AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7035.ShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7035.ShaftAdvancedTimeSteppingAnalysisForModulation]':
