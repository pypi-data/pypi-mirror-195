...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
    _6947, _6949, _6952, _6959,
    _6958, _6979, _6960, _6965,
    _6970, _6982, _6983, _6988,
    _6995, _6994, _6996, _7004,
    _7011, _7014, _7015, _7016,
    _7018, _7020, _7025, _7026,
    _7027, _7029, _7032, _7036,
    _7035, _7041, _7042, _7047,
    _7050, _7053, _7057, _7061,
    _7065, _7068, _6935
)
...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(_6935.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """AssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def bearings(self) -> 'List[_6947.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def belt_drives(self) -> 'List[_6949.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6952.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6959.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolts(self) -> 'List[_6958.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cv_ts(self) -> 'List[_6979.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def clutches(self) -> 'List[_6960.ClutchAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6965.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6970.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6982.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6983.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6988.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def fe_parts(self) -> 'List[_6995.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6994.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6996.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7004.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7011.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7014.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def mass_discs(self) -> 'List[_7015.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def measurement_components(self) -> 'List[_7016.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def oil_seals(self) -> 'List[_7018.OilSealAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7020.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7025.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def point_loads(self) -> 'List[_7026.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def power_loads(self) -> 'List[_7027.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def ring_pins(self) -> 'List[_7029.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7032.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7036.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shafts(self) -> 'List[_7035.ShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7041.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7042.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7047.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7050.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def synchronisers(self) -> 'List[_7053.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def torque_converters(self) -> 'List[_7057.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7061.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7065.WormGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7068.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
