...
class CycloidalDiscAdvancedTimeSteppingAnalysisForModulation(_6936.AbstractShaftAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6789.CycloidalDiscLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2688.CycloidalDiscSystemDeflection':
