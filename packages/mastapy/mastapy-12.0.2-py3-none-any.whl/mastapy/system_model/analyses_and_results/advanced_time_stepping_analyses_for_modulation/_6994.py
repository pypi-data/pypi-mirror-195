...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6992, _6993, _6999
...
class FaceGearSetAdvancedTimeSteppingAnalysisForModulation(_6999.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2705.FaceGearSetSystemDeflection':
    ...
    @property
    def face_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6992.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6993.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
