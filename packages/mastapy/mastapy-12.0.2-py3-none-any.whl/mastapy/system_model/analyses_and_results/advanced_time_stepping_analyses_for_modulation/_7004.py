...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7002, _7003, _6944
...
class HypoidGearSetAdvancedTimeSteppingAnalysisForModulation(_6944.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def hypoid_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7002.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7003.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
