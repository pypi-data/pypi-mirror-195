...
class PowerLoadAdvancedTimeSteppingAnalysisForModulation(_7062.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PowerLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2742.PowerLoadSystemDeflection':
