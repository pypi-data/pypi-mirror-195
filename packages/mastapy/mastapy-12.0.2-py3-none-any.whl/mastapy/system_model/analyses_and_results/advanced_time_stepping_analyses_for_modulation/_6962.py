...
class ClutchHalfAdvancedTimeSteppingAnalysisForModulation(_6978.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """ClutchHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2662.ClutchHalfSystemDeflection':
