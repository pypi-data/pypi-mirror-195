...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(_6976.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2780.TorqueConverterSystemDeflection':
