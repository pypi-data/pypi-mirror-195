...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7066, _7067, _6957
...
class ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6957.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2790.ZerolBevelGearSetSystemDeflection':
    ...
    @property
    def zerol_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7066.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7067.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
