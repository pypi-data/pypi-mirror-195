...
from mastapy.system_model.analyses_and_results.static_loads import _6889, _6895, _6896
from mastapy.system_model.analyses_and_results.system_deflections import _2765, _2769, _2770
...
class StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation(_6955.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6889.StraightBevelDiffGearLoadCase':
        ...
        if _6889.StraightBevelDiffGearLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2765.StraightBevelDiffGearSystemDeflection':
