...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6956.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6754.BevelDifferentialGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2651.BevelDifferentialGearMeshSystemDeflection':
