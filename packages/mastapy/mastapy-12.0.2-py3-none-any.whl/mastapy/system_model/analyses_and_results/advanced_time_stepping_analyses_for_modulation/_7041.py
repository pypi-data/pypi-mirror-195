...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7039, _7040, _6957
...
class SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6957.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2758.SpiralBevelGearSetSystemDeflection':
    ...
    @property
    def spiral_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7039.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7040.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
