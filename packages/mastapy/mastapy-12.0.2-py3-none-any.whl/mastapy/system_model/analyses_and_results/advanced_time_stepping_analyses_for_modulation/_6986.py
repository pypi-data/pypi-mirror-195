...
class CylindricalGearAdvancedTimeSteppingAnalysisForModulation(_6997.GearAdvancedTimeSteppingAnalysisForModulation):
    """CylindricalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2695.CylindricalGearSystemDeflection':
