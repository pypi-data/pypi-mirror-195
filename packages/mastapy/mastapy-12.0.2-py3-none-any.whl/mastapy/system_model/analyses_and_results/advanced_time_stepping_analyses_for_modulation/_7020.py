...
class PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(_6976.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2738.PartToPartShearCouplingSystemDeflection':
