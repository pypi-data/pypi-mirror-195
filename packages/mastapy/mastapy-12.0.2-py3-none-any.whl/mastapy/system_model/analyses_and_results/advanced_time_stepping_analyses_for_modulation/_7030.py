...
class RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation(_7005.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2745.RingPinsToDiscConnectionSystemDeflection':
