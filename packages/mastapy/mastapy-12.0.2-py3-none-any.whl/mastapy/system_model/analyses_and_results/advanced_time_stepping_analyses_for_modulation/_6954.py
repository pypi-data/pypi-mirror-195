...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6950.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2473.BevelDifferentialSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2655.BevelDifferentialSunGearSystemDeflection':
