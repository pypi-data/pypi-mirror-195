...
class DatumAdvancedTimeSteppingAnalysisForModulation(_6964.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """DatumAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2701.DatumSystemDeflection':
