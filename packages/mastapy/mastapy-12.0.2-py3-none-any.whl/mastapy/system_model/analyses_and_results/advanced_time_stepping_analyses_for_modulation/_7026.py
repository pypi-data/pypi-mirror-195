...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(_7062.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2741.PointLoadSystemDeflection':
