...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4794, _4795, _4731
...
class WormGearSetCompoundModalAnalysis(_4731.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4655.WormGearSetModalAnalysis]':
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_4794.WormGearCompoundModalAnalysis]':
    ...
    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_4795.WormGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4655.WormGearSetModalAnalysis]':
