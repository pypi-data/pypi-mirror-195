...
class SpringDamperHalfCompoundModalAnalysis(_4710.CouplingHalfCompoundModalAnalysis):
    """SpringDamperHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4630.SpringDamperHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4630.SpringDamperHalfModalAnalysis]':
