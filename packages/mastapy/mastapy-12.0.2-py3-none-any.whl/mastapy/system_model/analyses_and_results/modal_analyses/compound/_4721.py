...
class CylindricalPlanetGearCompoundModalAnalysis(_4718.CylindricalGearCompoundModalAnalysis):
    """CylindricalPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4569.CylindricalPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4569.CylindricalPlanetGearModalAnalysis]':
