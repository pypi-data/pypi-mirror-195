...
class PlanetCarrierCompoundModalAnalysis(_4748.MountableComponentCompoundModalAnalysis):
    """PlanetCarrierCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4611.PlanetCarrierModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4611.PlanetCarrierModalAnalysis]':
