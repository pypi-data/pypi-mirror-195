...
class BoltedJointCompoundModalAnalysis(_4769.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4537.BoltedJointModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4537.BoltedJointModalAnalysis]':
