...
class ComponentCompoundModalAnalysis(_4750.PartCompoundModalAnalysis):
    """ComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4543.ComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4543.ComponentModalAnalysis]':
