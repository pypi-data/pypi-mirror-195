...
class FlexiblePinAssemblyCompoundModalAnalysis(_4769.SpecialisedAssemblyCompoundModalAnalysis):
    """FlexiblePinAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4578.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4578.FlexiblePinAssemblyModalAnalysis]':
