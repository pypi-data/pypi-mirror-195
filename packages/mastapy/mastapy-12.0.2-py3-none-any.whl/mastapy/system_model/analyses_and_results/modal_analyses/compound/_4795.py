...
class WormGearMeshCompoundModalAnalysis(_4730.GearMeshCompoundModalAnalysis):
    """WormGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4653.WormGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4653.WormGearMeshModalAnalysis]':
