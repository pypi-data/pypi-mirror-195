...
class ConnectorCompoundModalAnalysis(_4748.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4554.ConnectorModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4554.ConnectorModalAnalysis]':
