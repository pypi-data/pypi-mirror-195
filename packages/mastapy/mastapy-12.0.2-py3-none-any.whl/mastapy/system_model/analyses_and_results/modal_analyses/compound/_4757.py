...
class PointLoadCompoundModalAnalysis(_4793.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4612.PointLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4612.PointLoadModalAnalysis]':
