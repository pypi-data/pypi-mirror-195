...
class BevelGearCompoundModalAnalysis(_4675.AGMAGleasonConicalGearCompoundModalAnalysis):
    """BevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4535.BevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4535.BevelGearModalAnalysis]':
