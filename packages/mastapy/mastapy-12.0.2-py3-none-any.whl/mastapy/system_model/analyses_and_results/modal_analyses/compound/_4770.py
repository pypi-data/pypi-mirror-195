...
class SpiralBevelGearCompoundModalAnalysis(_4687.BevelGearCompoundModalAnalysis):
    """SpiralBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4627.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4627.SpiralBevelGearModalAnalysis]':
