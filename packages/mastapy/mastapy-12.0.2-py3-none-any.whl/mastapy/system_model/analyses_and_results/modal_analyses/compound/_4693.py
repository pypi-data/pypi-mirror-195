...
class ClutchConnectionCompoundModalAnalysis(_4709.CouplingConnectionCompoundModalAnalysis):
    """ClutchConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4539.ClutchConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4539.ClutchConnectionModalAnalysis]':
