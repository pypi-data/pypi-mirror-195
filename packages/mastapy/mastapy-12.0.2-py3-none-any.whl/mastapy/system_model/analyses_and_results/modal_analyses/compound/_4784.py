...
class SynchroniserCompoundModalAnalysis(_4769.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4641.SynchroniserModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4641.SynchroniserModalAnalysis]':
