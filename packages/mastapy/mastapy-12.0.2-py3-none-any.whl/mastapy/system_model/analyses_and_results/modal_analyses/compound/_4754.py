...
class PlanetaryConnectionCompoundModalAnalysis(_4768.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """PlanetaryConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4609.PlanetaryConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4609.PlanetaryConnectionModalAnalysis]':
