...
class MassDiscCompoundModalAnalysis(_4793.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4597.MassDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4597.MassDiscModalAnalysis]':
