...
class RingPinsToDiscConnectionCompoundModalAnalysis(_4736.InterMountableComponentConnectionCompoundModalAnalysis):
    """RingPinsToDiscConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4616.RingPinsToDiscConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4616.RingPinsToDiscConnectionModalAnalysis]':
