...
class ConicalGearMeshCompoundModalAnalysis(_4730.GearMeshCompoundModalAnalysis):
    """ConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4550.ConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4550.ConicalGearMeshModalAnalysis]':
