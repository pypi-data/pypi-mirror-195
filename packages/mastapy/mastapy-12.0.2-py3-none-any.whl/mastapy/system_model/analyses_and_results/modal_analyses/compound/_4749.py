...
class OilSealCompoundModalAnalysis(_4707.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4603.OilSealModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4603.OilSealModalAnalysis]':
