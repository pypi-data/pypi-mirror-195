...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis(_4737.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4595.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4595.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
