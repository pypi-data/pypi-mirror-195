...
class PartToPartShearCouplingHalfCompoundModalAnalysis(_4710.CouplingHalfCompoundModalAnalysis):
    """PartToPartShearCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4607.PartToPartShearCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4607.PartToPartShearCouplingHalfModalAnalysis]':
