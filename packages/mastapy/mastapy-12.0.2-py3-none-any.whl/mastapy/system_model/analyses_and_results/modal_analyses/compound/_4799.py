...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4797, _4798, _4689
...
class ZerolBevelGearSetCompoundModalAnalysis(_4689.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4658.ZerolBevelGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis(self) -> 'List[_4797.ZerolBevelGearCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis(self) -> 'List[_4798.ZerolBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4658.ZerolBevelGearSetModalAnalysis]':
