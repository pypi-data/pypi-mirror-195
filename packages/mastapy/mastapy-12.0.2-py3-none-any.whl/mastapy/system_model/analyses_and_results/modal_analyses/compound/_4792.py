...
class UnbalancedMassCompoundModalAnalysis(_4793.VirtualComponentCompoundModalAnalysis):
    """UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4648.UnbalancedMassModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4648.UnbalancedMassModalAnalysis]':
