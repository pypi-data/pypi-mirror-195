...
class CylindricalGearCompoundModalAnalysis(_4729.GearCompoundModalAnalysis):
    """CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4567.CylindricalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4567.CylindricalGearModalAnalysis]':
