...
class PlanetaryGearSetCompoundModalAnalysis(_4720.CylindricalGearSetCompoundModalAnalysis):
    """PlanetaryGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4610.PlanetaryGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4610.PlanetaryGearSetModalAnalysis]':
