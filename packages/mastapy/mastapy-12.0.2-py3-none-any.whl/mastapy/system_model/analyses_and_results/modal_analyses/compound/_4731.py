...
class GearSetCompoundModalAnalysis(_4769.SpecialisedAssemblyCompoundModalAnalysis):
    """GearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4582.GearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4582.GearSetModalAnalysis]':
