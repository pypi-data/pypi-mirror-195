...
class WormGearCompoundModalAnalysis(_4729.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4654.WormGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4654.WormGearModalAnalysis]':
