...
class ConceptCouplingConnectionCompoundModalAnalysis(_4709.CouplingConnectionCompoundModalAnalysis):
    """ConceptCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4544.ConceptCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4544.ConceptCouplingConnectionModalAnalysis]':
