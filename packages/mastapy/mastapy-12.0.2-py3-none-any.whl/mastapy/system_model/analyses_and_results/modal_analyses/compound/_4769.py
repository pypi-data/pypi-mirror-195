...
class SpecialisedAssemblyCompoundModalAnalysis(_4671.AbstractAssemblyCompoundModalAnalysis):
    """SpecialisedAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4625.SpecialisedAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4625.SpecialisedAssemblyModalAnalysis]':
