...
class AbstractShaftOrHousingCompoundModalAnalysis(_4696.ComponentCompoundModalAnalysis):
    """AbstractShaftOrHousingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4520.AbstractShaftOrHousingModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4520.AbstractShaftOrHousingModalAnalysis]':
