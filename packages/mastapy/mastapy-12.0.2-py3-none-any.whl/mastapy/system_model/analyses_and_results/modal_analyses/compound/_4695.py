...
class CoaxialConnectionCompoundModalAnalysis(_4768.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """CoaxialConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4542.CoaxialConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4542.CoaxialConnectionModalAnalysis]':
