...
class AGMAGleasonConicalGearCompoundModalAnalysis(_4703.ConicalGearCompoundModalAnalysis):
    """AGMAGleasonConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4523.AGMAGleasonConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4523.AGMAGleasonConicalGearModalAnalysis]':
