...
class BearingCompoundModalAnalysis(_4707.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4526.BearingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4526.BearingModalAnalysis]':
