...
class MeasurementComponentCompoundModalAnalysis(_4793.VirtualComponentCompoundModalAnalysis):
    """MeasurementComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4598.MeasurementComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4598.MeasurementComponentModalAnalysis]':
