...
class AGMAGleasonConicalGearSetCompoundModalAnalysis(_4705.ConicalGearSetCompoundModalAnalysis):
    """AGMAGleasonConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4524.AGMAGleasonConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4524.AGMAGleasonConicalGearSetModalAnalysis]':
