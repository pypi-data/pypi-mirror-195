...
class BoltCompoundModalAnalysis(_4696.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4538.BoltModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4538.BoltModalAnalysis]':
