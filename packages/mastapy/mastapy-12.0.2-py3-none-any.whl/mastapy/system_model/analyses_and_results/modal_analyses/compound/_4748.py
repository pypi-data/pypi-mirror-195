...
class MountableComponentCompoundModalAnalysis(_4696.ComponentCompoundModalAnalysis):
    """MountableComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4602.MountableComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4602.MountableComponentModalAnalysis]':
