...
class DatumCompoundModalAnalysis(_4696.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4570.DatumModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4570.DatumModalAnalysis]':
