...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4718, _4719, _4731
...
class CylindricalGearSetCompoundModalAnalysis(_4731.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4568.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_4718.CylindricalGearCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_4719.CylindricalGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4568.CylindricalGearSetModalAnalysis]':
