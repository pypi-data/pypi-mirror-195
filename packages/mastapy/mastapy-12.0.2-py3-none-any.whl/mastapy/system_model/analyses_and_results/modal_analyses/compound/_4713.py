...
class CVTPulleyCompoundModalAnalysis(_4759.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4561.CVTPulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4561.CVTPulleyModalAnalysis]':
