...
class ConicalGearSetCompoundModalAnalysis(_4731.GearSetCompoundModalAnalysis):
    """ConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4552.ConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4552.ConicalGearSetModalAnalysis]':
