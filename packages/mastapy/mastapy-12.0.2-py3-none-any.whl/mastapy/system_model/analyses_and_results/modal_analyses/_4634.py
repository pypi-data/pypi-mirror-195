...
from mastapy.system_model.analyses_and_results.modal_analyses import _4633, _4632, _4536
...
class StraightBevelDiffGearSetModalAnalysis(_4536.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4633.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4632.StraightBevelDiffGearMeshModalAnalysis]':
