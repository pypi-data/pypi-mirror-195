...
class CouplingModalAnalysis(_4625.SpecialisedAssemblyModalAnalysis):
    """CouplingModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2681.CouplingSystemDeflection':
