...
from mastapy.system_model.analyses_and_results.modal_analyses import _4657, _4656, _4536
...
class ZerolBevelGearSetModalAnalysis(_4536.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4657.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4656.ZerolBevelGearMeshModalAnalysis]':
