...
class PerModeResultsReport(_1723.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1785.TableAndChartOptions':
    ...
    def display_option(self, value: '_1785.TableAndChartOptions'):
