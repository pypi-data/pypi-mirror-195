...
from mastapy.system_model.analyses_and_results.modal_analyses import _4567, _4566, _4582
...
class CylindricalGearSetModalAnalysis(_4582.GearSetModalAnalysis):
    """CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4567.CylindricalGearModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4566.CylindricalGearMeshModalAnalysis]':
