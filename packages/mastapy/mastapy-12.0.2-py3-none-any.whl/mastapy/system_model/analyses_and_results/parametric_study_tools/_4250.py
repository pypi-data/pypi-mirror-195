...
from mastapy.bearings.bearing_results import _1911
...
class BearingParametricStudyTool(_4278.ConnectorParametricStudyTool):
    """BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1911.LoadedBearingDutyCycle]':
