...
class SynchroniserSleeveParametricStudyTool(_4375.SynchroniserPartParametricStudyTool):
    """SynchroniserSleeveParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2773.SynchroniserSleeveSystemDeflection]':
