...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4329, _4326, _4294
...
class ParametricStudyVariable(_2603.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4329.ParametricStudyDimension':
        ...
        return constructor.new_from_mastapy_type(_4329.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4329.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4326.MonteCarloDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4326.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4326.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def doe_variable_setter(self) -> '_4294.DesignOfExperimentsVariableSetter':
