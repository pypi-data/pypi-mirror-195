...
class ParametricStudyDOEResultVariable(_1519.ParetoOptimisationVariableBase):
    """ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1521.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1521.PropertyTargetForDominantCandidateSearch'):
