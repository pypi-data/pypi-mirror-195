...
class MeasurementComponentCompoundParametricStudyTool(_4511.VirtualComponentCompoundParametricStudyTool):
    """MeasurementComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4325.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4325.MeasurementComponentParametricStudyTool]':
