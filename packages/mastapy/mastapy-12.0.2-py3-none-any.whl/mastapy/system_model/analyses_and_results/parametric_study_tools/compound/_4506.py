...
class TorqueConverterCompoundParametricStudyTool(_4426.CouplingCompoundParametricStudyTool):
    """TorqueConverterCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4378.TorqueConverterParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4378.TorqueConverterParametricStudyTool]':
