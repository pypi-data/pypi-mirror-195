...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4296, _4249
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model import _2390, _2430
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import (
    _4397, _4399, _4402, _4409,
    _4408, _4430, _4410, _4415,
    _4420, _4432, _4434, _4438,
    _4445, _4444, _4446, _4453,
    _4460, _4463, _4464, _4465,
    _4467, _4469, _4474, _4475,
    _4476, _4478, _4480, _4485,
    _4484, _4490, _4491, _4496,
    _4499, _4502, _4506, _4510,
    _4514, _4517, _4389
)
...
class AssemblyCompoundParametricStudyTool(_4389.AbstractAssemblyCompoundParametricStudyTool):
    """AssemblyCompoundParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> '_4296.DutyCycleResultsForAllComponents':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4249.AssemblyParametricStudyTool]':
    ...
    @property
    def bearings(self) -> 'List[_4397.BearingCompoundParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4399.BeltDriveCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4402.BevelDifferentialGearSetCompoundParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4409.BoltedJointCompoundParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4408.BoltCompoundParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4430.CVTCompoundParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4410.ClutchCompoundParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4415.ConceptCouplingCompoundParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4420.ConceptGearSetCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4432.CycloidalAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4434.CycloidalDiscCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4438.CylindricalGearSetCompoundParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4445.FEPartCompoundParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4444.FaceGearSetCompoundParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4446.FlexiblePinAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4453.HypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4460.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4463.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4464.MassDiscCompoundParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4465.MeasurementComponentCompoundParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4467.OilSealCompoundParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4469.PartToPartShearCouplingCompoundParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4474.PlanetCarrierCompoundParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4475.PointLoadCompoundParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4476.PowerLoadCompoundParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4478.RingPinsCompoundParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4480.RollingRingAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4485.ShaftHubConnectionCompoundParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4484.ShaftCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4490.SpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4491.SpringDamperCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4496.StraightBevelDiffGearSetCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4499.StraightBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4502.SynchroniserCompoundParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4506.TorqueConverterCompoundParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4510.UnbalancedMassCompoundParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4514.WormGearSetCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4517.ZerolBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4249.AssemblyParametricStudyTool]':
