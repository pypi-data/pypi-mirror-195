...
class ComponentCompoundParametricStudyTool(_4468.PartCompoundParametricStudyTool):
    """ComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4267.ComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4267.ComponentParametricStudyTool]':
