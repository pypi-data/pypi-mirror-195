...
class CycloidalDiscCompoundParametricStudyTool(_4390.AbstractShaftCompoundParametricStudyTool):
    """CycloidalDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4287.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4287.CycloidalDiscParametricStudyTool]':
