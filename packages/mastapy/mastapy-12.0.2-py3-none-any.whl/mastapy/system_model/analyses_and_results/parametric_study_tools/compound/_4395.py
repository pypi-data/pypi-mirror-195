...
class AGMAGleasonConicalGearSetCompoundParametricStudyTool(_4423.ConicalGearSetCompoundParametricStudyTool):
    """AGMAGleasonConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4248.AGMAGleasonConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4248.AGMAGleasonConicalGearSetParametricStudyTool]':
