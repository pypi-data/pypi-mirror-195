...
class BoltCompoundParametricStudyTool(_4414.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4262.BoltParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4262.BoltParametricStudyTool]':
