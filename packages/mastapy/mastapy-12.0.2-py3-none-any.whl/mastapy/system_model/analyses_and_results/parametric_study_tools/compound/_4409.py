...
class BoltedJointCompoundParametricStudyTool(_4487.SpecialisedAssemblyCompoundParametricStudyTool):
    """BoltedJointCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4261.BoltedJointParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4261.BoltedJointParametricStudyTool]':
