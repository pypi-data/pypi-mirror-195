...
class CouplingConnectionCompoundParametricStudyTool(_4454.InterMountableComponentConnectionCompoundParametricStudyTool):
    """CouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4279.CouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4279.CouplingConnectionParametricStudyTool]':
