...
class SynchroniserCompoundParametricStudyTool(_4487.SpecialisedAssemblyCompoundParametricStudyTool):
    """SynchroniserCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4374.SynchroniserParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4374.SynchroniserParametricStudyTool]':
