...
class CylindricalGearMeshCompoundParametricStudyTool(_4448.GearMeshCompoundParametricStudyTool):
    """CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4289.CylindricalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4289.CylindricalGearMeshParametricStudyTool]':
