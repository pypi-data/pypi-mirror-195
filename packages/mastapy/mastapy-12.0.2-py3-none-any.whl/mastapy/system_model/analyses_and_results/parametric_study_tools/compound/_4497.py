...
class StraightBevelGearCompoundParametricStudyTool(_4405.BevelGearCompoundParametricStudyTool):
    """StraightBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4369.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4369.StraightBevelGearParametricStudyTool]':
