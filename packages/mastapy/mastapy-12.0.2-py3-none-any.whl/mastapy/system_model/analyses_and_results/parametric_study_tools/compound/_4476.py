...
class PowerLoadCompoundParametricStudyTool(_4511.VirtualComponentCompoundParametricStudyTool):
    """PowerLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4347.PowerLoadParametricStudyTool]':
    ...
    @property
    def load_cases(self) -> 'List[_6869.PowerLoadLoadCase]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4347.PowerLoadParametricStudyTool]':
