...
class ShaftCompoundParametricStudyTool(_4390.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4356.ShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4356.ShaftParametricStudyTool]':
