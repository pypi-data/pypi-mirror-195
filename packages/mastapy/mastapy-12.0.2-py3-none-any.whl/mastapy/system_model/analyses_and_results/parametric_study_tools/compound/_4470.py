...
class PartToPartShearCouplingConnectionCompoundParametricStudyTool(_4427.CouplingConnectionCompoundParametricStudyTool):
    """PartToPartShearCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4340.PartToPartShearCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4340.PartToPartShearCouplingConnectionParametricStudyTool]':
