...
class TorqueConverterPumpCompoundParametricStudyTool(_4428.CouplingHalfCompoundParametricStudyTool):
    """TorqueConverterPumpCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4379.TorqueConverterPumpParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4379.TorqueConverterPumpParametricStudyTool]':
