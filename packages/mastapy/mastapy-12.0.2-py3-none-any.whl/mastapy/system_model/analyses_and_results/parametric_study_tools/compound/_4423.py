...
class ConicalGearSetCompoundParametricStudyTool(_4449.GearSetCompoundParametricStudyTool):
    """ConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4276.ConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4276.ConicalGearSetParametricStudyTool]':
