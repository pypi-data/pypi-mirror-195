...
class MountableComponentCompoundParametricStudyTool(_4414.ComponentCompoundParametricStudyTool):
    """MountableComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4327.MountableComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4327.MountableComponentParametricStudyTool]':
