...
class ExternalCADModelCompoundParametricStudyTool(_4414.ComponentCompoundParametricStudyTool):
    """ExternalCADModelCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4301.ExternalCADModelParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4301.ExternalCADModelParametricStudyTool]':
