...
class FEPartCompoundParametricStudyTool(_4391.AbstractShaftOrHousingCompoundParametricStudyTool):
    """FEPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4305.FEPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4305.FEPartParametricStudyTool]':
