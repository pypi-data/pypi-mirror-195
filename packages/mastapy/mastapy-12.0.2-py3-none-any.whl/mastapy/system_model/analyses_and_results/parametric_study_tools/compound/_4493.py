...
class SpringDamperHalfCompoundParametricStudyTool(_4428.CouplingHalfCompoundParametricStudyTool):
    """SpringDamperHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4363.SpringDamperHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4363.SpringDamperHalfParametricStudyTool]':
