...
class ShaftHubConnectionCompoundParametricStudyTool(_4425.ConnectorCompoundParametricStudyTool):
    """ShaftHubConnectionCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4355.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4355.ShaftHubConnectionParametricStudyTool]':
