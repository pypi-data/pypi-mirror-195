...
class PartToPartShearCouplingHalfCompoundParametricStudyTool(_4428.CouplingHalfCompoundParametricStudyTool):
    """PartToPartShearCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4341.PartToPartShearCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4341.PartToPartShearCouplingHalfParametricStudyTool]':
