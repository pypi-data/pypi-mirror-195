...
class CylindricalGearCompoundParametricStudyTool(_4447.GearCompoundParametricStudyTool):
    """CylindricalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4290.CylindricalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4290.CylindricalGearParametricStudyTool]':
