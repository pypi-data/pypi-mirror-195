...
class ConnectionCompoundParametricStudyTool(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4277.ConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4277.ConnectionParametricStudyTool]':
