...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4515, _4516, _4407
...
class ZerolBevelGearSetCompoundParametricStudyTool(_4407.BevelGearSetCompoundParametricStudyTool):
    """ZerolBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4388.ZerolBevelGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4515.ZerolBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4516.ZerolBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4388.ZerolBevelGearSetParametricStudyTool]':
