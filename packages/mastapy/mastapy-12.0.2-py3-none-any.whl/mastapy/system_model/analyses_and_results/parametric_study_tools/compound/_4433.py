...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4413
...
class CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool(_4413.CoaxialConnectionCompoundParametricStudyTool):
    """CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4286.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4286.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
