...
class ZerolBevelGearMeshCompoundParametricStudyTool(_4406.BevelGearMeshCompoundParametricStudyTool):
    """ZerolBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4386.ZerolBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4386.ZerolBevelGearMeshParametricStudyTool]':
