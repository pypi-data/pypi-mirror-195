...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4442, _4443, _4449
...
class FaceGearSetCompoundParametricStudyTool(_4449.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4304.FaceGearSetParametricStudyTool]':
    ...
    @property
    def face_gears_compound_parametric_study_tool(self) -> 'List[_4442.FaceGearCompoundParametricStudyTool]':
    ...
    @property
    def face_meshes_compound_parametric_study_tool(self) -> 'List[_4443.FaceGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4304.FaceGearSetParametricStudyTool]':
