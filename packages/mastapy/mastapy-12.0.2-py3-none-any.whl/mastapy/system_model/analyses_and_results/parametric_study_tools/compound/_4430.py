...
class CVTCompoundParametricStudyTool(_4399.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4283.CVTParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4283.CVTParametricStudyTool]':
