...
class WormGearMeshCompoundParametricStudyTool(_4448.GearMeshCompoundParametricStudyTool):
    """WormGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4383.WormGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4383.WormGearMeshParametricStudyTool]':
