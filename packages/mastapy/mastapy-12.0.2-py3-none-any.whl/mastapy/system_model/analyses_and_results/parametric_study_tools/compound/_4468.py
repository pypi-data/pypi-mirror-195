...
class PartCompoundParametricStudyTool(_7474.PartCompoundAnalysis):
    """PartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4339.PartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4339.PartParametricStudyTool]':
