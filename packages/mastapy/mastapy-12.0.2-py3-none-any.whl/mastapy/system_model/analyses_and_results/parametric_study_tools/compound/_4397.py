...
class BearingCompoundParametricStudyTool(_4425.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1911.LoadedBearingDutyCycle':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4250.BearingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4250.BearingParametricStudyTool]':
