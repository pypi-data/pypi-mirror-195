...
class AbstractAssemblyCompoundParametricStudyTool(_4468.PartCompoundParametricStudyTool):
    """AbstractAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4242.AbstractAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4242.AbstractAssemblyParametricStudyTool]':
