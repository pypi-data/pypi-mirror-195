...
class MassDiscCompoundParametricStudyTool(_4511.VirtualComponentCompoundParametricStudyTool):
    """MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4324.MassDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4324.MassDiscParametricStudyTool]':
