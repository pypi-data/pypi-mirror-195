...
class CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool(_4392.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4288.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4288.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
