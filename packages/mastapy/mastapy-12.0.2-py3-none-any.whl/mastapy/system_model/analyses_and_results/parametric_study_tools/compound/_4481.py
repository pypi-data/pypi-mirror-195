...
class RollingRingCompoundParametricStudyTool(_4428.CouplingHalfCompoundParametricStudyTool):
    """RollingRingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4353.RollingRingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4353.RollingRingParametricStudyTool]':
