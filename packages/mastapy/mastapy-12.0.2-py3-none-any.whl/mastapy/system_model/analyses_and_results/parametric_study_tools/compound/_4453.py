...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4451, _4452, _4395
...
class HypoidGearSetCompoundParametricStudyTool(_4395.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    """HypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4313.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4451.HypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4452.HypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4313.HypoidGearSetParametricStudyTool]':
