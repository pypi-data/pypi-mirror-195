...
class ConceptGearCompoundParametricStudyTool(_4447.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4272.ConceptGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4272.ConceptGearParametricStudyTool]':
