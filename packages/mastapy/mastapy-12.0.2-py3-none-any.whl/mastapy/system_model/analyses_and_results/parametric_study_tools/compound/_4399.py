...
class BeltDriveCompoundParametricStudyTool(_4487.SpecialisedAssemblyCompoundParametricStudyTool):
    """BeltDriveCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4252.BeltDriveParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4252.BeltDriveParametricStudyTool]':
