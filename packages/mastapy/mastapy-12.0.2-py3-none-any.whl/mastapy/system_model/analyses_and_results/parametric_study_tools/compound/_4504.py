...
class SynchroniserPartCompoundParametricStudyTool(_4428.CouplingHalfCompoundParametricStudyTool):
    """SynchroniserPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4375.SynchroniserPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4375.SynchroniserPartParametricStudyTool]':
