...
class CVTPulleyCompoundParametricStudyTool(_4477.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4284.CVTPulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4284.CVTPulleyParametricStudyTool]':
