...
class KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool(_4455.KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4319.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4319.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
