...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4387, _4386, _4260
...
class ZerolBevelGearSetParametricStudyTool(_4260.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4387.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4386.ZerolBevelGearMeshParametricStudyTool]':
