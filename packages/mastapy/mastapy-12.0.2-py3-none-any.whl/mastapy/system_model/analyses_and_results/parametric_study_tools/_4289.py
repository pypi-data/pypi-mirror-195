...
class CylindricalGearMeshParametricStudyTool(_4307.GearMeshParametricStudyTool):
    """CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2689.CylindricalGearMeshSystemDeflection]':
