...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4384, _4383, _4309
...
class WormGearSetParametricStudyTool(_4309.GearSetParametricStudyTool):
    """WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_4384.WormGearParametricStudyTool]':
    ...
    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_4383.WormGearMeshParametricStudyTool]':
