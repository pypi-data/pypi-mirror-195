...
from mastapy.system_model.analyses_and_results.power_flows import _4040, _4039, _4081
...
class GearSetPowerFlow(_4081.SpecialisedAssemblyPowerFlow):
    """GearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4040.GearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4039.GearMeshPowerFlow]':
