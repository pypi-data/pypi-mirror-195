...
from mastapy.system_model.analyses_and_results.power_flows import _4108, _4107, _4041
...
class WormGearSetPowerFlow(_4041.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4108.WormGearPowerFlow]':
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4108.WormGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4107.WormGearMeshPowerFlow]':
    ...
    @property
    def worm_meshes_power_flow(self) -> 'List[_4107.WormGearMeshPowerFlow]':
