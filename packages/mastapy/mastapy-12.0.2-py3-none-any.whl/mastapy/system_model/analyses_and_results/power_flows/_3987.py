...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3988, _3990, _3993, _3999,
    _4000, _4021, _4003, _4008,
    _4011, _4023, _4026, _4030,
    _4037, _4036, _4038, _4045,
    _4052, _4055, _4041, _4056,
    _4057, _4059, _4063, _4066,
    _4067, _4070, _4072, _4074,
    _4078, _4079, _4084, _4087,
    _4090, _4093, _4098, _4102,
    _4105, _4109, _4112, _3980
)
...
class AssemblyPowerFlow(_3980.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self) -> 'List[_3988.BearingPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_3990.BeltDrivePowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3993.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3999.BoltedJointPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_4000.BoltPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4021.CVTPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4003.ClutchPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4008.ConceptCouplingPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4011.ConceptGearSetPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4023.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4026.CycloidalDiscPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4030.CylindricalGearSetPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4037.FEPartPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4036.FaceGearSetPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4038.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4045.HypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4052.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4055.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4041.GearSetPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4056.MassDiscPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4057.MeasurementComponentPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4059.OilSealPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4063.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4066.PlanetCarrierPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4067.PointLoadPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4070.PowerLoadPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4072.RingPinsPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4074.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4078.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4079.ShaftPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4084.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4087.SpringDamperPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4090.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4093.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4098.SynchroniserPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4102.TorqueConverterPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4105.UnbalancedMassPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4109.WormGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4112.ZerolBevelGearSetPowerFlow]':
