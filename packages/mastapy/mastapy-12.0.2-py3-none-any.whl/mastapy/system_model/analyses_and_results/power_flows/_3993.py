...
from mastapy.system_model.analyses_and_results.power_flows import _3992, _3991, _3998
...
class BevelDifferentialGearSetPowerFlow(_3998.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3992.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_3992.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3991.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_3991.BevelDifferentialGearMeshPowerFlow]':
