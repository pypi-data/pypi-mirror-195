...
from mastapy.system_model.analyses_and_results.power_flows import _4044, _4043, _3986
...
class HypoidGearSetPowerFlow(_3986.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4044.HypoidGearPowerFlow]':
    ...
    @property
    def hypoid_gears_power_flow(self) -> 'List[_4044.HypoidGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4043.HypoidGearMeshPowerFlow]':
    ...
    @property
    def hypoid_meshes_power_flow(self) -> 'List[_4043.HypoidGearMeshPowerFlow]':
