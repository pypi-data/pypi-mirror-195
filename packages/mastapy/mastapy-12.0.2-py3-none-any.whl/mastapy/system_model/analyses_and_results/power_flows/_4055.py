...
from mastapy.system_model.analyses_and_results.power_flows import _4054, _4053, _4049
...
class KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow(_4049.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4054.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_power_flow(self) -> 'List[_4054.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4053.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_power_flow(self) -> 'List[_4053.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
