...
class SpringDamperHalfCompoundPowerFlow(_4152.CouplingHalfCompoundPowerFlow):
    """SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4086.SpringDamperHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4086.SpringDamperHalfPowerFlow]':
