...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4124, _4125, _4131
...
class BevelDifferentialGearSetCompoundPowerFlow(_4131.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3993.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bevel_differential_gears_compound_power_flow(self) -> 'List[_4124.BevelDifferentialGearCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_compound_power_flow(self) -> 'List[_4125.BevelDifferentialGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3993.BevelDifferentialGearSetPowerFlow]':
