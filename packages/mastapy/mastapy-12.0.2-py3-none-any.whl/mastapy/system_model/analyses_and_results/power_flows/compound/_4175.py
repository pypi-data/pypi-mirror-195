...
class HypoidGearCompoundPowerFlow(_4117.AGMAGleasonConicalGearCompoundPowerFlow):
    """HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4044.HypoidGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4044.HypoidGearPowerFlow]':
