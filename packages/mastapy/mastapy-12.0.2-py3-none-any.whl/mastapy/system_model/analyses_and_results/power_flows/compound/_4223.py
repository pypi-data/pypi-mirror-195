...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4221, _4222, _4131
...
class StraightBevelGearSetCompoundPowerFlow(_4131.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4093.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gears_compound_power_flow(self) -> 'List[_4221.StraightBevelGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_compound_power_flow(self) -> 'List[_4222.StraightBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4093.StraightBevelGearSetPowerFlow]':
