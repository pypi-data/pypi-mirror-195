...
class SpringDamperConnectionCompoundPowerFlow(_4151.CouplingConnectionCompoundPowerFlow):
    """SpringDamperConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4085.SpringDamperConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4085.SpringDamperConnectionPowerFlow]':
