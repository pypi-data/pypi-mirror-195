...
class SynchroniserPartCompoundPowerFlow(_4152.CouplingHalfCompoundPowerFlow):
    """SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4097.SynchroniserPartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4097.SynchroniserPartPowerFlow]':
