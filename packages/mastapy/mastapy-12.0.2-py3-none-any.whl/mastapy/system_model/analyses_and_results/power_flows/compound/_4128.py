...
class BevelDifferentialSunGearCompoundPowerFlow(_4124.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3995.BevelDifferentialSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3995.BevelDifferentialSunGearPowerFlow]':
