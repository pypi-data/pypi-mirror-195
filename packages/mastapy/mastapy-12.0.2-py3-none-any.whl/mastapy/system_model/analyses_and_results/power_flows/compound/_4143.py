...
class ConceptGearMeshCompoundPowerFlow(_4172.GearMeshCompoundPowerFlow):
    """ConceptGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4009.ConceptGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4009.ConceptGearMeshPowerFlow]':
