...
class BevelDifferentialGearMeshCompoundPowerFlow(_4130.BevelGearMeshCompoundPowerFlow):
    """BevelDifferentialGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3991.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3991.BevelDifferentialGearMeshPowerFlow]':
