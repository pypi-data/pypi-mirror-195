...
class ZerolBevelGearMeshCompoundPowerFlow(_4130.BevelGearMeshCompoundPowerFlow):
    """ZerolBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4110.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4110.ZerolBevelGearMeshPowerFlow]':
