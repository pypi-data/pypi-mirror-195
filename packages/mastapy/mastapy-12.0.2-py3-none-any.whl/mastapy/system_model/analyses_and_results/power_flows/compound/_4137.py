...
class CoaxialConnectionCompoundPowerFlow(_4210.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """CoaxialConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4004.CoaxialConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4004.CoaxialConnectionPowerFlow]':
