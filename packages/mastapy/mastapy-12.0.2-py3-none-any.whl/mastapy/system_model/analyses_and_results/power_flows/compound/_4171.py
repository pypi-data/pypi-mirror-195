...
class GearCompoundPowerFlow(_4190.MountableComponentCompoundPowerFlow):
    """GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4040.GearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4040.GearPowerFlow]':
