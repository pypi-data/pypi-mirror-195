...
class StraightBevelSunGearCompoundPowerFlow(_4218.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4095.StraightBevelSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4095.StraightBevelSunGearPowerFlow]':
