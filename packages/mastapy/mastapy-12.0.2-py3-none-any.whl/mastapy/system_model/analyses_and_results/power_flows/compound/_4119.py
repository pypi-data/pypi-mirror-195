...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_4147.ConicalGearSetCompoundPowerFlow):
    """AGMAGleasonConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3986.AGMAGleasonConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3986.AGMAGleasonConicalGearSetPowerFlow]':
