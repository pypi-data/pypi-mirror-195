...
class SpiralBevelGearCompoundPowerFlow(_4129.BevelGearCompoundPowerFlow):
    """SpiralBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4083.SpiralBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4083.SpiralBevelGearPowerFlow]':
