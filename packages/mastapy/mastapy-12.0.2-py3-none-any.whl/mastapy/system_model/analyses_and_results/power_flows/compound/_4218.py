...
class StraightBevelDiffGearCompoundPowerFlow(_4129.BevelGearCompoundPowerFlow):
    """StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4089.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4089.StraightBevelDiffGearPowerFlow]':
