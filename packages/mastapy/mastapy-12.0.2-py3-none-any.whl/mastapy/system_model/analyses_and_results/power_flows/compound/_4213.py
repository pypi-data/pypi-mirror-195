...
class SpiralBevelGearMeshCompoundPowerFlow(_4130.BevelGearMeshCompoundPowerFlow):
    """SpiralBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4082.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4082.SpiralBevelGearMeshPowerFlow]':
