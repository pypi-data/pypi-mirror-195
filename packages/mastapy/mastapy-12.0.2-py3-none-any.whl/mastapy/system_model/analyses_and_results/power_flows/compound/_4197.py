...
class PlanetaryGearSetCompoundPowerFlow(_4162.CylindricalGearSetCompoundPowerFlow):
    """PlanetaryGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4065.PlanetaryGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4065.PlanetaryGearSetPowerFlow]':
