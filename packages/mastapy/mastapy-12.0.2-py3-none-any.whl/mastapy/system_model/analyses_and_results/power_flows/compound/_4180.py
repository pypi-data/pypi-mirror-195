...
class KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow(_4146.ConicalGearMeshCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4047.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4047.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
