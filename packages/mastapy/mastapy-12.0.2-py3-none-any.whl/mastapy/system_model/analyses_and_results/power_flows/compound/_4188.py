...
class MassDiscCompoundPowerFlow(_4235.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4056.MassDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4056.MassDiscPowerFlow]':
