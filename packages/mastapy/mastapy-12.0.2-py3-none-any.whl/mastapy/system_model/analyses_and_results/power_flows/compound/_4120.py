...
from mastapy.system_model.analyses_and_results.power_flows.compound import (
    _4121, _4123, _4126, _4133,
    _4132, _4154, _4134, _4139,
    _4144, _4156, _4158, _4162,
    _4169, _4168, _4170, _4177,
    _4184, _4187, _4188, _4189,
    _4191, _4193, _4198, _4199,
    _4200, _4202, _4204, _4209,
    _4208, _4214, _4215, _4220,
    _4223, _4226, _4230, _4234,
    _4238, _4241, _4113
)
...
class AssemblyCompoundPowerFlow(_4113.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3987.AssemblyPowerFlow]':
    ...
    @property
    def bearings(self) -> 'List[_4121.BearingCompoundPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_4123.BeltDriveCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4126.BevelDifferentialGearSetCompoundPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4133.BoltedJointCompoundPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_4132.BoltCompoundPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4154.CVTCompoundPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4134.ClutchCompoundPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4139.ConceptCouplingCompoundPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4144.ConceptGearSetCompoundPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4156.CycloidalAssemblyCompoundPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4158.CycloidalDiscCompoundPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4162.CylindricalGearSetCompoundPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4169.FEPartCompoundPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4168.FaceGearSetCompoundPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4170.FlexiblePinAssemblyCompoundPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4177.HypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4184.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4187.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4188.MassDiscCompoundPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4189.MeasurementComponentCompoundPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4191.OilSealCompoundPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4193.PartToPartShearCouplingCompoundPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4198.PlanetCarrierCompoundPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4199.PointLoadCompoundPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4200.PowerLoadCompoundPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4202.RingPinsCompoundPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4204.RollingRingAssemblyCompoundPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4209.ShaftHubConnectionCompoundPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4208.ShaftCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4214.SpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4215.SpringDamperCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4220.StraightBevelDiffGearSetCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4223.StraightBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4226.SynchroniserCompoundPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4230.TorqueConverterCompoundPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4234.UnbalancedMassCompoundPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4238.WormGearSetCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4241.ZerolBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3987.AssemblyPowerFlow]':
