...
class BevelDifferentialGearCompoundPowerFlow(_4129.BevelGearCompoundPowerFlow):
    """BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3992.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3992.BevelDifferentialGearPowerFlow]':
