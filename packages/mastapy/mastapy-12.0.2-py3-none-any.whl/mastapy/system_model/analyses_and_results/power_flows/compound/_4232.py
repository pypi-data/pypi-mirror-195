...
class TorqueConverterPumpCompoundPowerFlow(_4152.CouplingHalfCompoundPowerFlow):
    """TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4103.TorqueConverterPumpPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4103.TorqueConverterPumpPowerFlow]':
