...
class CouplingCompoundPowerFlow(_4211.SpecialisedAssemblyCompoundPowerFlow):
    """CouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4019.CouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4019.CouplingPowerFlow]':
