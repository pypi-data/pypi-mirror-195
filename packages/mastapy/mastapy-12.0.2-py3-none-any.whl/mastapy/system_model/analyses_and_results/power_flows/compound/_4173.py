...
class GearSetCompoundPowerFlow(_4211.SpecialisedAssemblyCompoundPowerFlow):
    """GearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4041.GearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4041.GearSetPowerFlow]':
