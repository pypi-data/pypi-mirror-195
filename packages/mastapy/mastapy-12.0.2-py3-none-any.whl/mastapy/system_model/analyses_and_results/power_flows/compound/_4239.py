...
class ZerolBevelGearCompoundPowerFlow(_4129.BevelGearCompoundPowerFlow):
    """ZerolBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4111.ZerolBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4111.ZerolBevelGearPowerFlow]':
