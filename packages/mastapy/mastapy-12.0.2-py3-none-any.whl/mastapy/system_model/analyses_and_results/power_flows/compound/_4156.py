...
class CycloidalAssemblyCompoundPowerFlow(_4211.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4023.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4023.CycloidalAssemblyPowerFlow]':
