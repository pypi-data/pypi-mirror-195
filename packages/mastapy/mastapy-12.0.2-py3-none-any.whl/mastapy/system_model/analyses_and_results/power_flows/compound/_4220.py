...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4218, _4219, _4131
...
class StraightBevelDiffGearSetCompoundPowerFlow(_4131.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4090.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_compound_power_flow(self) -> 'List[_4218.StraightBevelDiffGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_power_flow(self) -> 'List[_4219.StraightBevelDiffGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4090.StraightBevelDiffGearSetPowerFlow]':
