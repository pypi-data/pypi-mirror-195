...
class CylindricalGearMeshCompoundPowerFlow(_4172.GearMeshCompoundPowerFlow):
    """CylindricalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4028.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4028.CylindricalGearMeshPowerFlow]':
