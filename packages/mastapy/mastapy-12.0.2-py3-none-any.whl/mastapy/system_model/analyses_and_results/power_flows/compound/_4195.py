...
class PartToPartShearCouplingHalfCompoundPowerFlow(_4152.CouplingHalfCompoundPowerFlow):
    """PartToPartShearCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4062.PartToPartShearCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4062.PartToPartShearCouplingHalfPowerFlow]':
