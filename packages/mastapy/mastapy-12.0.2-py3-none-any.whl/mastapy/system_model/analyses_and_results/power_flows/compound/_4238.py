...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4236, _4237, _4173
...
class WormGearSetCompoundPowerFlow(_4173.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4109.WormGearSetPowerFlow]':
    ...
    @property
    def worm_gears_compound_power_flow(self) -> 'List[_4236.WormGearCompoundPowerFlow]':
    ...
    @property
    def worm_meshes_compound_power_flow(self) -> 'List[_4237.WormGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4109.WormGearSetPowerFlow]':
