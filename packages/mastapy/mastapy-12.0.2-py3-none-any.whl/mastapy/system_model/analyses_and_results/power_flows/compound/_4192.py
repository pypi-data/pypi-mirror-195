...
class PartCompoundPowerFlow(_7474.PartCompoundAnalysis):
    """PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4060.PartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4060.PartPowerFlow]':
