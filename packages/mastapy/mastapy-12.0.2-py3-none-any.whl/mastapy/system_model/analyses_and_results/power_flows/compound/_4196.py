...
class PlanetaryConnectionCompoundPowerFlow(_4210.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4064.PlanetaryConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4064.PlanetaryConnectionPowerFlow]':
