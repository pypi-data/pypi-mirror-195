...
class AbstractShaftOrHousingCompoundPowerFlow(_4138.ComponentCompoundPowerFlow):
    """AbstractShaftOrHousingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3981.AbstractShaftOrHousingPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3981.AbstractShaftOrHousingPowerFlow]':
