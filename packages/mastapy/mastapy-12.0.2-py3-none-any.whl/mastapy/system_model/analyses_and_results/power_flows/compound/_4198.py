...
class PlanetCarrierCompoundPowerFlow(_4190.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4066.PlanetCarrierPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4066.PlanetCarrierPowerFlow]':
