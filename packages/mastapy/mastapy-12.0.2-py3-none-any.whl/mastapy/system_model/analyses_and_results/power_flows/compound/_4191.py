...
class OilSealCompoundPowerFlow(_4149.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4059.OilSealPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4059.OilSealPowerFlow]':
