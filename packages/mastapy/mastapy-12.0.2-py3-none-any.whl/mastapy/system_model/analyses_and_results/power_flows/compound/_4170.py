...
class FlexiblePinAssemblyCompoundPowerFlow(_4211.SpecialisedAssemblyCompoundPowerFlow):
    """FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4038.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4038.FlexiblePinAssemblyPowerFlow]':
