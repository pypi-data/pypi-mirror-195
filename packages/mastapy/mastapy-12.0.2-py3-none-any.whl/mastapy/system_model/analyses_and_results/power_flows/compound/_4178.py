...
class InterMountableComponentConnectionCompoundPowerFlow(_4148.ConnectionCompoundPowerFlow):
    """InterMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4046.InterMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4046.InterMountableComponentConnectionPowerFlow]':
