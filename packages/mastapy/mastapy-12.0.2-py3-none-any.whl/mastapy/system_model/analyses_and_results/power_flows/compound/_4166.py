...
class FaceGearCompoundPowerFlow(_4171.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4035.FaceGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4035.FaceGearPowerFlow]':
