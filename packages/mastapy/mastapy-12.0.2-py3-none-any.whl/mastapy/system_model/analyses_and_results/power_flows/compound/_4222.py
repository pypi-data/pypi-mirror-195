...
class StraightBevelGearMeshCompoundPowerFlow(_4130.BevelGearMeshCompoundPowerFlow):
    """StraightBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4091.StraightBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4091.StraightBevelGearMeshPowerFlow]':
