...
class VirtualComponentCompoundPowerFlow(_4190.MountableComponentCompoundPowerFlow):
    """VirtualComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4106.VirtualComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4106.VirtualComponentPowerFlow]':
