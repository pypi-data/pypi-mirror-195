...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_4148.ConnectionCompoundPowerFlow):
    """AbstractShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3983.AbstractShaftToMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3983.AbstractShaftToMountableComponentConnectionPowerFlow]':
