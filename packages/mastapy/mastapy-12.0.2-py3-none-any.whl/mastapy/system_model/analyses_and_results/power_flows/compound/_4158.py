...
class CycloidalDiscCompoundPowerFlow(_4114.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4026.CycloidalDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4026.CycloidalDiscPowerFlow]':
