...
class CVTBeltConnectionCompoundPowerFlow(_4122.BeltConnectionCompoundPowerFlow):
    """CVTBeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4020.CVTBeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4020.CVTBeltConnectionPowerFlow]':
