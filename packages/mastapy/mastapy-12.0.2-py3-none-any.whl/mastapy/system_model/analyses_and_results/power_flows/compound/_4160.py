...
class CylindricalGearCompoundPowerFlow(_4171.GearCompoundPowerFlow):
    """CylindricalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4029.CylindricalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4029.CylindricalGearPowerFlow]':
