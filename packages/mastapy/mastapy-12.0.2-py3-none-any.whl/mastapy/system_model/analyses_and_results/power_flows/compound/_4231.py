...
class TorqueConverterConnectionCompoundPowerFlow(_4151.CouplingConnectionCompoundPowerFlow):
    """TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4101.TorqueConverterConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4101.TorqueConverterConnectionPowerFlow]':
