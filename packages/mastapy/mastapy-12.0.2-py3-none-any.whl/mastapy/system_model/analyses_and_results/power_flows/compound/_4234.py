...
class UnbalancedMassCompoundPowerFlow(_4235.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4105.UnbalancedMassPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4105.UnbalancedMassPowerFlow]':
