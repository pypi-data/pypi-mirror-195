...
from mastapy.system_model.analyses_and_results.power_flows import _4111, _4110, _3998
...
class ZerolBevelGearSetPowerFlow(_3998.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4111.ZerolBevelGearPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_4111.ZerolBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4110.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_power_flow(self) -> 'List[_4110.ZerolBevelGearMeshPowerFlow]':
