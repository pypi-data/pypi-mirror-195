...
from mastapy.system_model.analyses_and_results.power_flows import _4083, _4082, _3998
...
class SpiralBevelGearSetPowerFlow(_3998.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4083.SpiralBevelGearPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_power_flow(self) -> 'List[_4083.SpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4082.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_power_flow(self) -> 'List[_4082.SpiralBevelGearMeshPowerFlow]':
