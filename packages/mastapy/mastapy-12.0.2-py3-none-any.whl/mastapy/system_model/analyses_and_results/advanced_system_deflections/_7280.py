...
class MeasurementComponentAdvancedSystemDeflection(_7327.VirtualComponentAdvancedSystemDeflection):
    """MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2730.MeasurementComponentSystemDeflection]':
