...
class DatumCompoundAdvancedSystemDeflection(_7359.ComponentCompoundAdvancedSystemDeflection):
    """DatumCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7254.DatumAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7254.DatumAdvancedSystemDeflection]':
