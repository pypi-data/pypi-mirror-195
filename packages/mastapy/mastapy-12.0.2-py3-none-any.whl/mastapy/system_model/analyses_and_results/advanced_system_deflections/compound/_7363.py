...
class ConceptGearCompoundAdvancedSystemDeflection(_7392.GearCompoundAdvancedSystemDeflection):
    """ConceptGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7230.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7230.ConceptGearAdvancedSystemDeflection]':
