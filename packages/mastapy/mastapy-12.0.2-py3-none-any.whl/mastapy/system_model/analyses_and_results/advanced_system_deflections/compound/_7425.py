...
class RollingRingAssemblyCompoundAdvancedSystemDeflection(_7432.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """RollingRingAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7296.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7296.RollingRingAssemblyAdvancedSystemDeflection]':
