...
class PointLoadCompoundAdvancedSystemDeflection(_7456.VirtualComponentCompoundAdvancedSystemDeflection):
    """PointLoadCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7290.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7290.PointLoadAdvancedSystemDeflection]':
