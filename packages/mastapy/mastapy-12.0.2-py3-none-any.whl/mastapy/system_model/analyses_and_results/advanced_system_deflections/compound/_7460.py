...
class ZerolBevelGearCompoundAdvancedSystemDeflection(_7350.BevelGearCompoundAdvancedSystemDeflection):
    """ZerolBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7331.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7331.ZerolBevelGearAdvancedSystemDeflection]':
