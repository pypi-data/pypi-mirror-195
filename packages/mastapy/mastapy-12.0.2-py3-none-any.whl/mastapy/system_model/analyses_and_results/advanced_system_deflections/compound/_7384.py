...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7381.CylindricalGearCompoundAdvancedSystemDeflection):
    """CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7253.CylindricalPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7253.CylindricalPlanetGearAdvancedSystemDeflection]':
