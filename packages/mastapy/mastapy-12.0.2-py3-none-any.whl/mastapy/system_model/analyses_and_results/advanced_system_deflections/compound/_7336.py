...
class AbstractShaftOrHousingCompoundAdvancedSystemDeflection(_7359.ComponentCompoundAdvancedSystemDeflection):
    """AbstractShaftOrHousingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7200.AbstractShaftOrHousingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7200.AbstractShaftOrHousingAdvancedSystemDeflection]':
