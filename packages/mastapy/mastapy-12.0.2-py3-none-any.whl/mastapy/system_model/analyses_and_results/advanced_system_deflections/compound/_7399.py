...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7369.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7268.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7268.InterMountableComponentConnectionAdvancedSystemDeflection]':
