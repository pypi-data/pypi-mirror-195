...
class RollingRingConnectionCompoundAdvancedSystemDeflection(_7399.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """RollingRingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7297.RollingRingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7297.RollingRingConnectionAdvancedSystemDeflection]':
