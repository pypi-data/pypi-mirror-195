...
class MeasurementComponentCompoundAdvancedSystemDeflection(_7456.VirtualComponentCompoundAdvancedSystemDeflection):
    """MeasurementComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7280.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7280.MeasurementComponentAdvancedSystemDeflection]':
