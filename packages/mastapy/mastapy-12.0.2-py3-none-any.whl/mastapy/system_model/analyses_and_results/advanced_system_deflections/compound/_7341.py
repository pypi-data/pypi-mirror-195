...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import (
    _7342, _7344, _7347, _7354,
    _7353, _7375, _7355, _7360,
    _7365, _7377, _7379, _7383,
    _7390, _7389, _7391, _7398,
    _7405, _7408, _7409, _7410,
    _7412, _7414, _7419, _7420,
    _7421, _7423, _7425, _7430,
    _7429, _7435, _7436, _7441,
    _7444, _7447, _7451, _7455,
    _7459, _7462, _7334
)
...
class AssemblyCompoundAdvancedSystemDeflection(_7334.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """AssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7208.AssemblyAdvancedSystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7342.BearingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7344.BeltDriveCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7347.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7354.BoltedJointCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7353.BoltCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7375.CVTCompoundAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7355.ClutchCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7360.ConceptCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7365.ConceptGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7377.CycloidalAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7379.CycloidalDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7383.CylindricalGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7390.FEPartCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7389.FaceGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7391.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7398.HypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7405.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7408.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7409.MassDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7410.MeasurementComponentCompoundAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7412.OilSealCompoundAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7414.PartToPartShearCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7419.PlanetCarrierCompoundAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7420.PointLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7421.PowerLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7423.RingPinsCompoundAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7425.RollingRingAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7430.ShaftHubConnectionCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7429.ShaftCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7435.SpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7436.SpringDamperCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7441.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7444.StraightBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7447.SynchroniserCompoundAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7451.TorqueConverterCompoundAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7455.UnbalancedMassCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7459.WormGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7462.ZerolBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7208.AssemblyAdvancedSystemDeflection]':
