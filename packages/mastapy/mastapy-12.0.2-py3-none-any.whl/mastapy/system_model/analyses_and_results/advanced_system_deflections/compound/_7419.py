...
class PlanetCarrierCompoundAdvancedSystemDeflection(_7411.MountableComponentCompoundAdvancedSystemDeflection):
    """PlanetCarrierCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7289.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7289.PlanetCarrierAdvancedSystemDeflection]':
