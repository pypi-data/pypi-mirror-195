...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7381, _7382, _7394
...
class CylindricalGearSetCompoundAdvancedSystemDeflection(_7394.GearSetCompoundAdvancedSystemDeflection):
    """CylindricalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7251.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gears_compound_advanced_system_deflection(self) -> 'List[_7381.CylindricalGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_advanced_system_deflection(self) -> 'List[_7382.CylindricalGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7251.CylindricalGearSetAdvancedSystemDeflection]':
