...
class StraightBevelSunGearCompoundAdvancedSystemDeflection(_7439.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7316.StraightBevelSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7316.StraightBevelSunGearAdvancedSystemDeflection]':
