...
class ConicalGearMeshCompoundAdvancedSystemDeflection(_7393.GearMeshCompoundAdvancedSystemDeflection):
    """ConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7234.ConicalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7234.ConicalGearMeshAdvancedSystemDeflection]':
