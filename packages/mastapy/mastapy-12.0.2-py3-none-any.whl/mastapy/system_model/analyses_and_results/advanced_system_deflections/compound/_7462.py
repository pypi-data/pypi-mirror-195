...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7460, _7461, _7352
...
class ZerolBevelGearSetCompoundAdvancedSystemDeflection(_7352.BevelGearSetCompoundAdvancedSystemDeflection):
    """ZerolBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7333.ZerolBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7460.ZerolBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7461.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7333.ZerolBevelGearSetAdvancedSystemDeflection]':
