...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7387, _7388, _7394
...
class FaceGearSetCompoundAdvancedSystemDeflection(_7394.GearSetCompoundAdvancedSystemDeflection):
    """FaceGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7258.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def face_gears_compound_advanced_system_deflection(self) -> 'List[_7387.FaceGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_compound_advanced_system_deflection(self) -> 'List[_7388.FaceGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7258.FaceGearSetAdvancedSystemDeflection]':
