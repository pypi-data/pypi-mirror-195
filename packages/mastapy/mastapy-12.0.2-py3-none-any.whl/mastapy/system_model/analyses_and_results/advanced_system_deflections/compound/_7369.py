...
class ConnectionCompoundAdvancedSystemDeflection(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7236.ConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7236.ConnectionAdvancedSystemDeflection]':
