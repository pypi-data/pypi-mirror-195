...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7345.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7216.BevelDifferentialSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7216.BevelDifferentialSunGearAdvancedSystemDeflection]':
