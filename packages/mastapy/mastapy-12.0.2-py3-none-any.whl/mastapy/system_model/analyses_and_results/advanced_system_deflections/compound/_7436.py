...
class SpringDamperCompoundAdvancedSystemDeflection(_7371.CouplingCompoundAdvancedSystemDeflection):
    """SpringDamperCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7306.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7306.SpringDamperAdvancedSystemDeflection]':
