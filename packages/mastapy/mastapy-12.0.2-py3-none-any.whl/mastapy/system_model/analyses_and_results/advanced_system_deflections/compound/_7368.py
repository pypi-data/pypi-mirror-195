...
class ConicalGearSetCompoundAdvancedSystemDeflection(_7394.GearSetCompoundAdvancedSystemDeflection):
    """ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7235.ConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7235.ConicalGearSetAdvancedSystemDeflection]':
