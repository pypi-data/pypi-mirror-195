...
class RingPinsCompoundAdvancedSystemDeflection(_7411.MountableComponentCompoundAdvancedSystemDeflection):
    """RingPinsCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7293.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7293.RingPinsAdvancedSystemDeflection]':
