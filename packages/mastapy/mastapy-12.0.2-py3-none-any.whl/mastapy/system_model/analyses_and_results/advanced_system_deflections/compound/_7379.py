...
class CycloidalDiscCompoundAdvancedSystemDeflection(_7335.AbstractShaftCompoundAdvancedSystemDeflection):
    """CycloidalDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7246.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7246.CycloidalDiscAdvancedSystemDeflection]':
