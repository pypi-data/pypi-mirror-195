...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7457, _7458, _7394
...
class WormGearSetCompoundAdvancedSystemDeflection(_7394.GearSetCompoundAdvancedSystemDeflection):
    """WormGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7330.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def worm_gears_compound_advanced_system_deflection(self) -> 'List[_7457.WormGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_advanced_system_deflection(self) -> 'List[_7458.WormGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7330.WormGearSetAdvancedSystemDeflection]':
