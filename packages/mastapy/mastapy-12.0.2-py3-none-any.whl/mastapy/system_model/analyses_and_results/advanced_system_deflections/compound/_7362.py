...
class ConceptCouplingHalfCompoundAdvancedSystemDeflection(_7373.CouplingHalfCompoundAdvancedSystemDeflection):
    """ConceptCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7229.ConceptCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7229.ConceptCouplingHalfAdvancedSystemDeflection]':
