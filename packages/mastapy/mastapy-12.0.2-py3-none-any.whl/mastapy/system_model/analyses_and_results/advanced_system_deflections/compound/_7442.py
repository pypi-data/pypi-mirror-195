...
class StraightBevelGearCompoundAdvancedSystemDeflection(_7350.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7312.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7312.StraightBevelGearAdvancedSystemDeflection]':
