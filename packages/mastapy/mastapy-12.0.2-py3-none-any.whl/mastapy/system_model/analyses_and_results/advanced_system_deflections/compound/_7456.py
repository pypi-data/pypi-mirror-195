...
class VirtualComponentCompoundAdvancedSystemDeflection(_7411.MountableComponentCompoundAdvancedSystemDeflection):
    """VirtualComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7327.VirtualComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7327.VirtualComponentAdvancedSystemDeflection]':
