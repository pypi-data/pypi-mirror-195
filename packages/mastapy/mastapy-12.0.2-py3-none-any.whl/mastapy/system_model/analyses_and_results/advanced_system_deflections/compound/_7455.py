...
class UnbalancedMassCompoundAdvancedSystemDeflection(_7456.VirtualComponentCompoundAdvancedSystemDeflection):
    """UnbalancedMassCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7326.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7326.UnbalancedMassAdvancedSystemDeflection]':
