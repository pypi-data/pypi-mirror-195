...
class BeltConnectionCompoundAdvancedSystemDeflection(_7399.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """BeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7210.BeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7210.BeltConnectionAdvancedSystemDeflection]':
