...
class MountableComponentCompoundAdvancedSystemDeflection(_7359.ComponentCompoundAdvancedSystemDeflection):
    """MountableComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7281.MountableComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7281.MountableComponentAdvancedSystemDeflection]':
