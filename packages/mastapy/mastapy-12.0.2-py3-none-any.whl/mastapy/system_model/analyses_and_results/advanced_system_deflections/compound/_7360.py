...
class ConceptCouplingCompoundAdvancedSystemDeflection(_7371.CouplingCompoundAdvancedSystemDeflection):
    """ConceptCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7227.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7227.ConceptCouplingAdvancedSystemDeflection]':
