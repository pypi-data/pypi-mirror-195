...
class ShaftHubConnectionCompoundAdvancedSystemDeflection(_7370.ConnectorCompoundAdvancedSystemDeflection):
    """ShaftHubConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7300.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7300.ShaftHubConnectionAdvancedSystemDeflection]':
