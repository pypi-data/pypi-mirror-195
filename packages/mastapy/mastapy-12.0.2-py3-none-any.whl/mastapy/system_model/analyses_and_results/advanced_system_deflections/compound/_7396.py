...
class HypoidGearCompoundAdvancedSystemDeflection(_7338.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection):
    """HypoidGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7265.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7265.HypoidGearAdvancedSystemDeflection]':
