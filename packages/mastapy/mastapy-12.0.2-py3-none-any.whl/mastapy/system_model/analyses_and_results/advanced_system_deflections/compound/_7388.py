...
class FaceGearMeshCompoundAdvancedSystemDeflection(_7393.GearMeshCompoundAdvancedSystemDeflection):
    """FaceGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7257.FaceGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7257.FaceGearMeshAdvancedSystemDeflection]':
