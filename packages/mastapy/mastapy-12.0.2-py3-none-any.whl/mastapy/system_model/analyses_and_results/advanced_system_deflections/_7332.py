...
class ZerolBevelGearMeshAdvancedSystemDeflection(_7218.BevelGearMeshAdvancedSystemDeflection):
    """ZerolBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2789.ZerolBevelGearMeshSystemDeflection]':
