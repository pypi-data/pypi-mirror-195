...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7331, _7332, _7219
...
class ZerolBevelGearSetAdvancedSystemDeflection(_7219.BevelGearSetAdvancedSystemDeflection):
    """ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2790.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_7331.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_7332.ZerolBevelGearMeshAdvancedSystemDeflection]':
