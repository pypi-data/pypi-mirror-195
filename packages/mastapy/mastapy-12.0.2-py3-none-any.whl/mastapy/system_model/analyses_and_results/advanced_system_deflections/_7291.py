...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7325, _7327
...
class PowerLoadAdvancedSystemDeflection(_7327.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6869.PowerLoadLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2742.PowerLoadSystemDeflection]':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7325.TransmissionErrorToOtherPowerLoad]':
