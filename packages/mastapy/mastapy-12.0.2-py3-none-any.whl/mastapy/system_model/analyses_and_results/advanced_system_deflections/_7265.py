...
class HypoidGearAdvancedSystemDeflection(_7205.AGMAGleasonConicalGearAdvancedSystemDeflection):
    """HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2715.HypoidGearSystemDeflection]':
