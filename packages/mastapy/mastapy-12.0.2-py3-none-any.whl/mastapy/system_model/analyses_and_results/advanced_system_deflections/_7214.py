...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7212, _7213, _7219
...
class BevelDifferentialGearSetAdvancedSystemDeflection(_7219.BevelGearSetAdvancedSystemDeflection):
    """BevelDifferentialGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2652.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_advanced_system_deflection(self) -> 'List[_7212.BevelDifferentialGearAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_advanced_system_deflection(self) -> 'List[_7213.BevelDifferentialGearMeshAdvancedSystemDeflection]':
