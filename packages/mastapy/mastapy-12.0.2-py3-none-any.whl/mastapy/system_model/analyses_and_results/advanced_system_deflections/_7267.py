...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7265, _7266, _7207
...
class HypoidGearSetAdvancedSystemDeflection(_7207.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    """HypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2714.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_advanced_system_deflection(self) -> 'List[_7265.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_advanced_system_deflection(self) -> 'List[_7266.HypoidGearMeshAdvancedSystemDeflection]':
