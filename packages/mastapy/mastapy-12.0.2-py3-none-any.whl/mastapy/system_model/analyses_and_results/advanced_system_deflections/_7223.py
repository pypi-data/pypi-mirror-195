...
class ClutchConnectionAdvancedSystemDeflection(_7240.CouplingConnectionAdvancedSystemDeflection):
    """ClutchConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2661.ClutchConnectionSystemDeflection]':
