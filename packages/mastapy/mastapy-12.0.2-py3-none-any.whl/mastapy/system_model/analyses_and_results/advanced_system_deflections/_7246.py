...
class CycloidalDiscAdvancedSystemDeflection(_7199.AbstractShaftAdvancedSystemDeflection):
    """CycloidalDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2688.CycloidalDiscSystemDeflection]':
