...
class RollingRingAdvancedSystemDeflection(_7241.CouplingHalfAdvancedSystemDeflection):
    """RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2749.RollingRingSystemDeflection]':
