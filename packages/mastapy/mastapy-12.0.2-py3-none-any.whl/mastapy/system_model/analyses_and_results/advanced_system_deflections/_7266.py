...
class HypoidGearMeshAdvancedSystemDeflection(_7206.AGMAGleasonConicalGearMeshAdvancedSystemDeflection):
    """HypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2713.HypoidGearMeshSystemDeflection]':
