...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import (
    _7209, _7211, _7214, _7221,
    _7220, _7242, _7222, _7227,
    _7232, _7245, _7246, _7251,
    _7259, _7258, _7260, _7267,
    _7274, _7277, _7279, _7280,
    _7282, _7284, _7289, _7290,
    _7291, _7293, _7296, _7300,
    _7299, _7305, _7306, _7311,
    _7314, _7317, _7321, _7326,
    _7330, _7333, _7198
)
...
class AssemblyAdvancedSystemDeflection(_7198.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2647.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7209.BearingAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7211.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7214.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7221.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7220.BoltAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7242.CVTAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7222.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7227.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7232.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7245.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7246.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7251.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7259.FEPartAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7258.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7260.FlexiblePinAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7267.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7274.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7277.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7279.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7280.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7282.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7284.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7289.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7290.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7291.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7293.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7296.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7300.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7299.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7305.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7306.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7311.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7314.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7317.SynchroniserAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7321.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7326.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7330.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7333.ZerolBevelGearSetAdvancedSystemDeflection]':
