...
class FaceGearMeshAdvancedSystemDeflection(_7262.GearMeshAdvancedSystemDeflection):
    """FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2704.FaceGearMeshSystemDeflection]':
