...
class BoltedJointAdvancedSystemDeflection(_7302.SpecialisedAssemblyAdvancedSystemDeflection):
    """BoltedJointAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2659.BoltedJointSystemDeflection]':
