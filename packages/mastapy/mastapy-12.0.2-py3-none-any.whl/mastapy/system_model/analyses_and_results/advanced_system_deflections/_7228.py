...
class ConceptCouplingConnectionAdvancedSystemDeflection(_7240.CouplingConnectionAdvancedSystemDeflection):
    """ConceptCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2667.ConceptCouplingConnectionSystemDeflection]':
