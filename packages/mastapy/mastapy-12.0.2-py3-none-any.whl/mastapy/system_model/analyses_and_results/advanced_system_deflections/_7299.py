...
class ShaftAdvancedSystemDeflection(_7199.AbstractShaftAdvancedSystemDeflection):
    """ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2754.ShaftSystemDeflection]':
