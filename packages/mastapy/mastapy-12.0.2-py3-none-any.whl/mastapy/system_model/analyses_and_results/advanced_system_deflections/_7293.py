...
class RingPinsAdvancedSystemDeflection(_7281.MountableComponentAdvancedSystemDeflection):
    """RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2744.RingPinsSystemDeflection]':
