...
class ConceptCouplingHalfAdvancedSystemDeflection(_7241.CouplingHalfAdvancedSystemDeflection):
    """ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2668.ConceptCouplingHalfSystemDeflection]':
