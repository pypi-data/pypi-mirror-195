...
class PartToPartShearCouplingAdvancedSystemDeflection(_7239.CouplingAdvancedSystemDeflection):
    """PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2738.PartToPartShearCouplingSystemDeflection]':
