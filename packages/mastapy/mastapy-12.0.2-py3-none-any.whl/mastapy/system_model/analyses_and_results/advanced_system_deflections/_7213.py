...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_7218.BevelGearMeshAdvancedSystemDeflection):
    """BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2651.BevelDifferentialGearMeshSystemDeflection]':
