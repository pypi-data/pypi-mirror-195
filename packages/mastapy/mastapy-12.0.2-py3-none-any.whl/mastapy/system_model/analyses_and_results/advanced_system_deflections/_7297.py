...
class RollingRingConnectionAdvancedSystemDeflection(_7268.InterMountableComponentConnectionAdvancedSystemDeflection):
    """RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2748.RollingRingConnectionSystemDeflection]':
