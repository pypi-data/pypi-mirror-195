...
class TorqueConverterTurbineAdvancedSystemDeflection(_7241.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2781.TorqueConverterTurbineSystemDeflection]':
