...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3509, _3507, _3513
...
class FaceGearSetSteadyStateSynchronousResponseAtASpeed(_3513.GearSetSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def face_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3509.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3507.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
