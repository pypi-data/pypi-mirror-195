...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3503, _3501, _3513
...
class CylindricalGearSetSteadyStateSynchronousResponseAtASpeed(_3513.GearSetSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3503.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3501.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
