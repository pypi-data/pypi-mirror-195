...
class PointLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3706.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PointLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3540.PointLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3540.PointLoadSteadyStateSynchronousResponseAtASpeed]':
