...
class BoltCompoundSteadyStateSynchronousResponseAtASpeed(_3609.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3474.BoltSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3474.BoltSteadyStateSynchronousResponseAtASpeed]':
