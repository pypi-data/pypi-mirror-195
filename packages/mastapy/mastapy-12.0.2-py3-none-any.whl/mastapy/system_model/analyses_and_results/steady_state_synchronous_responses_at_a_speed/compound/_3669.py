...
class PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed(_3661.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3539.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3539.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]':
