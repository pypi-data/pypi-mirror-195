...
class HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed(_3588.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3518.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3518.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
