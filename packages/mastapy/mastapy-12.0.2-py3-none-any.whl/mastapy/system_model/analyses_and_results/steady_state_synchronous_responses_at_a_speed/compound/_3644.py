...
class GearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3682.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """GearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3513.GearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3513.GearSetSteadyStateSynchronousResponseAtASpeed]':
