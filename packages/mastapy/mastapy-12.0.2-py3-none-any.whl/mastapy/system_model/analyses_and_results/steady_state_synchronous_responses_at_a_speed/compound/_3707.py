...
class WormGearCompoundSteadyStateSynchronousResponseAtASpeed(_3642.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3580.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3580.WormGearSteadyStateSynchronousResponseAtASpeed]':
