...
class BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3590.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3471.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3471.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
