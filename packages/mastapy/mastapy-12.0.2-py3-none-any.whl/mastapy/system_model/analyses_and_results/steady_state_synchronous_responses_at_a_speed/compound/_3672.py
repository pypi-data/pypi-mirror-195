...
class PulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3623.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """PulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3542.PulleySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3542.PulleySteadyStateSynchronousResponseAtASpeed]':
