...
class ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed(_3609.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3506.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3506.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
