...
from mastapy.system_model.analyses_and_results.stability_analyses import _3826, _3824, _3730
...
class StraightBevelGearSetStabilityAnalysis(_3730.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3826.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3824.StraightBevelGearMeshStabilityAnalysis]':
