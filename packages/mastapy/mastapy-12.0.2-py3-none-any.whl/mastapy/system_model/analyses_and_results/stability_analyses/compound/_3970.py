...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3968, _3969, _3905
...
class WormGearSetCompoundStabilityAnalysis(_3905.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3840.WormGearSetStabilityAnalysis]':
    ...
    @property
    def worm_gears_compound_stability_analysis(self) -> 'List[_3968.WormGearCompoundStabilityAnalysis]':
    ...
    @property
    def worm_meshes_compound_stability_analysis(self) -> 'List[_3969.WormGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3840.WormGearSetStabilityAnalysis]':
