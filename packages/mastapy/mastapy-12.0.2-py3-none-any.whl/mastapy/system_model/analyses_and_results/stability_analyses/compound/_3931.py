...
class PointLoadCompoundStabilityAnalysis(_3967.VirtualComponentCompoundStabilityAnalysis):
    """PointLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3800.PointLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3800.PointLoadStabilityAnalysis]':
