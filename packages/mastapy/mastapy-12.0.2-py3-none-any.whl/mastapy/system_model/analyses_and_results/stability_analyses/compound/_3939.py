...
class RootAssemblyCompoundStabilityAnalysis(_3852.AssemblyCompoundStabilityAnalysis):
    """RootAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3808.RootAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3808.RootAssemblyStabilityAnalysis]':
