...
class SynchroniserPartCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """SynchroniserPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3830.SynchroniserPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3830.SynchroniserPartStabilityAnalysis]':
