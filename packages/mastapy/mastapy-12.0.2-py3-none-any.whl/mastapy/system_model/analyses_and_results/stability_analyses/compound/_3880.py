...
class ConnectionCompoundStabilityAnalysis(_7467.ConnectionCompoundAnalysis):
    """ConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3748.ConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3748.ConnectionStabilityAnalysis]':
