...
class PlanetaryConnectionCompoundStabilityAnalysis(_3942.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """PlanetaryConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3797.PlanetaryConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3797.PlanetaryConnectionStabilityAnalysis]':
