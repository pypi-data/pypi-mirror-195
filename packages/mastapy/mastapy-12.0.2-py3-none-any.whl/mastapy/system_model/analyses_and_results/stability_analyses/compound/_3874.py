...
class ConceptGearCompoundStabilityAnalysis(_3903.GearCompoundStabilityAnalysis):
    """ConceptGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3744.ConceptGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3744.ConceptGearStabilityAnalysis]':
