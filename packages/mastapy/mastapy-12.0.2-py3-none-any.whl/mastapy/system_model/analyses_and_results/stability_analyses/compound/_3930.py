...
class PlanetCarrierCompoundStabilityAnalysis(_3922.MountableComponentCompoundStabilityAnalysis):
    """PlanetCarrierCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3799.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3799.PlanetCarrierStabilityAnalysis]':
