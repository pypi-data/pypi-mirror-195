...
class FaceGearMeshCompoundStabilityAnalysis(_3904.GearMeshCompoundStabilityAnalysis):
    """FaceGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3767.FaceGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3767.FaceGearMeshStabilityAnalysis]':
