...
class StraightBevelGearMeshCompoundStabilityAnalysis(_3862.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3824.StraightBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3824.StraightBevelGearMeshStabilityAnalysis]':
