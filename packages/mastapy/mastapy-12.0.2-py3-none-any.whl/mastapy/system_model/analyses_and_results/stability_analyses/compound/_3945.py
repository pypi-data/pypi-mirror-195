...
class SpiralBevelGearMeshCompoundStabilityAnalysis(_3862.BevelGearMeshCompoundStabilityAnalysis):
    """SpiralBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3813.SpiralBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3813.SpiralBevelGearMeshStabilityAnalysis]':
