...
class BevelGearSetCompoundStabilityAnalysis(_3851.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """BevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3730.BevelGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3730.BevelGearSetStabilityAnalysis]':
