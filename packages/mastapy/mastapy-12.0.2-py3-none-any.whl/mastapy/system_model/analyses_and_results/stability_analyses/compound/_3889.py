...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3869
...
class CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis(_3869.CoaxialConnectionCompoundStabilityAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3758.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3758.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
