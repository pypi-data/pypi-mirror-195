...
class CVTCompoundStabilityAnalysis(_3855.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3756.CVTStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3756.CVTStabilityAnalysis]':
