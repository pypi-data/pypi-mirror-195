...
class ExternalCADModelCompoundStabilityAnalysis(_3870.ComponentCompoundStabilityAnalysis):
    """ExternalCADModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3766.ExternalCADModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3766.ExternalCADModelStabilityAnalysis]':
