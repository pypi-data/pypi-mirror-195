...
class PartToPartShearCouplingConnectionCompoundStabilityAnalysis(_3883.CouplingConnectionCompoundStabilityAnalysis):
    """PartToPartShearCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3794.PartToPartShearCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3794.PartToPartShearCouplingConnectionStabilityAnalysis]':
