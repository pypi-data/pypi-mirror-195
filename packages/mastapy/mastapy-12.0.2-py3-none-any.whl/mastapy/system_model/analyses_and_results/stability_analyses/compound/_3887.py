...
class CVTPulleyCompoundStabilityAnalysis(_3933.PulleyCompoundStabilityAnalysis):
    """CVTPulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3755.CVTPulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3755.CVTPulleyStabilityAnalysis]':
