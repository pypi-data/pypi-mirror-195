...
class TorqueConverterTurbineCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterTurbineCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3836.TorqueConverterTurbineStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3836.TorqueConverterTurbineStabilityAnalysis]':
