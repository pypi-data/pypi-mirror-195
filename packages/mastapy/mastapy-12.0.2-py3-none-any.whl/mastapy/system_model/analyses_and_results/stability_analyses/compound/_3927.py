...
class PartToPartShearCouplingHalfCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """PartToPartShearCouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3795.PartToPartShearCouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3795.PartToPartShearCouplingHalfStabilityAnalysis]':
