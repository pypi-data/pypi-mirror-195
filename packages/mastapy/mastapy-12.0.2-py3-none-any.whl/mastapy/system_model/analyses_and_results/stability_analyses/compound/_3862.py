...
class BevelGearMeshCompoundStabilityAnalysis(_3850.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """BevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3729.BevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3729.BevelGearMeshStabilityAnalysis]':
