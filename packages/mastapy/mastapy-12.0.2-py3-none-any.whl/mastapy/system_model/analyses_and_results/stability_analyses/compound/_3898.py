...
class FaceGearCompoundStabilityAnalysis(_3903.GearCompoundStabilityAnalysis):
    """FaceGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3769.FaceGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3769.FaceGearStabilityAnalysis]':
