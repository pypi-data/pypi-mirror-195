...
class BevelDifferentialGearMeshCompoundStabilityAnalysis(_3862.BevelGearMeshCompoundStabilityAnalysis):
    """BevelDifferentialGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3724.BevelDifferentialGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3724.BevelDifferentialGearMeshStabilityAnalysis]':
