...
class StraightBevelPlanetGearCompoundStabilityAnalysis(_3950.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3827.StraightBevelPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3827.StraightBevelPlanetGearStabilityAnalysis]':
