...
class TorqueConverterPumpCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterPumpCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3834.TorqueConverterPumpStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3834.TorqueConverterPumpStabilityAnalysis]':
