...
class RingPinsToDiscConnectionCompoundStabilityAnalysis(_3910.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """RingPinsToDiscConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3804.RingPinsToDiscConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3804.RingPinsToDiscConnectionStabilityAnalysis]':
