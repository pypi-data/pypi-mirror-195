...
class SpringDamperConnectionCompoundStabilityAnalysis(_3883.CouplingConnectionCompoundStabilityAnalysis):
    """SpringDamperConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3816.SpringDamperConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3816.SpringDamperConnectionStabilityAnalysis]':
