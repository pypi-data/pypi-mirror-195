...
class BearingCompoundStabilityAnalysis(_3881.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3721.BearingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3721.BearingStabilityAnalysis]':
