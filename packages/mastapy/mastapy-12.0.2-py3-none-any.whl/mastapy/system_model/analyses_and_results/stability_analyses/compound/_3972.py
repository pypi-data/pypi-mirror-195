...
class ZerolBevelGearMeshCompoundStabilityAnalysis(_3862.BevelGearMeshCompoundStabilityAnalysis):
    """ZerolBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3842.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3842.ZerolBevelGearMeshStabilityAnalysis]':
