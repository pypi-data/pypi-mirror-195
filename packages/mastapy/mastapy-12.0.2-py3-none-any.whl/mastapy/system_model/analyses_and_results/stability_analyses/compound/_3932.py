...
class PowerLoadCompoundStabilityAnalysis(_3967.VirtualComponentCompoundStabilityAnalysis):
    """PowerLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3801.PowerLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3801.PowerLoadStabilityAnalysis]':
