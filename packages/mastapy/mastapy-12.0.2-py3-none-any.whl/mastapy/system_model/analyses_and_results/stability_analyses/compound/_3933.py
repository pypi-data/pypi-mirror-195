...
class PulleyCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3802.PulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3802.PulleyStabilityAnalysis]':
