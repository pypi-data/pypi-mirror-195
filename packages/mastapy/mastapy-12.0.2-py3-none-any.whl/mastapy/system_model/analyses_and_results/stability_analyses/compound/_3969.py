...
class WormGearMeshCompoundStabilityAnalysis(_3904.GearMeshCompoundStabilityAnalysis):
    """WormGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3839.WormGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3839.WormGearMeshStabilityAnalysis]':
