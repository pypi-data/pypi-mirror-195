...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import (
    _3853, _3855, _3858, _3865,
    _3864, _3886, _3866, _3871,
    _3876, _3888, _3890, _3894,
    _3901, _3900, _3902, _3909,
    _3916, _3919, _3920, _3921,
    _3923, _3925, _3930, _3931,
    _3932, _3934, _3936, _3941,
    _3940, _3946, _3947, _3952,
    _3955, _3958, _3962, _3966,
    _3970, _3973, _3845
)
...
class AssemblyCompoundStabilityAnalysis(_3845.AbstractAssemblyCompoundStabilityAnalysis):
    """AssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3720.AssemblyStabilityAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_3853.BearingCompoundStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3855.BeltDriveCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3858.BevelDifferentialGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3865.BoltedJointCompoundStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3864.BoltCompoundStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3886.CVTCompoundStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3866.ClutchCompoundStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3871.ConceptCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3876.ConceptGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3888.CycloidalAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3890.CycloidalDiscCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3894.CylindricalGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3901.FEPartCompoundStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3900.FaceGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3902.FlexiblePinAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3909.HypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3916.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3919.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3920.MassDiscCompoundStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3921.MeasurementComponentCompoundStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3923.OilSealCompoundStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3925.PartToPartShearCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3930.PlanetCarrierCompoundStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3931.PointLoadCompoundStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3932.PowerLoadCompoundStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3934.RingPinsCompoundStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3936.RollingRingAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3941.ShaftHubConnectionCompoundStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3940.ShaftCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3946.SpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3947.SpringDamperCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3952.StraightBevelDiffGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3955.StraightBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3958.SynchroniserCompoundStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3962.TorqueConverterCompoundStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3966.UnbalancedMassCompoundStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3970.WormGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3973.ZerolBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3720.AssemblyStabilityAnalysis]':
