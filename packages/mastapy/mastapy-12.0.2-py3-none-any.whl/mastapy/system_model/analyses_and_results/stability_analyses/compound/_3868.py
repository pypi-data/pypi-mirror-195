...
class ClutchHalfCompoundStabilityAnalysis(_3884.CouplingHalfCompoundStabilityAnalysis):
    """ClutchHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3735.ClutchHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3735.ClutchHalfStabilityAnalysis]':
