...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3907, _3908, _3851
...
class HypoidGearSetCompoundStabilityAnalysis(_3851.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """HypoidGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3777.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def hypoid_gears_compound_stability_analysis(self) -> 'List[_3907.HypoidGearCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_stability_analysis(self) -> 'List[_3908.HypoidGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3777.HypoidGearSetStabilityAnalysis]':
