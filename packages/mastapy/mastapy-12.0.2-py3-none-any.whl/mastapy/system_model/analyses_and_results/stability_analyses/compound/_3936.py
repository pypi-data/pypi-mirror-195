...
class RollingRingAssemblyCompoundStabilityAnalysis(_3943.SpecialisedAssemblyCompoundStabilityAnalysis):
    """RollingRingAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3805.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3805.RollingRingAssemblyStabilityAnalysis]':
