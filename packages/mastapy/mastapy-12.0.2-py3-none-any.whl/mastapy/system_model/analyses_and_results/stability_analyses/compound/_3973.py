...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3971, _3972, _3863
...
class ZerolBevelGearSetCompoundStabilityAnalysis(_3863.BevelGearSetCompoundStabilityAnalysis):
    """ZerolBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3843.ZerolBevelGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_stability_analysis(self) -> 'List[_3971.ZerolBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_stability_analysis(self) -> 'List[_3972.ZerolBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3843.ZerolBevelGearSetStabilityAnalysis]':
