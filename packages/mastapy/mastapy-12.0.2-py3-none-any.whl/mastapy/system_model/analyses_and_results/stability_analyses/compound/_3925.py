...
class PartToPartShearCouplingCompoundStabilityAnalysis(_3882.CouplingCompoundStabilityAnalysis):
    """PartToPartShearCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3796.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3796.PartToPartShearCouplingStabilityAnalysis]':
