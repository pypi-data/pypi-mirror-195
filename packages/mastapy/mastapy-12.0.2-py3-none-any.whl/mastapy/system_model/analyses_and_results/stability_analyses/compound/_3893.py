...
class CylindricalGearMeshCompoundStabilityAnalysis(_3904.GearMeshCompoundStabilityAnalysis):
    """CylindricalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3761.CylindricalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3761.CylindricalGearMeshStabilityAnalysis]':
