...
class PartCompoundStabilityAnalysis(_7474.PartCompoundAnalysis):
    """PartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3793.PartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3793.PartStabilityAnalysis]':
