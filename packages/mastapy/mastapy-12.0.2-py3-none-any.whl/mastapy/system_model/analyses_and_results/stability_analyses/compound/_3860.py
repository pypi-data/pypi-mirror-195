...
class BevelDifferentialSunGearCompoundStabilityAnalysis(_3856.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3728.BevelDifferentialSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3728.BevelDifferentialSunGearStabilityAnalysis]':
