...
class MassDiscCompoundStabilityAnalysis(_3967.VirtualComponentCompoundStabilityAnalysis):
    """MassDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3789.MassDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3789.MassDiscStabilityAnalysis]':
