...
class RingPinsCompoundStabilityAnalysis(_3922.MountableComponentCompoundStabilityAnalysis):
    """RingPinsCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3803.RingPinsStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3803.RingPinsStabilityAnalysis]':
