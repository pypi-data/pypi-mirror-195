...
class ComponentCompoundStabilityAnalysis(_3924.PartCompoundStabilityAnalysis):
    """ComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3738.ComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3738.ComponentStabilityAnalysis]':
