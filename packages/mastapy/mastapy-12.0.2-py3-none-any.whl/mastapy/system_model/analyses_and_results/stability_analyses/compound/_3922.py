...
class MountableComponentCompoundStabilityAnalysis(_3870.ComponentCompoundStabilityAnalysis):
    """MountableComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3791.MountableComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3791.MountableComponentStabilityAnalysis]':
