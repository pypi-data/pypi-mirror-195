...
class PlanetaryGearSetCompoundStabilityAnalysis(_3894.CylindricalGearSetCompoundStabilityAnalysis):
    """PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3798.PlanetaryGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3798.PlanetaryGearSetStabilityAnalysis]':
