...
from mastapy.system_model.analyses_and_results.stability_analyses import _3841, _3839, _3773
...
class WormGearSetStabilityAnalysis(_3773.GearSetStabilityAnalysis):
    """WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3841.WormGearStabilityAnalysis]':
    ...
    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3839.WormGearMeshStabilityAnalysis]':
