...
from mastapy.system_model.analyses_and_results.stability_analyses import _3769, _3767, _3773
...
class FaceGearSetStabilityAnalysis(_3773.GearSetStabilityAnalysis):
    """FaceGearSetStabilityAnalysis
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3769.FaceGearStabilityAnalysis]':
    ...
    @property
    def face_meshes_stability_analysis(self) -> 'List[_3767.FaceGearMeshStabilityAnalysis]':
