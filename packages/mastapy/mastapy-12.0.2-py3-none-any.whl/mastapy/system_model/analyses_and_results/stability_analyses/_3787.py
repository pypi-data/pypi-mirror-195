...
from mastapy.system_model.analyses_and_results.stability_analyses import _3788, _3786, _3781
...
class KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis(_3781.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_stability_analysis(self) -> 'List[_3788.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_stability_analysis(self) -> 'List[_3786.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
