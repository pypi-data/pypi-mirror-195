...
from mastapy.system_model.analyses_and_results.power_flows import _4069, _4027
...
from mastapy.system_model.optimization import _2189, _2198
...
from mastapy.utility import _1563, _1564
from mastapy.utility.scripting import _1706
...
class MastaSettings(_0.APIBase):
    ...
    @property
    def iso14179_settings_database(self) -> '_1938.ISO14179SettingsDatabase':
    ...
    @property
    def bearing_settings(self) -> '_1842.BearingSettings':
    ...
    @property
    def bearing_settings_database(self) -> '_1843.BearingSettingsDatabase':
    ...
    @property
    def rolling_bearing_database(self) -> '_1856.RollingBearingDatabase':
    ...
    @property
    def skf_settings(self) -> '_1862.SKFSettings':
    ...
    @property
    def critical_speed_analysis_draw_style(self) -> '_6514.CriticalSpeedAnalysisDrawStyle':
    ...
    @property
    def harmonic_analysis_draw_style(self) -> '_5699.HarmonicAnalysisDrawStyle':
    ...
    @property
    def mbd_analysis_draw_style(self) -> '_5401.MBDAnalysisDrawStyle':
    ...
    @property
    def modal_analysis_draw_style(self) -> '_4600.ModalAnalysisDrawStyle':
    ...
    @property
    def power_flow_draw_style(self) -> '_4069.PowerFlowDrawStyle':
        ...
        if _4069.PowerFlowDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def stability_analysis_draw_style(self) -> '_3819.StabilityAnalysisDrawStyle':
    ...
    @property
    def steady_state_synchronous_response_draw_style(self) -> '_3040.SteadyStateSynchronousResponseDrawStyle':
    ...
    @property
    def model_view_options_draw_style(self) -> '_2209.ModelViewOptionsDrawStyle':
    ...
    @property
    def conical_gear_optimization_strategy_database(self) -> '_2189.ConicalGearOptimizationStrategyDatabase':
    ...
    @property
    def optimization_strategy_database(self) -> '_2198.OptimizationStrategyDatabase':
    ...
    @property
    def supercharger_rotor_set_database(self) -> '_2519.SuperchargerRotorSetDatabase':
    ...
    @property
    def planet_carrier_settings(self) -> '_2426.PlanetCarrierSettings':
    ...
    @property
    def cad_export_settings(self) -> '_1797.CADExportSettings':
    ...
    @property
    def database_settings(self) -> '_1792.DatabaseSettings':
    ...
    @property
    def program_settings(self) -> '_1563.ProgramSettings':
    ...
    @property
    def pushbullet_settings(self) -> '_1564.PushbulletSettings':
    ...
    @property
    def scripting_setup(self) -> '_1706.ScriptingSetup':
    ...
    @property
    def measurement_settings(self) -> '_1573.MeasurementSettings':
