...
from mastapy.system_model_gui import _1810
...
from mastapy.system_model.part_model.configurations import _2570, _2567, _2569
from mastapy.bearings.bearing_results.rolling import _1939
from mastapy.system_model.database_access import _2222
from mastapy.system_model.analyses_and_results.load_case_groups import _5603, _5604, _5611
from mastapy.system_model.analyses_and_results.static_loads import _6735, _6734
from mastapy.utility.model_validation import _1760
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2932
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1810.MASTAGUI':
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_2184.ThermalExpansionOptionForGroundedNodes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2184.ThermalExpansionOptionForGroundedNodes)(value) if value is not None else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_2184.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def unbalanced_mass_inclusion(self) -> '_2434.UnbalancedMassInclusionOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2434.UnbalancedMassInclusionOption)(value) if value is not None else None

    @unbalanced_mass_inclusion.setter
    def unbalanced_mass_inclusion(self, value: '_2434.UnbalancedMassInclusionOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def default_system_temperatures(self) -> '_2185.TransmissionTemperatureSet':
    ...
    @property
    def electric_machine_group(self) -> '_2169.ElectricMachineGroup':
    ...
    @property
    def fe_batch_operations(self) -> '_2319.BatchOperations':
    ...
    @property
    def file_save_details_all(self) -> '_1549.FileHistory':
    ...
    @property
    def file_save_details_most_recent(self) -> '_1550.FileHistoryItem':
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2467.ActiveGearSetDesignSelectionGroup':
    ...
    @property
    def settings(self) -> '_2166.DesignSettings':
    ...
    @property
    def system(self) -> '_2183.SystemReporting':
    ...
    @property
    def bearing_detail_configurations(self) -> 'List[_2570.BearingDetailConfiguration]':
    ...
    @property
    def fe_substructure_configurations(self) -> 'List[_2567.ActiveFESubstructureSelectionGroup]':
    ...
    @property
    def gear_set_configurations(self) -> 'List[_2467.ActiveGearSetDesignSelectionGroup]':
    ...
    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1939.ISO14179SettingsPerBearingType]':
    ...
    @property
    def shaft_detail_configurations(self) -> 'List[_2569.ActiveShaftDesignSelectionGroup]':
    ...
    @property
    def databases(self) -> '_2222.Databases':
    ...
    @property
    def design_states(self) -> 'List[_5603.DesignState]':
    ...
    @property
    def duty_cycles(self) -> 'List[_5604.DutyCycle]':
    ...
    @property
    def gear_set_config(self) -> '_2488.GearSetConfiguration':
    ...
    def gear_set_config(self, value: '_2488.GearSetConfiguration'):
        value = value.wrapped if value else None
        self.wrapped.GearSetConfig = value

    @property
    def masta_settings(self) -> '_2173.MastaSettings':
    ...
    @property
    def root_assembly(self) -> '_2430.RootAssembly':
    ...
    @property
    def static_loads(self) -> 'List[_6735.StaticLoadCase]':
    ...
    @property
    def time_series_load_case_groups(self) -> 'List[_5611.TimeSeriesLoadCaseGroup]':
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5603.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5604.DutyCycle':
    ...
    def add_synchroniser_shift_empty(self) -> '_2932.SynchroniserShift':
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2932.SynchroniserShift':
        """ 'AddSynchroniserShift' is the original name of this method.
    ...
    def design_state_load_case_group_named(self, name: 'str') -> '_5603.DesignState':
    ...
    def design_state_named(self, name: 'str') -> '_5603.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5604.DutyCycle':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2526.BeltCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2527.CycloidalAssemblyCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2528.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2529.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2530.ShaftCreationOptions':
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_2126.RollingBearing'):
    ...
    def remove_synchroniser_shift(self, shift: '_2932.SynchroniserShift'):
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1760.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7487.TaskProgress') -> '_1760.Status':
        """ 'Save' is the original name of this method.
    ...
    def save_load_case_results(self, file_name: 'str', load_cases: 'List[_6734.LoadCase]'):
    ...
    def time_series_load_case_group_named(self, name: 'str') -> '_5611.TimeSeriesLoadCaseGroup':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2390.Assembly]':
        """ 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2390.Assembly.TYPE]())
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1548.ExternalFullFEFileOption'] = _1548.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
