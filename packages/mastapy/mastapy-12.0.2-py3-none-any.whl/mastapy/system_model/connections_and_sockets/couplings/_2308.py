...
from mastapy.system_model.connections_and_sockets.couplings import _2304
...
class SpringDamperConnection(_2304.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_2162.ComponentDampingOption':
        ...
        return constructor.new_from_mastapy_type(_2162.ComponentDampingOption)(value) if value is not None else None

    @damping_option.setter
    def damping_option(self, value: '_2162.ComponentDampingOption'):
