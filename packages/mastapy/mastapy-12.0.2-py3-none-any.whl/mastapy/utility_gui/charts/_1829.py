...
from mastapy.utility_gui.charts import _1816, _1825, _1821
...
class TwoDChartDefinition(_1821.NDChartDefinition):
    """TwoDChartDefinition
    ...
    @property
    def const_lines(self) -> 'List[_1816.ConstantLine]':
    ...
    @property
    def series_list(self) -> 'List[_1825.Series2D]':
