...
from mastapy.utility.databases import _1789, _1791
...
TKey = TypeVar('TKey', bound='_1791.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1789.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    """SQLDatabase
