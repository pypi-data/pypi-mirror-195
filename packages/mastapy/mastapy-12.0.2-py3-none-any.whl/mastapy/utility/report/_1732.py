...
from mastapy.utility.report import _1733, _1734
...
T = TypeVar('T', bound='_1734.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1733.CustomReportItemContainerCollectionBase, Generic[T]):
    """CustomReportItemContainerCollection
