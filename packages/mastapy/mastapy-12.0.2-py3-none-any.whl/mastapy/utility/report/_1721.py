...
class CustomReport(_1731.CustomReportItemContainer):
    """CustomReport
    ...
    @property
    def cad_table_border_style(self) -> '_1714.CadTableBorderType':
        ...
        return constructor.new_from_mastapy_type(_1714.CadTableBorderType)(value) if value is not None else None

    @cad_table_border_style.setter
    def cad_table_border_style(self, value: '_1714.CadTableBorderType'):
    ...
    @property
    def include_report_check(self) -> '_1748.DefinitionBooleanCheckOptions':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1748.DefinitionBooleanCheckOptions)(value) if value is not None else None

    @include_report_check.setter
    def include_report_check(self, value: '_1748.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def page_size_for_cad_export(self) -> '_1713.CadPageSize':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1713.CadPageSize)(value) if value is not None else None

    @page_size_for_cad_export.setter
    def page_size_for_cad_export(self, value: '_1713.CadPageSize'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
