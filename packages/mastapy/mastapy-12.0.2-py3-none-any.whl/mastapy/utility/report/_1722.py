...
class CustomReportCadDrawing(_1738.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1798.StockDrawings':
        ...
        return constructor.new_from_mastapy_type(_1798.StockDrawings)(value) if value is not None else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1798.StockDrawings'):
