...
class CylindricalGearDesignAndRatingSettingsItem(_1794.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @property
    def tolerance_rounding_system(self) -> '_1574.MeasurementSystem':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1574.MeasurementSystem)(value) if value is not None else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1574.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
