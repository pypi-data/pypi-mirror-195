...
class BevelGearSetDesign(_1185.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1484.MaxMinMean':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1484.MaxMinMean)(value) if value is not None else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1484.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
