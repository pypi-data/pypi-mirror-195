...
class ToothFlankFractureAnalysisSettings(_1553.IndependentReportablePropertiesBase['ToothFlankFractureAnalysisSettings']):
    """ToothFlankFractureAnalysisSettings
    ...
    @property
    def measured_residual_stress_profile_property(self) -> '_1500.Vector2DListAccessor':
    ...
    def measured_residual_stress_profile_property(self, value: '_1500.Vector2DListAccessor'):
