...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def contact_patch(self, result_type: '_820.ContactResultType', include_tip_contact: 'bool', start_rotation_index: Optional['int'] = 0) -> '_1480.GriddedSurface':
    ...
    def contact_patch_detailed(self, result_type: '_820.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int', start_rotation_index: Optional['int'] = 0) -> '_1480.GriddedSurface':
        """ 'ContactPatch' is the original name of this method.
