...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self) -> '_1756.CustomChartType':
        ...
        return constructor.new_from_mastapy_type(_1756.CustomChartType)(value) if value is not None else None
    ...
    @property
    def select_chart_type(self) -> '_1517.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1517.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value is not None else None

    @select_chart_type.setter
    def select_chart_type(self, value: '_1517.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
