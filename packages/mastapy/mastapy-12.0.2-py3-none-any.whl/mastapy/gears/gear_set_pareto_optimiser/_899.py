...
from mastapy.math_utility.optimisation import _1515, _1512, _1506
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1515.ParetoOptimisationStrategy':
    ...
    @property
    def filters(self) -> 'List[_1512.ParetoOptimisationFilter]':
    ...
    @property
    def input_setters(self) -> 'List[_1506.InputSetter[TAnalysis]]':
