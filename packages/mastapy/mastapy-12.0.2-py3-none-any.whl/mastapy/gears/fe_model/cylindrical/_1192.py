...
class CylindricalGearMeshFEModel(_1188.GearMeshFEModel):
    ...
    def stiffness_wrt_contacts_for_with_progress(self, gear: '_1187.GearFEModel', flank: '_320.GearFlanks', progress: '_7487.TaskProgress') -> 'List[_828.GearContactStiffness]':
        """ 'StiffnessWrtContactsFor' is the original name of this method.
    ...
    def generate_stiffness_wrt_contacts_for(self, progress: '_7487.TaskProgress'):
    ...
    def generate_stiffness_wrt_contacts_for_flank(self, flank: '_320.GearFlanks', progress: '_7487.TaskProgress'):
        """ 'GenerateStiffnessWrtContactsFor' is the original name of this method.
