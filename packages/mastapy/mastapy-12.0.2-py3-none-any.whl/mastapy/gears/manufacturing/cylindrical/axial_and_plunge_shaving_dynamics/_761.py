...
class ShavingDynamicsCalculationForHobbedGears(_759.ShavingDynamicsCalculation['T'], Generic[T]):
    ...
    @property
    def redressing_chart_maximum_start_and_end_of_shaving_profile(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def redressing_chart_maximum_start_and_minimum_end_of_shaving_profile(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def redressing_chart_minimum_start_and_end_of_shaving_profile(self) -> '_1829.TwoDChartDefinition':
    ...
    @property
    def redressing_chart_minimum_start_and_maximum_end_of_shaving_profile(self) -> '_1829.TwoDChartDefinition':
