...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def user_specified_center_distance_offset_relative_to_cutter_height(self) -> '_1500.Vector2DListAccessor':
    ...
    def user_specified_center_distance_offset_relative_to_cutter_height(self, value: '_1500.Vector2DListAccessor'):
