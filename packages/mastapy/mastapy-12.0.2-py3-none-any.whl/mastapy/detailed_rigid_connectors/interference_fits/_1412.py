...
from mastapy.bearings.tolerances import _1885, _1870, _1876
...
class InterferenceFitHalfDesign(_1354.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1885.SupportTolerance':
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1870.InnerSupportTolerance':
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1876.OuterSupportTolerance':
