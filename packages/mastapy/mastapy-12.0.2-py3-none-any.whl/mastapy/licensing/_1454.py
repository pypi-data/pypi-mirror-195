...
from mastapy.licensing import _7500, _7501, _7502
...
class LicenceServer:
    ...
    @staticmethod
    def update_server_settings(server_details: '_7500.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_7500.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_7501.ModuleDetails]':
    ...
    @staticmethod
    def get_available_module_details() -> 'Iterable[_7501.ModuleDetails]':
    ...
    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_7502.ModuleLicenceStatus]':
