...
from mastapy.math_utility.optimisation import _1521, _1519
...
class ParetoOptimistaionVariable(_1519.ParetoOptimisationVariableBase):
    """ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1521.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new_from_mastapy_type(_1521.PropertyTargetForDominantCandidateSearch)(value) if value is not None else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1521.PropertyTargetForDominantCandidateSearch'):
