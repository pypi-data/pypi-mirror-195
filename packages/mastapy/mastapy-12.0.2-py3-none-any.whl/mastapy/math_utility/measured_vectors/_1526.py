...
from mastapy.math_utility.measured_vectors import _1530, _1525
...
class ForceAndDisplacementResults(_1525.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1530.VectorWithLinearAndAngularComponents':
