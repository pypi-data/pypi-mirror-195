...
TMeasurement = TypeVar('TMeasurement', bound='_1572.MeasurementBase')


class DataScalingReferenceValues(_1538.DataScalingReferenceValuesBase, Generic[TMeasurement]):
    """DataScalingReferenceValues
