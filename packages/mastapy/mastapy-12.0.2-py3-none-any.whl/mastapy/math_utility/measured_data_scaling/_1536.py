...
from mastapy.math_utility import _1471, _1456
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.math_utility.measured_data_scaling import _1537
from mastapy.utility.units_and_measurements.measurements import (
    _1579, _1584, _1588, _1603,
    _1609, _1661, _1660, _1666,
    _1582, _1699, _1692, _1637
)
...
class DataScalingOptions(_0.APIBase):
    ...
    @property
    def acceleration_reference_values(self) -> '_1537.DataScalingReferenceValues[_1579.Acceleration]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1579.Acceleration](temp) if temp is not None else None

    @property
    def angular_acceleration_reference_values(self) -> '_1537.DataScalingReferenceValues[_1584.AngularAcceleration]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1584.AngularAcceleration](temp) if temp is not None else None

    @property
    def angular_velocity_reference_values(self) -> '_1537.DataScalingReferenceValues[_1588.AngularVelocity]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1588.AngularVelocity](temp) if temp is not None else None

    @property
    def energy_reference_values(self) -> '_1537.DataScalingReferenceValues[_1603.Energy]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1603.Energy](temp) if temp is not None else None

    @property
    def force_reference_values(self) -> '_1537.DataScalingReferenceValues[_1609.Force]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1609.Force](temp) if temp is not None else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_1537.DataScalingReferenceValues[_1661.PowerSmallPerArea]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1661.PowerSmallPerArea](temp) if temp is not None else None

    @property
    def power_small_reference_values(self) -> '_1537.DataScalingReferenceValues[_1660.PowerSmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1660.PowerSmall](temp) if temp is not None else None

    @property
    def pressure_reference_values(self) -> '_1537.DataScalingReferenceValues[_1666.Pressure]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1666.Pressure](temp) if temp is not None else None

    @property
    def small_angle_reference_values(self) -> '_1537.DataScalingReferenceValues[_1582.AngleSmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1582.AngleSmall](temp) if temp is not None else None

    @property
    def small_velocity_reference_values(self) -> '_1537.DataScalingReferenceValues[_1699.VelocitySmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1699.VelocitySmall](temp) if temp is not None else None

    @property
    def torque_reference_values(self) -> '_1537.DataScalingReferenceValues[_1692.Torque]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1692.Torque](temp) if temp is not None else None

    @property
    def very_short_length_reference_values(self) -> '_1537.DataScalingReferenceValues[_1637.LengthVeryShort]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1637.LengthVeryShort](temp) if temp is not None else None
