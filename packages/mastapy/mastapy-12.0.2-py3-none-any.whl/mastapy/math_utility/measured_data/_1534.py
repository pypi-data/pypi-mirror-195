...
class OnedimensionalFunctionLookupTable(_1533.LookupTableBase['OnedimensionalFunctionLookupTable']):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1500.Vector2DListAccessor':
    ...
    @lookup_table.setter
    def lookup_table(self, value: '_1500.Vector2DListAccessor'):
