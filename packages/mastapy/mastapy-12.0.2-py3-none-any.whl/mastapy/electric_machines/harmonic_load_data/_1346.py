...
from mastapy.utility_gui.charts import _1828, _1824, _1815
...
class ElectricMachineHarmonicLoadDataBase(_1351.SpeedDependentHarmonicLoadData):
    ...
    @property
    def force_distribution_3d(self) -> '_1828.ThreeDVectorChartDefinition':
    ...
    @property
    def temporal_spatial_harmonics_chart(self) -> '_1824.ScatterChartDefinition':
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_1350.HarmonicLoadDataType', slice_index: 'int') -> '_1486.MultipleFourierSeriesInterpolator':
