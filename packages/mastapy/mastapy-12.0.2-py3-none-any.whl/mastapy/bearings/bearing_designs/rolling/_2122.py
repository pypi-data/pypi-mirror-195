...
from mastapy.bearings.bearing_designs.rolling import _2124, _2125, _2123
...
class NonBarrelRollerBearing(_2123.RollerBearing):
    """NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_2124.RollerEndShape':
        ...
        return constructor.new_from_mastapy_type(_2124.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_2124.RollerEndShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RollerEndShape = value

    @property
    def ribs(self) -> 'List[_2125.RollerRibDetail]':
