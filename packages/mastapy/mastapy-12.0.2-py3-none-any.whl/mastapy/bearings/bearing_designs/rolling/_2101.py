...
from mastapy.bearings.bearing_designs.rolling import _2102, _2126
...
class BallBearing(_2126.RollingBearing):
    """BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_2102.BallBearingShoulderDefinition]':
