...
class TaperRollerBearing(_2122.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1839.BearingMeasurementType':
        ...
        return constructor.new_from_mastapy_type(_1839.BearingMeasurementType)(value) if value is not None else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1839.BearingMeasurementType'):
