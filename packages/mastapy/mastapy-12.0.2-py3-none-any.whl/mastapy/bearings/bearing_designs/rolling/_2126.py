...
from mastapy.bearings import (
    _1855, _1833, _1834, _1835,
    _1832, _1858
)
from mastapy.bearings.bearing_designs.rolling import (
    _2108, _2112, _2113, _2119,
    _2129, _2107, _2136, _2116,
    _2104, _2128
)
...
class RollingBearing(_2092.DetailedBearing):
    """RollingBearing
    ...
    @property
    def cage_bridge_shape(self) -> '_2108.CageBridgeShape':
        ...
        return constructor.new_from_mastapy_type(_2108.CageBridgeShape)(value) if value is not None else None

    @cage_bridge_shape.setter
    def cage_bridge_shape(self, value: '_2108.CageBridgeShape'):
    ...
    @property
    def cage_material(self) -> '_1835.BearingCageMaterial':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1835.BearingCageMaterial)(value) if value is not None else None

    @cage_material.setter
    def cage_material(self, value: '_1835.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def catalogue(self) -> '_1832.BearingCatalog':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1832.BearingCatalog)(value) if value is not None else None
    ...
    @property
    def sleeve_type(self) -> '_2129.SleeveType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2129.SleeveType)(value) if value is not None else None
    ...
    @property
    def type_information(self) -> '_2107.BearingTypeExtraInformation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2107.BearingTypeExtraInformation)(value) if value is not None else None
    ...
    @property
    def geometric_constants(self) -> '_2116.GeometricConstants':
    ...
    @property
    def history(self) -> '_1549.FileHistory':
    ...
    @property
    def protection(self) -> '_2104.BearingProtection':
    ...
    @property
    def skf_seal_frictional_moment_constants(self) -> '_2128.SKFSealFrictionalMomentConstants':
