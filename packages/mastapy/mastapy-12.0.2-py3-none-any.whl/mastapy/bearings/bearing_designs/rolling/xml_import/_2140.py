...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2138, _2137
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_2138.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_2137.AbstractXmlVariableAssignment]':
