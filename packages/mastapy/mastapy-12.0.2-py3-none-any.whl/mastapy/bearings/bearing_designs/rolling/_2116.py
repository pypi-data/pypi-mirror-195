...
from mastapy.bearings.bearing_designs.rolling import _2117, _2118
...
class GeometricConstants(_0.APIBase):
    ...
    @property
    def geometric_constants_for_rolling_frictional_moments(self) -> '_2117.GeometricConstantsForRollingFrictionalMoments':
    ...
    @property
    def geometric_constants_for_sliding_frictional_moments(self) -> '_2118.GeometricConstantsForSlidingFrictionalMoments':
