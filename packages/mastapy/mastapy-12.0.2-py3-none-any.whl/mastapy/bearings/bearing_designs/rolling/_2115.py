...
from mastapy.bearings.bearing_designs.rolling import _2114, _2120
...
class FourPointContactBallBearing(_2120.MultiPointContactBallBearing):
    """FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_2114.FourPointContactAngleDefinition':
        ...
        return constructor.new_from_mastapy_type(_2114.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_2114.FourPointContactAngleDefinition'):
