...
from mastapy.bearings.bearing_designs.rolling import _2106
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_2106.BearingProtectionLevel':
        ...
        return constructor.new_from_mastapy_type(_2106.BearingProtectionLevel)(value) if value is not None else None
    ...
    @property
    def new_protection_level(self) -> '_2106.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_2106.BearingProtectionLevel'):
