...
class ThrustBallBearing(_2101.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1852.OuterRingMounting':
        ...
        return constructor.new_from_mastapy_type(_1852.OuterRingMounting)(value) if value is not None else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1852.OuterRingMounting'):
