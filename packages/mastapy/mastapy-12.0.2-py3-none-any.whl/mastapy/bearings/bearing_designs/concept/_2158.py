...
from mastapy.bearings.bearing_designs.concept import _2157, _2159
...
class ConceptAxialClearanceBearing(_2159.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_2157.BearingNodePosition':
        ...
        return constructor.new_from_mastapy_type(_2157.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2157.BearingNodePosition'):
