...
class PlainOilFedJournalBearing(_2152.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self) -> '_1850.JournalOilFeedType':
        ...
        return constructor.new_from_mastapy_type(_1850.JournalOilFeedType)(value) if value is not None else None

    @feed_type.setter
    def feed_type(self, value: '_1850.JournalOilFeedType'):
    ...
    @property
    def axial_groove_oil_feed(self) -> '_2143.AxialGrooveJournalBearing':
    ...
    @property
    def axial_hole_oil_feed(self) -> '_2144.AxialHoleJournalBearing':
    ...
    @property
    def circumferential_groove_oil_feed(self) -> '_2145.CircumferentialFeedJournalBearing':
