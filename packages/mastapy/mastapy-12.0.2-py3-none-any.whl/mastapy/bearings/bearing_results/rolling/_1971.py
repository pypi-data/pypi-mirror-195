...
from mastapy.bearings.bearing_results.rolling import _2026, _1986
...
class LoadedCylindricalRollerBearingResults(_1986.LoadedNonBarrelRollerBearingResults):
    """LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_2026.PermissibleContinuousAxialLoadResults':
