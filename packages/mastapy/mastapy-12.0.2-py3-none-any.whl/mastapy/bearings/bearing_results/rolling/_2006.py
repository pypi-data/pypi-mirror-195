...
from mastapy.bearings.bearing_results.rolling import _2005, _1992
...
class LoadedSphericalRollerThrustBearingRow(_1992.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2005.LoadedSphericalRollerThrustBearingResults':
