...
class GreaseLifeAndRelubricationInterval(_2058.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease_quantity(self) -> '_2050.GreaseQuantity':
    ...
    @property
    def initial_fill(self) -> '_2051.InitialFill':
