...
from mastapy.bearings.bearing_results.rolling.skf_module import _2054, _2058
...
class Viscosities(_2058.SKFCalculationResult):
    """Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_2054.OperatingViscosity':
