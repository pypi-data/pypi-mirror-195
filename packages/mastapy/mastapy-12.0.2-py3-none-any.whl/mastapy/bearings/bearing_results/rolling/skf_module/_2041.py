...
from mastapy.bearings.bearing_results.rolling.skf_module import _2052, _2058
...
class BearingRatingLife(_2058.SKFCalculationResult):
    """BearingRatingLife
    ...
    @property
    def life_model(self) -> '_2052.LifeModel':
