...
from mastapy.bearings.bearing_results.rolling.skf_module import _2055, _2058
...
class DynamicAxialLoadCarryingCapacity(_2058.SKFCalculationResult):
    """DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_2055.PermissibleAxialLoad':
