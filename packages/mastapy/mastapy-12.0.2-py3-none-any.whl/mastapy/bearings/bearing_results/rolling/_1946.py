...
from mastapy.bearings.bearing_results.rolling import _1945, _1948, _1965
...
class LoadedAngularContactBallBearingRow(_1965.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1945.LoadedAngularContactBallBearingResults':
