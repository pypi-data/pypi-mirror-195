...
from mastapy.bearings.bearing_results.rolling import _1998, _1965
...
class LoadedSelfAligningBallBearingRow(_1965.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1998.LoadedSelfAligningBallBearingResults':
