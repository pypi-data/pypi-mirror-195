...
from mastapy.bearings.bearing_results.rolling import _1931, _1976
...
class LoadedBallBearingElement(_1976.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1931.BallBearingRaceContactGeometry]':
    ...
    @property
    def outer_race_contact_geometries(self) -> 'List[_1931.BallBearingRaceContactGeometry]':
