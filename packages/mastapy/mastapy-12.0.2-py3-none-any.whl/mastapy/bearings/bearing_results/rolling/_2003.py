...
from mastapy.bearings.bearing_results.rolling import _2002, _1992
...
class LoadedSphericalRollerRadialBearingRow(_1992.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2002.LoadedSphericalRollerRadialBearingResults':
