...
from mastapy.bearings.bearing_results.rolling import _1959, _1957
...
class LoadedAxialThrustNeedleRollerBearingRow(_1957.LoadedAxialThrustCylindricalRollerBearingRow):
    """LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1959.LoadedAxialThrustNeedleRollerBearingResults':
