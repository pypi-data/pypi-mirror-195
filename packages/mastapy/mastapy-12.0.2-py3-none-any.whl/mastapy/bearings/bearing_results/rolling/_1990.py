...
from mastapy.bearings.bearing_results.rolling import _2029, _1976
...
class LoadedRollerBearingElement(_1976.LoadedElement):
    """LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_2029.ResultsAtRollerOffset]':
