...
from mastapy.bearings.bearing_results.rolling import _1967, _1992
...
class LoadedCrossedRollerBearingRow(_1992.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1967.LoadedCrossedRollerBearingResults':
