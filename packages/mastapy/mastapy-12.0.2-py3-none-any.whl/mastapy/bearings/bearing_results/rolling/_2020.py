...
from mastapy.bearings.bearing_results.rolling import _2019, _1992
...
class LoadedToroidalRollerBearingRow(_1992.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2019.LoadedToroidalRollerBearingResults':
