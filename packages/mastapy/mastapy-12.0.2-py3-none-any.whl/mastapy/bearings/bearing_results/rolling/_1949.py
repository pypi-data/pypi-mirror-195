...
from mastapy.bearings.bearing_results.rolling import _1948, _1946
...
class LoadedAngularContactThrustBallBearingRow(_1946.LoadedAngularContactBallBearingRow):
    """LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1948.LoadedAngularContactThrustBallBearingResults':
