...
from mastapy.bearings import _1841
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1841.BearingRow':
        ...
        return constructor.new_from_mastapy_type(_1841.BearingRow)(value) if value is not None else None
