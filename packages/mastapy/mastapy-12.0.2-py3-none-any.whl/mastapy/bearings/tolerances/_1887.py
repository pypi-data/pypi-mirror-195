...
from mastapy.bearings.tolerances import _1868
...
class ToleranceCombination(_0.APIBase):
    ...
    def fit(self) -> '_1868.FitType':
        ...
        return constructor.new_from_mastapy_type(_1868.FitType)(value) if value is not None else None
