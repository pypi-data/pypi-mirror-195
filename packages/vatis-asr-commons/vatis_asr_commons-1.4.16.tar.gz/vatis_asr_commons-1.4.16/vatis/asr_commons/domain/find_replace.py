...
class FindReplaceConfig(JSONDeserializable):
    ...
    regex: List[str]
    enabled: bool = True
    merge: str = Expressions.DEFAULT_REPLACEMENT_MERGE
    entity: str = Expressions.DEFAULT_REPLACEMENT_ENTITY
...
class FindReplaceExpressions(Expressions):
    def __init__(self, expressions: Dict[str, List[str]] = None,
        ...
        super(FindReplaceExpressions, self).__init__(expressions, replacement_merge, replacement_entity)
