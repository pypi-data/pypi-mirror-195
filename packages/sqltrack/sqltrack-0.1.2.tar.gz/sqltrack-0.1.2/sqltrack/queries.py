...
def first_row(cursor: pg.Cursor, query: str | SQL, parameters=()):
    """
...
def first_value(cursor: pg.Cursor, query: str | SQL, parameters=()):
    """
...
def first_values(cursor: pg.Cursor, query: str | SQL, parameters=()):
    """
