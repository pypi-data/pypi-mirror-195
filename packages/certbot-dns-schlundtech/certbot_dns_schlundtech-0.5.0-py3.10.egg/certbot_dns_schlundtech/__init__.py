...
===========================================  =================================
``--dns-schlundtech-credentials``            SchlundTech credentials_ INI
                                             file.
                                             (Required)
``--dns-schlundtech-propagation-seconds``    The number of seconds to wait for
