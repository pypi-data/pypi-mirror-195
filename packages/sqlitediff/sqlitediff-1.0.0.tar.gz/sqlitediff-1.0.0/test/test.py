...
cursor.execute("INSERT INTO fish (name, species, tank) VALUES ('Carl', 'goldfish', 8)")
cursor.execute("INSERT INTO fish (name, species, tank) VALUES ('Mark', 'bigfish', 9)")
...
cursor_.execute("INSERT INTO fish (id, name, species, tank) VALUES (3, 'Carl', 'goldfish', 8)")
cursor_.execute("INSERT INTO fish (id, name, species, tank) VALUES (4, 'Mark', 'bigfish', 9)")
cursor_.execute("INSERT INTO fish (id, name, species, tank) VALUES (5, 'Leo', 'whale', 3)")
cursor_.execute("INSERT INTO fish (id, name, species, tank) VALUES (6, 'Ole', 'delfin', 4)")

cursor_.execute("UPDATE fish SET tank = '77' WHERE id = 2")
cursor_.execute("UPDATE fish SET tank = '99' WHERE id = 4")
