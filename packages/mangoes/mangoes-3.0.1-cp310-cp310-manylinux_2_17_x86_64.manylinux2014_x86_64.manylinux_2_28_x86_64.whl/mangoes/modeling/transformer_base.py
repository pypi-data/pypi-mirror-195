...
class TransformerModel:
    ...
    Parameters
    ----------
    model: transformers.PretrainedModel subclass
        The pretrained model to use for predictions or embedding extractions.
    tokenizer: transformers.PretrainedTokenizer subclass
