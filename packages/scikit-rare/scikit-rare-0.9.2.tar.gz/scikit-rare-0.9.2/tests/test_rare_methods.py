...
class TestRARERandomFunctions(unittest.TestCase):
    ...
    def testRandomFeatureGrouping(self):
        feature_matrix = pd.read_csv('data/UnitTestingFeatures.csv')
    ...
    def testRemoveEmptyVariables(self):
        original_feature_matrix = pd.read_csv('data/UnitTestingFeatures.csv')
        label_name = 'Class'
    ...
    def testRareAndCommonVariableSeparation(self):
        original_feature_matrix = pd.read_csv('data/UnitTestingFeatures.csv')
        rare_feature_list, rare_feature_maf_dict, rare_feature_df, \
            common_feature_list, common_feature_maf_dict, \
    ...
    def testGroupedFeatureMatrix(self):
        feature_matrix_no_empty_variables = pd.read_csv('data/UnitTestingNoEmptyVariables.csv')
        amino_acid_bins = {'Bin 1': ['P_4'], 'Bin 2': ['P_9'], 'Bin 3': ['P_2'], 'Bin 4': ['P_7', 'P_8'],
                           'Bin 5': ['P_1']}
    ...
    def testCreateNextGeneration(self):
        binned_feature_groups = {'Bin 1': 0.08185036434599975, 'Bin 2': 0.0070904177836004865,
                                 'Bin 3': 0.0039696931865948045, 'Bin 4': -6.937411128554303e-05,
                                 'Bin 5': 0.008400928951761456, 'Bin 6': -0.024357040731407695,
                                 'Bin 7': 0.12765715324169724, 'Bin 8': 0.02213622028877459,
                                 'Bin 9': 0.008688720194967562, 'Bin 10': 0.0985988621826421,
                                 'Bin 11': 0.01004939642792752, 'Bin 12': -0.022689810714508443,
                                 'Bin 13': 0.054728631840882946, 'Bin 14': 0.1313862063950056,
                                 'Bin 15': 0.014758619589872663, 'Bin 16': -0.011658443730054603,
                                 'Bin 17': -0.019925078912097858, 'Bin 18': 0.035482796600742106,
                                 'Bin 19': 0.03711125314948674, 'Bin 20': -0.002978721356392027,
                                 'Bin 21': 0.08724325094155098, 'Bin 22': 0.026574541936889174,
                                 'Bin 23': 0.006173701379022588, 'Bin 24': 0.002796281211816425,
                                 'Bin 25': 0.1620856766066954, 'Bin 26': 0.06153315327942737,
                                 'Bin 27': -0.021091132940857644, 'Bin 28': -0.016643451703359645,
                                 'Bin 29': 0.0469667679158174, 'Bin 30': -0.016630996655104605,
                                 'Bin 31': -0.0063094447710799525, 'Bin 32': 0.0066770786568598195,
                                 'Bin 33': 0.040641553748154355, 'Bin 34': 0.009016032264098197,
                                 'Bin 35': -0.01665213864605951, 'Bin 36': 0.016726427969616417,
                                 'Bin 37': 0.006890896982547367, 'Bin 38': 0.010546699872941679,
                                 'Bin 39': -0.007925083964826858, 'Bin 40': 0.13215789226888913,
                                 'Bin 41': -0.00022180087256394644, 'Bin 42': 0.06705267054290298,
                                 'Bin 43': 0.07027298292699084, 'Bin 44': -0.012493018390475882,
                                 'Bin 45': -0.0004297498677824603, 'Bin 46': 0.00019773818973229664,
                                 'Bin 47': 0.019755875893369808, 'Bin 48': 0.003981579895843561,
                                 'Bin 49': -0.02091237656009778, 'Bin 50': 0.0867252178539734}
        max_population_of_bins = 10
        elitism_parameter = 0.2
        bin_scores = {"Bin 1": .910, "Bin 2": .814, "Bin 3": 0.678, "Bin 4": 0.765, "Bin 5": 0.7557, "Bin 6": 0.56,
                      "Bin 7": 0.1233, "Bin 8": -0.435, "Bin 9": 0.7569, "Bin 10": 0.92112,
                      "Bin 11": -0.786, "Bin 12": 0.2465, "Bin 13": -0.657, "Bin 14": -0.25981, "Bin 15": 0.8979,
                      "Bin 16": 0.8912, "Bin 17": 0.0051, "Bin 18": 0.561, "Bin 19": 0.6712, "Bin 20": 0.6129,
                      "Bin 21": 0.419, "Bin 22": -0.2210, "Bin 23": -.0903, "Bin 24": 0.00004, "Bin 25": 0.993245,
                      ...
                      "Bin 41": -0.999, "Bin 42": -0.926, "Bin 43": -0.193, "Bin 44": 0.188, "Bin 45": 0.913,
                      "Bin 46": 0.97, "Bin 47": -0.00010, "Bin 48": -.45, "Bin 49": .00023, "Bin 50": -.077}
        offspring_list = [['R_5'], ['R_27'], ['P_10'], ['R_21', 'R_17'], ['R_27'], ['P_5'], ['R_35', 'R_26'],
                          ['R_10', 'R_21', 'R_20']]
        feature_bin_list, elite_bin_list = create_next_generation(binned_feature_groups, bin_scores,
                                                                  max_population_of_bins, elitism_parameter,
                                                                  offspring_list)
        ...
        # 10 * 0.2 = 2, two elite bins should be selected, the highest scores are bin 25 and bin 31. In
        # binned_feature_groups. Expected scores of 0.1620856766066954 and -0.0063094447710799525
