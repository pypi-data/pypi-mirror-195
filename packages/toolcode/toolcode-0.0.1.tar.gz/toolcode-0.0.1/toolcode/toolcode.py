...
def fbpage(id,cookie):
    ...
    if urlpage==[]:
        ...
        replaceurl =urlfollow[0].replace('"',"").replace("amp;","")
        done=s.get(f"https://mbasic.facebook.com{replaceurl}").text
class checkfb:
