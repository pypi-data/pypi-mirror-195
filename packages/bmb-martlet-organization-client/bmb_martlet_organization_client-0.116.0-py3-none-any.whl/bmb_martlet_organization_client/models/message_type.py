...
class MessageType(object):
    ...
    attribute_map = {
        ...
        'direction': 'direction',
        'retention_poligy': 'retention_poligy'
    }

    def __init__(self, id=None, updated_at=None, address=None, message_type=None, direction=None, retention_poligy=None):  # noqa: E501
        ...
        if retention_poligy is not None:
            self.retention_poligy = retention_poligy
    ...
    @property
    def retention_poligy(self):
        """Gets the retention_poligy of this MessageType.  # noqa: E501


        :return: The retention_poligy of this MessageType.  # noqa: E501
        :rtype: str
        """
        return self._retention_poligy

    @retention_poligy.setter
    def retention_poligy(self, retention_poligy):
        """Sets the retention_poligy of this MessageType.


        :param retention_poligy: The retention_poligy of this MessageType.  # noqa: E501
        :type: str
        """

        self._retention_poligy = retention_poligy
