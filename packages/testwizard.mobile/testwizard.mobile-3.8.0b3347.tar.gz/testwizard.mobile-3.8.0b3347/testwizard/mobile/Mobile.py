...
from testwizard.commands_mobile import GetAppiumSettingsCommand
from testwizard.commands_mobile import GetElementCommand
...
from testwizard.commands_mobile import GetElementsCommand
...
from testwizard.commands_mobile import SetAppiumSettingsCommand
...
class Mobile(TestObjectBase):
    ...
    def getAppiumSettings(self):
        self.throwIfDisposed()
        return GetAppiumSettingsCommand(self).execute()
    
    def getElement(self, selector):
        self.throwIfDisposed()
        return GetElementCommand(self).execute(selector)
    ...
    def getElements(self, selector):
        self.throwIfDisposed()
        return GetElementsCommand(self).execute(selector)   
    ...
    def setAppiumSettings(self, settings):
        self.throwIfDisposed()
        return SetAppiumSettingsCommand(self).execute(settings)
