...
def get_helpers_send(save_stats: dict[str, Any]) -> dict[str, Any]:
...
def edit_helpers(save_stats: dict[str, Any], member: int, count: int) -> dict[str, Any]:
    """Handler for gamatoto helpers"""
    ...
    print(helper_count)
    print(helpers_counts_input)
    if member == 0:
        helpers_counts_input['Intern'] = count
    elif member == 1:
        helpers_counts_input['Lackey'] = count
    elif member == 2:
        helpers_counts_input['Underling'] = count
    elif member == 3:
        helpers_counts_input['Assistant'] = count
    elif member == 4:
        helpers_counts_input['Legend'] = count
