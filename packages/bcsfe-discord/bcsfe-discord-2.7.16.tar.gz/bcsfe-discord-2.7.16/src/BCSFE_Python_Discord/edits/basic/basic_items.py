...
async def edit_base_materials2(save_stats: dict[str, Any], ctx, bot) -> dict[str, Any]:
    """Handler for editing ototo base materials"""
    ...
    if msg.content == "1":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Bricks"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "2":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Feathers"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "3":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Coal"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "4":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Sprockets"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "5":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Gold"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "6":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Meteorite"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "7":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Beast Bones"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "8":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
        base_materials["Ammonite"] == int(msg.content)
        await ctx.send("세팅 완료.")
    elif msg.content == "9":
        await ctx.send("원하는 개수를 입력하세요. (최대 9999")
        msg = await bot.wait_for('message', check=check, timeout=None)
