...
def edit_helpers(save_stats: dict[str, Any], member: int, count: int) -> dict[str, Any]:
    ...
    print(helper_count)
    #print(helpers_counts_input+"bruh")
    if member == 0:
        helper_count['Intern'] = count
    elif member == 1:
        helper_count['Lackey'] = count
    elif member == 2:
        helper_count['Underling'] = count
    elif member == 3:
        helper_count['Assistant'] = count
    elif member == 4:
        helper_count['Legend'] = count
