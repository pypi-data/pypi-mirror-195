...
from rasa.nlu.tokenizers.whitespacetokenizer_oncf_eng_v2 import WhitespaceTokenizer_oncf_eng_v2
...
from rasa.nlu.tokenizers.whitesepacetokenizer_fr import WhitespaceTokenizer_fr
