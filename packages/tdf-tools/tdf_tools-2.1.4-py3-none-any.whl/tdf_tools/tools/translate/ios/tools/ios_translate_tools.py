...
class iOSTranslateTools:
    ...
    def update_iOS_string_key_Values(
        ...
        path = args[0]
        string_type = args[1]
        dic_from_strings = iOSTranslateTools.get_dic_with_dir(
            source_path, string_type)
    ...
    def get_dic_with_dir(source_dir: str, string_type: str) -> dict:
        ...
        # 获取组件下所有的国际化键值对
        module_dict = iOSTranslateTools.get_module_dict(
            source_dir, string_type)
