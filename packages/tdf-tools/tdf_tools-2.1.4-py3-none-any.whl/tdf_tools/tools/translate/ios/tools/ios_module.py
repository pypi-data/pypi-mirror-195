...
class IosModule:
    ...
    def check_strings_file(self):
        ...
        podspec_resource_bundle = podspec_resource_bundle.replace(
            "/*.lproj", "")
    ...
    def change_location_string(self):
        ...
        def __replace_nslocalized_impl__(str: str):
            ...
            pattern = re.compile(
                r"%s" % (iOSTranslatePattern.patten_localized_suffix))
    ...
    def checkout_change_pod_spec(self):
        ...
        print("模块当前resource_bundles path:",
              self.podspecModel.podspec_resource_bundles)
