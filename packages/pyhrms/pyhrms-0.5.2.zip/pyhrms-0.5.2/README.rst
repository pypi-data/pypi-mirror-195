...
Update
======
Mar.6.2023: pyhrms 0.5.02 new features:

    * SWATH data processing function: Easily process SWATH data using our new function.
    * Improved docstring: We've made updates to our docstring for more clarity and ease of use.
    * Documentation update: Our documentation has been updated to provide even more support for our users.
...
**I want to starting using PyHRMS**
...
.. note::
   ...
   - **Lowest PNEC Freshwater [µg//l]:** Lowest predicted no-effect concentration in freshwater. These data were obtained from NORMAN ecotoxicology database.
