...
class Logger:
    ...
    def catch_exception(self, submit, fn, *args, **kwargs):
        """
        catch_exception
        :return:
        """
...
class ImageLogger(Logger):
    ...
    def log(self,
        ...
        self.catch_exception(self._submit, cv2.imwrite, designation, image.data)
...
class BlobLogger(Logger):
    ...
    def log(self,
            ...
            designation: str = '',
            metadata: Dict = None):
        self.catch_exception(self._submit, self.file_write, designation, blob.data)
