...
class Logger:
    def __init__(self, config: Dict = None):
        ...
        """
        self._logger = None
        self._thread_executor_max_workers = config.get('max_workers')
        self._thread_executor = futures.ThreadPoolExecutor(
            max_workers=self._thread_executor_max_workers)
    ...
    def catch_exception(self, fn, *args, **kwargs):
        """
        catch_exception
        :return:
        """
...
class ImageLogger(Logger):
    ...
    def log(self,
        ...
        self.catch_exception(cv2.imwrite, designation, image.data)
...
class BlobLogger(Logger):
    ...
    def log(self,
            ...
            designation: str = '',
            metadata: Dict = None):
        self.catch_exception(self.file_write, designation, blob.data)
