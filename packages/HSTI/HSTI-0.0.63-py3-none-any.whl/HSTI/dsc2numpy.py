...
def dsc2np(file_location):
	...
	with open('file_location', 'r') as file:
	    ...
	    explination = ['Time', 'Unsubtracted Heat Flow', 'Baseline Heat Flow', 'Program Temperature',\
	                  'Sample Temperature', 'Approx. Gas Flow', 'Heat FLow Calibration', 'Uncorrected Heat Flow']
