...
from ..schema import BIEFDumper, ExtendedBIEF, ExtendedBIEFField, NormalizedPath
...
class URIParser(DynamicBlock):
    ...
    def parseURI(self, uri):
        ...
        for element in path:
            ...
            if tokens[0] in self.uri_kls.DF:
                d[ token[0] ] = token[1]

        assert len(d) == len(self.uri_kls.DF), 'invalid input'
        return d
