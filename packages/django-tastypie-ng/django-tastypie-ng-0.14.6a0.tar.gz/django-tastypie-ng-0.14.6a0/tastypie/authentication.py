...
from tastypie.compat import (
    get_user_model, get_username_field, unsalt_token, is_authenticated, compare_sanitized_tokens
)
...
class SessionAuthentication(Authentication):
    ...
    def is_authenticated(self, request, **kwargs):
        ...
        if not compare_sanitized_tokens(unsalt_token(request_csrf_token),
