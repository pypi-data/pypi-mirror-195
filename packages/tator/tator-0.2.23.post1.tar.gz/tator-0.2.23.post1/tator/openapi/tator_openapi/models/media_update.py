...
class MediaUpdate(object):
    ...
    def __init__(self, archive_state=None, attributes=None, codec=None, concat=None, elemental_id=None, fps=None, height=None, last_edit_end=None, last_edit_start=None, live=None, media_files=None, multi=None, name=None, num_frames=None, summary_level=None, width=None, local_vars_configuration=None):  # noqa: E501
