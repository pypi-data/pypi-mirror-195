...
class StateUpdate(object):
    ...
    def __init__(self, attributes=None, elemental_id=None, frame=None, localization_ids_add=None, localization_ids_remove=None, parent=None, local_vars_configuration=None):  # noqa: E501
