...
class ProjectSpec(object):
    ...
    def __init__(self, backup_bucket=None, bucket=None, enable_downloads=True, name=None, organization=None, summary='', upload_bucket=None, local_vars_configuration=None):  # noqa: E501
