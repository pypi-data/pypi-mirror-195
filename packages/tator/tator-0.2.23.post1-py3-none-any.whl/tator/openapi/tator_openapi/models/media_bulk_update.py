...
class MediaBulkUpdate(object):
    ...
    def __init__(self, archive_state=None, attributes=None, float_array=None, ids=None, localization_ids=None, state_ids=None, local_vars_configuration=None):  # noqa: E501
