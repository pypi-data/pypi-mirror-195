...
class ProjectUpdate(object):
    ...
    def __init__(self, backup_bucket=None, bucket=None, enable_downloads=None, name=None, summary=None, thumb=None, upload_bucket=None, local_vars_configuration=None):  # noqa: E501
