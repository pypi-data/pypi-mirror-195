...
class Media(object):
    ...
    def __init__(self, archive_state=None, archive_status_date=None, attributes=None, codec=None, created_by=None, created_datetime=None, elemental_id=None, fps=None, gid=None, height=None, id=None, last_edit_end=None, last_edit_start=None, md5=None, media_files=None, meta=None, modified_by=None, modified_datetime=None, name=None, num_frames=None, project=None, summary_level=None, uid=None, width=None, local_vars_configuration=None):  # noqa: E501
