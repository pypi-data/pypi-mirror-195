...
class Project(object):
    ...
    def __init__(self, backup_bucket=None, bucket=None, created=None, duration=None, enable_downloads=True, id=None, name=None, num_files=None, organization=None, permission=None, size=None, summary='', thumb=None, upload_bucket=None, usernames=None, local_vars_configuration=None):  # noqa: E501
