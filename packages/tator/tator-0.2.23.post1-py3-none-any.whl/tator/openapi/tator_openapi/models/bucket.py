...
class Bucket(object):
    ...
    def __init__(self, archive_sc=None, endpoint_url=None, id=None, live_sc=None, name=None, organization=None, store_type=None, local_vars_configuration=None):  # noqa: E501
