...
Github = namedtuple('Github', 'repo_name template_name description owner token')
...
class Repo(object):
    ...
    def set_remote(self, owner, repo_name, remote_url='git@github.com:{}/{}.git'):
