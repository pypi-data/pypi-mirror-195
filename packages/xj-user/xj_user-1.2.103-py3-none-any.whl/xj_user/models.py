...
class UserRelateToUser(models.Model):
    ...
    id = models.AutoField(verbose_name='ID', primary_key=True)
    user = models.ForeignKey(to="BaseInfo", verbose_name='关系人', related_name="relate_user_id_alias", blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
    with_user = models.ForeignKey(to="BaseInfo", verbose_name='关联关系人', related_name="relate_with_user_id_alias", blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
    user_relate_type = models.ForeignKey(to=UserRelateType, verbose_name='关系类型ID', blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
