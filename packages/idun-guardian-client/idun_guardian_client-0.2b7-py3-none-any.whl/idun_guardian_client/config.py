...
class Settings(BaseSettings):
    ...
    # BI-DIRECTIONAL API Gateway
    WS_IDENTIFIER_BIDIRECTIONAL: str = "wss://demo.piesocket.com/v3/channel_123?api_key=VCXCEuvhGcBDP7XhiJJUDvR1e1D3eiVjgZ9VRiaV&notify_self"
