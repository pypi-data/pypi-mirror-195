...
from algora.api.data.query.__util import (
    ...
    _query_dataset_csv_request_info_v2,
)
...
def query_dataset_csv_v2(id: str, request: TimeseriesQueryRequest) -> Response:
    """
    Query dataset CSV by ID.
    ...
    Returns:
        Response: HTTP response object
    """
    request_info = _query_dataset_csv_request_info_v2(id, request)
    return __get_request(**request_info)
