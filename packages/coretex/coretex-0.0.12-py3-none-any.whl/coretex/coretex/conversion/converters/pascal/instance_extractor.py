...
class InstanceExtractor:
    ...
    def createSubmasks(self, maskImage: Image) -> dict[str, Any]:
        """
            ...
            Parameters:
            maskImage: Image -> Segmentation mask

            Returns:
            Dictionary with submask image and color
        """
    ...
    def calculateIoU(self, boxA: dict[str, float], boxB: list[float]) -> float:
        """
            ...
            Parameters:
            boxA: dict[str, float] -> annotated object boxes
            boxB: dict[str, float] -> extracted boxes from contour
    ...
    def boxesOverlap(self, bbox: dict[str, Any], listOfPoints: ContourPoints) -> float:
        """
            ...
            Parameters:
            bbox: dict[str, Any] -> annotated object boxes
            listOfPoints: ContourPoints -> contour points

            Returns:
            Calculated overlap of boxes area
        """
    ...
    def matchContour(self, bbox: dict[str, Any], objectCandidate: ObjectCandidate, contourCandidates: list[ContourCandidate]) -> ContourPoints:
        """
            ...
            Parameters:
            bbox: dict[str, Any] -> annotated object boxes
            objectCandidate: ObjectCandidate -> groundtruth object
            contourCandidates: list[ContourCandidate] -> list of ContourCandidate objects

            Returns:
            The corresponding contour which matches given object
        """
    ...
    def extractInstances(
        ...
        """
            ...
            Parameters:
            filename: str -> file with annotations
            objects: list[ET.Element] -> annotated objects
        """
