...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cbitarray",
        "sources": [
            "opteryx/utils/bitarray/cbitarray.pyx"
        ]
    },
 ...
 */
  __pyx_v_n_bytes = __Pyx_div_long((__pyx_v_size + 7), 8);
 ...
 *             for j in range(8):
 */
  __pyx_t_1 = __Pyx_PyInt_From_long(__Pyx_div_long((__pyx_v_self->size + 7), 8)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
 ...
 *                 if i * 8 + j < self.size:
 */
  __pyx_t_2 = __Pyx_PyInt_From_long(__Pyx_div_long((__pyx_v_self->size + 7), 8)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
