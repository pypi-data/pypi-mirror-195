...
from pybi.core.components.reactiveComponent.echarts import EChartInfo
    ...
    def add_echart(
        ...
        *,
        ...
        if isinstance(options, (BaseChart, ChartCollector)):
            ...
            for chart in options._collector:
                opts, ds_infos, updateInfos = chart.get_options_infos()

                info = EChartInfo(opts, list(ds_infos), updateInfos)
            ...
            ds_infos = [
                info for info in EChart._extract_dataset_infos_from_option_(options)
            ]
