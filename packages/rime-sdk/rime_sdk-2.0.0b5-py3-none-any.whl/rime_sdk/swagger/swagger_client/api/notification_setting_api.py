...
class NotificationSettingApi(object):
    ...
    def notification_setting_list_notifications(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[str] list_notifications_query_object_types: Specifies a set of object types. Filters results by the specified set of object types.   - OBJECT_TYPE_PROJECT: Used for notifications associated with an project. The Notification object ID is the Project ID.
