...
class DataCollector:
    ...
    def __init__(self, api_client: ApiClient, project_id: str) -> None:
        ...
        Arguments:
            ...
            project_id: str
                The Project identifier the Data Collector is for.
        """
    ...
    def register_data_stream(self) -> str:
        ...
        A data stream is a location where data can be uploaded to.

        Returns:
            str: The ID of the registered data stream.
        """
    ...
    def log_datapoints(
        ...
        Args:
            data_stream_id: str
                The ID of the data stream to log the datapoints to.
            inputs: List[Dict]
        ...
        Returns:
            List[str]: List of datapoint IDs that were logged.

        Raises:
            ValueError: If the length of the inputs, timestamps, labels, or query_ids
                lists are not equal.

        Example:
            This example registers a data stream, and logs two datapoints to it.
