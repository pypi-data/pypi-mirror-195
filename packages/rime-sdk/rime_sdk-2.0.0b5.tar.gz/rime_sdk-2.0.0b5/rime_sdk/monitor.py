...
class Monitor:
    ...
    def __init__(
        ...
        Args:
            api_client: ApiClient
                The client to query for the up-to-date status of the Monitor.
            monitor_id: str
                The unique identifier for the RI Monitor object.
            firewall_id: str
                The unique identifier for the parent Firewall of the Monitor.
            project_id: str
                The unique identifier for the parent Project of the Monitor.
        """
    ...
    def update(self, notify: Optional[bool] = None) -> None:
        ...
        Args:
            notify: Optional[bool]
                Whether to turn Monitoring notifications on/off for a given monitor.
                If you turn Monitoring notifications on for the same Project and the
                monitor finds a Detection Event, the system will send you an alert.
        """
    ...
    def list_detected_events(self) -> Iterator[DetectionEvent]:
        ...
        For each continuous testing bin upload, the RI platform compares the
