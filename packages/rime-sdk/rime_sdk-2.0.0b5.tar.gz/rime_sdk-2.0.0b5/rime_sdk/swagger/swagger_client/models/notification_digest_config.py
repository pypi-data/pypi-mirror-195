...
class NotificationDigestConfig(object):
    ...
    def hour_offset(self):
        ...
        The offset in the day when the digest starts. The offset is taken in the configured timezone for the workspace. Uses a default value of 0800 when not provided.  # noqa: E501
    ...
    def last_digest_time(self):
        ...
        The last time that RIME sent the digest. This timestamp is zero when no digests have ever been sent.  # noqa: E501
