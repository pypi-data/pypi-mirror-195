...
class TestrunresultTestFeatureResult(object):
    ...
    def __init__(self, feature_id=None, feature_name=None, feature_type=None, severity=None, summary_counts=None, failing_tests=None, num_failing_rows=None, failing_rows_html=None, drift_statistic=None, model_impact=None, feature_infos=None, display=None):  # noqa: E501
