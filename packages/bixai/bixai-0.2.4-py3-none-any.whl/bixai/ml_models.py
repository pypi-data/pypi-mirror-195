...
class EvaluateModels:
    ...
    def visualize_probabilities_mvlogit(self, model, selection='', bin_size=0.01,
        ...
        :param model: het model dat gemaakt is
        :param selection: een sql statement om een selectie van de data te laten zien type: string. 'geslacht_Man == 0'
        :param bin_size: de bin size waarin de kansen worden opgeteld voor de histogram. als getal set as 0.01
        :param title: titel boven de grafiek. type:string
        :param xaxis: titel voor de x-as. type:string
        :param yaxis: titel voor de y-as. type:string
        :return:
        """
        if len(selection) > 0:
