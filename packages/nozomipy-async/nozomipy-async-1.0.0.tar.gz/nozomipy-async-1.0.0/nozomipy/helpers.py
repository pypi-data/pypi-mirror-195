...
def solve_date(date_object:datetime,start_date:datetime,end_date:datetime)->bool:
    if start_date>end_date:
        use = ((date_object < start_date) and (date_object > end_date))
        unuse = (start_date is None) and (start_date is None)
        return (use or unuse)
    else:
