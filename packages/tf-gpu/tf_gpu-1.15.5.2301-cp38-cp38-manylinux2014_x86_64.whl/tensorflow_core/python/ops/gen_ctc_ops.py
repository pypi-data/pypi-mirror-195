...
_ctc_loss_v2_outputs = ["loss", "gradient"]
_CTCLossV2Output = _collections.namedtuple(
    "CTCLossV2", _ctc_loss_v2_outputs)


@_dispatch.add_dispatch_list
@tf_export('ctc_loss_v2')
def ctc_loss_v2(inputs, labels_indices, labels_values, sequence_length, preprocess_collapse_repeated=False, ctc_merge_repeated=True, ignore_longer_outputs_than_inputs=False, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "CTCLossV2", name, _ctx.post_execution_callbacks, inputs,
      ...
      try:
        ...
        result = _dispatch.dispatch(
              ctc_loss_v2, inputs=inputs, labels_indices=labels_indices,
                           labels_values=labels_values,
                           sequence_length=sequence_length,
                           preprocess_collapse_repeated=preprocess_collapse_repeated,
                           ctc_merge_repeated=ctc_merge_repeated,
  ...
  _execute.record_gradient(
      "CTCLossV2", _inputs_flat, _attrs, _result, name)
  _result = _CTCLossV2Output._make(_result)
  return _result

def CTCLossV2(inputs, labels_indices, labels_values, sequence_length, preprocess_collapse_repeated=False, ctc_merge_repeated=True, ignore_longer_outputs_than_inputs=False, name=None):
  return ctc_loss_v2(inputs=inputs, labels_indices=labels_indices, labels_values=labels_values, sequence_length=sequence_length, preprocess_collapse_repeated=preprocess_collapse_repeated, ctc_merge_repeated=ctc_merge_repeated, ignore_longer_outputs_than_inputs=ignore_longer_outputs_than_inputs, name=name)
CTCLossV2.__doc__ = ctc_loss_v2.__doc__
CTCLossV2 = _doc_controls.do_not_generate_docs(_kwarg_only(CTCLossV2))
tf_export("raw_ops.CTCLossV2")(CTCLossV2)


def ctc_loss_v2_eager_fallback(inputs, labels_indices, labels_values, sequence_length, preprocess_collapse_repeated=False, ctc_merge_repeated=True, ignore_longer_outputs_than_inputs=False, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function ctc_loss_v2
  """
  _ctx = ctx if ctx else _context.context()
  if preprocess_collapse_repeated is None:
    preprocess_collapse_repeated = False
