...
def GetTestUndeclaredOutputsDir(dir):
    return _pywrap_tensorflow_internal.GetTestUndeclaredOutputsDir(dir)
GetTestUndeclaredOutputsDir = _pywrap_tensorflow_internal.GetTestUndeclaredOutputsDir
