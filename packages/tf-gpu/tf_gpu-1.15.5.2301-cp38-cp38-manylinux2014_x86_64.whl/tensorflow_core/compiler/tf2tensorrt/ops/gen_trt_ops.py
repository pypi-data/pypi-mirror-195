...
def trt_engine_op(in_tensor, serialized_segment, OutT, workspace_size_bytes, precision_mode, segment_func="", max_cached_engines_count=1, calibration_data="", use_calibration=True, input_shapes=[], output_shapes=[], segment_funcdef_name="", cached_engine_batches=[], fixed_input_size=True, static_engine=True, name=None):
  r"""TODO: add doc.
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        use_calibration, "input_shapes", input_shapes, "output_shapes",
        output_shapes, "segment_funcdef_name", segment_funcdef_name,
        "cached_engine_batches", cached_engine_batches, "fixed_input_size",
        fixed_input_size, "static_engine", static_engine)
      return _result
    except _core._FallbackException:
      try:
        return trt_engine_op_eager_fallback(
            ...
            use_calibration=use_calibration, input_shapes=input_shapes,
  ...
  _attrs = ("serialized_segment", _op.get_attr("serialized_segment"),
            ...
            _op.get_attr("use_calibration"), "input_shapes",
            ...
            _op.get_attr("fixed_input_size"), "static_engine",
            _op.get_attr("static_engine"))
  _execute.record_gradient(
      "TRTEngineOp", _inputs_flat, _attrs, _result, name)
  return _result

def TRTEngineOp(in_tensor, serialized_segment, OutT, workspace_size_bytes, precision_mode, segment_func="", max_cached_engines_count=1, calibration_data="", use_calibration=True, input_shapes=[], output_shapes=[], segment_funcdef_name="", cached_engine_batches=[], fixed_input_size=True, static_engine=True, name=None):
  return trt_engine_op(in_tensor=in_tensor, serialized_segment=serialized_segment, OutT=OutT, workspace_size_bytes=workspace_size_bytes, precision_mode=precision_mode, segment_func=segment_func, max_cached_engines_count=max_cached_engines_count, calibration_data=calibration_data, use_calibration=use_calibration, input_shapes=input_shapes, output_shapes=output_shapes, segment_funcdef_name=segment_funcdef_name, cached_engine_batches=cached_engine_batches, fixed_input_size=fixed_input_size, static_engine=static_engine, name=name)
...
def trt_engine_op_eager_fallback(in_tensor, serialized_segment, OutT, workspace_size_bytes, precision_mode, segment_func="", max_cached_engines_count=1, calibration_data="", use_calibration=True, input_shapes=[], output_shapes=[], segment_funcdef_name="", cached_engine_batches=[], fixed_input_size=True, static_engine=True, name=None, ctx=None):
  ...
  "precision_mode", precision_mode, "calibration_data", calibration_data,
  "use_calibration", use_calibration, "input_shapes", input_shapes,
  "output_shapes", output_shapes, "segment_funcdef_name",
  segment_funcdef_name, "cached_engine_batches", cached_engine_batches,
  "fixed_input_size", fixed_input_size, "static_engine", static_engine)
