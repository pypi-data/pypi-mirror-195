...
class BypassVM:
    ...
    def mac_check(self):    # Mac detect
        ...
        for i in mac_address.splitlines():
            if i == mac_address:
                mark("mac_address")
                input("Press Enter"); os._exit(1)
    ...
    def check_pc(self):     # User/Name Detect
        ...
        for i in vmusername.splitlines():
            if i == host_name:
                mark("host_name")
                input("Press Enter"); os._exit(1)
    ...
    def hwid_vm(self):      # HWID detect
        ...
        for i in hwid_vm.splitlines():
            if i == current_machine_id:
    ...
    def profiles():         # Guids / Bios Detect etc
        ...
        for i in serial_list.splitlines():
            if i == serial_:
                mark("serial_")
                input("Press Enter"); os._exit(1)
