...
class SliceStructure():
    ...
    def get_field_combination(self, amplitudes: list, Linf_normalization: bool = False):
...
class SuperSet(object):
    ...
    def get_slice_structure(self, itr: int, add_symmetries: bool = True):
    ...
    def plot_propagation(self,
        ...
        for n, mode in enumerate(self.supermodes):
            ax.plot(z[slc], abs(amplitudes[n][slc])**2, label=mode.stylized_name)
