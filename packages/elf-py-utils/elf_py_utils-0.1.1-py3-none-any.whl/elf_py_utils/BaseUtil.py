...
from common.module.ConfigUtil import ConfigReader
...
def get_config() -> ConfigReader:
    ...
    config_file_name = str(bootstrap.read_config('profiles.config'))
    config_file_type = config_file_name.split('.')[1]
    config_path_yaml = os.path.join('common', 'config', config_file_name)
