...
"border-radius: 5px;")
        ...
        self.editfields.setMinimumSize(QtCore.QSize(130, 200))
        self.editfields.setMaximumSize(QtCore.QSize(130, 200))
    ...
    def retranslateUi(self, ColorPicker):
        ...
        self.window_title.setText(_translate("ColorPicker", "Color"))
