...
class Citation(BaseModel):
    ...
    def extract_id_prefix_citation_from_data(
        ...
        Examples:
            ...
            ('gr.1985.4.l-63915', 'gr/1985/4/l-63915', Citation(docket_category='GR', docket_serial='L-63915', docket_date=datetime.date(1985, 4, 24), docket='GR L-63915, Apr. 24, 1985', phil='220 Phil. 422', scra='136 SCRA 27', offg=None))
