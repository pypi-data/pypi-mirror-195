...
class FitCal:
    ...
    def iir_cuin_calc(self, meta_sval, dic_polc_rstr, curr_stag: int):
        ...
        if curr_stag == 0:
            ...
            para_medi = dic_polc_rstr[9]["prob_ablt"]
            dic_polc_rstr[9]["prob_ablt"] = 0
            dic_polc_rstr[13]["prob_ablt"] += para_medi
            para_medi = dic_polc_rstr[10]["prob_ablt"]
            dic_polc_rstr[10]["prob_ablt"] = 0
            dic_polc_rstr[14]["prob_ablt"] += para_medi
            para_medi = dic_polc_rstr[11]["prob_ablt"]
            dic_polc_rstr[11]["prob_ablt"] = 0
            dic_polc_rstr[15]["prob_ablt"] += para_medi
        elif curr_stag == 2:
            self.valu_kssr = 0
            self.valu_ksur = 1
        ...
        while para_numb <= 20:
            for numb_time in range(29):
                ...
                totl_cost += dic_polc_rstr[numb_time][1] * self.valu_tfir + self.valu_tsec  # 时间消耗
                totl_cost += dic_polc_rstr[numb_time][3] * self.valu_mtrl  # 物资消耗
                totl_cost += dic_polc_rstr[numb_time][4] * self.valu_mdcb  # 魔方消耗
                totl_outp += dic_polc_rstr[numb_time][5] * self.valu_kssr  # 金船图纸产出
                totl_outp += dic_polc_rstr[numb_time][6] * self.valu_ksur  # 彩船图纸产出
                totl_outp += dic_polc_rstr[numb_time][7] * self.valu_tcur  # 彩装蓝图产出
                totl_outp += dic_polc_rstr[numb_time][8] * self.valu_mtut  # 心智单元产出
                totl_outp *= dic_polc_rstr[numb_time][1]
                ...
                self.list_valu[numb_time][3] = dic_polc_rstr[numb_time][2]
                self.list_valu[numb_time][4] = dic_polc_rstr[numb_time][1]
