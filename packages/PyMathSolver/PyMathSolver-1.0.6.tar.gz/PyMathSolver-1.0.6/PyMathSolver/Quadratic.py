...
def about():
    ...
    print(colored('\n1) findRoots() - This function finds the roots of the Quadratic Equation. It has 3 parameters (Integers): Values of A, B, and C.', 'green'))
...
def findRoots(a, b, c):
    ...
    print(colored('\nThe roots of the equation are {0} and {1}.\n'.format(alpha, beta), 'green'))