...
def about():
    ...
    print(magenta("7) ") + magenta("ComplexNumbers", ["bold", "underlined"]) + magenta(" - Algebra of complex numbers, find the modulus, conjugate, and multiplicative inverse of a complex number, argand plane, and polar representation of a complex number."))
    ...
    print(green("Version", "bold") + green(" - 1.2.2"))
