...
# Function - About
def about():
    print(magenta("\nGeometry is the branch of science and mathematics that is concerned with properties of of space such as the distance, shape, volume, area, size, and relative position of figures."))
