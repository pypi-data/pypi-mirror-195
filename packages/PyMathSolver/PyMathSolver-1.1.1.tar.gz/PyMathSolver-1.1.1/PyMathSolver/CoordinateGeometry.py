...
# Function - About
def about():
    print(colored('\nCoordinate Geometry is the study of geometry using the coordinate points and planes. There are 3 axes: X-Axis, Y-Axis, and Z-Axis. Hence, there are also 3 planes: XY-Plane, YZ-Place, and XZ-Plane.', 'green'))

    print(colored('\nX-Coordinate - Abscissa', 'green'))
    print(colored('Y-Coordinate - Ordinate', 'green'))
    print(colored('Z-Coordinate - Applicate', 'green'))

    print(colored('\nPyMathSolver.CoordinateGeometry has the following functions:', 'green'))
    print(colored('\n1) distance() - Takes the coordinates of Point 1 and Point 2 as parameters and returns the distance.', 'green'))
    print(colored('2) collinear() - Takes the coordinates of Point 1, Point 2, and Point 3 and checks if the 3 points are collinear. It returns a boolean.', 'green'))
    print(colored('3) section() - Takes the coordinates of Point 1, Point 2, the Ratio, and "typeOfSection" as parameters. "typeOfSection" is either "Internal" or "External". It returns the coordinates of the point which divides the given coordinates in the given ratio.', 'green'))

    print(colored('\nNOTE: The coordinates of a point should be in the form of a tuple. Both points should be in the form (x₁, y₁) and (x₂, y₂) or (x₁, y₁, z₁) and (x₂, y₂, z₂). The ratio should be in the form (m, n).', 'red'))
