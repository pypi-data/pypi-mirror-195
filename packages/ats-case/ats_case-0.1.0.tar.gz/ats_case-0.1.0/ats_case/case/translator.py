...
class Translator(object):
    ...
    def _script(self):
        ...
        user_dir = os.path.join(root_dir, 'script', 'debug', self._context.tester.username)
    ...
    def _gen_import(self):
        return 'from case import command' + self.LINE + 'from case.context import Context' + self.LINE
