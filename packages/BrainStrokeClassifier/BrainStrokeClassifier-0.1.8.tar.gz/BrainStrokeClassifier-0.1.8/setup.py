...
setup(
    ...
    package_data = {'BrainStrokeClassifier': ['src/BrainStrokeClassifier/pickled_model/trained_model.pkl']},
    long_description = long_description,
    long_description_content_type = "text/markdown", 
    packages=["BrainStrokeClassifier","BrainStrokeClassifier.pickled_model"],
    package_dir={
        "": ".",
        "BrainStrokeClassifier": "./src/BrainStrokeClassifier",
        "BrainStrokeClassifier.pickled_model": "./src/BrainStrokeClassifier/pickled_model"
    },
