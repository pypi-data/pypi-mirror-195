...
class S3DataWrapper(DataWrapper):
    ...
    This DataWrapper wraps data that you have stored in AWS S3.
    You assign it to a step.

    ```python
    from vectice import S3DataWrapper
    ...
    def __init__(
        ...
        Parameters:
            ...
            name: The name of the [`DataWrapper`][vectice.models.datasource.datawrapper.data_wrapper.DataWrapper] (local to Vectice).
        ...
        super(S3DataWrapper, self).__init__(name, usage, derived_from)
