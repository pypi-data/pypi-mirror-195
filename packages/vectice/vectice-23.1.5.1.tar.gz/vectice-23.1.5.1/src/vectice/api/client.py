...
class Client:
    ...
    def register_dataset_from_source(
        ...
        derived_from = self.get_dataset_derived_from(data_source)
    ...
    def get_dataset_inputs(data_source: DataWrapper) -> list[int]:
        return Client.get_dataset_derived_from(data_source)

    @staticmethod
    def get_dataset_derived_from(data_source: DataWrapper) -> list[int]:
        return [] if data_source.derived_from is None else data_source.derived_from
