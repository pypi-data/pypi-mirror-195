...
class MapLayersEndpoint(Endpoint):
    ...
    def get(self, identifier: str, granularity: int) -> Dict[str, Any]:
        """Get the metadata of a specific map layer.

        :param identifier:  The identifier of the map layer.
    ...
    def put(self, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Create a new map layer. Required parameters for the creation of this entity are "title" and "world.id".

        {
            "title": "Town Map layer",
            "world": {
                "id":"{{worldId}}"
            }
        }

        :param content:     Metadata of the new map layer with at least he required fields.
        :return:            Metadata of the created map layer with the id.
        """
        return self._put_request(self.path, content)

    def patch(self, identifier: str, content: Dict[str, Any]) -> Dict[str, Any]:
        """
        Update (patch) the content of a map layer.

        :param identifier:  The id of the map layer to be updated.
        :param content:     All the fields that should be updated.
        :return:            Metadata of the map layer.
        """
    ...
    def delete(self, identifier: str):
        ...
        :param identifier:  The id of the map layer to be deleted.
        """
