...
def get_sub_files(path,full_path = True,include_folder=False,include='*',exclude=None):
    rs_list=[]
...
def join_path(path1,path2,path3=None,path4=None):
    if path4:
        return join_path(path1,path2,join_path(path3,path4))
    if path3:
        return join_path(path1,join_path(path2,path3))
