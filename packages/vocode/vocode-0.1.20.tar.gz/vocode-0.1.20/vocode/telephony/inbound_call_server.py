...
VOCODE_INBOUND_CALL_URL = f"https://api.vocode.dev/create_inbound_call"

class InboundCallServer():

    def __init__(self, agent_config: AgentConfig, synthesizer_config: Optional[SynthesizerConfig]):
