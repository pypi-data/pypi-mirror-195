...
args_before_x=[], args_after_x=[],
title="", xlabel="", ylabel="", function_label="", color="blue", linestyle ="-", **kwargs) :
...
min_y:float, max_y:float, values_y:int, args_before_variables=[], args_between_variables=[], args_after_variables=[], x_before_y = True,
ax=None, title="", xlabel ="", ylabel="", zlabel="", colormap=cm.RdYlGn, **kwargs) :
