...
class Notifications:
    ...
    def __init__(
        ...
        """Constructor to initialise the notifications object.
    ...
    @property
    def channel(self):
        """Gets the current notification channel.
    ...
    def job_started(self):
        """Checks if job started notifications are enabled.
    ...
    @property
    def job_failed(self):
        """Checks if job failed notifications are enabled.
    ...
    def job_completed(self):
        """Checks if job completed notifications are enabled.
