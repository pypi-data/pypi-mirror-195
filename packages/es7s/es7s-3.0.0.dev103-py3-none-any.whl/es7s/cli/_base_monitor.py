...
from ..shared.threads import class_to_command_name
...
class GenericRenderer(IMonitorRenderer):
    ...
    def wrap_progress_bar(self, *frags: RT, sep_left="▏", sep_right=" ") -> list[RT]:
        sep_left = pt.Fragment(sep_left, pt.Style(bg=Styles.STATUSBAR_BG, class_name="separator"))
        sep_right = pt.Fragment(sep_right, pt.Style(bg=Styles.STATUSBAR_BG, class_name="separator"))
