...
#            ['foo', ['bar', [['a1', 'v1']], "p4"]],
#            ['foo', ['bar', [['a1', 'v2']], "p5"]]]
# for path in ('foo/bar', 'foo/bar/@a1', 'foo/bar[@a1="v1"]'):
#     print("{}  |  {}".format(path, search_for_path(path, content)))
# print("{}  ->  {}".format('foo/bar[@a1="v1"]', search_for_path('foo/bar[@a1="v1"]', content, with_element=True)))
