<template>
	<div class="BuilderApp" tabindex="-1" v-on:keydown="handleKeydown">
		...
		>
								...
								<BuilderInsertionLabel>
									{{
										ss.getComponentDefinition(
											ss.getComponentById(candidateId)
												.type
										).name
									}}
								</BuilderInsertionLabel>
			...
			<div class="floatingContainer">
				<div class="floatingSticky">
					...
					<div
						class="settingsBar"
						:class="{ collapsed: ssbm.isSettingsBarCollapsed() }"
...
function handleKeydown(ev: KeyboardEvent): void {
	...
	if (ev.key == "ArrowUp" && ev.ctrlKey && ev.shiftKey) {
...
const handleRendererDragStart = (ev: DragEvent) => {
	...
	ev.dataTransfer.setData(`application/json;${type},${componentId}`, "{}");
};
