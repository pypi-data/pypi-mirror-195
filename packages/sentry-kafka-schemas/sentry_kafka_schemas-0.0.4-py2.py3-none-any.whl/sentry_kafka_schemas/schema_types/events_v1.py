from typing import Any, Dict, Union, Literal, List, Tuple, TypedDict
...
Event = Tuple[Union[int, float], str, "InsertEvent", "_Base"]
"""
Event.
...
_SentryEventTagsAnyof0ItemAnyof0 = Tuple[str, Union[str, None]]
"""
maxItems: 2
minItems: 2
"""
