...
class clf_within_ROI(ConfigReader):
    ...
    def __init__(self,
        ...
        if not os.path.isfile(self.roi_coordinates_path):
            print(f'SIMBA ERROR: No ROI coordinates found. Please use the [ROI] tab to define ROIs. Expected at location {self.roi_coordinates_path}')
            raise FileNotFoundError(f'SIMBA ERROR: No ROI coordinates found. Please use the [ROI] tab to define ROIs. Expected at location {self.roi_coordinates_path}')
