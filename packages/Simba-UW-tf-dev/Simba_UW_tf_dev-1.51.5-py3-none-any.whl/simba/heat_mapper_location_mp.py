...
class HeatMapperLocationMultiprocess(object):
    ...
    def __init__(self,
        ...
        self.out_parent_dir = os.path.join(self.project_path, Paths.HEATMAP_LOCATION_DIR.value)
    ...
    def create_heatmaps(self):
        ...
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            if self.video_setting:
                ...
                self.save_video_path = os.path.join(self.out_parent_dir, f'{self.video_name}.mp4')
            ...
            if self.final_img_setting:
                make_location_heatmap_plot(data_arr=location_array,
