...
def make_location_heatmap_plot(data_arr: np.array,
                               max_scale: float,
                               palette: str,
                               aspect_ratio: float,
                               file_name: str,
    ...
    cv2.imwrite(file_name, image)
    timer.stop_timer()
    print('SIMBA COMPLETE: Final location heatmap image saved at at {} (elapsed time: {}s)...'.format(file_name, timer.elapsed_time_str))
