...
class DeepEthogramImporter(object):
    ...
    def __init__(self,
        ...
        check_if_filepath_list_is_empty(filepaths=self.deepethogram_files_found,
                                        error_msg='SIMBA ERROR: ZERO DeepEthogram CSV files found in {} directory'.format(self.data_dir))
        check_if_filepath_list_is_empty(filepaths=self.features_files_found,
