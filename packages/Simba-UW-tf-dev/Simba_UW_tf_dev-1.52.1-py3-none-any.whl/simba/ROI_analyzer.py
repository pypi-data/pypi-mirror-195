...
class ROIAnalyzer(ConfigReader):
    ...
    def __init__(self,
        ...
        self.p_thresh = read_config_entry(self.config, ReadConfig.ROI_SETTINGS.value, ReadConfig.PROBABILITY_THRESHOLD.value, Dtypes.FLOAT.value, 0.00)
        if data_path != None:
...
# test = ROIAnalyzer(ini_path = r"/Users/simon/Desktop/envs/troubleshooting/two_animals_16bp_032023/project_folder"
#                               r"/project_config.ini",
