...
class HeatmapperLocationSingleCore(object):
    """
    ...
    def __init__(self,
        ...
        self.config, self.style_attr = read_config_file(config_path), style_attr
    ...
    def __create_img(self):
        ...
        plt.pcolormesh(self.color_array, shading=self.style_attr['shading'], cmap=self.style_attr['palette'], rasterized=True, alpha=1, vmin=0.0, vmax=float(self.max_scale))
    ...
    def create_heatmaps(self):
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            self.pixels_per_bin = int(float(self.px_per_mm) * float(self.style_attr['bin_size']))
