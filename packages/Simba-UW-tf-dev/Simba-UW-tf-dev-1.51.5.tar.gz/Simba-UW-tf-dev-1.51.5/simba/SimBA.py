...
class loadprojectini:
    def __init__(self,
        ...
        analyze_distances_velocity_timebins_btn = Button(processmovementdupLabel, text='ANALYZE DISTANCES / VELOCITY: TIME-BINS', fg='blue', command=lambda: TimeBinsMovementPopUp(config_path=str(self.projectconfigini)))
        self.hmlvar = IntVar()
        self.hmlvar.set(1)
