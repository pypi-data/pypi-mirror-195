  ...
  'syms': { 'domolibrary.classes.DomoAccount': { 'domolibrary.classes.DomoAccount.AccountConfig': ( 'classes/domoaccount.html#accountconfig',
            ...
            'domolibrary.client.get_data': { 'domolibrary.client.get_data.LooperError': ( 'client/get_data.html#loopererror',
                                             ...
                                             'domolibrary.client.get_data.looper_aiohttp': ( 'client/get_data.html#looper_aiohttp',
                                                                                             'domolibrary/client/get_data.py')},
            'domolibrary.domo_github.DomoDatacenter': { 'domolibrary.domo_github.DomoDatacenter.DomoDatacenter': ( 'classes/domodatacenter.html#domodatacenter',
                                                                                                                   'domolibrary/domo_github/DomoDatacenter.py'),
                                                        'domolibrary.domo_github.DomoDatacenter.DomoDatacenter.generate_search_datacenter_body': ( 'classes/domodatacenter.html#domodatacenter.generate_search_datacenter_body',
                                                                                                                                                   'domolibrary/domo_github/DomoDatacenter.py'),
                                                        'domolibrary.domo_github.DomoDatacenter.DomoEntity': ( 'classes/domodatacenter.html#domoentity',
                                                                                                               'domolibrary/domo_github/DomoDatacenter.py')},
