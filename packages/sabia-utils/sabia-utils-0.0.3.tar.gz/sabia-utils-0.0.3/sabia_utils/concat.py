...
import logging
from utils.concat_utils import concatenate_parquet_files, take_files_from_path, delete_duplicate_rows
import timeit

if "LOGGING_LEVEL" in os.environ:
    logging.basicConfig(level=os.getenv("LOGGING_LEVEL", default="DEBUG"))
...
def concatenate_all_from_path(path_in,path_out = None, file_name = None):
    '''
    ...
    try:
        ...
        df = delete_duplicate_rows(concatenate_parquet_files(parquet_files))
        ...
        if path_out is not None and file_name is not None:
