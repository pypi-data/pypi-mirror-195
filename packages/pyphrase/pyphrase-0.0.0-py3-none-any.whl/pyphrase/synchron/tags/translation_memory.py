...
class TranslationMemoryOperations:
    ...
    def getTransMemory(self, phrase_token: str, transMemoryUid: str) -> TransMemoryDto:
        """
    ...
    def downloadCleanedTM(self, phrase_token: str, asyncRequestId: str) -> bytes:
        """
        Download cleaned TM
    ...
    def clearTransMemory(self, phrase_token: str, transMemoryUid: str) -> None:
        """
        Delete all segments
    ...
    def clearTransMemoryV2(self, phrase_token: str, transMemoryUid: str) -> None:
        """
        Delete all segments.
