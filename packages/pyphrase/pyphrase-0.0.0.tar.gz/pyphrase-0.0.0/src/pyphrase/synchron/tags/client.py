...
class ClientOperations:
    ...
    def getClient(self, phrase_token: str, clientUid: str) -> ClientDto:
        """
        Get client
    ...
    def deleteClient(self, phrase_token: str, clientUid: str) -> None:
        """
        Delete client
    ...
    def createClient(self, phrase_token: str, body: ClientEditDto) -> ClientDto:
        """
        Create client
