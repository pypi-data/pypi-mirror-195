...
class Scope:
    ...
    def SetReturn(self, value: bool) -> None:
        self.Return = value
        if (self.Parent is not None and self.Parent.isFunction):
            self.Parent.SetReturn(value)



    def SetContinue(self, value: bool) -> None:
        self.Continue = value
        if (self.Parent is not None and self.Parent.isLoopRoot is False):
            self.Parent.SetContinue(value)



    def SetBreak(self, value: bool) -> None:
        self.Break = value
        if (self.Parent is not None and self.Parent.isLoopRoot is False):
            self.Parent.SetBreak(value)
