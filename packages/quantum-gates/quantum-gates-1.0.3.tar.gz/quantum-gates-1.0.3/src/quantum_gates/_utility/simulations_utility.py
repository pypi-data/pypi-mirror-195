...
def create_qc_list(circuit_generator, nqubits_list, qubits_layout, backend):
    """ Takes a generator of quantum circuits, a list of number of qubits, their layout, and a backend. Returns a list
        of transpiled circuits, generated by the Qiskit transpiler. The list items correspond 1:1 to the items in
        the list of qubits.
    """
    print("Warning:")
...
def load_config(filename: str="") -> dict:
    """ Asks for the config filename in the prompt, loads it and returns it as json file.
        Note: In case you provide a filename as argument, then you can choose to use this filename by providing the
        empty input.
    """
    if filename == "":
