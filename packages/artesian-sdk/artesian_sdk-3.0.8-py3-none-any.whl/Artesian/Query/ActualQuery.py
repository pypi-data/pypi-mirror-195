...
class ActualQuery(_Query):
    ...
    def withFillNone(self) -> ActualQuery:
        ...
        return self
    def withFillLatestValue(self, period: str, continueToEnd: bool = False) -> ActualQuery:
        """ 
            Optional filler strategy for the extraction.
        
            Args:
                period: string of the last period value to fill in case there are missing values. Ex.: withFillLatestValue("P5D") 
                continueToEnd: true means the fill value extends to the end of the period even if there's no value at the end of the period
