...
def split_examples(
    ...
    if shufffle:
        order = np.random.RandomState(random_seed).permutation(n_examples)
...
def get_labels_type(maybe_nested_labels):
    max_level = 1
