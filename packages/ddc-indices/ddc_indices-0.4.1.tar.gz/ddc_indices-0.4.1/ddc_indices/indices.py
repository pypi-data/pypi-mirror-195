...
from typing import Dict, Tuple, Union, MutableMapping, Optional, List
from xarray.backends import ZarrStore
from pydantic import ValidationError

from .compute import compute_spi, compute_spei, compute_pni
from .config import IndexConfig, SpiConfig, SpeiConfig, PniConfig, PdsiConfig
from .constants import *
from .eto import eto_hargreaves
from .metadata import DDC_INDICES_METADATA
from .errors import DataValidationError, IndexCalculationError, IndexConfigurationError
...
class Spi(Index):
    ...
    def compute(self) -> None:
        ...
        self._params = dict(alpha=alpha_ds, theta=theta_ds)
