...
from .constants import SpiPeriods, SpeiPeriods, PniPeriods, Distribution
...
def compute_spei(data_prec: xr.DataArray,
    ...
    PET values are subtracted from the precipitation values to come up with an array of (P - PET) values,
...
def compute_pni(data_prec: xr.DataArray,
    ...
    for ref_month in ref_months_list:
        ...
        time_steps = data_rolling_sum_coverage_range.groupby(
