...
class ModelMixture(Model):
    ...
    def prob_mode(self, params: jnp.ndarray,
        ...
        if self.dist == 'NB':
            ...
            pmf = dist.LeftTruncatedNewDist.logprob
            pmf = jnp.exp(pmf(data, r, p, self.left))
        elif self.dist == 'BetaNB':
            k = self.get_param('k', params)
    ...
    def cdf_mode(self, params: jnp.ndarray,
        ...
        if self.dist == 'NB':
            ...
            lp = dist.LeftTruncatedNewDist.long_cdf
            lp = lp(data, r, p, self.left)
        elif self.dist == 'BetaNB':
            k = self.get_param('k', params)
    ...
    def mean(self, params=None, return_modes=False):
        ...
        if self.dist == 'BetaNB':
            ...
            l1 = dist.LeftTruncatedNewDist.mean(r, p1, self.left)
            if self.bad == 1:
                l2 = l1
            else:
                l2 = dist.LeftTruncatedNewDist.mean(r, p2, self.left)
