...
from .util import tld_tree_update, tld_list_to_tree, tld_tree_path, get_logger
...
class TLDMagic(object):
    ...
    def __init__(self, initialtldlist:tp.Iterable[str]=()):
        self.tldtree = {}  # store
    ...
    def get_tld(self, fqdn:str) -> tp.Union[None, str]:
