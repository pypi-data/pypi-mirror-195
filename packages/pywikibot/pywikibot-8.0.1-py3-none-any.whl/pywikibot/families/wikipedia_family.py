...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ast', 'zh-yue', 'lv', 'lld', 'tg', 'af', 'my', 'mg', 'bs', 'mr', 'sq',
        'oc', 'nds', 'ml', 'be-tarask', 'te', 'ky', 'br', 'sw', 'jv', 'new',
        'vec', 'ht', 'pms', 'pnb', 'ba', 'lb', 'su', 'ku', 'ga', 'lmo', 'szl',
        'is', 'fy', 'cv', 'ckb', 'tl', 'an', 'wuu', 'pa', 'diq', 'io', 'sco',
        'vo', 'yo', 'ne', 'gu', 'kn', 'als', 'ia', 'bar', 'avk', 'scn', 'bpy',
        'qu', 'crh', 'mn', 'nv', 'ha', 'xmf', 'si', 'ban', 'ps', 'bat-smg',
        ...
        'myv', 'vls', 'nds-nl', 'nah', 'sc', 'kw', 'glk', 'vep', 'kab', 'tk',
        'gan', 'co', 'dag', 'ary', 'fiu-vro', 'bo', 'ab', 'gv', 'frp', 'zea',
        'skr', 'ug', 'udm', 'pcd', 'kv', 'csb', 'mt', 'gn', 'ay', 'smn', 'nrm',
        'rw', 'lez', 'lfn', 'stq', 'olo', 'lo', 'mwl', 'ang', 'fur', 'rm',
        'lad', 'gom', 'koi', 'tyv', 'ext', 'dsb', 'av', 'ln', 'dty', 'cbk-zam',
        'kaa', 'pap', 'dv', 'ksh', 'gag', 'bxr', 'pfl', 'mdf', 'ks', 'tw',
        'pi', 'pag', 'szy', 'haw', 'awa', 'za', 'tay', 'blk', 'inh', 'lg',
        'krc', 'xal', 'pdc', 'atj', 'to', 'arc', 'tcy', 'mnw', 'jam', 'kbp',
        'na', 'wo', 'kbd', 'nia', 'nov', 'ki', 'nqo', 'bi', 'tpi', 'tet',
        'shi', 'jbo', 'roa-rup', 'fj', 'lbe', 'xh', 'kg', 'ty', 'cu', 'guw',
        'om', 'trv', 'srn', 'sm', 'gcr', 'alt', 'chr', 'ltg', 'ny', 'tn', 'st',
        'mad', 'pih', 'got', 'ami', 'ee', 'rmy', 'bm', 've', 'ts', 'ff', 'chy',
        'ss', 'iu', 'rn', 'kcg', 'ak', 'ch', 'pcm', 'ik', 'pnt', 'ady', 'pwn',
        'sg', 'din', 'kl', 'ti', 'dz', 'cr', 'guc', 'gur',
    ]
