...
class ImageFont:
    ...
    def getmask(self, text, mode="", *args, **kwargs):
        ...
        :return: An internal _PIL storage memory instance as defined by the
                 :py:mod:`_PIL.Image.core` interface module.
        """
...
class FreeTypeFont:
    ...
    def getoffset(self, text):
        ...
        included in the result of :py:func:`~_PIL.ImageFont.FreeTypeFont.getsize`.
    ...
    def getmask2(
        ...
        **kwargs,
        ...
        :return: A tuple of an internal _PIL storage memory instance as defined by the
                 :py:mod:`_PIL.Image.core` interface module, and the text offset, the
...
def truetype(font=None, size=10, index=0, encoding="", layout_engine=None):
    ...
    :param layout_engine: Which layout engine to use, if available:
                     ...
                     :py:func:`_PIL.features.check_feature` with ``feature="raqm"``.
...
def load_path(filename):
    """
    Load font file. Same as :py:func:`~_PIL.ImageFont.load`, but searches for a
