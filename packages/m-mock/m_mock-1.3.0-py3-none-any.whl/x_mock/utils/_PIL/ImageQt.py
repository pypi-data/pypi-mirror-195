...
def fromqimage(im):
    """
    :param im: QImage or _PIL ImageQt object
    """
    buffer = QBuffer()
    if qt_version == "6":
        try:
...
if qt_is_installed:
    ...
    class ImageQt(QImage):
        def __init__(self, im):
            """
            An _PIL image wrapper for Qt.  This is a subclass of PyQt's QImage
            class.

            :param im: A _PIL Image object, or a file name (given either as
