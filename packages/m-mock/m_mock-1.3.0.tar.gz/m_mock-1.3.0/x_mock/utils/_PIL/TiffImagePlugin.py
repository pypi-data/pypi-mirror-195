...
# 1999-06-13 fl   Rewritten for _PIL 1.0 (1.0)
...
class ImageFileDirectory_v2(MutableMapping):
    ...
    tag types in
    :attr:`~_PIL.TiffImagePlugin.ImageFileDirectory_v2.tagtype`. The types
    ...
    :py:class:`~_PIL.TiffImagePlugin.ImageFileDirectory_v1`, if ``legacy_api``
    ...
    def save(self, fp):
        ...
        if fp.tell() == 0:  # skip TIFF header on subsequent pages
            # tiff header -- _PIL always starts the first IFD at offset 8
...
class ImageFileDirectory_v1(ImageFileDirectory_v2):
    ...
    :attr:`~_PIL.TiffImagePlugin.ImageFileDirectory_v1.tagtype`.
    ...
    def from_v2(cls, original):
        """Returns an
        :py:class:`~_PIL.TiffImagePlugin.ImageFileDirectory_v1`
        instance with the same data as is contained in the original
        :py:class:`~_PIL.TiffImagePlugin.ImageFileDirectory_v2`
        instance.

        :returns: :py:class:`~_PIL.TiffImagePlugin.ImageFileDirectory_v1`
    ...
    def to_v2(self):
        ...
        :returns: :py:class:`~_PIL.TiffImagePlugin.ImageFileDirectory_v2`
