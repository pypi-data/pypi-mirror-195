...
class CoffeeOffers(viewsets.ViewSet):
    ...
    def _get_quota(self, user) -> float:
        ...
        # Round quota
        quota = int(round(quota/settings.COFFEE_OFFER_ROUND_FACTOR))*settings.COFFEE_OFFER_ROUND_FACTOR
        return quota
    ...
    def pre_load(self, request) -> Response:
        ...
        try:
            ...
            data_return = {
                ...
                "to_date": to_date,
                "offers": Offer.objects.get_active_offers(user),
