...
class SoPSuperFunction(SoPFunction):
    ...
    def _super_action_wrapper(self, super_action_request: Union[SoPSuperScheduleRequest, SoPSuperExecuteRequest], hierarchical_service_table: Dict[str, List[SoPService]]):
        ...
        try:
            ...
            SOPLOG_DEBUG(
                f'[{super_action_request._action_type.value.upper()} END] {super_action_request._action_type.value} of {self._name} by scenario {super_action_request._trigger_msg._requester_middleware_name}|{super_action_request._trigger_msg._scenario} end. duration: {super_action_request.duration():.4f} Sec', 'green')
