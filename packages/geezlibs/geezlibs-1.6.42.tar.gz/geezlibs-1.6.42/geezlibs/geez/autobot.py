...
async def geez_log():
    ...
    group_name = 'GeezPyro Log Group'
    group_description = 'Group untuk Log GeezPyro, Jangan keluar atau delete group ini'
    ...
    message_text = 'Bot Log Group diaktifkan\nHarap masukan bot anda secara manual ke group ini!,\nrestarting now'
