...
class YieldTestCase(ModuleTestCase):
    ...
    def test_yield_dividend_category_in(self):
        ...
        self.assertEqual(book_asset.rec_name, 'Depot | 27.50 usd | Open | 3.0000 u')
    ...
    def test_yield_dividend_transfer_from_splitbooking_cash_out(self):
        ...
        self.assertEqual(book_asset.rec_name, 'Depot | 13.50 usd | Open | 2.0000 u')
        self.assertEqual(len(book_asset.lines), 2)
        self.assertEqual(book_cash.rec_name, 'Cash | 20.00 usd | Open')
        self.assertEqual(len(book_cash.lines), 1)

        self.assertEqual(book_asset.lines[0].rec_name,
            '05/02/2022|to|-10.00 usd|sell shares [Cash | 20.00 usd | Open]|-1.0000 u')
        self.assertEqual(book_asset.lines[1].rec_name,
        ...
        self.assertEqual(book_asset.lines[0].asset_gainloss, Decimal('0.0'))
        self.assertEqual(book_asset.lines[0].asset_dividend, Decimal('10.0'))
    ...
    def test_yield_dividend_transfer_to_splitbooking_aset(self):
        ...
        self.assertEqual(book_asset.rec_name, 'Depot | 43.50 usd | Open | 4.0000 u')
        self.assertEqual(len(book_asset.lines), 2)
        ...
        self.assertEqual(book_cash.lines[0].rec_name,
            '05/02/2022|to|-10.00 usd|buy shares [Depot | 43.50 usd | Open | 4.0000 u]')

        self.assertEqual(book_asset.lines[0].asset_gainloss, Decimal('0.0'))
        self.assertEqual(book_asset.lines[0].asset_dividend, Decimal('00.0'))
        self.assertEqual(book_asset.lines[0].trade_fee, Decimal('0.0'))

        self.assertEqual(book_asset.lines[1].asset_gainloss, Decimal('0.0'))
        self.assertEqual(book_asset.lines[1].asset_dividend, Decimal('10.0'))
