...
from np_workflows.models.experiment import WithLims
...
def save(experiment: WithLims, suffix: Optional[str] = None):
...
def most_recent_session(experiment_type: Type[WithLims]) -> pathlib.Path | None:
...
def most_recent_save(experiment_type: Type[WithLims]) -> pathlib.Path | None:
