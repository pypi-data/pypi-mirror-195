...
try:
    ...
    from np_workflows.services.protocols import (Finalizable, Startable,
                                                 Stoppable)
...
def review_photodoc_enter(state_globals) -> None:
    ...
    for service in npxc.experiment.photodoc_services:
        ...
        pdb.set_trace()
        raise ValueError(
            f"No photodoc image found from services {[_.__name__ for _ in npxc.experiment.photodoc_services]}"
        )
