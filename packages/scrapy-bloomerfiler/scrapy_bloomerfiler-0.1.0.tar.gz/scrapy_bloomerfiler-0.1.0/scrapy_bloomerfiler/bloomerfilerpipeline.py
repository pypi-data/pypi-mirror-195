...
class BloomFilterPipeline(object):
    ...
    def from_crawler(cls, crawler):
        ...
        section_select ="redis_cfg_prod" if os.environ.get('IF_PROD') in ("True","true",True) \
             or get_config().get("settings","IF_PROD",fallback="False") in ("True","true",True) else "redis_cfg_dev"
