...
def awslambda():from localstack.services.awslambda import lambda_starter as A;from localstack_ext.services.awslambda.lambda_extended import patch_lambda as B;B();return Service(_A,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,lifecycle_hook=A.LambdaLifecycleHook())
@pro_aws_provider(api=_A,name=_B)
def lambda_asf():from localstack_ext.services.awslambda.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
@pro_aws_provider(api=_A,name=_C)
def lambda_v2():from localstack_ext.services.awslambda.provider import LambdaProviderPro as A;B=A();return Service.for_provider(B)
...
@pro_aws_provider(api='s3',name=_B)
...
@pro_aws_provider(api='s3',name=_C)
