...
class TkinterConfigLoader(ConfigLoader):
    def __init__(self, namespace: typing.Dict[str, typing.Any], title=gettext.gettext('Config'), icon=None) -> None:
...
def load_tkinter(namespace, title: typing.Union[str, None]=None, icon=None) -> typing.Any:
