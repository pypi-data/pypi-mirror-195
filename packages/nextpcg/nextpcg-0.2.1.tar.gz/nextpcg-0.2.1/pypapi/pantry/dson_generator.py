...
from pypapi.module_protocol import module_send_done
import sys
import os
import json
import logging
...
dson_module_name = '{dson_config['name']}'
dispatcher = Dispatcher()
logger = logging.getLogger('pypapi_'+dson_module_name)
...
if __name__ == "__main__":
    try:
        ...
        generate_dson_files(dson_config['name'], dson_path)
