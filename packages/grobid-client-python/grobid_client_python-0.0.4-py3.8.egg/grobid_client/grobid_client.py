...
class GrobidClient(ApiClient):
    ...
    def process_txt(
        ...
        if bibtex:
            local_headers = {"Accept": "application/x-bibtex"}
        else:
            local_headers = {"Accept": "application/xml"}
...
def main():
    ...
    parser.add_argument(
        "--bibtex",
        action="store_true",
        help="return extracted reference in BibTeX format, only for processReferences and processCitationList services",
    )
    parser.add_argument(
        "--verbose",
        action="store_true",
