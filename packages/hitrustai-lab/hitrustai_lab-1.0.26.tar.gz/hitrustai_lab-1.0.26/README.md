...
pypy最新版本
```sh
pip install hitrustai-lab==1.0.26
```
...
tmts = TrainModelToSQl(dict_init_arg, host="192.168.10.102", port="3305", user="root", passwd="root16313302", db="diia_test")
tmts.insert_db(Model_Performance)
