...
pypy最新版本
```sh
pip install hitrustai-lab==1.0.33
```
...
def main():
    ...
    output_txt = template_output_txt % (
        htt.dict_init_arg["training_id_lst"],
        htt.dict_init_arg["customer_id_lst"],
        htt.dict_init_arg["model_id_lst"],
        htt.dict_init_arg["training_data_start_date"],
        htt.dict_init_arg["training_data_end_date"],
        htt.dict_init_arg["number_of_dump_data"],
        htt.dict_init_arg["training_start_time_lst"],
        htt.dict_init_arg["total_training_time_lst"],
        htt.dict_init_arg["return_code"],
        htt.dict_init_arg["reason"],

    )
    path = './data/lib/output.txt'
