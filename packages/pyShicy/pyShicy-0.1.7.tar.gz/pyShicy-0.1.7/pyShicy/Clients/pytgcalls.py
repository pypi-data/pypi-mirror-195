...
class ClientCalls(object):
    async def StartAud(self, video_ids):
        if SHICY1:
            try:
                await SHICY1.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY1.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY2:
            try:
                await SHICY2.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY2.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY3:
            try:
                await SHICY3.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY3.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY4:
            try:
                await SHICY4.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY4.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY5:
            try:
                await SHICY5.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY5.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY6:
            try:
                await SHICY6.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY6.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY7:
            try:
                await SHICY7.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY7.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY8:
            try:
                await SHICY8.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY8.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY9:
            try:
                await SHICY9.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY9.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
        if SHICY10:
            try:
                await SHICY10.group_call.start_audio(video_ids)
            except BaseException as ex:
                await SHICY10.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
                )
    ...
    async def StartVid(self, video_ids):
        if SHICY1:
            try:
                await SHICY1.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY1.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY2:
            try:
                await SHICY2.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY2.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY3:
            try:
                await SHICY3.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY3.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY4:
            try:
                await SHICY4.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY4.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY5:
            try:
                await SHICY5.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY5.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY6:
            try:
                await SHICY6.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY6.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY7:
            try:
                await SHICY7.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY7.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY8:
            try:
                await SHICY8.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY8.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY9:
            try:
                await SHICY9.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY9.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY10:
            try:
                await SHICY10.group_call.start_video(video_ids)
            except BaseException as ex:
                await SHICY10.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
    ...
    async def JoinVc(self, ids):
        if SHICY1:
            try:
                await SHICY1.group_call.join(ids)
            except BaseException as ex:
                await SHICY1.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY2:
            try:
                await SHICY2.group_call.join(ids)
            except BaseException as ex:
                await SHICY2.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY3:
            try:
                await SHICY3.group_call.join(ids)
            except BaseException as ex:
                await SHICY3.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY4:
            try:
                await SHICY4.group_call.join(ids)
            except BaseException as ex:
                await SHICY4.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY5:
            try:
                await SHICY5.group_call.join(ids)
            except BaseException as ex:
                await SHICY5.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY6:
            try:
                await SHICY6.group_call.join(ids)
            except BaseException as ex:
                await SHICY6.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY7:
            try:
                await SHICY7.group_call.join(ids)
            except BaseException as ex:
                await SHICY7.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY8:
            try:
                await SHICY8.group_call.join(ids)
            except BaseException as ex:
                await SHICY8.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY9:
            try:
                await SHICY9.group_call.join(ids)
            except BaseException as ex:
                await SHICY9.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
        ...
        if SHICY10:
            try:
                await SHICY10.group_call.join(ids)
            except BaseException as ex:
                await SHICY10.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
    ...
    async def LeaveVc(self, video_ids):
        ...
        if SHICY10:
            try:
                await SHICY10.group_call.leave()
            except BaseException as ex:
                await SHICY10.send_message(
                    Var.LOG_CHAT,
                    f'KESALAHAN: {ex}',
...
class GroupCalls(ClientCalls, Queues):
    ...
    async def StartVc(self, client, m, title=None):
        ...
        titt = title if title else "🎧 SHICY Music 🎧"
