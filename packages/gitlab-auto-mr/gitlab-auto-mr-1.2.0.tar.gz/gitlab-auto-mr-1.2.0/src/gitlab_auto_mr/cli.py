...
@click.option("--commit-prefix", "-c", default="Draft", help="Prefix for the MR title e.g. Draft.")
...
def get_mr_title(commit_prefix, source_branch):
    """Gets the title of the MR. If a prefix exists we add it to the URL. By default we add a prefix of Draft, so the
    MR doesn't get merged by accident.

    Args:
        commit_prefix (str): Prefix for the MR title e.g. Draft.
